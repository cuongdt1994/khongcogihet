...
struct TaskInterface
{
	...
	//virtual bool GoldConvert(unsigned int) = 0;
	virtual void TakeAwayGold(unsigned int ulNum) = 0;
	virtual unsigned int GetGoldNumNew() = 0;
	virtual void TakeAwayGoldNew(unsigned int ulNum) = 0;
	...
	virtual unsigned int GetCurPeriodFlag() = 0;
	...
	virtual bool GetPointsEventTask(unsigned int uTaskID) = 0;
	...
	virtual void LeaveCarrier() = 0;
	virtual void UnlockRepositorySystem() = 0;
	virtual bool CheckEventValidTask(int task_id) = 0;
	virtual void TaskExpCelestialMemorial(int swallow_exp) = 0;
	virtual void SetAnecdotePoints() = 0;
