...
enum
{
	...
	CLS_PLAYER_CONTROLLER_LESS_10,			//3  �Ѿ�����
	...
	// arena of aurora
	CLS_ARENAOFAURORA_SWITCH_DATA,	// 75
	CLS_ARENAOFAURORA_PLAYER_IMP,	// 76
	// end arena of aurora
	
	CLS_CARRIER_AGGRO_POLICY, // 77
	...
	CLS_SESSION_CARRIER_SKILL,
	CLS_SESSION_PRODUCE_NEW_ARMOR,
...
// arena of aurora
	CLS_FILTER_CHECK_ARENAOFAURORA_KEY,
	CLS_FILTER_ARENA_INVISIBLE,
// end arena of aurora
