...
namespace 
{
	...
	//glyph point
	template <>
	class arg_addon<GLYPH_POINT> : public addon_handler
	{
	public:
		virtual int GenerateParam(int datatype,addon_data & data,int arg_num)
		{
			...
			float p1 = *(float*)&(data.arg[1]);
			data.arg[0] = p0 + p1;
			//data.arg[0] = abase::RandNormal((int)(p0 * 1.f), (int)(p1 * 1.f));
			return 1;
		}
...
class enhance_speed_addon_2 : public addon_handler // 2 Argumentos em porcentagem
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
		// Calcula aleatóriamente 2 valores entre os valores passados
		ASSERT(arg_num == 2);
		data.arg[0] = abase::Rand(data.arg[0] ,data.arg[1]);
		return 1;
	}
...
class enhance_speed_addon_point_2arg : public addon_handler // 2 Argumentos em pontos
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
		// Calcula aleatóriamente 2 valores entre os valores passados
		ASSERT(arg_num == 2);
		*(float*)&(data.arg[0]) = abase::Rand(*(float*)&(data.arg[0]) ,*(float*)&(data.arg[1]));
		return 1;
	}
	virtual int ApplyAtGeneration(const addon_data & data, void * essence,unsigned int ess_size,prerequisition * require){return 0;}
	virtual int UpdateItem(const addon_data & , equip_item *){return addon_manager::ADDON_MASK_ACTIVATE;}
...
class template_crit_damage: public arg_addon<ARG_TYPE>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
	...
	virtual int Activate(const addon_data & data, equip_item * item, gactive_imp *pImp)
	{
		pImp->_crit_damage_bonus += data.arg[0];
		return 0;
	}
...
typedef template_crit_damage<POINT>			enhance_template_crit_damage;
typedef template_crit_damage<DOUBLE_POINT>	enhance_template_crit_damage_2arg;

template <typename ARG_TYPE>
class template_crit_damage_reduce: public arg_addon<ARG_TYPE>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
	...
	virtual int Activate(const addon_data & data, equip_item * item, gactive_imp *pImp)
	{
		pImp->_crit_damage_reduce += data.arg[0];
		return 0;
	}
...
typedef template_crit_damage_reduce<POINT>			enhance_template_crit_damage_reduce;
typedef template_crit_damage_reduce<DOUBLE_POINT>	enhance_template_crit_damage_reduce_2arg;
...
class enhance_attack_speed_addon_2arg : public addon_handler
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
		float speed = abase::RandNormal(*(float*)&data.arg[0] , *(float*)&data.arg[1]);
		ASSERT(speed >= -1 && speed <= 1);
		if(speed <= -1 || speed> 1) return -1;
		data.arg[0] = (int)(speed * 20);
...
public:
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->_skill.ActivateSkill(pImp,data.arg[0],data.arg[1],0);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->_skill.DeactivateSkill(pImp,data.arg[0],data.arg[1],0);
		return 0;
	}
};

class item_skill_addon_2 : public addon_handler
{
public:
	//155 skilladdon2
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->_skill.ActivateSkill(pImp,data.arg[0],data.arg[1], 1);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->_skill.DeactivateSkill(pImp,data.arg[0],data.arg[1], 1);
		return 0;
	}
};
...
public:
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->_skill.ActivateReboundSkill(pImp,data.arg[0],data.arg[1],data.arg[2], 0);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->_skill.DeactivateReboundSkill(pImp,data.arg[0],data.arg[1],data.arg[2], 0);
		return 0;
	}
};

class item_rebound_skill_addon2 : public addon_handler
{
public:
	//155 reboundskilladdon2
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
		ASSERT(arg_num == 3);
		return 3;
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->_skill.ActivateReboundSkill(pImp,data.arg[0], 1, data.arg[1],data.arg[2]);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->_skill.DeactivateReboundSkill(pImp,data.arg[0], 1, data.arg[1],data.arg[2]);
		return 0;
	}
};

// Nível de Genesis
class dynamic_genesis_level : public addon_handler
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		// Ativa o nível de genesis
		pImp->_skill.ActivateDynGenesisLevel(pImp,0,data.arg[0],data.arg[1]);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		// Desativa o nível de genesis
		pImp->_skill.DeactivateDynGenesisLevel(pImp,0,data.arg[0],data.arg[1]);
		return 0;
	}
};

class new_armor_skill_addon : public addon_handler
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->_skill.NewArmorActivateSkill(pImp,data.arg[0],data.arg[1]);
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->_skill.NewArmorDeactivateSkill(pImp,data.arg[0],data.arg[1]);
		return 0;
	}
};
...
class enhance_fly_speed_addon : public addon_handler
{
public:
	virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
	{
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		pImp->EnhanceFlySpeedEn( *(float*)&(data.arg[0]));
		return 0;
	}

	virtual int Deactivate(const addon_data & data, equip_item *, gactive_imp *pImp)
	{
		pImp->ImpairFlySpeedEn( *(float*)&(data.arg[0]));
		return 0;
	}
};
...
//--glyph
template <typename GLYPH_POINT>
class template_enhance_all_resistance_3: public arg_addon<GLYPH_POINT>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
...
template <typename GLYPH_POINT>
class template_enhance_magic_damage_3: public arg_addon<GLYPH_POINT>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
...
template <typename GLYPH_POINT>
class template_enhance_damage_3: public arg_addon<GLYPH_POINT>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
...
typedef EPSA_addon<int, ANTI_DEF_OFF,DOUBLE_POINT> enhance_anti_def_addon_2;
typedef EPSA_addon<int, ANTI_RESIST_OFF,DOUBLE_POINT> enhance_anti_resist_addon_2;
typedef EPSA_addon<int, VIGOUR_EN_OFF,DOUBLE_POINT> enhance_vigour_2;
typedef EPSA_addon<int, MY_OFFSETOF(gactive_imp,_highest_level),POINT> enhance_highest_level_addon;
typedef EPSA_addon<int, MY_OFFSETOF(gactive_imp,_highest_level),DOUBLE_POINT> enhance_highest_level_addon_2;

typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,attack),DOUBLE_PERCENT> enhance_attack_addon_float;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,attack),PERCENT> enhance_attack_addon_float_single;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,armor),DOUBLE_PERCENT> enhance_armor_addon_float;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,max_hp),DOUBLE_PERCENT> enhance_hp_addon_float;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,max_mp),DOUBLE_PERCENT> enhance_mp_addon_float;
typedef refine_addon_template2<enhance_attack_degree_2arg,enhance_defend_degree_2arg> enhance_attack_and_defend_degree;
typedef refine_addon_template<enhance_vigour> refine_vigour;
typedef refine_addon_template<enhance_attack_degree> refine_attack_degree;
typedef refine_addon_template<enhance_defend_degree> refine_defend_degree;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,max_hp),GLYPH_POINT> enhance_hp_addon_3;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,defense),GLYPH_POINT> enhance_defense_addon_3;
typedef EPSA_addon<float, POINT_OFF+offsetof(enhanced_param,eng), GLYPH_POINT> enhance_eng_addon_3;
typedef template_enhance_all_resistance_3<GLYPH_POINT> enhance_all_resistance_addon_3;
typedef template_enhance_magic_damage_3<GLYPH_POINT> enhance_magic_damage_addon_3;
typedef template_enhance_damage_3<GLYPH_POINT>		enhance_damage_addon_3;
typedef EPSA_addon<float, MY_OFFSETOF(gactive_imp,_defend_degree),GLYPH_POINT> enhance_defend_degree_3;
typedef EPSA_addon<float, MY_OFFSETOF(gactive_imp,_attack_degree),GLYPH_POINT> enhance_attack_degree_3;
typedef EPSA_addon<int, VIGOUR_EN_OFF,GLYPH_POINT> enhance_vigour_3;
...
#define TEMPORARY_ADDON_MACRO(type) temporary_addon_template<type>
	...
	// Finaliza os addons prontos
	INSERT_ADDON(3221, item_skill_addon_2);
	INSERT_ADDON(3222, item_skill_addon_2);
	INSERT_ADDON(3223, item_skill_addon_2);
	INSERT_ADDON(3224, item_skill_addon_2);
	INSERT_ADDON(3225, item_skill_addon_2);
	INSERT_ADDON(3226, item_rebound_skill_addon2);
	INSERT_ADDON(3227, item_rebound_skill_addon2);
	INSERT_ADDON(3228, item_rebound_skill_addon2);
	INSERT_ADDON(3229, item_rebound_skill_addon2);
	INSERT_ADDON(3230, enhance_attack_degree);
	INSERT_ADDON(3231, enhance_defend_degree);
	INSERT_ADDON(3232, enhance_str_addon);
	INSERT_ADDON(3233, enhance_eng_addon);
	INSERT_ADDON(3234, enhance_agi_addon);
	INSERT_ADDON(3235, enhance_vit_addon);
	INSERT_ADDON(3236, enhance_vigour);
	INSERT_ADDON(3237, enhance_vigour);
	INSERT_ADDON(3238, enhance_vigour);
	INSERT_ADDON(3239, item_skill_addon_2);
	INSERT_ADDON(3240, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3241, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3242, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3243, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3244, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3245, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3246, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3247, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3248, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3249, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3250, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3251, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3252, enhance_str_addon_1arg);
	INSERT_ADDON(3253, enhance_eng_addon_1arg);
	INSERT_ADDON(3254, enhance_agi_addon_1arg);
	INSERT_ADDON(3255, enhance_str_addon_1arg);
	INSERT_ADDON(3256, enhance_agi_addon_1arg);
	INSERT_ADDON(3257, enhance_eng_addon_1arg);
	INSERT_ADDON(3258, enhance_vit_addon_1arg);
	INSERT_ADDON(3259, enhance_str_addon_1arg);
	INSERT_ADDON(3260, enhance_agi_addon_1arg);
	INSERT_ADDON(3261, enhance_eng_addon_1arg);
	INSERT_ADDON(3262, enhance_vit_addon_1arg);
	INSERT_ADDON(3263, enhance_attack_degree);
	INSERT_ADDON(3264, enhance_attack_degree);
	INSERT_ADDON(3265, enhance_defend_degree);
	INSERT_ADDON(3266, enhance_defend_degree);
	INSERT_ADDON(3267, enhance_vit_addon); // Null
	INSERT_ADDON(3268, enhance_vit_addon); // Null
	INSERT_ADDON(3269, enhance_hp_addon_3); // Rune Start
	INSERT_ADDON(3270, enhance_hp_addon_3);
	INSERT_ADDON(3271, enhance_hp_addon_3);
	INSERT_ADDON(3272, enhance_hp_addon_3);
	INSERT_ADDON(3273, enhance_hp_addon_3);
	INSERT_ADDON(3274, enhance_hp_addon_3);
	INSERT_ADDON(3275, enhance_hp_addon_3);
	INSERT_ADDON(3276, enhance_hp_addon_3);
	INSERT_ADDON(3277, enhance_hp_addon_3);
	INSERT_ADDON(3278, enhance_hp_addon_3);
	INSERT_ADDON(3279, enhance_defense_addon_3);
	INSERT_ADDON(3280, enhance_defense_addon_3);
	INSERT_ADDON(3281, enhance_defense_addon_3);
	INSERT_ADDON(3282, enhance_defense_addon_3);
	INSERT_ADDON(3283, enhance_defense_addon_3);
	INSERT_ADDON(3284, enhance_defense_addon_3);
	INSERT_ADDON(3285, enhance_defense_addon_3);
	INSERT_ADDON(3286, enhance_defense_addon_3);
	INSERT_ADDON(3287, enhance_all_resistance_addon_3);
	INSERT_ADDON(3288, enhance_all_resistance_addon_3);
	INSERT_ADDON(3289, enhance_all_resistance_addon_3);
	INSERT_ADDON(3290, enhance_all_resistance_addon_3);
	INSERT_ADDON(3291, enhance_all_resistance_addon_3);
	INSERT_ADDON(3292, enhance_all_resistance_addon_3);
	INSERT_ADDON(3293, enhance_all_resistance_addon_3);
	INSERT_ADDON(3294, enhance_all_resistance_addon_3);
	INSERT_ADDON(3295, enhance_magic_damage_addon_3);
	INSERT_ADDON(3296, enhance_magic_damage_addon_3);
	INSERT_ADDON(3297, enhance_magic_damage_addon_3);
	INSERT_ADDON(3298, enhance_magic_damage_addon_3);
	INSERT_ADDON(3299, enhance_magic_damage_addon_3);
	INSERT_ADDON(3300, enhance_magic_damage_addon_3);
	INSERT_ADDON(3301, enhance_damage_addon_3);
	INSERT_ADDON(3302, enhance_damage_addon_3);
	INSERT_ADDON(3303, enhance_damage_addon_3);
	INSERT_ADDON(3304, enhance_damage_addon_3);
	INSERT_ADDON(3305, enhance_damage_addon_3);
	INSERT_ADDON(3306, enhance_damage_addon_3);
	INSERT_ADDON(3307, enhance_vigour_3);
	INSERT_ADDON(3308, enhance_vigour_3);
	INSERT_ADDON(3309, enhance_vigour_3);
	INSERT_ADDON(3310, enhance_defend_degree_3);
	INSERT_ADDON(3311, enhance_defend_degree_3);
	INSERT_ADDON(3312, enhance_attack_degree_3); // Rune End
	INSERT_ADDON(3313, TEMPORARY_ADDON_MACRO(enhance_fly_speed_addon)); // Equipament Rune (True) (Fly)
	INSERT_ADDON(3314, enhance_vigour);
	INSERT_ADDON(3315, enhance_vigour);
	INSERT_ADDON(3316, enhance_crit_rate_2arg);
	INSERT_ADDON(3317, enhance_crit_rate_2arg);
	INSERT_ADDON(3318, enhance_crit_rate_2arg);
	INSERT_ADDON(3319, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3320, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3321, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3322, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3323, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3324, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3325, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3326, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3327, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3328, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3329, enhance_vit_addon);
	INSERT_ADDON(3330, enhance_vit_addon);
	INSERT_ADDON(3331, enhance_vit_addon);
	INSERT_ADDON(3332, enhance_vit_addon);
	INSERT_ADDON(3333, enhance_vit_addon);
	INSERT_ADDON(3334, enhance_attack_degree_2arg);
	INSERT_ADDON(3335, enhance_attack_degree_2arg);
	INSERT_ADDON(3336, enhance_attack_degree_2arg);
	INSERT_ADDON(3337, enhance_attack_degree_2arg);
	INSERT_ADDON(3338, enhance_defend_degree_2arg);
	INSERT_ADDON(3339, enhance_defend_degree_2arg);
	INSERT_ADDON(3340, enhance_defend_degree_2arg);
	INSERT_ADDON(3341, enhance_vigour_2);
	INSERT_ADDON(3342, enhance_vigour_2);
	INSERT_ADDON(3343, enhance_vigour_2);
	INSERT_ADDON(3344, enhance_anti_def_addon_2); // Double new
	INSERT_ADDON(3345, enhance_anti_resist_addon_2); // Double new
	INSERT_ADDON(3346, refine_defense_resistance);
	INSERT_ADDON(3347, refine_defense_resistance);
	INSERT_ADDON(3348, refine_defense_resistance);
	INSERT_ADDON(3349, enhance_vit_addon);
	INSERT_ADDON(3350, enhance_vit_addon);
	INSERT_ADDON(3351, enhance_vit_addon);
	INSERT_ADDON(3352, enhance_str_addon);
	INSERT_ADDON(3353, enhance_str_addon);
	INSERT_ADDON(3354, enhance_str_addon);
	INSERT_ADDON(3355, enhance_eng_addon);
	INSERT_ADDON(3356, enhance_eng_addon);
	INSERT_ADDON(3357, enhance_eng_addon);
	INSERT_ADDON(3358, enhance_agi_addon);
	INSERT_ADDON(3359, enhance_agi_addon);
	INSERT_ADDON(3360, enhance_agi_addon);
	INSERT_ADDON(3361, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3362, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3363, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3364, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3365, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3366, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3367, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3368, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3369, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3370, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3371, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3372, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3373, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3374, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3375, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3376, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3377, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3378, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3379, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3380, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3381, enhance_defend_degree_2arg);
	INSERT_ADDON(3382, enhance_defend_degree_2arg);
	INSERT_ADDON(3383, enhance_defend_degree_2arg);
	INSERT_ADDON(3384, enhance_defend_degree_2arg);
	INSERT_ADDON(3385, enhance_attack_degree_2arg);
	INSERT_ADDON(3386, enhance_attack_degree_2arg);
	INSERT_ADDON(3387, enhance_attack_degree_2arg);
	INSERT_ADDON(3388, enhance_vigour_2);
	INSERT_ADDON(3389, enhance_attack_degree);
	INSERT_ADDON(3390, enhance_attack_degree);
	INSERT_ADDON(3391, enhance_attack_degree);
	INSERT_ADDON(3392, item_rebound_skill_addon2);
	INSERT_ADDON(3393, item_rebound_skill_addon2);
	INSERT_ADDON(3394, enhance_defend_degree);
	INSERT_ADDON(3395, enhance_defend_degree);
	INSERT_ADDON(3396, enhance_defend_degree);
	INSERT_ADDON(3397, enhance_mp_addon);
	INSERT_ADDON(3398, enhance_damage_addon);
	INSERT_ADDON(3399, enhance_defense_addon_2);
	INSERT_ADDON(3400, enhance_magic_damage_addon);
	INSERT_ADDON(3401, enhance_all_resistance_addon);
	INSERT_ADDON(3402, enhance_vit_addon);
	INSERT_ADDON(3403, reduce_cast_time_addon);
	INSERT_ADDON(3404, reduce_cast_time_addon);
	INSERT_ADDON(3405, enhance_crit_rate);
	INSERT_ADDON(3406, enhance_hp_addon);
	INSERT_ADDON(3407, refine_vigour);
	INSERT_ADDON(3408, refine_vigour);
	INSERT_ADDON(3409, refine_vigour);
	INSERT_ADDON(3410, refine_vigour);
	INSERT_ADDON(3411, refine_vigour);
	INSERT_ADDON(3412, refine_vigour);
	INSERT_ADDON(3413, refine_vigour);
	INSERT_ADDON(3414, refine_vigour);
	INSERT_ADDON(3415, refine_vigour);
	INSERT_ADDON(3416, refine_vigour);
	INSERT_ADDON(3417, enhance_damage_addon_2_2arg);
	INSERT_ADDON(3418, enhance_damage_addon_2_2arg);
	INSERT_ADDON(3419, enhance_magic_damage_addon_2_2arg);
	INSERT_ADDON(3420, enhance_magic_damage_addon_2_2arg);
	INSERT_ADDON(3421, enhance_attack_degree_2arg);
	INSERT_ADDON(3422, enhance_attack_degree_2arg);
	INSERT_ADDON(3423, enhance_vit_addon); // Null
	INSERT_ADDON(3424, enhance_max_damage_addon_2);
	INSERT_ADDON(3425, enhance_max_damage_addon_2);
	INSERT_ADDON(3426, enhance_max_magic_addon_2);
	INSERT_ADDON(3427, enhance_max_magic_addon_2);
	INSERT_ADDON(3428, enhance_attack_degree);
	INSERT_ADDON(3429, enhance_attack_degree);
	INSERT_ADDON(3430, item_rebound_skill_addon2); // Null
	INSERT_ADDON(3431, enhance_str_addon);
	INSERT_ADDON(3432, enhance_agi_addon);
	INSERT_ADDON(3433, enhance_eng_addon);
	INSERT_ADDON(3434, enhance_vit_addon);
	INSERT_ADDON(3435, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3436, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3437, enhance_hpgen_addon_2arg);
	INSERT_ADDON(3438, enhance_hp_addon_float);
	INSERT_ADDON(3439, enhance_hp_addon_2);
	INSERT_ADDON(3440, enhance_mpgen_addon_2arg);
	INSERT_ADDON(3441, enhance_mp_addon_2);
	INSERT_ADDON(3442, enhance_attack_addon_2);
	INSERT_ADDON(3443, enhance_armor_addon_2_2arg);
	INSERT_ADDON(3444, enhance_attack_speed_addon_2arg);
	INSERT_ADDON(3445, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3446, enhance_defend_degree_2arg);
	INSERT_ADDON(3447, enhance_attack_degree_2arg);
	INSERT_ADDON(3448, enhance_speed_addon_point_2arg);
	INSERT_ADDON(3449, enhance_crit_rate_2arg);
	INSERT_ADDON(3450, enhance_vigour_2);
	INSERT_ADDON(3451, enhance_damage_addon_2_2arg);
	INSERT_ADDON(3452, enhance_magic_damage_addon_2_2arg);
	INSERT_ADDON(3453, enhance_str_addon);
	INSERT_ADDON(3454, enhance_agi_addon);
	INSERT_ADDON(3455, enhance_eng_addon);
	INSERT_ADDON(3456, enhance_vit_addon);
	INSERT_ADDON(3457, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3458, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3459, enhance_hpgen_addon_2arg);
	INSERT_ADDON(3460, enhance_hp_addon_float);
	INSERT_ADDON(3461, enhance_hp_addon_2);
	INSERT_ADDON(3462, enhance_mpgen_addon_2arg);
	INSERT_ADDON(3463, enhance_mp_addon_2);
	INSERT_ADDON(3464, enhance_attack_addon_2);
	INSERT_ADDON(3465, enhance_armor_addon_2_2arg);
	INSERT_ADDON(3466, enhance_attack_speed_addon_2arg);
	INSERT_ADDON(3467, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3468, enhance_defend_degree_2arg);
	INSERT_ADDON(3469, enhance_attack_degree_2arg);
	INSERT_ADDON(3470, enhance_speed_addon_point_2arg);
	INSERT_ADDON(3471, enhance_crit_rate_2arg);
	INSERT_ADDON(3472, enhance_vigour_2);
	INSERT_ADDON(3473, enhance_damage_addon_2_2arg);
	INSERT_ADDON(3474, enhance_magic_damage_addon_2_2arg);
	INSERT_ADDON(3475, enhance_str_addon);
	INSERT_ADDON(3476, enhance_agi_addon);
	INSERT_ADDON(3477, enhance_eng_addon);
	INSERT_ADDON(3478, enhance_vit_addon);
	INSERT_ADDON(3479, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3480, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3481, enhance_hpgen_addon_2arg);
	INSERT_ADDON(3482, enhance_hp_addon_float);
	INSERT_ADDON(3483, enhance_hp_addon_2);
	INSERT_ADDON(3484, enhance_mpgen_addon_2arg);
	INSERT_ADDON(3485, enhance_mp_addon_2);
	INSERT_ADDON(3486, enhance_attack_addon_2);
	INSERT_ADDON(3487, enhance_armor_addon_2_2arg);
	INSERT_ADDON(3488, enhance_attack_speed_addon_2arg);
	INSERT_ADDON(3489, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3490, enhance_defend_degree_2arg);
	INSERT_ADDON(3491, enhance_attack_degree_2arg);
	INSERT_ADDON(3492, enhance_speed_addon_point_2arg);
	INSERT_ADDON(3493, enhance_crit_rate_2arg);
	INSERT_ADDON(3494, enhance_vigour_2);
	INSERT_ADDON(3495, enhance_damage_addon_2_2arg);
	INSERT_ADDON(3496, enhance_magic_damage_addon_2_2arg);
	INSERT_ADDON(3497, enhance_vit_addon); // Null
	INSERT_ADDON(3498, enhance_vit_addon); // Null
	INSERT_ADDON(3499, enhance_str_addon);
	INSERT_ADDON(3500, enhance_agi_addon);
	INSERT_ADDON(3501, enhance_eng_addon);
	INSERT_ADDON(3502, enhance_vit_addon);
	INSERT_ADDON(3503, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3504, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3505, enhance_hp_scale_addon);
	INSERT_ADDON(3506, enhance_hp_addon_2);
	INSERT_ADDON(3507, enhance_hp_addon_2);
	INSERT_ADDON(3508, enhance_attack_speed_addon);
	INSERT_ADDON(3509, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3510, enhance_defend_degree_2arg);
	INSERT_ADDON(3511, enhance_attack_degree_2arg);
	INSERT_ADDON(3512, enhance_speed_addon_point);
	INSERT_ADDON(3513, enhance_crit_rate);
	INSERT_ADDON(3514, enhance_damage_addon);
	INSERT_ADDON(3515, enhance_magic_damage_addon);
	INSERT_ADDON(3516, enhance_str_addon);
	INSERT_ADDON(3517, enhance_agi_addon);
	INSERT_ADDON(3518, enhance_eng_addon);
	INSERT_ADDON(3519, enhance_vit_addon);
	INSERT_ADDON(3520, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3521, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3522, enhance_hp_scale_addon);
	INSERT_ADDON(3523, enhance_hp_addon_2);
	INSERT_ADDON(3524, enhance_hp_addon_2);
	INSERT_ADDON(3525, enhance_attack_speed_addon);
	INSERT_ADDON(3526, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3527, enhance_defend_degree_2arg);
	INSERT_ADDON(3528, enhance_attack_degree_2arg);
	INSERT_ADDON(3529, enhance_speed_addon_point);
	INSERT_ADDON(3530, enhance_crit_rate);
	INSERT_ADDON(3531, enhance_damage_addon);
	INSERT_ADDON(3532, enhance_magic_damage_addon);
	INSERT_ADDON(3533, enhance_str_addon);
	INSERT_ADDON(3534, enhance_agi_addon);
	INSERT_ADDON(3535, enhance_eng_addon);
	INSERT_ADDON(3536, enhance_vit_addon);
	INSERT_ADDON(3537, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3538, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3539, enhance_hp_scale_addon);
	INSERT_ADDON(3540, enhance_hp_addon_2);
	INSERT_ADDON(3541, enhance_hp_addon_2);
	INSERT_ADDON(3542, enhance_attack_speed_addon);
	INSERT_ADDON(3543, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3544, enhance_defend_degree_2arg);
	INSERT_ADDON(3545, enhance_attack_degree_2arg);
	INSERT_ADDON(3546, enhance_speed_addon_point);
	INSERT_ADDON(3547, enhance_crit_rate);
	INSERT_ADDON(3548, enhance_damage_addon);
	INSERT_ADDON(3549, enhance_magic_damage_addon);
	INSERT_ADDON(3550, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3551, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3552, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3553, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3554, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3555, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3556, enhance_attack_degree_2arg);
	INSERT_ADDON(3557, enhance_defend_degree_2arg);
	INSERT_ADDON(3558, enhance_highest_level_addon_2);
	INSERT_ADDON(3559, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3560, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3561, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3562, SET_ADDON_MACRO(4,enhance_attack_degree));
	INSERT_ADDON(3563, SET_ADDON_MACRO(4,enhance_defend_degree));
	INSERT_ADDON(3564, SET_ADDON_MACRO(3,enhance_crit_rate));
	INSERT_ADDON(3565, SET_ADDON_MACRO(3,enhance_attack_speed_addon));
	INSERT_ADDON(3566, SET_ADDON_MACRO(3,reduce_cast_time_addon));
	INSERT_ADDON(3567, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3568, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3569, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3570, SET_ADDON_MACRO(4,enhance_attack_degree));
	INSERT_ADDON(3571, SET_ADDON_MACRO(4,enhance_defend_degree));
	INSERT_ADDON(3572, SET_ADDON_MACRO(3,enhance_crit_rate));
	INSERT_ADDON(3573, SET_ADDON_MACRO(3,enhance_attack_speed_addon));
	INSERT_ADDON(3574, SET_ADDON_MACRO(3,reduce_cast_time_addon));
	INSERT_ADDON(3575, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3576, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3577, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3578, SET_ADDON_MACRO(4,enhance_attack_degree));
	INSERT_ADDON(3579, SET_ADDON_MACRO(5,enhance_defend_degree));
	INSERT_ADDON(3580, SET_ADDON_MACRO(3,enhance_crit_rate));
	INSERT_ADDON(3581, SET_ADDON_MACRO(3,enhance_attack_speed_addon));
	INSERT_ADDON(3582, SET_ADDON_MACRO(3,reduce_cast_time_addon));
	
	INSERT_ADDON(3583, new_armor_skill_addon);
	INSERT_ADDON(3584, new_armor_skill_addon);
	INSERT_ADDON(3585, new_armor_skill_addon);
	INSERT_ADDON(3586, new_armor_skill_addon);
	INSERT_ADDON(3587, new_armor_skill_addon);
	INSERT_ADDON(3588, new_armor_skill_addon);
	INSERT_ADDON(3589, new_armor_skill_addon);
	INSERT_ADDON(3590, new_armor_skill_addon);
	INSERT_ADDON(3591, new_armor_skill_addon);
	INSERT_ADDON(3592, new_armor_skill_addon);
	INSERT_ADDON(3593, new_armor_skill_addon);
	INSERT_ADDON(3594, new_armor_skill_addon);
	INSERT_ADDON(3595, new_armor_skill_addon);
	INSERT_ADDON(3596, new_armor_skill_addon);
	INSERT_ADDON(3597, new_armor_skill_addon);
	INSERT_ADDON(3598, new_armor_skill_addon);
	INSERT_ADDON(3599, new_armor_skill_addon);
	INSERT_ADDON(3600, new_armor_skill_addon);
	INSERT_ADDON(3601, new_armor_skill_addon);
	INSERT_ADDON(3602, new_armor_skill_addon);
	INSERT_ADDON(3603, new_armor_skill_addon);
	INSERT_ADDON(3604, new_armor_skill_addon);
	INSERT_ADDON(3605, new_armor_skill_addon);
	INSERT_ADDON(3606, new_armor_skill_addon);
	INSERT_ADDON(3607, new_armor_skill_addon);
	
	INSERT_CAMP_ADDON(3608,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3609,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3610,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_ADDON(3611, enhance_vigour);
	INSERT_CAMP_ADDON(3612,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3613,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3614,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3615,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3616,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3617,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3618,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3619,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3620,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3621,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3622,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3623,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3624,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3625,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3626,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3627,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3628,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3629,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3630,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3631,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3632,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3633,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3634,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3635,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3636,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3637,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3638,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3639,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3640,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3641,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3642,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3643,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3644,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3645,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3646,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3647,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3648,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3649,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3650,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3651,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3652,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3653,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3654,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3655,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3656,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3657,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3658,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3659,as_enhance_magic_dmg_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3660,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3661,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3662,as_enhance_maxhp_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3663,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3664,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3665,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3666,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_ADDON(3667, enhance_attack_degree);
	INSERT_ADDON(3668, enhance_defend_degree);
	INSERT_CAMP_ADDON(3669,as_enhance_damage_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3670,as_enhance_all_resistance, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_ADDON(3671, TEMPORARY_ADDON_MACRO(enhance_attack_degree));
	INSERT_ADDON(3672, TEMPORARY_ADDON_MACRO(enhance_defend_degree));
	INSERT_ADDON(3673, item_skill_addon);
	INSERT_ADDON(3674, item_skill_addon);
	INSERT_ADDON(3675, item_skill_addon);
	INSERT_ADDON(3676, item_skill_addon);
	INSERT_ADDON(3677, enhance_crit_rate);
	INSERT_ADDON(3678, enhance_attack_scale_addon);
	INSERT_ADDON(3679, reduce_cast_time_addon);
	INSERT_ADDON(3680, enhance_attack_speed_addon);
	INSERT_ADDON(3681, enhance_attack_speed_addon);
	INSERT_ADDON(3682, enhance_attack_range_addon_2arg);
	INSERT_ADDON(3683, enhance_vigour);
	INSERT_ADDON(3684, enhance_hp_scale_addon);
	INSERT_ADDON(3685, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3686, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3687, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3688, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3689, enhance_vit_addon); // Falta Inicio
	INSERT_ADDON(3690, enhance_vit_addon);
	INSERT_ADDON(3691, enhance_vit_addon);
	INSERT_ADDON(3692, enhance_hp_scale_addon);
	INSERT_ADDON(3693, enhance_attack_degree_2arg);
	INSERT_ADDON(3694, enhance_attack_degree_2arg);
	INSERT_ADDON(3695, enhance_defend_degree_2arg);
	INSERT_ADDON(3696, enhance_defend_degree_2arg);
	INSERT_ADDON(3697, enhance_vigour_2);
	INSERT_ADDON(3698, enhance_hp_addon_2);
	INSERT_ADDON(3699, SET_ADDON_MACRO(2,enhance_defend_degree));
	INSERT_ADDON(3700, SET_ADDON_MACRO(2,enhance_defend_degree));
	INSERT_ADDON(3701, item_skill_addon);
	INSERT_ADDON(3702, item_skill_addon);
	INSERT_ADDON(3703, item_skill_addon);
	INSERT_ADDON(3704, item_skill_addon);
	INSERT_ADDON(3705, item_skill_addon);
	INSERT_ADDON(3706, item_skill_addon);
	INSERT_ADDON(3707, item_skill_addon);
	INSERT_ADDON(3708, item_skill_addon);
	INSERT_ADDON(3709, item_skill_addon);
	INSERT_ADDON(3710, item_skill_addon);
	INSERT_ADDON(3711, item_skill_addon);
	INSERT_ADDON(3712, item_skill_addon);
	INSERT_ADDON(3713, item_skill_addon);
	INSERT_ADDON(3714, item_skill_addon);
	INSERT_ADDON(3715, item_skill_addon);
	INSERT_ADDON(3716, item_skill_addon);
	INSERT_ADDON(3717, enhance_highest_level_addon_2);
	INSERT_ADDON(3718, item_skill_addon);
	INSERT_ADDON(3719, item_skill_addon);
	INSERT_ADDON(3720, item_skill_addon);
	INSERT_ADDON(3721, item_skill_addon);
	INSERT_ADDON(3722, item_skill_addon);
	INSERT_ADDON(3723, item_skill_addon);
	INSERT_ADDON(3724, item_skill_addon);
	INSERT_ADDON(3725, item_skill_addon);
	INSERT_ADDON(3726, enhance_hp_addon); // N/A
	INSERT_ADDON(3727, enhance_resilience_2arg);
	INSERT_ADDON(3728, enhance_penetration);
	INSERT_ADDON(3729, enhance_vigour);
	INSERT_ADDON(3730, enhance_defend_degree);
	INSERT_ADDON(3731, enhance_attack_degree);
	INSERT_ADDON(3732, enhance_highest_level_addon);
	INSERT_ADDON(3733, enhance_vigour);
	INSERT_ADDON(3734, enhance_damage_addon_2);
	INSERT_ADDON(3735, enhance_all_resistance_addon);
	INSERT_ADDON(3736, enhance_vit_addon_1arg);
	INSERT_ADDON(3737, enhance_vigour);
	INSERT_ADDON(3738, enhance_attack_degree);
	INSERT_ADDON(3739, enhance_defend_degree);
	INSERT_ADDON(3740, dynamic_genesis_level); // Nível de Genesis
	INSERT_ADDON(3741, refine_damage);
	INSERT_ADDON(3742, refine_magic_damage);
	INSERT_ADDON(3743, refine_damage);
	INSERT_ADDON(3744, refine_damage);
	INSERT_ADDON(3745, refine_magic_damage);
	INSERT_ADDON(3746, refine_damage);
	INSERT_ADDON(3747, refine_damage);
	INSERT_ADDON(3748, enhance_defend_degree);
	INSERT_ADDON(3749, enhance_crit_rate);
	INSERT_ADDON(3750, enhance_crit_rate);
	INSERT_ADDON(3751, enhance_str_addon);
	INSERT_ADDON(3752, enhance_str_addon);
	INSERT_ADDON(3753, enhance_eng_addon);
	INSERT_ADDON(3754, enhance_eng_addon);
	INSERT_ADDON(3755, enhance_agi_addon);
	INSERT_ADDON(3756, enhance_agi_addon);
	INSERT_ADDON(3757, enhance_attack_addon);
	INSERT_ADDON(3758, reduce_cast_time_addon);
	INSERT_ADDON(3759, reduce_cast_time_addon);
	INSERT_ADDON(3760, item_skill_addon);
	INSERT_ADDON(3761, item_skill_addon);
	INSERT_ADDON(3762, enhance_crit_rate_2arg);
	INSERT_ADDON(3763, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3764, enhance_attack_scale_addon_2arg);
	INSERT_ADDON(3765, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3766, reduce_cast_time_addon_2arg);
	INSERT_ADDON(3767, enhance_vit_addon);
	INSERT_ADDON(3768, enhance_vit_addon);
	INSERT_ADDON(3769, enhance_attack_degree_2arg);
	INSERT_ADDON(3770, enhance_attack_degree_2arg);
	INSERT_ADDON(3771, enhance_defend_degree_2arg);
	INSERT_ADDON(3772, enhance_defend_degree_2arg);
	INSERT_ADDON(3773, enhance_vigour_2);
	INSERT_ADDON(3774, enhance_vigour_2);
	INSERT_ADDON(3775, enhance_anti_def_addon_2);
	INSERT_ADDON(3776, enhance_anti_def_addon_2);
	INSERT_ADDON(3777, enhance_anti_resist_addon_2);
	INSERT_ADDON(3778, enhance_anti_resist_addon_2);
	INSERT_ADDON(3779, enhance_highest_level_addon_2);
	INSERT_ADDON(3780, enhance_str_addon);
	INSERT_ADDON(3781, enhance_str_addon);
	INSERT_ADDON(3782, enhance_eng_addon);
	INSERT_ADDON(3783, enhance_eng_addon);
	INSERT_ADDON(3784, enhance_agi_addon);
	INSERT_ADDON(3785, enhance_agi_addon);
	INSERT_ADDON(3786, enhance_vit_addon);
	INSERT_ADDON(3787, enhance_vit_addon);
	INSERT_ADDON(3788, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3789, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3790, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3791, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3792, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3793, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3794, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3795, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3796, enhance_attack_degree_2arg);
	INSERT_ADDON(3797, enhance_attack_degree_2arg);
	INSERT_ADDON(3798, enhance_defend_degree_2arg);
	INSERT_ADDON(3799, enhance_defend_degree_2arg);
	INSERT_ADDON(3800, enhance_vigour_2);
	INSERT_ADDON(3801, enhance_vigour_2);
	INSERT_ADDON(3802, enhance_damage_reduce_addon_2arg);
	INSERT_ADDON(3803, refine_defense_resistance);
	INSERT_ADDON(3804, refine_defense_resistance);
	INSERT_ADDON(3805, enhance_all_magic_damage_reduce_addon_2arg);
	INSERT_ADDON(3806, enhance_attack_and_defend_degree);
	INSERT_ADDON(3807, enhance_attack_and_defend_degree);
	INSERT_ADDON(3808, enhance_attack_and_defend_degree);
	INSERT_ADDON(3809, enhance_attack_and_defend_degree);
	INSERT_ADDON(3810, enhance_attack_and_defend_degree);
	INSERT_ADDON(3811, enhance_attack_and_defend_degree);
	INSERT_ADDON(3812, enhance_crit_rate);
	INSERT_ADDON(3813, enhance_vigour);
	INSERT_ADDON(3814, enhance_attack_degree);
	INSERT_ADDON(3815, enhance_defend_degree);
	INSERT_ADDON(3816, enhance_vit_addon);
	INSERT_ADDON(3817, enhance_str_addon);
	INSERT_ADDON(3818, enhance_agi_addon);
	INSERT_ADDON(3819, enhance_eng_addon);
	INSERT_ADDON(3820, enhance_all_magic_damage_reduce_addon);
	INSERT_ADDON(3821, enhance_damage_reduce_addon);
	// 1.6.2 > 1.7.3
	
	// 1.7.4 >		
	INSERT_ADDON(3822, enhance_str_addon_1arg);
	INSERT_ADDON(3823, enhance_agi_addon_1arg);
	INSERT_ADDON(3824, enhance_eng_addon_1arg);
	INSERT_ADDON(3825, enhance_attack_speed_addon);
	INSERT_ADDON(3826, enhance_highest_level_addon);
	INSERT_ADDON(3827, enhance_damage_reduce_addon);
	INSERT_ADDON(3828, enhance_all_magic_damage_reduce_addon);
	// 1.7.4 <

	// 1.7.5 >
	INSERT_ADDON(3829, refine_defense);
	INSERT_ADDON(3830, enhance_hp_scale_addon);
	INSERT_ADDON(3831, enhance_all_resistance_addon_2arg);
	INSERT_ADDON(3832, enhance_attack_degree);
	INSERT_ADDON(3833, enhance_defend_degree);
	INSERT_ADDON(3834, enhance_anti_def_addon);
	INSERT_ADDON(3835, enhance_anti_resist_addon);
	INSERT_ADDON(3836, enhance_template_crit_damage_reduce);
	INSERT_ADDON(3837, enhance_template_crit_damage);
	INSERT_ADDON(3838, refine_defense_resistance);
	INSERT_ADDON(3839, enhance_defense_addon_2_2arg);
	INSERT_ADDON(3840, enhance_template_crit_damage); // Novo Atributo
	INSERT_ADDON(3841, enhance_template_crit_damage_reduce); // Novo Atributo
	INSERT_ADDON(3842, enhance_str_addon_1arg); // Novo Atributo (Não utilizado)
	// 1.7.5 <

	// 1.7.6 >
	INSERT_ADDON(3843, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3844, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3845, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3846, SET_ADDON_MACRO(4,enhance_attack_degree));
	INSERT_ADDON(3847, SET_ADDON_MACRO(4,enhance_defend_degree));
	INSERT_ADDON(3848, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3849, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3850, SET_ADDON_MACRO(2,enhance_hp_addon));
	INSERT_ADDON(3851, SET_ADDON_MACRO(4,enhance_attack_degree));
	INSERT_ADDON(3852, SET_ADDON_MACRO(4,enhance_defend_degree));
	INSERT_ADDON(3853, refine_max_hp);
	INSERT_ADDON(3854, refine_max_hp);
	INSERT_ADDON(3855, refine_max_hp);
	INSERT_ADDON(3856, enhance_attack_degree);
	INSERT_ADDON(3857, enhance_defend_degree);
	INSERT_ADDON(3858, enhance_attack_degree);
	INSERT_ADDON(3859, enhance_defend_degree);
	INSERT_ADDON(3860, enhance_highest_level_addon);
	// 1.7.7 <

	INSERT_ADDON(4083,enhance_hp_addon);
