#ifndef __ONLINEGAME_GS_CAPTURE_H__
#define __ONLINEGAME_GS_CAPTURE_H__
...
class capture_item : public item_body
{
protected:
...
public:
	DECLARE_SUBSTANCE(capture_item);

	virtual item_body* Clone() const { return new capture_item(*this); }

	virtual ITEM_TYPE GetItemType()
	{
		return ITEM_TYPE_CAPTURE;
	}
private:
