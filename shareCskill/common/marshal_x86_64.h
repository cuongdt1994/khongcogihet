...
template<typename T>
inline Marshal::OctetsStream & Marshal::OctetsStream:: operator << (const std::vector<T> &x)
{
    return *this <<( MarshalContainer(x));
}
template<typename T>
inline Marshal::OctetsStream & Marshal::OctetsStream:: operator << (const std::list<T> &x)
{
    return *this <<( MarshalContainer(x));
}
template<typename T>
inline Marshal::OctetsStream & Marshal::OctetsStream:: operator << (const std::deque<T> &x)
{
    return *this <<( MarshalContainer(x));
}
template<typename T1, typename T2>
inline Marshal::OctetsStream & Marshal::OctetsStream:: operator << (const std::map<T1, T2> &x)
{
    return *this <<( MarshalContainer(x));
}

template<typename T>
inline const Marshal::OctetsStream& Marshal::OctetsStream:: operator >> (const std::vector<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T>
inline const Marshal::OctetsStream& Marshal::OctetsStream:: operator >> (const std::deque<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T>
inline const Marshal::OctetsStream& Marshal::OctetsStream:: operator >> (const std::list<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T1, typename T2>
inline const Marshal::OctetsStream& Marshal::OctetsStream:: operator >> (const std::map<T1, T2> &x) const
{
	return *this >>( MarshalContainer(x));			
}
