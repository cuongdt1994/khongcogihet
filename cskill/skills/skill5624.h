...
/* 
56240  "Reino do Norte - Aumento do Tempo de Canaliza莽茫o"56241  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5624 
#define __CPPGEN_GNET_SKILL5624 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5624:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5624 }; 
        Skill5624 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5624Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5624Stub ():SkillStub (5624) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-增加吟唱时间"; 
        nativename          = "北陆-增加吟唱时间"; 
        icon                = "朔光咏.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
