...
/* 
17920  "Causa danos duplos aos monstros"17921  "Dura 1 hora."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetLevel () == 3 ? 2.6 : skill->GetLevel ());//skill->GetVictim ()->SetRatio (skill->GetLevel ());
