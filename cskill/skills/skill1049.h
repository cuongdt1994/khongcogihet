...
/* 
10490  "FÃ©"10491  "^ffffffFÃ© (NÃ­vel %d)^ffcb4aCusto de SP: ^96f5ff160^ffffff^ffcb4aCusto de EP: ^96f5ff500^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff60 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasFica imune de todos efeitos negativos em 5s,cada nÃ­vel aumenta 10%% de chance(SÃ³ poderÃ¡ usar quando SP > 160, consumo real depende de For)^ffa083For: Cada 5 pontos diminui consumo de SP em 1 ponto. "*/ 
