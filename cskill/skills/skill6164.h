...
/* 
61640  "Mo Ranyun - Espada Voadora reversa em 240掳"61641  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6164 
#define __CPPGEN_GNET_SKILL6164 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6164:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6164 }; 
        Skill6164 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6164Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6164Stub ():SkillStub (6164) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"墨然允-反向240度飞剑"; 
        nativename          = "墨然允-反向240度飞剑"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 1; 
