...
/* 
5270  "○Mares Turbulentos"5271  "^8080ff○Mares Turbulentos
...
Ataque com uma força devastadora, rasgando todos os inimigos
a até ^96f5ff8^ffffff metros do alvo. Causa dano
físico básico mais ^96f5ff2241^ffffff. Causa lentidão no alvo
por ^96f5ff8^ffffff segundos, reduzindo a velocidade em ^96f5ff50%%^ffffff.
O alvo sempre será preso ao Bárbaro por 10^96f5ff^ffffff segundos.

^a6caf0Só afeta alvos não jogadores.

^d618e7A versão Demônio tem ^96f5ff25%%^d618e7 de chance de congelar alvo por ^96f5ff4^d618e7 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetForceselecttargetSurfImpact (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
