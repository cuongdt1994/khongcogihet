...
/* 
1100  "ï¼Š"1101  "Martelo dos Deuses"*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 20000,20000,20000,30000,30000,30000,40000,40000,40000,40000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 55,55,55,60,60,60,65,65,65,65 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
