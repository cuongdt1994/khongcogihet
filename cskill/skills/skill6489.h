...
/* 
64890  "Punição Cadente"64891  "^ffffffPunição Cadente              ^ffcb4aAlcance ^ffffffCorpo-a-corpo^ffcb4aCusto em MP ^96f5ff%.1f^ffffff    ^ffcb4aCanalização ^ffffff0,3 ^ffcb4asegundo    ^ffcb4aConjuração ^ffffff1,3 ^ffcb4asegundo    ^ffcb4aEspera ^ffffff45,0 ^ffcb4asegundos    ^ffcb4aArma ^ffffffClavas^ffcb4aCultivo ^ffffffMahayanaPule bem alto e esmague o chão, causando dano físico básico mais ^96f5ff7399^ffffff aos inimigos a até ^96f5ff8^ffffff metros. Se você tiver a Marca de Yin ou Yang, ela será removida e a velocidade de movimento de seus inimigos será limitada a ^96f5ff0^ffffff m/s e eles não poderão usar a Reposição. Dura ^96f5ff10^ffffff segundo.^a6caf0A habilidade só faz efeito em jogadores.^a6caf0Custa ^ffffff1 ^a6caf0Chi.^f7dfa5Este ataque tem a garantia de acertar."*/ 
