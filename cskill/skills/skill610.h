...
/* 
36100  "ΨEsmagador de Pedras"36101  "^ff5c00ΨEsmagador de Pedras

^ffcb4aAlcance ^ff5c0035^ffffff  ^ffcb4ametros
...
^ffcb4aArma: ^ffffffEsferas da Alma ou Desarmado
^ffcb4aBônus de Runa ^ff5c00Maestria Marcial

^ffcb4aCultivo ^ffffffAlma Celestial
Invoque ^96f5ff5^ffffff ondas de rochas sobre todos os inimigos
a até ^96f5ff8^ffffff metros do seu
alvo, causando ^96f5ff200%%^ffffff do seu dano mágico básico
mais ^96f5ff400%%^ffffff do dano da arma mais ^96f5ff12000^ffffff
de Dano de Terra. 
...
^ff0000Nível 5 a 7: Causa ^96f5ff60%%^ff0000 de dano de arma adicional.
^ff0000Nível 8 a 9: Causa ^96f5ff80%%^ff0000 de dano de arma adicional.
^ff0000Nível 10: Causa ^96f5ff100%%^ff0000 de dano adicional da arma.@1@2
Causa ^96f5ff%d%% ^ff0000de dano adicional da arma.@2"*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
			...
			skill->GetVictim ()->SetRatio (0.3); // Velocidade
