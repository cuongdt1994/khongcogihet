...
/* 
60280  "Inst芒ncia Aleat贸ria_Aura Neutra Geral"60281  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6028 
#define __CPPGEN_GNET_SKILL6028 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6028:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6028 }; 
        Skill6028 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6028Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6028Stub ():SkillStub (6028) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"随机本_通用中性光环"; 
        nativename          = "随机本_通用中性光环"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 2; 
