...
/* 
63250  "Continente Ocidental-Mergulho Concentrado"63251  "Continente Ocidental-Mergulho Concentrado"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6325 
#define __CPPGEN_GNET_SKILL6325 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6325:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6325 }; 
        Skill6325 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6325Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
