...
/* 
66570  "NTW AdE Aura de Atordoar"66571  "Atordoamento em Massa"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6657 
#define __CPPGEN_GNET_SKILL6657 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6657:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6657 }; 
        Skill6657 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6657Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6657Stub ():SkillStub (6657) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战aoe晕眩光环"; 
        nativename          = "新城战aoe晕眩光环"; 
        icon                = ""; 
#endif 
        max_level           = 99; 
        type                = 3; 
