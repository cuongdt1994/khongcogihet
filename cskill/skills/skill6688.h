...
/* 
66880  "Tela Preta Principal do Guerreiro"66881  "NÃ­vel 1 = 1 segundo NÃ­vel 10 = 10 segundos"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6688 
#define __CPPGEN_GNET_SKILL6688 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6688:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6688 }; 
        Skill6688 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6688Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6688Stub ():SkillStub (6688) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÎäÏÀÖ÷Ïß_ºÚÆÁ"; 
        nativename          = "ÎäÏÀÖ÷Ïß_ºÚÆÁ"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 4; 
