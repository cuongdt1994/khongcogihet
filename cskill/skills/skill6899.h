...
/* 
68990  "ΨChama: Grito Mortal"68991  "^ff5c00ΨChama: Grito Mortal
...
O tempo de espera de ^96f5ff
ΨIndulgência Assassina^ffffff é reduzido em ^96f5ff0,5^ffffff segundos por uso desta habilidade.
...
^00ffffNível 1 a 4: Gera ^ffffff20 Chi.
^00ffffNível 5 a 7: Gera ^ffffff25 Chi.
^00ffffNível 8 a 9: Gera ^ffffff30 Chi.
^00ffffNível 10: Gera ^ffffff35 de Chi.@1@2
^00ffffGera ^ffffff%d de Chi.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6899 
#define __CPPGEN_GNET_SKILL6899 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6899:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6899 }; 
        Skill6899 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6899Stub:public SkillStub 
    { 
    public: 
