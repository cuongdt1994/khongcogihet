...
/* 
58710  "Monstro do Espelho - Espelho_Dano de Jogador Aumentado"58711  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5871 
#define __CPPGEN_GNET_SKILL5871 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5871:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5871 }; 
        Skill5871 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5871Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5871Stub ():SkillStub (5871) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾µÄ§-¾µ_Íæ¼ÒÔöÉË"; 
        nativename          = "¾µÄ§-¾µ_Íæ¼ÒÔöÉË"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
