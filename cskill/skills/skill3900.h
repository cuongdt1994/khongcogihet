...
/* 
39000  "ΨSalto Feroz"39001  "^ff5c00ΨSalto Feroz
...
^ffeaabNível 1 a 4: Quando você usar Lâminas e Espadas, causará ^96f5ff40%%^ffeaab de dano adicional de arma.
^ffeaabNível 5 a 7: Quando você usar Lâminas e Espadas, causará ^96f5ff60%%^ffeaab de dano adicional de arma.
^ffeaabNível 8 a 9: Quando você usar Lâminas e Espadas, causará ^96f5ff80%%^ffeaab de dano adicional de arma.
^ffeaab Nível 10: Quando você usar Lâminas e Espadas, causará ^96f5ff100%%^ffeaab de dano adicional de arma.@1@2
^ffeaabQuando você usar Lâminas e Espadas, causará ^96f5ff%d%%^ffeaab de dano adicional de arma.@2"*/ 
          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (skill->GetPlayer ()->GetCurweapon () != 1 ? 2825 : 1839);
 				//skill->SetRatio (skill->GetPlayer ()->GetCurweapon () == 1 ? 2 + _glyph_value : skill->GetPlayer ()->GetCurweapon () == 5 ? 1 : 0);
                skill->SetRatio (skill->GetPlayer ()->GetCurweapon () == 1 ? (2 + _glyph_value) : skill->GetPlayer ()->GetCurweapon () == 5 ? 1 : 0);
