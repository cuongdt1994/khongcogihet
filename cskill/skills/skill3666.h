...
/* 
36660  "ΨChuva de Pedra"36661  "^ff5c00ΨChuva de Pedra
...
Tem ^96f5ff20%%^ffffff de chance de atordoar o alvo por ^96f5ff5^ffffffsegundos."*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(472, 1)); 
        pre_skills.push_back (std::pair < ID, int >(473, 1)); 
    ...
    { 
        static int aarray[10] = { 53898,53898,53898,53898,53898,53898,53898,53898,53898,53898 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
