...
#ifndef __CPPGEN_GNET_SKILL6564 
#define __CPPGEN_GNET_SKILL6564 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6564:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6564 }; 
        Skill6564 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6564Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        public:
            ...
            void Calculate(Skill *skill) const
            {
                ...
                skill->SetRatio(0.3 * (2.7 + _glyph_value));
        ...
        public:
            ...
            void Calculate(Skill *skill) const
            {
                ...
                skill->SetRatio(0.4 * (2.7 + _glyph_value));
                skill->SetDamage(skill->GetAttack());
                skill->GetPlayer()->SetPerform(0);
            }
            bool Interrupt(Skill *skill) const
    ...
    bool StateAttack (Skill * skill) const
    {
            ...
            skill->GetPlayer ()->SetInccrit (skill->GetSection () == 2 ? 100 : 0);
            return true;
    }
#endif 
#ifdef _SKILL_SERVER 
