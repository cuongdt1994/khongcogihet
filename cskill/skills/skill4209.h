...
/* 
42090  "Efeito de Habilidade [3938] da 唯Lan莽a Glacial"42091  "Efeito 3938, aumenta o dano da 唯Ira do Para铆so"*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·寒冰刃域[3938]的技能效果"; 
        nativename          = "神·寒冰刃域[3938]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
