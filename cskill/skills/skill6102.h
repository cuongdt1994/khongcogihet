...
/* 
61020  "Borboleta - Aura de AdE da Esfera do Trov茫o"61021  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6102 
#define __CPPGEN_GNET_SKILL6102 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6102:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6102 }; 
        Skill6102 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6102Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6102Stub ():SkillStub (6102) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"蝴蝶-闪电球aoe光环"; 
        nativename          = "蝴蝶-闪电球aoe光环"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 2; 
