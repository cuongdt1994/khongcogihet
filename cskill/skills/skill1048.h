...
/* 
10480  "Armadura Pesada"10481  "^ffffffArmadura Pesada (NÃ­vel %d)^ffcb4Alcance: ^ffffff20 metros^ffcb4aCusto de SP: ^96f5ff125^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasUsa uma magia de defesa,causa lacre no alvo e deixando-o imune ao dano fÃ­sico,pode ser usada somente nos alvos nÃ£o inimigos.%.1f de duraÃ§Ã£o.^72fe00Agi: Cada 40 pontos aumenta 1s de efeito."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 5060052,5060057,5060062,5060067,5060072,5060077,5060082,5060087,5060092,5060097 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
