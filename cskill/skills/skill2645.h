...
/* 
26450  "Alma da Vingança - Reação do Artista Marcial"26451  "^ffffffAlma da Vingança - Reação (Nível %d)^ffcb4aAlcance ^96f5ff%.1f^ffffff ^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aCanalização ^ffffff2.1 ^ffcb4asegundos^ffcb4aConjuração ^ffffff1.0 ^ffcb4asegundos^ffcb4aEspera  ^ffffff30.0 ^ffcb4asegundos^ffcb4aArma ^ffffffEsfera de Alma^ffcb4aCultivo Necessário ^ffffffAmeaçadorQueime a alma do alvo com energia psiônica,causando dano igual à sua Força da Alma cadavez que ele atacar. Dura ^96f5ff%.1f^ffffff segundos.^a6caf0Custa ^ffffff1^a6caf0 Chi."*/ 
