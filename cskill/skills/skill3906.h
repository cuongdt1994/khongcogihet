...
/* 
39060  "ΨCindir a Montanha"39061  "^ff5c00ΨCindir a Montanha
...
^ffeaabNível 1 a 4: Ao usar Lâminas e Espadas, causará^96f5ff80%%^ffeaab de dano adicional de arma.
^ffeaabNível 5 a 7: Ao usar Lâminas e Espadas, causará^96f5ff120%%^ffeaab de dano adicional de arma.
^ffeaabNível 8 a 9: Ao usar Lâminas e Espadas, causará^96f5ff160%%^ffeaab de dano adicional de arma.
^ffeaab Nível 10: Ao usar Lâminas e Espadas, causa^96f5ff200%%^ffeaab de dano adicional de arma.@1@2
^ffeaabAo usar Lâminas e Espadas, causa^96f5ff%d%%^ffeaab de dano adicional de arma.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            float _glyph_value = get_glyph(skill->GetLevel (), 3.9, 4.3, 4.7, 5.1);

            skill->GetPlayer ()->SetDecmp (112);
            skill->SetPlus (2800 + skill->GetPlayer ()->GetCurweapon () == 1 ? 1864 : 0);
            skill->SetRatio (skill->GetPlayer ()->GetCurweapon () == 5 ? 1.5 : skill->GetPlayer ()->GetCurweapon () == 1 ? _glyph_value : 0 );
