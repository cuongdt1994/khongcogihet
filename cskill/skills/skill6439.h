...
#ifndef __CPPGEN_GNET_SKILL6439 
#define __CPPGEN_GNET_SKILL6439 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6439:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6439 }; 
        Skill6439 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6439Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
