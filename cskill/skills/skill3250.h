...
/* 
32500  "Efeito 1 de Mestre das Sombras"32501  "Efeito de Habilidade 3248"*/ 
...
{ 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 200; } 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 800; } 
        bool Quit (Skill * skill) const { return false; } 
        bool Loop (Skill * skill) const { return false; } 
        bool Bypass (Skill * skill) const { return false; } 
        void Calculate (Skill * skill) const 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio(0);
            skill->GetVictim ()->SetAmount(500);
            skill->GetVictim ()->SetValue(3800);
            skill->GetVictim ()->SetSkillcooldown(1);

            skill->GetVictim ()->SetProbability (100);
            skill->GetVictim ()->SetRatio(0);
            skill->GetVictim ()->SetAmount(500);
            skill->GetVictim ()->SetValue(3801);
            skill->GetVictim ()->SetSkillcooldown(1);

            skill->GetVictim ()->SetProbability (100);
            skill->GetVictim ()->SetRatio(0);
            skill->GetVictim ()->SetAmount(500);
            skill->GetVictim ()->SetValue(3802);
            skill->GetVictim ()->SetSkillcooldown(1);

            skill->GetVictim ()->SetProbability (100);
            skill->GetVictim ()->SetRatio(0);
            skill->GetVictim ()->SetAmount(500);
            skill->GetVictim ()->SetValue(3803);
            skill->GetVictim ()->SetSkillcooldown(1);
            return true;
        }
#endif 
