...
/* 
15620  "Nubium: BÃªnÃ§Ã£o"15621  "^ffffffNubium: BÃªnÃ§Ã£o             NÃ­vel %d^ffcb4aEspera ^ffffff3 ^ffcb4a segundos^ffffffAumenta o HP mÃ¡ximo em ^96f5ff35%%^ffffff por 1 hora."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 125000,125000,125000,125000,125000,125000,125000,125000,125000,125000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static int aarray[10] = { 30263,30263,30263,30263,30263,30263,30263,30263,30263,30263 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
