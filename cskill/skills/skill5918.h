...
/* 
59180  "Dan莽arina_Cura Efeito de Aura de Veneno da Flor do Al茅m"59181  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5918 
#define __CPPGEN_GNET_SKILL5918 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5918:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5918 }; 
        Skill5918 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5918Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5918Stub ():SkillStub (5918) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_解彼岸花毒光环效果"; 
        nativename          = "舞女_解彼岸花毒光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
