...
/* 
55490  "ΨEscudo da Monstruosidade"55491  "^ff5c00ΨEscudo da Monstruosidade
...
^ffcb4aNível 1 a 4: O número de habilidades refletidas é aumentado em ^96f5ff1^ffcb4a.
^ffcb4aNível 5 a 7: O número de habilidades refletidas é aumentado em ^96f5ff2^ffcb4a.
^ffcb4aNível 8 a 9: O número de habilidades refletidas é aumentado em ^96f5ff3^ffcb4a.
^ffcb4aNível 10: O número de habilidades refletidas é aumentado em ^96f5ff4^ffcb4a.@1@2
O número de habilidades refletidas é aumentado em ^96f5ff%d^ffcb4a@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5549 
#define __CPPGEN_GNET_SKILL5549 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5549:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5549 }; 
        Skill5549 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5549Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {						
            ...
            skill->GetVictim ()->SetNewValue (4 + _glyph_value);
