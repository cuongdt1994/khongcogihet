...
#ifndef __CPPGEN_GNET_SKILL5359 
#define __CPPGEN_GNET_SKILL5359 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5359:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5359 }; 
        Skill5359 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5359Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
