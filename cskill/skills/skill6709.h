...
/* 
67090  "Aura dos Esporos de Curandeiro"67091  "Ver 5885. Ignorar dano 脿 defesa 5% + Habilidade de Ben莽茫o Banida por 10 segundos.Cancela no n铆vel. 1"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6709 
#define __CPPGEN_GNET_SKILL6709 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6709:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6709 }; 
        Skill6709 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6709Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
