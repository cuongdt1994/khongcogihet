...
/* 
70090  "Somente Efeitos do C茅u Majestoso 2021"70091  "N铆vel 1 Efeito de Ilumina莽茫o #2N铆vel 2 Efeito de Ilumina莽茫o #48"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7009 
#define __CPPGEN_GNET_SKILL7009 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7009:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7009 }; 
        Skill7009 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7009Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill7009Stub ():SkillStub (7009) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021凌天日常纯表现光效"; 
        nativename          = "2021凌天日常纯表现光效"; 
        icon                = "宠物强体.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
