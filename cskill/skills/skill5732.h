...
/* 
57320  "Hab. do Walbyre 2"57321  "ç¥ž_é’è—¤ç»•_é£žè¡Œ1.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5732 
#define __CPPGEN_GNET_SKILL5732 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5732:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5732 }; 
        Skill5732 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5732Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5732Stub ():SkillStub (5732) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÎÖÂ×°Ý¶û¼¼ÄÜ2"; 
        nativename          = "ÎÖÂ×°Ý¶û¼¼ÄÜ2"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
