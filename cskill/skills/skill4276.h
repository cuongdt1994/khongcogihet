...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                int _glyph_value =  get_glyph(skill->GetPlayer ()->GetSkilllevel (3469), 1900, 1500, 1100, 700);
                return skill->GetPlayer ()->GetBalls () == 15 ? _glyph_value : 2467;
            }
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetDamage (0.5 * ((skill->GetPlayer ()->GetBalls () == 15 ? 1 : 0) * skill->GetMagicattack ()));
