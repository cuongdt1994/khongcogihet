...
/* 
54880  "ΨGarras do Paraíso"
54881  "^ff5c00ΨÁguia da Fúria da Tempestade

^ffcb4aAlcance ^ffffffAtaque à Distância
^ffcb4aCusto em MP ^96f5ff%d^ffffff
^ffcb4aCanalização ^ffcb4aCarregamento
...
^ffeaabCarregue por até ^96f5ff2,0^ffeaab segundos, causando ^96f5ff120%%^ffeaab de dano.
Causa apenas ^96f5ff70%%^ffeaab do dano se não for carregada.

^ffeaabEfeito da Runa Argêntea:@1
^ffeaabNível 1 a 4: Causa ^96f5ff80%%^ffeaab de dano de arma adicional.
^ffeaabNível 5 a 7: Causa ^96f5ff160%%^ffeaab de dano de arma adicional.
^ffeaabNível 8 a 9: Causa ^96f5ff240%%^ffeaab de dano de arma adicional.
^ffeaabNível 10: Causa ^96f5ff320%%^ffeaab de dano de arma adicional.@1@2
^ffeaabCausa ^96f5ff%d%%^ffeaab de dano de arma adicional.@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5488 
#define __CPPGEN_GNET_SKILL5488 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5488:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5488 }; 
        Skill5488 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5488Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            float _glyph_value = get_glyph(player->GetSkilllevel(5488), 0.8, 1.6, 2.4, 3.2);

            return (float) ((1 + _glyph_value) * player->GetWeapondamage () + 8343);
        }
#endif 
#ifdef _SKILL_SERVER 
