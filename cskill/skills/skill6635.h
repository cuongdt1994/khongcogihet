...
/* 
66350  "ΨAbismo Celestial"66351  "^ff5c00ΨAbismo Celestial              
...
causa ^96f5ff230%%^ffffff de dano físico básico mais ^96f5ff%d^ffffff aos inimigos, 
...
dobrar a sua Taxa de Acerto Crítico para causar ^96f5ff1,5^ffffffvezes de dano.
...
^ffcb4aNível 1 a 4: Causa dano adicional igual a ^96f5ff15%%^ffcb4a do Ataque básico
^ffcb4aNível 5 a 7: Causa dano adicional igual a ^96f5ff20%%^ffcb4a do Ataque básico
^ffcb4aNível 8 a 9: Causa dano adicional igual a ^96f5ff25%%^ffcb4a do Ataque básico
^ffcb4aNível 10: Causa dano adicional igual a ^96f5ff30%%^ffcb4a do Ataque básico@1@2
Causa dano adicional igual a ^96f5ff%d%%^ffcb4a do Ataque básico@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    {
            float _glyph_value = get_glyph(skill->GetLevel (), 2.65, 2.7, 2.75, 2.8);

            skill->GetVictim ()->SetValue ((skill->GetPlayer ()->GetPureattack () + _glyph_value * skill->GetPlayer ()->GetWeapondamage () + 13298) * skill->GetT2 () * 0.1 *
                                           (1 +
