...
/* 
65270  "â—‹Arremesso"65271  "^8080ffâ—‹Arremesso              ^ffcb4aAlcance ^96f5ff%d^ffffff ^ffcb4ametro(s)    ^ffcb4aCusto em MP ^96f5ff%.1f^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff0,3 ^ffcb4asegundos    ^ffcb4aConjuraÃ§Ã£o ^ffffff1,5 ^ffcb4asegundos    ^ffcb4aEspera ^ffffff120,0 ^ffcb4asegundos    ^ffcb4aArma ^ffffffClavas^ffcb4aCultivo ^ffffffDiabÃ³licoArremesse a sua clava em alvos a atÃ© ^96f5ff20^ffffff metros, dentro da Ã¡rea selecionada (comprimento ^96f5ff25^ffffff metros, largura ^96f5ff4^ffffff metros)causando dano fÃ­sico bÃ¡sico mais ^96f5ff230%%^ffffff do dano da arma mais ^96f5ff%d^ffffff aos jogadores, os aterrando por ^96f5ff30^ffffff segundos.^d618e7O tempo de Aterrado Ã© aumentado em ^96f5ff2^d618e7 segundos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6527 
#define __CPPGEN_GNET_SKILL6527 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6527:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6527 }; 
        Skill6527 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6527Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
