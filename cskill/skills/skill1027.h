...
/* 
10270  "Luz de Iluminação"10271  "^ffffffLuz de Iluminação (Nível %d)^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff60 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasCura as feridas, recuperando %d de HP instantaneamente.^ffa083For: Cada 2 pontos aumenta 2%% de recuperação."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 110110,110115,110120,110125,110130,110135,110140,110145,110150,110155 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
