...
/* 
10410  "Energia de DragÃ£o"10411  "^ffffffEnergia de DragÃ£o (NÃ­vel %d)^ffcb4Alcance: ^ffffff25 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff20 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasInvoca um dragÃ£o no alvo,causando %.1f de dano fÃ­sico e de fogo;causa efeito de medo,baixando nÃ­vel de defesa em %d durante 3s.^ffa083For: Cada ponto aumenta 10 dano fÃ­sico.^72fe00Agi: Cada ponto aumenta 10 dano de fogo.^ffa083For: Cada 20 pontos aumenta 1s de duraÃ§Ã£o do efeito.^d618e7Causa duplo de dano para alvos corpo a corpo.^ff0000SÃ³ pode ser usada no chÃ£o."*/ 
