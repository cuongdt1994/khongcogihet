...
/* 
15630  "Nubium: Armadura"15631  "^ffffffNubium: Armadura             NÃ­vel %d^ffcb4aEspera ^ffffff3 ^ffcb4a segundos^ffffffAumenta a defesa fÃ­sica em ^96f5ff180%%^ffffff por 1 hora."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 30264,30264,30264,30264,30264,30264,30264,30264,30264,30264 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
