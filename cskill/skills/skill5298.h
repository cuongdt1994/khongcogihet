...
/* 
52980  "Palavras de Vigor"52981  "^ff0000Palavras de Vigor Nível %d
^ffffffRecupera HP em ^96f5ff%d%%^ffffff do
custo em MP."*/ 
...
{ 
    ...
    { 
        float get_value[] = { 0, 0.05, 0.10, 0.15, 0.20, 0.25 };

        skill->GetVictim ()->SetProbability (1.0 * 100);
        skill->GetVictim ()->SetTime (99999999);
        skill->GetVictim ()->SetValue (get_value[skill->GetLevel ()] * skill->GetPlayer ()->GetMaxmp ());      
        skill->GetVictim ()->SetAdjustHPFromMP (1);   
        return true; 
    } 
#endif 
#ifdef _SKILL_SERVER 
