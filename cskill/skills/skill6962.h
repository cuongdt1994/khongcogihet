...
/* 
69620  "ΨEscudo Zênite"69621  "^ff5c00ΨEscudo Zênite
...
#ifndef __CPPGEN_GNET_SKILL6962 
#define __CPPGEN_GNET_SKILL6962 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6962:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6962 }; 
        Skill6962 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6962Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 72325,72325,72325,72325,72325,72325,72325,72325,72325,72325 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
