...
/* 
44120  "ΨTsunami de Chamas"44121  "^ff5c00ΨTsunami de Chamas

^ffcb4aAlcance ^ffffffCorpo a Corpo
^ffcb4aCanalização ^ffffff0,4 ^ffcb4a segundos
^ffcb4aConjuração ^ffffff0,9 ^ffcb4a segundos
^ffcb4aEspera ^ffffff120 ^ffcb4a segundos
^ffcb4aArma ^ffffffLâmina ou Espada
^ffcb4aBônus de Runa ^ff5c00Fúria do Tigre

^ffcb4aCultivo Necessário ^ffffffAlma Celestial
Causa dano a todos os alvos em uma linha de ^96f5ff12^ffffff metros. Dano físico básico, mais 
...
Arma de Haste: O alcance é aumentado para ^96f5ff20^ffffff metros. 
Causa dano a todos os oponentes em uma linha de ^96f5ff22^ffffff metros.
