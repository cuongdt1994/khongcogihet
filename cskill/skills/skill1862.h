...
/* 
18620  "Olho Místico"
18621  "^ffff00Olho Místico

^ffcb4aMP ^96f5ff%d^ffffff
^ffcb4aCanalização ^ffffffInstantânea ^ffcb4a
^ffcb4aEspera ^ffffff90,0 ^ffcb4asegundos 
^ffcb4aArma ^ffffff Desarmado, Instrumento Mágico

^ffcb4aCultivo Necessário ^ffffffMahayana
Aumenta o seu nível de Detecção em ^96f5ff31^ffffff pontos. Dura ^96f5ff8^ffffff segundos."
*/ 
