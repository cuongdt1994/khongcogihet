...
/* 
36970  "ΨMar de Chamas"36971  "^ff5c00ΨMar de Chamas
...
Recupera ^96f5ff40^ffffff Chi após o uso. Tem ^96f5ff50%%^ffffff de chance 
de quebrar a habilidade ou a conjuração dos inimigos.

^a6caf0Custa ^ffffff2^a6caf0 Chis

^ffcb4aEfeito da Runa Áurea:@1
^ffcb4aNível 1 a 4: Causa ^96f5ff40%% ^ffcb4ade dano adicional da arma mais ^96f5ff860^ffcb4a
^ffcb4aNível 5 a 7: Causa ^96f5ff60%% ^ffcb4ade dano adicional da arma mais ^96f5ff1290^ffcb4a
^ffcb4aNível 8 a 9: Causa ^96f5ff80%% ^ffcb4ade dano adicional da arma mais ^96f5ff1720^ffcb4a
^ffcb4a Nível 10: Causa um dano de arma adicional de ^96f5ff100%% ^ffcb4ae mais ^96f5ff2150^ffcb4a.@1@2
^ffcb4a Causa um dano adicional de arma de ^96f5ff%d%% ^ffcb4ae mais ^96f5ff%d^ffcb4a.@2"*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 860, 1290, 1720, 2150);

                skill->GetPlayer ()->SetDecmp (524);
                skill->SetPlus (6200 + _glyph_value_2);
