...
#ifndef __CPPGEN_GNET_SKILL6031 
#define __CPPGEN_GNET_SKILL6031 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6031:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6031 }; 
        Skill6031 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6031Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
