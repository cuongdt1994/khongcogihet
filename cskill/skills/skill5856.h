...
/* 
58560  "Dan莽arina_Mata Ref茅m Pr贸ximo"58561  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5856 
#define __CPPGEN_GNET_SKILL5856 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5856:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5856 }; 
        Skill5856 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5856Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5856Stub ():SkillStub (5856) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_击杀周围人质"; 
        nativename          = "舞女_击杀周围人质"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
