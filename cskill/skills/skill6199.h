...
/* 
61990  "Aura de Teletransporte do Cal. Anni"61991  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6199 
#define __CPPGEN_GNET_SKILL6199 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6199:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6199 }; 
        Skill6199 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6199Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6199Stub ():SkillStub (6199) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"周年庆地宫传入光环"; 
        nativename          = "周年庆地宫传入光环"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 2; 
