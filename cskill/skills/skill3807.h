...
/* 
38070  "ΨPrisão Amaldiçoada"38071  "^ff5c00ΨPrisão Amaldiçoada
...
^00ff00Nível 1 a 4: Causa ^96f5ff240%%^00ff00 de dano básico da habilidade.
       Causa ^96f5ff6%%^00ff00 de dano básico da habilidade adicional por Carga de Ataque.
^00ff00Nível 5 a 7: Causa ^96f5ff260%%^00ff00 de dano básico da habilidade.
       Causa ^96f5ff9%%^00ff00 de dano básico da habilidade adicional por Carga de Ataque.
^00ff00Nível 8 a 9: Causa ^96f5ff280%%^00ff00 de dano básico da habilidade.
       Causa ^96f5ff12%%^00ff00 de dano básico da habilidade adicional por Carga de Ataque.
^00ff00Nível 10: Causa ^96f5ff300%%^00ff00 de dano básico da habilidade.
     Causa ^96f5ff15%%^00ff00 de dano básico da habilidade adicional por Carga de Ataque.@1@2
Causa ^96f5ff%d%%^00ff00 de dano básico da habilidade.
Causa ^96f5ff%d%%^00ff00 de dano básico da habilidade adicional por Carga de Ataque.@2
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (7497);
                skill->SetRatio (3.75);
                skill->SetDamage (0.25 * (skill->GetAttack () * (_glyph_value + (_charge_merc_count * _glyph_plus_from_charge))));
        ...
        class State4:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (7497);
                skill->SetRatio (3.75);
                skill->SetDamage (0.1 * (skill->GetAttack () * (_glyph_value + (_charge_merc_count * _glyph_plus_from_charge))));
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
        ...
        class State5:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (7497);
                skill->SetRatio (3.75);
                skill->SetDamage (0.15 * (skill->GetAttack () * (_glyph_value + (_charge_merc_count * _glyph_plus_from_charge))));
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
        ...
        class State6:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (7497);
                skill->SetRatio (3.75);
                skill->SetDamage (0.5 * (skill->GetAttack () * (_glyph_value + (_charge_merc_count * _glyph_plus_from_charge))));
                skill->GetPlayer ()->SetPerform (0);
