...
#ifndef __CPPGEN_GNET_SKILL6479 
#define __CPPGEN_GNET_SKILL6479 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6479:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6479 }; 
        Skill6479 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6479Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
