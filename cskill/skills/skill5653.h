...
/* 
56530  "Reino do Norte - Carga da Sentinela Vermelha"56531  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5653 
#define __CPPGEN_GNET_SKILL5653 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5653:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5653 }; 
        Skill5653 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5653Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5653Stub ():SkillStub (5653) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-红方前哨突进"; 
        nativename          = "北陆-红方前哨突进"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
