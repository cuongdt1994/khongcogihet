...
/* 
64160  "Mestre Cervejeiro-L√¢mina da Elimina√ß√£o"64161  "Ao seu redor Mata ao seu redor"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6416 
#define __CPPGEN_GNET_SKILL6416 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6416:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6416 }; 
        Skill6416 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6416Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6416Stub ():SkillStub (6416) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æ∆œ…-Ã‘Ã≠÷Æ»–"; 
        nativename          = "æ∆œ…-Ã‘Ã≠÷Æ»–"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
