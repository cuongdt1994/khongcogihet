...
#ifndef __CPPGEN_GNET_SKILL6567 
#define __CPPGEN_GNET_SKILL6567 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6567:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6567 }; 
        Skill6567 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6567Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6567Stub ():SkillStub (6567) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"妖猴主线-成年主角"; 
        nativename          = "妖猴主线-成年主角"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 4; 
