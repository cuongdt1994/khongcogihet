...
/* 
60300  "Borboleta - Lama de AutoexplosÃ£o"60301  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6030 
#define __CPPGEN_GNET_SKILL6030 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6030:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6030 }; 
        Skill6030 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6030Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6030Stub ():SkillStub (6030) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÄàÌ¶×Ô±¬"; 
        nativename          = "ºûµû-ÄàÌ¶×Ô±¬"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
