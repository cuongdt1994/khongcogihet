...
/* 
55200  "For莽a Elemental"55201  "^ffff00For莽a Elemental            ^ffffffN铆vel %d^ffcb4aHabilidade Passiva^ffcb4aCultivo Necess谩rio ^ffffffAlma CelestialO enviado elemental me ensinou que a mis茅ria vai recebero favor dos deuses. Unidade de ap贸stolos divinos de m茫os dadas, tornando-seuma for莽a incans谩vel. Iniciantes podem aprender essa habilidade b谩sica.Se quiser aprender o poder avan莽ado da f茅, voc锚 precisa unir-se ao cl茫 e continuar praticando.^ffffffTodos os danos diretos de habilidade s茫o aumentados em ^96f5ff%d%%^ffffff.^ffffffO Ataque M谩gico 茅 aumentado em ^96f5ff%d^ffffff."*/ 
