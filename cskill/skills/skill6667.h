...
/* 
66670  "Habilidade de Item - Banquete de Peixe"66671  "Taxa de Acelera莽茫o 1"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6667 
#define __CPPGEN_GNET_SKILL6667 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6667:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6667 }; 
        Skill6667 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6667Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
