...
#ifndef __CPPGEN_GNET_SKILL6339 
#define __CPPGEN_GNET_SKILL6339 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6339:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6339 }; 
        Skill6339 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6339Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
