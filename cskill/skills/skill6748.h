...
/* 
67480  "Defesa Especial da 脕rvore da Inst芒ncia Vermelha 2021"67481  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6748 
#define __CPPGEN_GNET_SKILL6748 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6748:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6748 }; 
        Skill6748 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6748Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6748Stub ():SkillStub (6748) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021小红本推水果_果树特殊防御"; 
        nativename          = "2021小红本推水果_果树特殊防御"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
