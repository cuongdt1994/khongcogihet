...
/* 
67420  "Empurr茫o Frutado"67421  "^ffcb4aAlcance  ^96f5ff3^ffffff  ^ffcb4ametros^ffcb4aEspera ^ffffff  1,0^ffcb4asegundos^ffffffVamos juntos mandar todas as frutas ao ponto de coleta!"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6742 
#define __CPPGEN_GNET_SKILL6742 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6742:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6742 }; 
        Skill6742 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6742Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
