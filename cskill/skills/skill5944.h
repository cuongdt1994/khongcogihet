...
/* 
59440  "ApÃ³stolo Maligno Conjura CÃ­rculo Preto"59441  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5944 
#define __CPPGEN_GNET_SKILL5944 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5944:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5944 }; 
        Skill5944 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5944Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5944Stub ():SkillStub (5944) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ð°Ê¹ÕÐÈ¦ºÚ"; 
        nativename          = "Ð°Ê¹ÕÐÈ¦ºÚ"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
