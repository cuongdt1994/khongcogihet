...
/* 
66490  "PuniÃ§Ã£o Cadente"66491  "^ffffffPuniÃ§Ã£o Cadente^ffffffPule alto e esmague o chÃ£o, causando dano fÃ­sico bÃ¡sicoa inimigos em atÃ© ^96f5ff8^ffffff metros. "*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6649 
#define __CPPGEN_GNET_SKILL6649 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6649:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6649 }; 
        Skill6649 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6649Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
