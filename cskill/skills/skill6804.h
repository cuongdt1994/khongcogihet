...
/* 
68040  "Dano AdE TaoÃ­sta"68041  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6804 
#define __CPPGEN_GNET_SKILL6804 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6804:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6804 }; 
        Skill6804 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6804Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6804Stub ():SkillStub (6804) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"µÀ¼Ò-·¶Î§ÉËº¦"; 
        nativename          = "µÀ¼Ò-·¶Î§ÉËº¦"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
