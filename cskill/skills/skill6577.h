...
/* 
65770  "ΨPunição Cadente"65771  "^ff5c00ΨPunição Cadente              
...
Recupera ^96f5ff20^ffffff de Chi
...
^00ffffNível 5 a 7: Recupera ^ffffff60 de Chi
^00ffffNível 8 a 9: Recupera ^ffffff80 de Chi
^00ffffNível 10: Recupera ^ffffff100 Chi@1@2
^00ffffRecupera ^ffffff%d^00ffff Chi@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6577 
#define __CPPGEN_GNET_SKILL6577 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6577:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6577 }; 
        Skill6577 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6577Stub:public SkillStub 
    { 
    public: 
