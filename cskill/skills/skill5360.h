...
#ifndef __CPPGEN_GNET_SKILL5360 
#define __CPPGEN_GNET_SKILL5360 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5360:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5360 }; 
        Skill5360 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5360Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    public: 
        ...
        { 
            static int aarray[10] = { 8,12,17,21,26,30,34,39,43,48 }; 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 640; } 
        bool Quit (Skill * skill) const { return false; } 
        bool Loop (Skill * skill) const { return false; } 
        bool Bypass (Skill * skill) const { return false; } 
        void Calculate (Skill * skill) const 
        { 
            static int aarray[10] = { 32,50,67,85,102,120,138,155,173,190 }; 
            skill->GetPlayer ()->SetDecmp (aarray[skill->GetLevel () - 1]); 
