...
/* 
64740  "Vento Ascendente"64741  "^ffffffVento Ascendente            Nível %d  
...
^96f5ff%.1f^ffffff de dano físico ao alvo. 
Reduz a defesa física do alvo em ^96f5ff60%%^ffffff do valor do equipamento. Dura ^96f5ff10^ffffff segundo.
...
{ 
    ...
    { 
        static int aarray[10] = { 2600,4200,4800,7000,9900,13800,18900,25900,35300,56000 }; 
