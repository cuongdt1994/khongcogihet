...
/* 
59760  "Lobo do TrovÃ£o - Carga de Monstro"59761  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5976 
#define __CPPGEN_GNET_SKILL5976 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5976:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5976 }; 
        Skill5976 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5976Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5976Stub ():SkillStub (5976) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-¹ÖÎïÍ»½ø"; 
        nativename          = "À×ÀÇ-¹ÖÎïÍ»½ø"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
