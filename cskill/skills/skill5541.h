...
#ifndef __CPPGEN_GNET_SKILL5541 
#define __CPPGEN_GNET_SKILL5541 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5541:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5541 }; 
        Skill5541 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5541Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5541Stub ():SkillStub (5541) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2019回流BOSS群技能"; 
        nativename          = "2019回流BOSS群技能"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
