...
/* 
55150  "Limpar Status da Escolta"55151  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5515 
#define __CPPGEN_GNET_SKILL5515 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5515:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5515 }; 
        Skill5515 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5515Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5515Stub ():SkillStub (5515) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Çå³ýÑºïÚ×´Ì¬"; 
        nativename          = "Çå³ýÑºïÚ×´Ì¬"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 4; 
