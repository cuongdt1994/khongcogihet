...
/* 
61300  "Monstro do Espelho - Ignorar Dano M谩ximo "61301  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6130 
#define __CPPGEN_GNET_SKILL6130 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6130:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6130 }; 
        Skill6130 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6130Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6130Stub ():SkillStub (6130) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"镜魔-无视上限伤害"; 
        nativename          = "镜魔-无视上限伤害"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 12; 
