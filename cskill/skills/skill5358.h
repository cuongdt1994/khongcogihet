...
#ifndef __CPPGEN_GNET_SKILL5358 
#define __CPPGEN_GNET_SKILL5358 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5358:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5358 }; 
        Skill5358 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5358Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
