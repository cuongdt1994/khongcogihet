...
/* 
55690  "Reduz o HP recuperado do dano recebido"55691  "Reduz o HP recuperado do dano recebido"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5569 
#define __CPPGEN_GNET_SKILL5569 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5569:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5569 }; 
        Skill5569 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5569Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5569Stub ():SkillStub (5569) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÉËº¦»ØÑª½µµÍ"; 
        nativename          = "ÉËº¦»ØÑª½µµÍ"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 1; 
