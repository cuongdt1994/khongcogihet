...
#ifndef __CPPGEN_GNET_SKILL6928 
#define __CPPGEN_GNET_SKILL6928 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6928:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6928 }; 
        Skill6928 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6928Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 10; } 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 40; } 
        bool Quit (Skill * skill) const { return false; } 
        bool Loop (Skill * skill) const { return false; } 
        bool Bypass (Skill * skill) const { return false; } 
        void Calculate (Skill * skill) const 
