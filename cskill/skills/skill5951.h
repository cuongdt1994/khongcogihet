...
/* 
59510  "Borboleta - Dano de Veneno"59511  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5951 
#define __CPPGEN_GNET_SKILL5951 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5951:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5951 }; 
        Skill5951 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5951Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5951Stub ():SkillStub (5951) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-¶¾ÏµÉËº¦"; 
        nativename          = "ºûµû-¶¾ÏµÉËº¦"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
