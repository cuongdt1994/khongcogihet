...
/* 
60990  "Permanecer Juntos"60991  "^ffff00Use em ^ff00ffAida^ffff00.^ffff00Causa dano igual a dez por cento da Saúde Máxima!^ff00ffAida^ffff00 é muito forte, ^ffff00mas Bod e Irene vão te ajudar."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6099 
#define __CPPGEN_GNET_SKILL6099 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6099:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6099 }; 
        Skill6099 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6099Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
