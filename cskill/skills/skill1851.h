...
/* 
18510  "N/A双子星(作废)"18511  "N/A^ffffff双子星

^ffcb4a施放距离 ^ffffff近身
^ffcb4a消耗真气 ^96f5ff%d^ffffff
^ffcb4a准备时间 ^ffffff0.4 ^ffcb4a秒
^ffcb4a施放时间 ^ffffff0.7 ^ffcb4a秒
^ffcb4a施放间隔 ^ffffff3.0 ^ffcb4a秒
^ffcb4a武器限制 ^ffffff近身武器

^ffcb4a修真期要求 ^ffffff筑基
奋力一击,对敌人造成基础物理攻击力附
加^96f5ff%.1f^ffffff的物理伤害."*/ 
