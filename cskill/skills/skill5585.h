...
/* 
55850  "Arma de Gelo"55851  "Clique no alvo com o botÃ£o esquerdo para usar."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5585 
#define __CPPGEN_GNET_SKILL5585 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5585:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5585 }; 
        Skill5585 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5585Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5585Stub ():SkillStub (5585) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±ùÖýÎäÆ÷"; 
        nativename          = "±ùÖýÎäÆ÷"; 
        icon                = "2015Ñ©»¨ÎäÆ÷Ø°Ê×.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
        allow_ride          = 0; 
