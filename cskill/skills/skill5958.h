...
/* 
59580  "Borboleta - AutodestruiÃ§Ã£o de Esfera de TrovÃ£o"59581  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5958 
#define __CPPGEN_GNET_SKILL5958 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5958:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5958 }; 
        Skill5958 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5958Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5958Stub ():SkillStub (5958) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-À×Çò×Ô±¬"; 
        nativename          = "ºûµû-À×Çò×Ô±¬"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
