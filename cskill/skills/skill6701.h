...
/* 
67010  "Dano de Tela Cheia de Curandeiro"67011  "1. Penalidade vulnerÃ¡vel,2. Penalidade de diminuiÃ§Ã£o de cura3. Dano=1x o dano bÃ¡sico"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6701 
#define __CPPGEN_GNET_SKILL6701 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6701:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6701 }; 
        Skill6701 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6701Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6701Stub ():SkillStub (6701) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ò½¼Ò-È«ÆÁÉËº¦"; 
        nativename          = "Ò½¼Ò-È«ÆÁÉËº¦"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 1; 
