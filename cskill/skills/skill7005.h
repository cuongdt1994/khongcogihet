...
/* 
70050  "ΨPresença do Tigre"70051  "^ff5c00ΨPresença do Tigre
...
em ^96f5ff30%%^ffffff do Ataque da sua arma e a velocidade em ^96f5ff50%%^ffffff por ^96f5ff10^ffffff segundos.

^00ff00Efeito da Runa Verdejante:@1
Reduz em ^96f5ff60%%^00ff00 o Ataque Físico do alvo e em ^96f5ff90%%^00ff00 
o Ataque Mágico
^00ff00Nível 1 a 4: O Alcance do Ataque é aumentado para ^96f5ff13^00ff00 metros
^00ff00Nível 5 a 7: O Alcance do Ataque é aumentado para ^96f5ff14^00ff00 metros
^00ff00Nível 8 a 9: O Alcance do Ataque é aumentado para ^96f5ff15^00ff00 metros
^00ff00Nível 10: O Alcance do Ataque é aumentado para ^96f5ff16^00ff00 metros @1@2
^00ff00Reduz em ^96f5ff60%%^00ff00 o Ataque Físico do alvo e em ^96f5ff90%%^00ff00 
o Ataque Mágico. O alcance é aumentado para ^96f5ff%d^00ff00 metros@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        float GetEffectdistance (Skill * skill) const
        {
            ...
            return (float) (skill->GetPlayer ()->GetRange () + 15 + _glyph_value);
        }
#endif 
#ifdef _SKILL_SERVER 
