...
/* 
66440  "Ordem do General Summer"66441  "^ffcb4aAlcance ^ffffff30 ^ffcb4ametros^ffcb4aEspera ^ffffff10 ^ffcb4asegundos^ffffffUse a Ordem do General Summer para irritar a apari莽茫opara que ela possa ser atacada.^ff00ffA apari莽茫o se retira."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6644 
#define __CPPGEN_GNET_SKILL6644 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6644:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6644 }; 
        Skill6644 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6644Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
