...
/* 
55900  "O Î¨Ataque de Stalag (Runa Verdejante) aciona o status Gota de Sangue"55901  "Usado para o grande efeito da Gota de Sangue da Î¨LÃ¢mina de Cascalho (Vermelha), que Ã© acionada pelo Î¨Ataque de Stalag (Runa Verdejante)"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5590 
#define __CPPGEN_GNET_SKILL5590 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5590:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5590 }; 
        Skill5590 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5590Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5590Stub ():SkillStub (5590) 
    { 
        cls                 = 8; 
#ifdef _SKILL_CLIENT 
        name                = L"¡¾Éñ¡¤Ðé¿Õ½£¾¢£¨ÂÌÒ¶£©¡¿´¥·¢ÒûÑª×¨ÓÃÐ§¹û"; 
        nativename          = "¡¾Éñ¡¤Ðé¿Õ½£¾¢£¨ÂÌÒ¶£©¡¿´¥·¢ÒûÑª×¨ÓÃÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
