...
/* 
61000  "Lobo do TrovÃ£o - Desmagnetizar "61001  "Quando essa instÃ¢ncia for zero, retira o bÃ´nus magnÃ©tico dos jogadores restantes no campo de batalha"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6100 
#define __CPPGEN_GNET_SKILL6100 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6100:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6100 }; 
        Skill6100 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6100Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6100Stub ():SkillStub (6100) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Ïû´Å"; 
        nativename          = "À×ÀÇ-Ïû´Å"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
