...
/* 
25610  "Cântico da Lua"25611  "^ffffffCântico da Lua (Nível %d)
...
Invoque uma bênção lunar sobre os seus aliados, reduzindo os danos críticos sofridos por eles em ^96f5ff%d%%^ffffff
e aumentando o dano de habilidade deles contra alvos não jogadores em ^96f5ff%d%%^ffffff. Dura ^96f5ff30^ffffff minutos.

^a6caf0O efeito desaparece se você trocar de instância."*/ 
