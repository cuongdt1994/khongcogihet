...
/* 
59630  "Derrubar do Lobo do TrovÃ£o"59631  "Habilidade de carga do ChefeEfeito NocauteEm testes"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5963 
#define __CPPGEN_GNET_SKILL5963 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5963:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5963 }; 
        Skill5963 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5963Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5963Stub ():SkillStub (5963) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Í»½ø»÷ÍË"; 
        nativename          = "À×ÀÇ-Í»½ø»÷ÍË"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
