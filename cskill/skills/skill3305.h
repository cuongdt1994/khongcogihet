...
/* 
33050  "Sombra do Trilho do Vento"33051  "Sombra do Trilho do Vento: ao ser atacado, voc锚 tem a chancede ficar imune ao dano por 5 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetIncdamagedodge2 (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
