...
/* 
31940  "Φ Rugido do Leão"31941  "^ffff00ΦRugido do Leão
...
^f7dfa5A versão Sábio reduz o custo de Chi em ^96f5ff15^f7dfa5."*/ 
...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(424, 1)); 
    ...
    { 
        static int aarray[10] = { 49896,49896,49896,49896,49896,49896,49896,49896,49896,49896 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {
            return (float) (skill->GetPlayer ()->GetCurWeapon() != 5 ? 10 : 0);
        }
        ...
        {
            return (float) (skill->GetPlayer ()->GetCurWeapon() != 5 ? 10 : 20);
        }
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPerformerCurWeapon () == 1 ? 100 : skill->GetPerformerCurWeapon () == 5 ? 100 : 0));
            skill->GetVictim ()->SetValue (10000 + (skill->GetPerformerCurWeapon () == 1 ? 2 : 1) * skill->GetPerformerCurWeaponDamage ());
