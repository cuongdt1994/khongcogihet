...
/* 
67510  "Defesa Especial da Melancia da Inst芒ncia Vermelha 2021"67511  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6751 
#define __CPPGEN_GNET_SKILL6751 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6751:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6751 }; 
        Skill6751 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6751Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6751Stub ():SkillStub (6751) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021小红本推水果_西瓜特殊防御"; 
        nativename          = "2021小红本推水果_西瓜特殊防御"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
