...
#ifndef __CPPGEN_GNET_SKILL5336 
#define __CPPGEN_GNET_SKILL5336 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5336:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5336 }; 
        Skill5336 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5336Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5336Stub ():SkillStub (5336) 
    { 
        cls                 = 10; 
#ifdef _SKILL_CLIENT 
        name                = L"水月镜花·一式留神"; 
        nativename          = "水月镜花·一式留神"; 
        icon                = "一式留神.dds"; 
#endif 
        max_level           = 1; 
        type                = 1; 
