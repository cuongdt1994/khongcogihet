...
/* 
56010  "Limpar Status Básico"56011  "Limpa o pacote de status após uma missão ser concluída.O nível máximo da habilidade é 9999.Insira o ID da compra do pacote de status no espaço do nível da habilidade.Clear 572-icon2 using LV4587."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5601 
#define __CPPGEN_GNET_SKILL5601 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5601:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5601 }; 
        Skill5601 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5601Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
