...
/* 
46050  "Comandante das Tropas da Vingan√ßa: Caeya, Rei Espectral"46051  "Ataque em √°rea de linha retaPerde ChiPerde ManaRemove Status"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"‘π¡È∆ﬂæ¸Õ≥Àß∫£“π"; 
        nativename          = "‘π¡È∆ﬂæ¸Õ≥Àß∫£“π"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
