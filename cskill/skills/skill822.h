...
/* 
18220  "N茅voa da Sombra"18221  "^80ff00^a0ff00^b0ff00^bfff00^e0ff00^ffff00V茅u das Sombras^ffcb4aCusto em MP ^96f5ff1212^ffffff^ffcb4aCanaliza莽茫o ^ffffff2,0 ^ffcb4asegundos^ffcb4aConjura莽茫o ^ffffff1,0 ^ffcb4asegundo^ffcb4aEspera ^ffffff300,0 ^ffcb4asegundos^ffcb4aArma ^ffffffEsfera da Alma^ffcb4aCultivo ^ffffffMahayanaMergulhe em uma nuvem de escurid茫o profunda,obscurecendo a vis茫o e impedindo que os membros do grupoa at茅 ^96f5ff12 ^ffffffmetros se tornem alvos dos inimigos.Dura de ^96f5ff5 ^ffffffa ^96f5ff9 ^ffffffsegundos, baseado em sua For莽a da Alma. ^a6caf0Custa ^ffffff2 ^a6caf0Chis."*/ 
