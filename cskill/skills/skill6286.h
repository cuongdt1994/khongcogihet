...
/* 
62860  "Ω Salvação"62861  "^ffff00ΩSalvação           Nível %d

^ffcb4aCusto em MP ^96f5ff1240^ffffff
...
Invoque um servo angelical para proteger você. A Salvação protege
seus aliados, aumentando suas defesas e os curando. Dura por
^96f5ff50^ffffff segundos. Você pode usar o Sugador de Energia para drenar força 
da Salvação para proteger Místicos e aliados dentro de ^96f5ff15^ffffff metros, 
absorvendo ^96f5ff4000^ffffff de dano e 
aplicando uma versão do feitiço Pétalas Cadentes que recupera ^96f5ff4500^ffffff de HP por ^96f5ff30^ffffff segundos.
Obtém o efeito para o mascote que está sendo invocado.

^a6caf0Você pode usar a Transferência para aumentar a duração do Portador do Vazio.

^d618e7Gera ^96f5ff15^d618e7 Chi quando usar a habilidade.
^d618e7Concede à Salvação a habilidade ^96f5ffEscudo de Teletransporte^d618e7."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6286 
#define __CPPGEN_GNET_SKILL6286 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6286:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6286 }; 
        Skill6286 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6286Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1661, 1)); 
