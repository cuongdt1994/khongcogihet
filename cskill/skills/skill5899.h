...
/* 
58990  "Colosso - Aceno_M√£o Direita"58991  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5899 
#define __CPPGEN_GNET_SKILL5899 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5899:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5899 }; 
        Skill5899 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5899Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5899Stub ():SkillStub (5899) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æﬁœÒ-ª”ŒË_”“ ÷"; 
        nativename          = "æﬁœÒ-ª”ŒË_”“ ÷"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
