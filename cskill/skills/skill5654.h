...
/* 
56540  "Reino do Norte - Carga da Sentinela Azul"56541  "Carga de Alvo Circular do Chungyun"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5654 
#define __CPPGEN_GNET_SKILL5654 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5654:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5654 }; 
        Skill5654 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5654Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5654Stub ():SkillStub (5654) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-蓝方前哨突进"; 
        nativename          = "北陆-蓝方前哨突进"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
