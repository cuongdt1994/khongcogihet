...
/* 
13470  "Destruidor de CoraÃ§Ãµes"13471  "^ffffffDestruidor de CoraÃ§Ãµes (NÃ­vel %d)^ffcb4aAlcance ^96f5ff%.1f^ffffff ^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff1.0  ^ffcb4a segundos^ffcb4aConjuraÃ§Ã£o ^ffffff0.5 ^ffcb4asegundos^ffcb4aEspera ^ffffff15.0  ^ffcb4a segundos^ffcb4aVigor Recebido ^ffffff10^ffcb4aArma ^ffffffLÃ¢mina ou Espada^ffcb4aCultivo NecessÃ¡rio ^ffffffHarmoniosoCanalize a fÃºria da natureza em uma explosÃ£oque reduz as defesas do seu inimigo, fazendosuas habilidades FÃ­sica e de Metal causarem mais^96f5ff%d%%^ffffff de dano a um alvo nÃ£o jogador por ^96f5ff%d^ffffff segundos.^a6caf0^a6caf0NÃ£o pode ser vinculado como seu ataque primÃ¡rio."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 24,29,34,39,44,49,54,59,64,69 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
