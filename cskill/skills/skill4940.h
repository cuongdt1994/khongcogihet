...
/* 
49400  "Chama: Afeição Mortal"49401  "^ffffffChama: Afeição Mortal          Nível %d
...
ao Ataque Físico base mais ^96f5ff56%%^ffffff do Ataque do equipamento mais ^96f5ff%.1f^ffffff de dano Físico.
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
			    ...
			    skill->SetPlus ((0.56*skill->GetPlayer ()->GetAttack () - skill->GetPlayer ()->GetAttack ()) + (656.8 + (179.8 * skill->GetLevel()) + (27.6 * skill->GetLevel()) - (skill->GetLevel () < 3 ? 13.8 * skill->GetLevel () : 0) + (skill->GetLevel () > 2 ? (13.8 * skill->GetLevel ()) + (22.08 * skill->GetLevel ()) : 0)));
                skill->SetRatio (0);
