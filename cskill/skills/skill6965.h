...
/* 
69650  "ΨEscudo Zênite"69651  "^ff5c00ΨEscudo Zênite
...
^00ffffNível 1 a 4: O Chi Recebido é aumentado para ^FFFFFF12^00ffff pontos
^00ffffNível 5 a 7: O Chi Recebido é aumentado para ^FFFFFF13^00ffff pontos
^00ffffNível 8 a 9: O Chi Recebido é aumentado para ^FFFFFF14^00ffff pontos
^00ffffNível 10: O Chi Recebido é aumentado para ^FFFFFF15^00ffff pontos@1@2
^00ffffO Chi Recebido é aumentado para ^FFFFFF%d^00ffff@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6965 
#define __CPPGEN_GNET_SKILL6965 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6965:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6965 }; 
        Skill6965 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6965Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            float _glyph_value = get_glyph(skill->GetLevel (), 12, 13, 14, 15);

            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (900000);
            skill->GetVictim ()->SetValue (_glyph_value); // AP
