...
/* 
34250  "ΨRuptura da Nuvem"34251  "^ff5c00ΨRuptura da Nuvem             
...
Reduz as Resistências Elementais do alvo em até ^96f5ff60%%^ffffff, baseado na
quantidade de Cargas de Trovão, por ^96f5ff10^ffffff segundos. Gera uma Carga de Trovão.
As Resistências Elementais são reduzidas de ^96f5ff45%%^ffffff para ^96f5ff60%%^ffffff.
...
^ffeaabNível 1 a 4: Enquanto estiver na Forma Sombria, o dano aumenta em ^96f5ff45%%.
^ffeaabNível 5 a 7: Enquanto estiver na Forma Sombria, o dano aumenta em ^96f5ff50%%.
^ffeaabNível 8 a 9: Enquanto estiver na Forma Sombria, o dano aumenta em ^96f5ff55%%.
^ffeaabNível 10: Enquanto você estiver na Forma Sombria, o dano é aumentado em ^96f5ff60%%.@1@2
^ffeaabEnquanto você estiver na Forma Sombria, o dano é aumentado em ^96f5ff%d%%.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.45, 0.5, 0.55, 0.6);
