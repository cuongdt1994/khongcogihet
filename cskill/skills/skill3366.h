...
/* 
33660  "Inst芒ncia das Miss玫es Principais do Limite V: Noite Marinha Meu escudo ir谩 deter qualquer machado!"33661  "Aumenta a HP do jogador e a Velocidade de Regenera莽茫o de HP."*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"5重主线副本海夜无斧可破之盾"; 
        nativename          = "5重主线副本海夜无斧可破之盾"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
    ...
    { 
        static float aarray[10] = { 10.00,20.00,30.00,40.00,50.00,60.00,70.00,80.00,90.00,100.00 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
