...
/* 
62200  "Transporte AquÃ¡tico"62201  "^ffcb4aTransporte AquÃ¡tico^ffcb4aCanalizaÃ§Ã£o ^ffffffInstantÃ¢nea^ffcb4aEspera ^ffffff15 ^ffcb4asegundos^ffffffNem pense em empurrar o pequeno peixe!O pequeno peixe Ã© imune a todos os status de efeitos negativos por ^96f5ff3^ffffff segundos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6220 
#define __CPPGEN_GNET_SKILL6220 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6220:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6220 }; 
        Skill6220 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6220Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6220Stub ():SkillStub (6220) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Óã¶ùËæÐÄÓÎ"; 
        nativename          = "Óã¶ùËæÐÄÓÎ"; 
        icon                = "ÐÅÄî.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
