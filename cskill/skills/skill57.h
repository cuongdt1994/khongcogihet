...
{ 
    ...
    { 
        static int aarray[10] = { 9200,13900,20000,28100,38900,53200,72400,98300,133000,181000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
