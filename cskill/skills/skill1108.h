...
/* 
11080  "Magia Negra"11081  "^ffffff Magia Negra (NÃ­vel %d)^ffcb4aCusto em MP ^96f5ff%d^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff1,0  ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff1,4  ^ffcb4asegundos^ffcb4aEspera ^ffffff 8,0 ^ffcb4a segundos^ffcb4aChi Recebido ^ffffff10^ffcb4aArma ^ffffff Esferas da Alma, Desarmado ^ffcb4aCultivo NecessÃ¡rio ^ffffffAstutoMedite para receber o poder da escuridÃ£o, aumentando seu NÃ­vel de Ataque em ^96f5ff%.1f ^ffffffe diminuindo seu NÃ­vel de Defesa em ^96f5ff%.1f ^ffffffpor ^96f5ff15 ^ffffffminutos.^a6caf0Substitui o Magia Branca."*/ 
