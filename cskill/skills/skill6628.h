...
/* 
66280  "ΨTravessia Planar"66281  "^ff5c00ΨTravessia Planar              
...
#ifndef __CPPGEN_GNET_SKILL6628 
#define __CPPGEN_GNET_SKILL6628 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6628:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6628 }; 
        Skill6628 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6628Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        pre_skills.push_back (std::pair < ID, int >(6501, 1)); 
    ...
    { 
        static int aarray[10] = { 70224,70224,70224,70224,70224,70224,70224,70224,70224,70224 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
