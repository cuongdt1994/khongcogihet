...
/* 
58210  "Novo Ataque Adicional BoS"58211  "^FFFFFFAtaque FÃ­sico aumentado em ^00ffff%d%%^FFFFFF, ^FFFFFFAtaque MÃ¡gico aumentado em ^00ffff%d%%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5821 
#define __CPPGEN_GNET_SKILL5821 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5821:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5821 }; 
        Skill5821 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5821Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
