...
/* 
22300  "ΦVerme Venenoso da Pedra Vermelha"22301  "^ffff00ΦVerme Venenoso da Pedra Vermelha
...
dano por madeira. O verme penetra no alvo por ^96f5ff20^ffffff
segundos, reduzindo sua defesa física em até ^96f5ff40%%^ffffff e
causando ^96f5ff600%%^ffffff do dano da arma e mais ^96f5ff6427^ffffff como dano por fogo.

^a6caf0Custa ^ffffff25^a6caf0 Chi.

^f7dfa5A versão do Sábio aumenta a duração para ^96f5ff20^f7dfa5 segundos.
^f7dfa5A versão do Sábio reduz a defesa física em ^96f5ff50%%^f7dfa5."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 42143,42143,42143,42143,42143,42143,42143,42143,42143,42143 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
