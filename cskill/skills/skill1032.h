...
/* 
10320  "Ódio de Sangue"10321  "^ffffffÓdio de Sangue (Nível %d)^ffcb4aAlcance: ^ffffff20 metros^ffcb4aCusto de SP: ^96f5ff120^ffffff^ffcb4aCusto de EP: ^96f5ff900^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff1 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffTodasEnfurece todos os alvos em 20 metros, aumentando a vingança deles em relação a você epor 1 segundos reflete %d%% do dano que receber. ^ffa083Força: A cada 10 pontos de Força de Daimon, o tempo de reflexão é aumentado em 1."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 5260,7300,10000,13620,18480,25000,34000,53200,88000,141000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 500440,500445,500450,500455,500460,500465,500470,500475,500480,500485 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
