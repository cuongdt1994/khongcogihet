...
#ifndef __CPPGEN_GNET_SKILL6424 
#define __CPPGEN_GNET_SKILL6424 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6424:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6424 }; 
        Skill6424 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6424Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
