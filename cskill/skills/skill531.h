...
/* 
5310  "○Fúria Bestial"5311  "^8080ff○Fúria Bestial

^ffcb4aCusto em MP: ^ffffff50
^ffcb4aConjuração: ^ffffffInstantâneo
^ffcb4aEspera: ^ffffff30.0 ^ffcb4asegundos
^ffcb4aRestrições da Arma: ^ffffffMachado, Martelo ou Martelo Longo, Desarmado

^ffcb4aCultivo necessário: ^ffffffDiabólico
Quando ativada, cada ataque recebido pelo tigre aumenta a 
vitalidade em ^96f5ff6^ffffff pontos por ^96f5ff15^ffffff segundos.
Se o HP do personagem estiver menor que ^96f5ff50%%^ffffff, 
cria um escudo que absorve ^96f5ff4000^ffffff pontos de dano 
mágico por ^96f5ff10^ffffff segundos

^d618e7A versão Demônio aumenta o custo para ^96f5ff8^d618e7 Chi por acerto."*/ 
