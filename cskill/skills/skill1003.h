...
/* 
10030  "Neblina"10031  "^ffffffNeblina                            Nv.%d^ffcb4Alcance:   ^ffffff25 m^ffcb4aCusto de SP:   ^96f5ff35^ffffff^ffcb4aCusto de EP:   ^96f5ff%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera:   ^ffffff1 ^ffcb4as^ffcb4aClasse:   ^ffffffTodasCria uma neblina de 4s, diminuindo taxa de acerto do alvo em %d%%,Diminui nível de ataque do alvo em 5s, no máx. 4 níveis.^72fe00Agi: Cada 20 pontos aumenta 1s de duração.^72fe00Agi: Cada 50 pontos diminui 1 nível de ataque do alvo a mais.^ff0000只能在空中使用。"*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 11005,11010,11015,11020,11025,11030,11035,11040,11045,11050 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
