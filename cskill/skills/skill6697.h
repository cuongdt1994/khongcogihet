...
#ifndef __CPPGEN_GNET_SKILL6697 
#define __CPPGEN_GNET_SKILL6697 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6697:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6697 }; 
        Skill6697 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6697Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 13500,13500,13500,13500,13500,13500,13500,13500,13500,13500 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
