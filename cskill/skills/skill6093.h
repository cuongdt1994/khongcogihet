...
#ifndef __CPPGEN_GNET_SKILL6093 
#define __CPPGEN_GNET_SKILL6093 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6093:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6093 }; 
        Skill6093 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6093Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6093Stub ():SkillStub (6093) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"玄冰城精英单体缴械"; 
        nativename          = "玄冰城精英单体缴械"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
