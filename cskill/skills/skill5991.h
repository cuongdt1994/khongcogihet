...
/* 
59910  "Lobo do TrovÃ£o - AcÃºmulo de Positivo Polar"59911  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5991 
#define __CPPGEN_GNET_SKILL5991 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5991:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5991 }; 
        Skill5991 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5991Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5991Stub ():SkillStub (5991) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Õý´Å¼«µþ²ã"; 
        nativename          = "À×ÀÇ-Õý´Å¼«µþ²ã"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
