...
/* 
61380  "20 Celestial - Limpa Mudan莽a de Cores"61381  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6138 
#define __CPPGEN_GNET_SKILL6138 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6138:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6138 }; 
        Skill6138 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6138Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6138Stub ():SkillStub (6138) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"20御仙-清除变色"; 
        nativename          = "20御仙-清除变色"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 4; 
