...
#ifndef __CPPGEN_GNET_SKILL6075 
#define __CPPGEN_GNET_SKILL6075 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6075:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6075 }; 
        Skill6075 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6075Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
