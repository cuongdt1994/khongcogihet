...
/* 
56130  "Reino do Norte - Empurr茫o e Dano do Anel de Cristal Centrado no Conjurador"56131  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5613 
#define __CPPGEN_GNET_SKILL5613 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5613:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5613 }; 
        Skill5613 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5613Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5613Stub ():SkillStub (5613) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-水晶自身圆伤害推人"; 
        nativename          = "北陆-水晶自身圆伤害推人"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
