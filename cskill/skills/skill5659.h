...
#ifndef __CPPGEN_GNET_SKILL5659 
#define __CPPGEN_GNET_SKILL5659 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5659:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5659 }; 
        Skill5659 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5659Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
