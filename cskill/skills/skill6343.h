...
/* 
63430  "ΨEscudo da Imprecação"63431  "^ff5c00ΨEscudo da Imprecação
...
Consome sua Energia do Escudo, aumentando seu dano em ^96f5ff35%%^ffffff.
Dura ^96f5ff12 ^ffffffsegundos.
...
^ffcb4aNível 1 a 4: Aumenta seu dano em ^96f5ff38%%^ffcb4a.
^ffcb4aNível 5 a 7: Aumenta seu dano em ^96f5ff42%%^ffcb4a.
^ffcb4aNível 8 a 9: Aumenta seu dano em ^96f5ff46%%^ffcb4a.
^ffcb4aNível 10: Aumenta seu dano em ^96f5ff50%%^ffcb4a.@1@2
Aumenta seu dano em ^96f5ff%d%%^ffcb4a.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6343 
#define __CPPGEN_GNET_SKILL6343 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6343:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6343 }; 
        Skill6343 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6343Stub:public SkillStub 
    { 
    public: 
    ...
    { 
       ...
       bool StateAttack (Skill * skill) const
        {				
            ...
            float _glyph_value = get_glyph(skill->GetLevel (), 0.38, 0.42, 0.46, 0.50);
