...
/* 
55640  "Fúria"55641  "Aumenta a Taxa de Ataque Crítico, o Ataque Físico e a Taxa de Ataque"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5564 
#define __CPPGEN_GNET_SKILL5564 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5564:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5564 }; 
        Skill5564 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5564Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
