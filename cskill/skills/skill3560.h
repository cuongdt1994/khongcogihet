...
/* 
35600  "ΨDança Ultravioleta"35601  "^ff5c00ΨDança Ultravioleta
...
^00ff00Nível 1 a 4: Recupera ^96f5ff10%%^00ff00 adicional do seu HP.
^00ff00Nível 5 a 7: Recupera ^96f5ff20%%^00ff00 adicional do seu HP.
^00ff00Nível 8 a 9: Recupera ^96f5ff30%%^00ff00 adicional do seu HP.
^00ff00Nível 10: Recupera ^96f5ff40%%^00ff00 adicional do seu HP.@1@2
Recupera ^96f5ff%d%%^00ff00 adicional do seu HP.@2"*/ 
...
bool BlessMe (Skill * skill) const
        ...
        {
            float _glyph_value = get_glyph(player->GetSkilllevel (3560), 0.1, 0.2, 0.3, 0.4);

            return (float) (player->GetMaxhp () * (0.1 + _glyph_value));
        }
#endif 
#ifdef _SKILL_SERVER 
