...
{ 
    ...
    { 
        static int aarray[10] = { 4300,6000,8280,11320,15380,20800,28400,38400,65400,106600 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 837,842,847,852,857,862,867,872,877,882 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
