...
/* 
36960  "ΨMar de Chamas"36961  "^ff5c00ΨMar de Chamas
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(454, 1)); 
        pre_skills.push_back (std::pair < ID, int >(455, 1)); 
    ...
    { 
        static int aarray[10] = { 53903,53903,53903,53903,53903,53903,53903,53903,53903,53903 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
