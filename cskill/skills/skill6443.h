...
/* 
64430  "Mestre Cervejeiro-Remover Aura de Brinde"64431  "Remove o b么nus de Bebida Mortal dos jogadores"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6443 
#define __CPPGEN_GNET_SKILL6443 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6443:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6443 }; 
        Skill6443 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6443Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
