...
/* 
25510  "Armadilha do DragÃ£o"25511  "^ffffffArmadilha do DragÃ£o (NÃ­vel %d)^ffcb4aAlcance: ^ffffffCorpo a Corpo^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aCanalizaÃ§Ã£o: ^ffffffCarregar^ffcb4aConjuraÃ§Ã£o: ^ffffff0.3 ^ffcb4asegundos^ffcb4aEspera: ^ffffff15.0 ^ffcb4asegundos^ffcb4aVigor Recebido: ^ffffff10^ffcb4aArma: ^ffffffSabre^ffcb4aCultivo NecessÃ¡rio: ^ffffffAmeaÃ§adorAcumule sua forÃ§a por ^96f5ff3^ffffff segundos e libere uma sÃ©rie de atÃ© ^96f5ff4^ffffff ataques devastadores para paralisar seuinimigo por ^96f5ff4^ffffff segundos. Cada golpe causa ^96f5ff%.1f%%^ffffff de dano de arma mais ^96f5ff%.1f^ffffff e paralisa brevemente o alvo. Dobrao dano do seu prÃ³ximo ataque automÃ¡tico nos ^96f5ff6^ffffff segundos seguintes."*/ 
