...
/* 
66580  "NTW Aura de Atordoar de Dragonet AdE"66581  "50 metros 5% de dano"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6658 
#define __CPPGEN_GNET_SKILL6658 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6658:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6658 }; 
        Skill6658 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6658Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6658Stub ():SkillStub (6658) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战小龙aoe伤害光环"; 
        nativename          = "新城战小龙aoe伤害光环"; 
        icon                = ""; 
#endif 
        max_level           = 99; 
        type                = 3; 
