...
/* 
10220  "Encanto de Velocidade"10221  "^ffffffEncanto de Velocidade (N铆vel %d)^ffcb4aAlcance: ^ffffff10 metros^ffcb4aCusto de SP: ^96f5ff75^ffffff^ffcb4aCusto de EP: ^96f5ff400^ffffff^ffcb4aInstant芒neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasAumenta a velocidade de movimento at茅 o m谩ximo durante %.1fs.^72fe00Agi: Cada 100 ponto aumenta 1s de dura莽茫o."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 2200225,2200230,2200235,2200240,2200245,2200250,2200255,2200260,2200265,2200270 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
