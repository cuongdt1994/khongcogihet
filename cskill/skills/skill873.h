...
/* 
18730  "Reversão Espacial"18731  "^ffff00Reversão Espacial^ffcb4aAlcance: ^96f5ff30^ffffff ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff432^ffcb4aConjuração: ^ffffff0.2 ^ffcb4asegundos^ffcb4aDuração: ^ffffff0.6 ^ffcb4asegundos^ffcb4aEspera: ^ffffff60.0 ^ffcb4asegundos^ffcb4aRestrições da Arma: ^ffffffDesarmado, Instrumento Místico^ffcb4aEstima: ^ffffffMahayanaMarca a localização de um jogador inimigo, podendo ele voltarao mesmo local em ^96f5ff6^ffffff segundos.Taxa de sucesso quando o leitor e destino são o mesmo nívelé de aproximadamante ^96f5ff60%%^ffffff com uma taxa de sucesso mínimade ^96f5ff40%%^ffffff para uma chance de ^96f5ff80%%^ffffff,dependendo da anina dos jogadores^a6caf0Não pode ser utilizado em jogadores de 5 níveis amais de você.^a6caf0Só pode ser utlizado em Jogadores^a6caf0Não é possível utlizar em área de PK;^a6caf0Requer ^ffffff50^a6caf0 Chi para utiizar"*/ 
