...
/* 
56140  "Reino do Norte - Morte Instant. em Ãrea em Leque de Cristal"56141  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5614 
#define __CPPGEN_GNET_SKILL5614 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5614:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5614 }; 
        Skill5614 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5614Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5614Stub ():SkillStub (5614) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½-Ë®¾§ÉÈÐÎÃëÉ±"; 
        nativename          = "±±Â½-Ë®¾§ÉÈÐÎÃëÉ±"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
