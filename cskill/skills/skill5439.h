...
/* 
54390  "ΣChoque Voltaico"
54391  "^ffff00ΣChoque Voltaico
...
^ffcb4aArma ^ffffffLâmina ou Espada, Punhos

^ffcb4aCultivo Necessário ^ffffffImortal
Causa dano físico igual a ^96f5ff200%%^ffffff do seu Ataque Básico. Nunca erra.

Tipos diferentes de armas causam efeitos diferentes.
Lâmina ou Espada causam um adicional de ^96f5ff40%% ^ffffffde dano físico básico. 
Punhos atordoam o alvo por ^96f5ff5^ffffff segundos e causam adicional  de dano de ^96f5ff80%%^ffffff do seu Ataque Básico. O tipo de dano é convertido em Metal e Físico.

^a6caf0Custa ^ffffff1 ^a6caf0Chi."
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5439 
#define __CPPGEN_GNET_SKILL5439 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5439:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5439 }; 
        Skill5439 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5439Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (2 + (skill->GetPlayer ()->GetCurweapon () == 1 ? 0.4 : 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(899, 1)); 
    ...
    { 
        ...
        {     
            skill->GetVictim ()->SetProbability (1.0 * ((int)skill->GetT0 () == 182 ? 100 : 0));
