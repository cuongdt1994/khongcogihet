...
#ifndef __CPPGEN_GNET_SKILL6778 
#define __CPPGEN_GNET_SKILL6778 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6778:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6778 }; 
        Skill6778 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6778Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
