...
/* 
14000  "Transferência"14001  "^ffffffTransferência (Nível %d)

^ffcb4aHabilidade Passiva

^ffcb4aCultivo Necessário ^ffffffAstuto

Aumenta a duração da entidade invocada em ^96f5ff%d^ffffff segundos."*/ 
...
{ 
    ...
    { 
        ...
        {
            skill->GetPlayer ()->SetTimerAdittionPetSummon (1000 * skill->GetLevel ());
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
