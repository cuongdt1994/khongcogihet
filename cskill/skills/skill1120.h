...
/* 
11200  "Tudo ou Nada"11201  "^ffffffTudo ou Nada (N铆vel %d)^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjura莽茫o: Instant芒neo^ffffff^ffcb4aEspera: ^ffffff60.0^ffcb4a segundos^ffcb4aVitalidade: ^96f5ff%d^ffffff^ffcb4aRestri莽玫es de Arma: ^ffffffAdaga^ffcb4aCultivo necess谩rio: ^ffffffSinistroConcentrar todas as for莽as e junta pontos de Chi"*/ 
