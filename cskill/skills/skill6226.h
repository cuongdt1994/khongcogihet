...
/* 
62260  "Σ Fúria Selvagem"62261  "^ffff00Σ Fúria Selvagem           
...
^ffcb4aArma ^ffffffA/H, Desarmado

^ffcb4aCultivo Necessário ^ffffffDemoníaco
Ataque o alvo, causando dano básico. Tem ^96f5ff20%%^ffffff
de chance de remover todos os status positivos. Garante a remoção de ^96f5ff2^ffffff
status positivos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6226 
#define __CPPGEN_GNET_SKILL6226 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6226:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6226 }; 
        Skill6226 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6226Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0;
        pre_skills.push_back (std::pair < ID, int >(929, 1)); 
