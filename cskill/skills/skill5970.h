...
/* 
59700  "Lobo do Trov茫o - Aumento de Dano Polar Positivo/Negativo"59701  "Habilidade de Aumento de Dano para o mesmo p贸lo magn茅ticoAplica efeito 5972 no alvo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5970 
#define __CPPGEN_GNET_SKILL5970 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5970:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5970 }; 
        Skill5970 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5970Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
