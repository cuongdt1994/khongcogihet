...
/* 
590  "Tigre Saltador"591  "^ffffffTigre Saltador (Nível %d)
...
Salta instantaneamente ^96f5ff%.1f^ffffff metros para a frente. Recebe
^96f5ff65%%^ffffff chance de ficar imune a penalizações de status durante o salto.
