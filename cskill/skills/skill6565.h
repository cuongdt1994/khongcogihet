...
/* 
65650  "Andarilho Principal - Juventude"65651  "N铆vel de Habilidade 1 alterado para Nenhum, 2 alterado para habilidade e 3 Remover Transforma莽茫o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6565 
#define __CPPGEN_GNET_SKILL6565 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6565:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6565 }; 
        Skill6565 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6565Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6565Stub ():SkillStub (6565) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"妖猴主线-少年主角"; 
        nativename          = "妖猴主线-少年主角"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 4; 
