...
/* 
54860  "ΨGarras do Paraíso"54861  "^ff5c00ΨÁguia da Fúria da Tempestade
...
do alvo em ^96f5ff60%%^ffffff. Causa lentidão no alvo em ^96f5ff80%%^ffffff por ^96f5ff30^ffffff segundos.

^a6caf0Custa ^ffffff1^a6caf0 unidade de munição.
^a6caf0Custa ^ffffff50^a6caf0 Chis.

^00ffffEfeito da Runa Celeste:@1
^00ffffNível 1 a 4: Tempo de canalização é reduzido para ^ffffff0,8^00ffff segundos e 
diminui a Defesa Física do alvo em ^ffffff72%%^00ffff do valor do equipamento.
^00ffffNível 5 a 7: Tempo de canalização é reduzido para ^ffffff0,7^00ffff segundos e 
diminui a Defesa Física do alvo em ^ffffff78%%^00ffff do valor do equipamento.
^00ffffNível 8 a 9: Tempo de canalização é reduzido para ^ffffff0,6^00ffff segundos e 
diminui a Defesa Física do alvo em ^ffffff84%%^00ffff do valor do equipamento.
^00ffffNível 10: Tempo de canalização é reduzido para ^ffffff0,5^00ffff segundos e 
diminui a Defesa Física do alvo em ^ffffff90%%^00ffff do valor do equipamento.@1@2
Tempo de canalização é reduzido para ^ffffff%.1f^00ffff segundos e 
diminui a Defesa Física do alvo em ^ffffff%d%%^00ffff do valor do equipamento.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 800, 700, 600, 500);
                return _glyph_value;
            }
    ...
    { 
        ...
        {
            float _glyph_value = get_glyph(skill->GetLevel (), 0.72, 0.78, 0.84, 0.9);
