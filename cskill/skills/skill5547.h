...
#ifndef __CPPGEN_GNET_SKILL5547 
#define __CPPGEN_GNET_SKILL5547 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5547:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5547 }; 
        Skill5547 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5547Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5547Stub ():SkillStub (5547) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2019回流吸人打断封印光环效果"; 
        nativename          = "2019回流吸人打断封印光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
