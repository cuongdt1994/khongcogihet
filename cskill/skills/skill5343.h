...
/* 
53430  "Formato de Leque do Luar Corrompido"53431  "Formato de Leque do Luar Corrompido"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5343 
#define __CPPGEN_GNET_SKILL5343 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5343:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5343 }; 
        Skill5343 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5343Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
