...
/* 
53500  "Teleporte da Plataforma da Moradia Celeste"53501  "Mate o Chefe e Teleporte de Volta 脿 Plataforma Central"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5350 
#define __CPPGEN_GNET_SKILL5350 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5350:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5350 }; 
        Skill5350 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5350Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
