...
/* 
61410  "20 Celestial -Obsoleto"61411  "CelebraÃ§Ã£o de AniversÃ¡rio: Evento Carpa Saltando sobre o PortÃ£o do DragÃ£o; transformar-se em carpa"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6141 
#define __CPPGEN_GNET_SKILL6141 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6141:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6141 }; 
        Skill6141 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6141Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
