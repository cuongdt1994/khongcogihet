...
#ifndef __CPPGEN_GNET_SKILL6049 
#define __CPPGEN_GNET_SKILL6049 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6049:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6049 }; 
        Skill6049 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6049Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
