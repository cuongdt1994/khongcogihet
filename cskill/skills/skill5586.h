...
#ifndef __CPPGEN_GNET_SKILL5586 
#define __CPPGEN_GNET_SKILL5586 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5586:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5586 }; 
        Skill5586 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5586Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
