...
#ifndef __CPPGEN_GNET_SKILL6670 
#define __CPPGEN_GNET_SKILL6670 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6670:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6670 }; 
        Skill6670 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6670Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
