...
/* 
67870  "Aura do Pux茫o Tao铆sta"67871  "N铆vel = 1 Cancelamento. O n铆vel corresponde ao alcance"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6787 
#define __CPPGEN_GNET_SKILL6787 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6787:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6787 }; 
        Skill6787 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6787Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
