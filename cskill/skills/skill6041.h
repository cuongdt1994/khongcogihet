...
/* 
60410  "Cidade Glacial: Finalizando Defesa Especial Dois "60411  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6041 
#define __CPPGEN_GNET_SKILL6041 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6041:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6041 }; 
        Skill6041 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6041Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6041Stub ():SkillStub (6041) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"玄冰城结局二特殊防御"; 
        nativename          = "玄冰城结局二特殊防御"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
