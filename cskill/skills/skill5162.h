...
/* 
51620  "○Escudo da Imprecação"51621  "^8080ff○Escudo da Imprecação
...
Consome a energia do seu escudo, aumentando o dano em ^96f5ff30%%^ffffff.
...
^d618e7A duração é aumentada para ^96f5ff12^d618e7 segundos."*/ 
...
{ 
    ...
    { 
        ...
        {						
            ...
            skill->GetVictim ()->SetRatio (0.30);
            skill->GetVictim ()->SetShowicon (1);
            skill->GetVictim ()->SetSharpblade (1);
			
			// Define Icon / Gfx Buff
            skill->GetVictim ()->SetTime (13000); // Tempo
