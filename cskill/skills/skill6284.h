...
#ifndef __CPPGEN_GNET_SKILL6284 
#define __CPPGEN_GNET_SKILL6284 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6284:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6284 }; 
        Skill6284 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6284Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
