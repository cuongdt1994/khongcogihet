...
/* 
33030  "Espírito Sossegado"33031  "Espírito Sossegado: seus ataques têm a chance dereduzir seu Tempo de Canalização em 30%% por 8 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetFastpray3 (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
