...
/* 
66730  "Cerco de Monstros Habilidade 2"66731  "2021 NTW AdE. Causa dano a jogadores a at茅 10 metros e fere jogadores que montaram uma barraca."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6673 
#define __CPPGEN_GNET_SKILL6673 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6673:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6673 }; 
        Skill6673 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6673Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6673Stub ():SkillStub (6673) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"怪物攻城小怪技能2"; 
        nativename          = "怪物攻城小怪技能2"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 1; 
