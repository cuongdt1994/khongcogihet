...
#ifndef __CPPGEN_GNET_SKILL6647 
#define __CPPGEN_GNET_SKILL6647 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6647:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6647 }; 
        Skill6647 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6647Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
