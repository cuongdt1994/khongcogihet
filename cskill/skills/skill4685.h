...
/* 
46850  "Restaurar Poder de Ataque"46851  "^ffcb4a Restaura o Poder de Ataque  ^ffcb4a Alcance ^96f5ff60^ffffff ^ffcb4a m ^ffcb4a CanalizaÃ§Ã£o ^ffffff0.1 ^ffcb4a s  ^ffcb4a ConjuraÃ§Ã£o ^ffffff2.0 ^ffcb4a s ^ffcb4a Intervalo ^ffffff40.0 ^ffcb4a s  ^ffffff Perfeita para combater as habilidades especiais da cabeÃ§a do Haravin.  Restaura o Poder de Ataque dos jogadores em um raio de ^96f5ff20^ffffff metros a partir de quem usa a habilidade.  ^00ffff SÃ³ funciona em jogadores. O tempo de intervalo Ã© alto, entÃ£o use racionalmente!"*/ 
