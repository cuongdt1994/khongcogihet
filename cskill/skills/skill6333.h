...
/* 
63330  "Mestre Cervejeiro-Efeito de Bomba Viva"63331  "Efeito de Habilidade 6332"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6333 
#define __CPPGEN_GNET_SKILL6333 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6333:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6333 }; 
        Skill6333 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6333Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6333Stub ():SkillStub (6333) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"酒仙-活体炸弹效果"; 
        nativename          = "酒仙-活体炸弹效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
