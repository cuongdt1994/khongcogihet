...
#ifndef __CPPGEN_GNET_SKILL6643 
#define __CPPGEN_GNET_SKILL6643 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6643:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6643 }; 
        Skill6643 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6643Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
