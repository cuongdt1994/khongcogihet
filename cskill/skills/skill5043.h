...
/* 
50430  "ΨIndulgência Assassina"50431  "^ff5c00ΨIndulgência Assassina          

^ffcb4aAlcance ^ffffffA Distância
^ffcb4aMP ^96f5ff167^ffffff
...
Lança um ataque frenético que causa dano Físico igual a
^96f5ff400%%^ffffff do seu Ataque Físico base.
Primeiro Acerto: se o inimigo estiver dentro de ^96f5ff10^ffffff metros, é empurrado
por ^96f5ff15^ffffff metros.

^a6caf0Custa ^ffffff1 ^a6caf0Chi.

^ffeaabEfeito da Runa Argêntea:@1
Pode carregar até duas vezes, com um intervalo de ^96f5ff45^ffeaab segundos.
^ffeaabNível 1 a 4: Causa dano adicional igual a ^96f5ff36%%^ffeaab do Ataque Físico base.
^ffeaabNível 5 a 7: Causa dano adicional igual a ^96f5ff54%%^ffeaab do Ataque Físico base.
^ffeaabNível 8 a 9: Causa dano adicional igual a ^96f5ff72%%^ffeaab do Ataque Físico base.
^ffeaabNível 10: Causa dano adicional igual a ^96f5ff90%%^ffeaab do Ataque Físico base. @1@2
^ffeaabPode carregar até duas vezes, aumentando o dano em ^96f5ff%d%%^ffeaab do seu Ataque Físico base. @2"*/ 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                float _glyph_value = get_glyph(skill->GetLevel (), 0.36, 0.54, 0.72, 0.9);

                skill->SetSection (1);
                skill->SetPlus (0);
                skill->SetRatio (_glyph_value + (4));
