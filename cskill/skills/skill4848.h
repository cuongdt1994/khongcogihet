...
/* 
48480  "Po√ß√£o de Ca√ßador de Dem√¥nios do Dia do Trabalho de 2018"48481  "Aumenta o N√≠vel de Guarda e Massacre em 20 por 1 hora."*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2018¿Õ∂ØΩ⁄¡‘ƒß“©º¡"; 
        nativename          = "2018¿Õ∂ØΩ⁄¡‘ƒß“©º¡"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 4; 
