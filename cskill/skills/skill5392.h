...
#ifndef __CPPGEN_GNET_SKILL5392 
#define __CPPGEN_GNET_SKILL5392 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5392:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5392 }; 
        Skill5392 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5392Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
