...
/* 
40780  "ΨErva Vital"40781  "^ff5c00ΨErva Vital
...
Invoca um fada das ervas que restaura
^96f5ff20^ffffff de Chi por segundo dos aliados próximos.
...
^00ff00Nível 1 a 4: A Erva dura ^96f5ff6^00ff00 segundos.
^00ff00Nível 5 a 7: A Erva dura ^96f5ff9^00ff00 segundos.
^00ff00Nível 8 a 9: A Erva dura ^96f5ff12^00ff00 segundos.
^00ff00Nível 10: A Erva dura ^96f5ff15^00ff00 segundos.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {    
            ...
            //skill->GetVictim ()->SetTime (9000 + _glyph_value);
            skill->GetVictim ()->SetTime (_glyph_value);
            skill->GetVictim ()->SetRatio (10);
            skill->GetVictim ()->SetAmount (1);
            skill->GetVictim ()->SetValue (54034);
