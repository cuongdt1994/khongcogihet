...
/* 
45020  "ΨMaldição: Demência"45021  "^ff5c00ΨMaldição: Demência
 
 ^ffcb4a Alcance ^96f5ff%d^ffffff ^ffcb4a m
 ^ffcb4a Mana ^96f5ff%d^ffffff
 ^ffcb4a Canalização ^ffffff1 ^ffcb4a s
 ^ffcb4a Conjuração ^ffffff1 ^ffcb4a s
 ^ffcb4a Intervalo ^ffffff2 ^ffcb4a minutos
 ^ffcb4a Arma ^ffffff Desarmado, Instrumentos Mágicos
 
 ^ffcb4a Cultivo ^ffffff Diabólico
 Causa nos inimigos um ataque mágico básico com ^96f5ff100%%^ffffff ataque das armas mais ^96f5ff150%%^ffffff de seu MP máximo
 mais ^96f5ff20%%^ffffff dano físico de um ataque básico, e causará uma redução na sua velocidade de movimentação ^96f5ff70%%^ffffff, Aumenta a Canalização
 ^96f5ff90%%^ffffff, mantendo por ^96f5ff15^ffffff segundos.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 56873,56873,56873,56873,56873,56873,56873,56873,56873,56873 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
