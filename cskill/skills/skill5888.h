...
/* 
58880  "Corrup√ß√£o - Golpe em √Årea de Chefe"58881  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5888 
#define __CPPGEN_GNET_SKILL5888 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5888:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5888 }; 
        Skill5888 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5888Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5888Stub ():SkillStub (5888) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"∏ØªØ-boss∑∂Œß¥∑»À"; 
        nativename          = "∏ØªØ-boss∑∂Œß¥∑»À"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
    ...
    { 
        static int aarray[10] = { 1067,1067,1067,1067,1067,1067,1067,1067,1067,1067 }; 
