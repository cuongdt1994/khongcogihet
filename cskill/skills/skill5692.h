...
/* 
56920  "Efeito do Ataque Normal do Monstro do Campo de Batalha"56921  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5692 
#define __CPPGEN_GNET_SKILL5692 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5692:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5692 }; 
        Skill5692 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5692Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5692Stub ():SkillStub (5692) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"阵营战怪物普攻效果"; 
        nativename          = "阵营战怪物普攻效果"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 3; 
