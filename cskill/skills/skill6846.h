...
/* 
68460  "Sede de Sangue Cyphon"68461  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6846 
#define __CPPGEN_GNET_SKILL6846 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6846:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6846 }; 
        Skill6846 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6846Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6846Stub ():SkillStub (6846) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½õ·ç_¶áÃü¿ñá°"; 
        nativename          = "½õ·ç_¶áÃü¿ñá°"; 
        icon                = "ÉñÍûÔÂÓ½.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "2021_Èå¼ÒBOSS_½õ·ç_Ô¤¾¯¾Û¼¯.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
