...
/* 
59710  "Mestre Espadachim - Dano Aura da Espada Pesada"59711  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5971 
#define __CPPGEN_GNET_SKILL5971 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5971:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5971 }; 
        Skill5971 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5971Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5971Stub ():SkillStub (5971) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ω£ •-÷ÿΩ£…À∫¶π‚ª∑"; 
        nativename          = "Ω£ •-÷ÿΩ£…À∫¶π‚ª∑"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
