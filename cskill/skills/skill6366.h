...
/* 
63660  "Efeito de Habilidade G锚nesis "63661  "Efeito de Habilidade G锚nesis"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6366 
#define __CPPGEN_GNET_SKILL6366 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6366:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6366 }; 
        Skill6366 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6366Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
