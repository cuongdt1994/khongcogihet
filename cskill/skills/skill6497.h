...
/* 
64970  "Rasante do Ganso"64971  "^ffffffRasante do Ganso              
...
Balance seu bastão para se defender. O dano de longo alcance direto causado por jogadores a 
^96f5ff8^ffffff metros de distância é reduzido em ^96f5ff90%%^ffffff.
Enquanto conjura, torna-se imune a efeitos negativos e regenera 30 Chi
a cada ^96f5ff1,5^ffffff segundos. Dura até ^96f5ff20^ffffff segundos.

^a6caf0Custa ^ffffff1 ^a6caf0Chi."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6497 
#define __CPPGEN_GNET_SKILL6497 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6497:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6497 }; 
        Skill6497 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6497Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
