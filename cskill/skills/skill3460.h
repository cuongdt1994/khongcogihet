...
/* 
34600  "ΨTrovão Frígido"34601  "^ff5c00ΨTrovão Frígido  
...
Congela o alvo se você tiver ^96f5ff1 Carga de Trovão e 2 Cargas de Gelo^ff0000.
^ff0000Nível 1 a 4: Imobiliza o alvo por ^96f5ff3,1^ff0000 segundos.
^ff0000Nível 5 a 7: Imobiliza o alvo por ^96f5ff3,4^ff0000 segundos.
^ff0000Nível 8 a 9: Imobiliza o alvo por ^96f5ff3,7^ff0000 segundos.
^ff0000Nível 10: Imobiliza o alvo por ^96f5ff4,0^ff0000 segundos.@1@2
Se você tiver ^96f5ff1 Carga de Trovão e 2 Cargas de Gelo^ff0000, imobiliza o alvo por ^96f5ff%.1f^ff0000 segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph((skill->GetLevel ()), 100, 400, 700, 1000);

            skill->GetVictim ()->SetProbability (1.0 * skill->GetT0 () == 7 ? 100 : 70);
            skill->GetVictim ()->SetTime (4000 + skill->GetT0 () == 7 ? _glyph_value : 0);
