...
/* 
59880  "Dan莽arina_Morte Instant芒nea em Massa sem Flor do Al茅m"59881  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5988 
#define __CPPGEN_GNET_SKILL5988 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5988:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5988 }; 
        Skill5988 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5988Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5988Stub ():SkillStub (5988) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_群秒无彼岸花"; 
        nativename          = "舞女_群秒无彼岸花"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
