...
/* 
63620  "Mestre Cervejeiro-CÃ¢ntico Zumbi Dimensional"63621  "Aura Pessoal de Raio Pequeno; Aumento de Dano"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6362 
#define __CPPGEN_GNET_SKILL6362 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6362:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6362 }; 
        Skill6362 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6362Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6362Stub ():SkillStub (6362) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÆÏÉ-½©½©ÁùºÏÐÄ¾ö"; 
        nativename          = "¾ÆÏÉ-½©½©ÁùºÏÐÄ¾ö"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
