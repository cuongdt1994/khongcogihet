...
/* 
64710  "Solidificação"64711  "^ffffffSolidificação            Nível %d  

^ffcb4aHabilidade Passiva

^ffcb4aCultivo ^ffffffAstuto
Bloqueie dano direto igual a ^96f5ff%.1f%%^ffffff do seu HP máximo e mais ^96f5ff100^ffffff.
Até ^96f5ff3000^ffffff no total."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 1600,3000,3800,5900,6500,9200,12900,17800,24300,33200 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 15,20,25,30,35,40,45,50,55,60 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
