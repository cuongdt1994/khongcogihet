...
/* 
51140  "Inferno Laminado"51141  "^ffffffInferno Laminado
...
Lança um ataque frenético que causa dano de até
^96f5ff450%%^ffffff de seu Ataque Físico base mais ^96f5ff9.437^ffffff.
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (9437);
                skill->SetRatio (4.5);
                skill->SetDamage (0.10 * skill->GetAttack ());
        ...
        class State10:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (9437);
                skill->SetRatio (4.5);
                skill->SetDamage (0.30 * skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
