...
/* 
57110  "Reino do Norte - B么nus do Centro de Eventos"57111  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5711 
#define __CPPGEN_GNET_SKILL5711 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5711:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5711 }; 
        Skill5711 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5711Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5711Stub ():SkillStub (5711) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-事件中心增益"; 
        nativename          = "北陆-事件中心增益"; 
        icon                = "北陆火雨.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
