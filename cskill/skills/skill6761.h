...
/* 
67610  "Recompensa de Curandeiro por EliminaÃ§Ã£o"67611  "DÃª a mm um pacote de efeitos aceitÃ¡vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6761 
#define __CPPGEN_GNET_SKILL6761 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6761:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6761 }; 
        Skill6761 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6761Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6761Stub ():SkillStub (6761) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ò½¼Ò_»÷É±½±Àø"; 
        nativename          = "Ò½¼Ò_»÷É±½±Àø"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 12; 
