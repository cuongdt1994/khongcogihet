...
/* 
57210  "Reino do Norte - Efeito de Morte InstantÃ¢nea 06"57211  "åˆ›ä¸–_å‹¾é­‚ç­å¤©çŸ¢_æ–°è¿žå°„.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5721 
#define __CPPGEN_GNET_SKILL5721 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5721:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5721 }; 
        Skill5721 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5721Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5721Stub ():SkillStub (5721) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½ÃëÉ±Ð§¹û06"; 
        nativename          = "±±Â½ÃëÉ±Ð§¹û06"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
