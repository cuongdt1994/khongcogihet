...
/* 
3030  "Enxame Primitivo"3031  "^ffffffEnxame Primitivo (Nível %d)^ffcb4aAlcance: ^96f5ff%.1f^ffffff ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff2.5 ^ffcb4asegundos^ffcb4aDuração: ^ffffff0.8 ^ffcb4asegundos^ffcb4aEspera: ^ffffff6.0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff20^ffcb4aRestrições da Arma: ^ffffffDesarmado, Instrumentos Mágicos^ffcb4aCultivo necessário: ^ffffffEnigmáticoUm grande parasita venenoso e transmissor de doenças ataca o alvofazendo com que ele e todos os inimigos dentro de ^96f5ff%.1f^ffffff metros sofram dano por Madeira equivalente ao ataque mágico básico mais ^96f5ff%d%%^ffffff de dano por arma mais ^96f5ff%.1f^ffffff.Durante ^96f5ff9^96f5ff segundos, os inimigos também sofrem ^96f5ff%.1f^ffffff de dano por Madeira."*/ 
