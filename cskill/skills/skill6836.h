...
/* 
68360  "RemoÃ§Ã£o Yi-ologista de Cargo"68361  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6836 
#define __CPPGEN_GNET_SKILL6836 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6836:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6836 }; 
        Skill6836 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6836Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6836Stub ():SkillStub (6836) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÒõÑô¼Ò-Õ¼Î»ÇýÉ¢"; 
        nativename          = "ÒõÑô¼Ò-Õ¼Î»ÇýÉ¢"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 12; 
