...
/* 
4100  "●Montanha Retumbante"4101  "^8080ff●Montanha Retumbante^ffcb4aAlcance: ^ffffffCorpo-a-Corpo^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuração: ^ffffff0,3 ^ffcb4asegundos^ffcb4aDuração: ^ffffff1,4 ^ffcb4asegundos^ffcb4aEspera: ^ffffff8,0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff10^ffcb4aRestrições de Armas: ^ffffffMachados e Martelos^ffcb4aCultivo necessário: ^ffffffNobreCom toda a sua força, o personagem salta e bate a sua arma no chão, provocando dano em todos os inimigos num raio de ^96f5ff10^ffffff metros. Os inimigos sofrem ^96f5ff3097^ffffff dano físico e têm sua velocidade reduzida em ^96f5ff50%%^ffffff durante ^96f5ff%d^fffffff segundos.^f7dfa5 A versão sábio reduz a resistência a fogo dos inimigos em ^96f5ff30%%^f7dfa5."*/ 
