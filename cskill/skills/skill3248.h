...
/* 
32480  "ΔMestre das Sombras"32481  "^ff0000ΔMestre das Sombras              Nível %d|if&dynskilllv()>0&^ffcb4a +%d&|
...
Aplique sua maestria sombria para sumir
imediatamente de vista por ^96f5ff|if&(skilllv()+dynskilllv())<2&10&20|^ffffff segundos, aumentando seu

Nível Furtivo em ^96f5ff12^ffffff. Se sua Furtividade terminar enquanto o efeito estiver ativo, você voltará
a ficar Furtivo em ^96f5ff2^ffffff segundos. Enquanto não estiver Furtivo, seu
dano aumenta em ^96f5ff50%%^ffffff. Remove a espera do 
Arremesso de Sabre e reduz sua Velocidade de Ataque em ^96f5ff200%%^ffffff.

|if&(skilllv()+dynskilllv())>Nível 2&^ffffff3: Durante a status sombrio, recupera ^96f5ff5^ff0000 de Carga de Ataque por segundo. &^808080Nível 3: Durante a status sombrio, recupera 5 de Carga de Ataque por segundo."*/ 
