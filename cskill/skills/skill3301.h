...
/* 
33010  "Perdição Cascateada"33011  "Perdição Cascateada: seus ataques têm a chance deaumentar sua Taxa de Acerto Crítico em 30%%se seu Dano Crítico em 30%% por 10 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetIncsmitedamage (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
