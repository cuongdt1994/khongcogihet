...
/* 
57960  "Reino do Norte - Sopro do Drag̣o G̩lido"57961  "^ffffffSopro do Drag̣o G̩lido^ffcb4aAlcance ^ffffff25^ffcb4a metros^ffcb4aCanaliza̤̣o ^ffffff0,5 ^ffcb4asegundo^ffcb4aConjura̤̣o ^ffffff0,5 ^ffcb4asegundo^ffcb4aEspera ^ffffff1,0 ^ffcb4asegundo^ffffffCospe gelo, causando um dano enorme aos alvos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5796 
#define __CPPGEN_GNET_SKILL5796 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5796:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5796 }; 
        Skill5796 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5796Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
