...
#ifndef __CPPGEN_GNET_SKILL6058 
#define __CPPGEN_GNET_SKILL6058 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6058:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6058 }; 
        Skill6058 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6058Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
