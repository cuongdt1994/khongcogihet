...
#ifndef __CPPGEN_GNET_SKILL5519 
#define __CPPGEN_GNET_SKILL5519 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5519:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5519 }; 
        Skill5519 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5519Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
