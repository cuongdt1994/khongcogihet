...
/* 
66290  "ΨTravessia Planar"66291  "^ff5c00ΨTravessia Planar              
...
Ruja seu grito de guerra! Causa ^96f5ff190%%^ffffff de dano físico básico e 
mais ^96f5ff%d^ffffff aos inimigos dentro de uma área em cone, empurrando-os para trás. 
Se você possuir a Marca de Yin ou a Marca de Yang, seu golpe irá
atordoar os inimigos dentro da área em cone por ^96f5ff5^ffffff segundos.

^a6caf0Apenas jogadores podem ser empurrados.
...
#ifndef __CPPGEN_GNET_SKILL6629 
#define __CPPGEN_GNET_SKILL6629 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6629:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6629 }; 
        Skill6629 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6629Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        public:
            ...
            void Calculate(Skill *skill) const
            {
                ...
                skill->SetPlus(11441);
                skill->SetRatio(1.9 + _glyph_value);
