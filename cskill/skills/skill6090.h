...
/* 
60900  "Esquivar de Estado de Patrulha"60901  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6090 
#define __CPPGEN_GNET_SKILL6090 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6090:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6090 }; 
        Skill6090 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6090Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6090Stub ():SkillStub (6090) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¶ã±ÜÑ²Âß×´Ì¬"; 
        nativename          = "¶ã±ÜÑ²Âß×´Ì¬"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 4; 
