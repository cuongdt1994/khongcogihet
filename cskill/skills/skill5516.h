...
#ifndef __CPPGEN_GNET_SKILL5516 
#define __CPPGEN_GNET_SKILL5516 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5516:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5516 }; 
        Skill5516 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5516Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
