...
/* 
39210  "ΨAvalanche do Rio"39211  "^ff5c00ΨAvalanche do Rio
...
Caia sobre o inimigo com o poder de uma onda devastadora, causando dano físico básico, mais ^96f5ff170%%^ffffff
de dano da arma e mais ^96f5ff4664^ffffff de dano físico Aumenta a sua ameaça.
...
^00ff00Nível 1 a 4: O tempo de conjuração é reduzido para ^96f5ff0,1^00ff00 segundo.
^00ff00Nível 5 a 7: O tempo de conjuração é reduzido para ^96f5ff0,2^00ff00 segundos.
^00ff00Nível 8 a 9: O tempo de conjuração é reduzido para ^96f5ff0,3^00ff00 segundos.
^00ff00 Nível 10: O tempo de conjuração é reduzido para ^96f5ff0,4^00ff00 segundos.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                int _glyph_value = get_glyph(skill->GetLevel (), 100, 200, 300, 400);

                return 400 - _glyph_value;
            }
