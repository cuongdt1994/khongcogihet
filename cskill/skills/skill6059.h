...
#ifndef __CPPGEN_GNET_SKILL6059 
#define __CPPGEN_GNET_SKILL6059 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6059:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6059 }; 
        Skill6059 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6059Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
