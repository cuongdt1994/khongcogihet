...
/* 
58630  "DanÃ§arina_Veneno da Flor Vermelha do AlÃ©m"58631  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5863 
#define __CPPGEN_GNET_SKILL5863 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5863:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5863 }; 
        Skill5863 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5863Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5863Stub ():SkillStub (5863) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÎèÅ®_À¶±Ë°¶»¨½â°×»¨¶¾"; 
        nativename          = "ÎèÅ®_À¶±Ë°¶»¨½â°×»¨¶¾"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 1000; 
        type                = 2; 
