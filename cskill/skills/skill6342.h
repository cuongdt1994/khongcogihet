...
/* 
63420  "ΨEscudo da Imprecação"63421  "^ff5c00ΨEscudo da Imprecação
...
#ifndef __CPPGEN_GNET_SKILL6342 
#define __CPPGEN_GNET_SKILL6342 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6342:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6342 }; 
        Skill6342 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6342Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 69118,69118,69118,69118,69118,69118,69118,69118,69118,69118 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
