...
#ifndef __CPPGEN_GNET_SKILL6812 
#define __CPPGEN_GNET_SKILL6812 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6812:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6812 }; 
        Skill6812 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6812Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6812Stub ():SkillStub (6812) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-朝向检测光环"; 
        nativename          = "道家-朝向检测光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 2; 
