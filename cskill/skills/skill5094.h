...
/* 
50940  "Escudo da Rejeição"50941  "^ffffffEscudo da Rejeição            Nível %d
...
Arremessa seu escudo repleto de energia no inimigo, causando Dano Físico igual ao
seu Ataque Físico base mais ^96f5ff%.1f%%^ffffff do Ataque do equipamento e ^96f5ff%.1f^ffffff.
Também atordoa o alvo por ^96f5ff3^ffffff segundos. 
