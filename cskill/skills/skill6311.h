...
/* 
63110  "Origem Justa"
63111  "^ffff00Origem Justa                    ^ffffffNível %d

^ffcb4aHabilidade Passiva

^ffcb4aCultivo Necessário ^ffffffAlma Celestial

^ffffffAumenta a Defesa Física e Mágica obtida de equipamentos em ^96f5ff%d%%^ffffff."
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6311 
#define __CPPGEN_GNET_SKILL6311 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6311:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6311 }; 
        Skill6311 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6311Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 68976,68976,68976,68976,68976,71943,71943,71943,71943,71943 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static int aarray[10] = { 72,74,76,78,80,82,84,86,88,90 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
