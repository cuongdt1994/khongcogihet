...
/* 
59350  "General - CÃ­rculo de ParalisaÃ§Ã£o de Servo"59351  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5935 
#define __CPPGEN_GNET_SKILL5935 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5935:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5935 }; 
        Skill5935 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5935Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5935Stub ():SkillStub (5935) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½«¾ü-Ð¡¹ÖÌ±»¾Õó"; 
        nativename          = "½«¾ü-Ð¡¹ÖÌ±»¾Õó"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
