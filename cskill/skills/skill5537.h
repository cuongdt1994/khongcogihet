...
/* 
55370  "AdE de Wenliang"55371  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5537 
#define __CPPGEN_GNET_SKILL5537 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5537:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5537 }; 
        Skill5537 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5537Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5537Stub ():SkillStub (5537) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ö©ö¦·¶Î§AOE"; 
        nativename          = "ö©ö¦·¶Î§AOE"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
