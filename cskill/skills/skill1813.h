...
/* 
18130  "BenÃ§Ã£o Devota"18131  "^ffff00BenÃ§Ã£o Devota      ^ffcb4aRequer DanÃ§a Violeta^ffcb4aMP ^96f5ff%d^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff0,6 ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff0,8 ^ffcb4asegundo ^ffcb4aEspera ^ffffff45,0 ^ffcb4asegundos^ffcb4aArma ^ffffffDesarmado, Instrumento MÃ¡gico^ffcb4aCultivo NecessÃ¡rio ^ffffffMahayanaInvoca uma benÃ§Ã£o divina que te protege damorte por ^96f5ff12^ffffff segundos. Ao receber dano fatal,vocÃª serÃ¡ recuperado a ^96f5ff50%%^ffffff de seu HP mÃ¡ximo."*/ 
