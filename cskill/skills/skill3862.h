...
/* 
38620  "ΨFúria Bestial"38621  "^ff5c00ΨFúria Bestial
...
^00ffffNível 1 a 4: O escudo aparece quando o HP máximo estiver abaixo de ^ffffff60%%^00ffff.
^00ffffNível 5 a 7: O escudo aparece quando o HP máximo estiver abaixo de ^ffffff65%%^00ffff.
^00ffffNível 8 a 9: O escudo aparece quando o HP máximo estiver abaixo de ^ffffff70%%^00ffff.
^00ffffNível 10: O escudo aparece quando o HP máximo estiver abaixo de ^ffffff75%%^00ffff.@1@2
^00ffffO escudo aparece quando o HP máximo estiver abaixo de ^ffffff%d%%^00ffff.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer()->GetHp() < skill->GetPlayer()->GetMaxhp()*_glyph_value) ? 100 : 0);
            skill->GetVictim ()->SetTime (10000);
            skill->GetVictim ()->SetShowicon (1);				
            skill->GetVictim ()->SetAmount (skill->GetT0 () * 0.50);
