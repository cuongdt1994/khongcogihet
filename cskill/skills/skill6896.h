...
/* 
68960  "ΨChama: Grito Mortal"68961  "^ff5c00ΨChama: Grito Mortal
...
#ifndef __CPPGEN_GNET_SKILL6896 
#define __CPPGEN_GNET_SKILL6896 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6896:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6896 }; 
        Skill6896 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6896Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 72323,72323,72323,72323,72323,72323,72323,72323,72323,72323 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
