...
/* 
54810  "ΨCinco Significados"54811  "^ff5c00ΨCinco Significados
...
^ff0000Nível 1 a 4: O Chi recebido é aumentado para ^96f5ff15
^ff0000Nível 5 a 7: O Chi recebido é aumentado para ^96f5ff20
^ff0000Nível 8 a 9: O Chi recebido é aumentado para ^96f5ff25
^ff0000Nível 10: O Chi recebido é aumentado para ^96f5ff30 @1@2
O Chi recebido é aumentado para ^96f5ff%d@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5481 
#define __CPPGEN_GNET_SKILL5481 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5481:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5481 }; 
        Skill5481 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5481Stub:public SkillStub 
    { 
    public: 
