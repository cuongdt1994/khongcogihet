...
/* 
66550  "Habilidade NTW Torre de Guarda Defesa "66551  "Dano % que ignora Defesa"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6655 
#define __CPPGEN_GNET_SKILL6655 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6655:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6655 }; 
        Skill6655 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6655Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6655Stub ():SkillStub (6655) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战防御塔伤害技能"; 
        nativename          = "新城战防御塔伤害技能"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
