...
#ifndef __CPPGEN_GNET_SKILL5351 
#define __CPPGEN_GNET_SKILL5351 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5351:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5351 }; 
        Skill5351 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5351Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
