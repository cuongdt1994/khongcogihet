...
/* 
39480  "ΨDez Mil Lâminas"39481  "^ff5c00ΨDez Mil Lâminas
...
^ffeaabNível 1 a 4: Causa um dano de arma adicional de ^96f5ff75%%^ffeaab mais ^96f5ff436^ffeaab.
^ffeaabNível 5 a 7: Causa um dano de arma adicional de ^96f5ff110%%^ffeaab mais ^96f5ff654^ffeaab.
^ffeaabNível 8 a 9: Causa um dano de arma adicional de ^96f5ff145%%^ffeaab mais ^96f5ff872^ffeaab.
^ffeaabNível 10: Causa ^96f5ff180%%^ffeaab de dano adicional da arma mais ^96f5ff1.090^ffeaab.@1@2
^ffeaabCausa ^96f5ff%d%%^ffeaab de dano adicional da arma mais ^96f5ff%d^ffeaab.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.28, 0.30, 0.32, 0.34);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 88, 131, 175, 218);
        ...
        class State4:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.58, 0.60, 0.65, 0.70);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 88, 131, 175, 218);
        ...
        class State5:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.81, 0.90, 0.95, 1);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 88, 131, 175, 218);
        ...
        class State6:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.88, 0.95, 1.05, 1.1);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 88, 131, 175, 218);
        ...
        class State7:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 2.2, 2.35, 2.48, 2.66);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 88, 131, 175, 218);
