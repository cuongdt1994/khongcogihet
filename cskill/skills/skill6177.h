...
/* 
61770  "Onda de espada de madeira do Mestre Cervejeiro"61771  "EmpurrÃ£o em RetÃ¢ngulo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6177 
#define __CPPGEN_GNET_SKILL6177 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6177:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6177 }; 
        Skill6177 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6177Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6177Stub ():SkillStub (6177) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÆÏÉ-ÁÖ¿Ë½£Æø"; 
        nativename          = "¾ÆÏÉ-ÁÖ¿Ë½£Æø"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
