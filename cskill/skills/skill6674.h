...
/* 
66740  "Cerco de Monstros Habilidade 3"66741  "2021 NTW AdE. Causa dano a jogadores a at茅 10 metros e fere jogadores que montaram uma barraca."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6674 
#define __CPPGEN_GNET_SKILL6674 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6674:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6674 }; 
        Skill6674 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6674Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6674Stub ():SkillStub (6674) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"怪物攻城小怪技能3"; 
        nativename          = "怪物攻城小怪技能3"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 1; 
