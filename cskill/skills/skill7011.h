...
/* 
70110  "Alta Resistência do Yi-ologista"70111  "Redução de Dano Passiva de Retalhador dentro de 8 metros. Virtualmente livre de danos a 17,5 metros"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7011 
#define __CPPGEN_GNET_SKILL7011 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7011:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7011 }; 
        Skill7011 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7011Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
