...
/* 
32620  "ΣTransposição"32621  "^ffff00ΣTransposição  

^ffcb4aAlcance ^96f5ff28^ffffff ^ffcb4aMetros
^ffcb4aCusto em MP ^96f5ff141
^ffcb4aCanalização ^ffffff0,5 ^ffcb4aSegundos
^ffcb4aConjuração ^ffffff0,1 ^ffcb4aSegundos
^ffcb4aEspera ^ffffff60,0 ^ffcb4aSegundos
^ffcb4aArma ^ffffffLâmina

^ffcb4aCultivo ^ffffffMahayana
Altere o tecido da realidade e para tentar
trocar de lugar com um jogador inimigo e não poder ser um
alvo por ^96f5ff3 ^ffffffsegundos. Nunca erra."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 49958,49958,49958,49958,49958,49958,49958,49958,49958,49958 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
