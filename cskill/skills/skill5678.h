...
/* 
56780  "Aura de Chefe Principal Visado do Continente Ocidental"56781  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5678 
#define __CPPGEN_GNET_SKILL5678 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5678:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5678 }; 
        Skill5678 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5678Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5678Stub ():SkillStub (5678) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"西陆主线BOSS目标圆光环"; 
        nativename          = "西陆主线BOSS目标圆光环"; 
        icon                = "泥泞.dds"; 
#endif 
        max_level           = 10; 
        type                = 1; 
