...
/* 
25620  "Reflexo da Lua"25621  "^ffffffReflexo da Lua (N铆vel %d)^ffcb4aAlcance: ^ffffff20 ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aCanaliza莽茫o: ^ffffff0,1 ^ffcb4asegundos^ffcb4aConjura莽茫o: ^ffffff0,5 ^ffcb4asegundos^ffcb4aEspera: ^ffffff60,0 ^ffcb4asegundos^ffcb4aVigor Recebido: ^ffffff150^ffcb4aArma: ^ffffffSabre, Desarmado^ffcb4aCultivo Necess谩rio: ^ffffffMahayanaInvoque o reflexo da lua para copiar as habilidades de um dos seus alvos.Classes diferentes conceder茫o habilidades diferentes."*/ 
