...
/* 
67240  "Aura dos Esporos de Curandeiro"67241  "6709 Efeito"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6724 
#define __CPPGEN_GNET_SKILL6724 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6724:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6724 }; 
        Skill6724 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6724Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6724Stub ():SkillStub (6724) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"医家-孢子光环效果"; 
        nativename          = "医家-孢子光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 3; 
