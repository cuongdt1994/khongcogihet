...
/* 
3140  "Fogo Espiritual"3141  "^ffffffFogo Espiritual          (Nível %d)
...
Borrifa uma bruma cativante que causa dano físico
básico mais ^96f5ff%.1f^ffffff. 
Se o alvo for um jogador, aumenta o dano que eles sofrem de habilidades por ^96f5ff6^ffffff segundos
em ^96f5ff5%%^ffffff  Este efeito pode 
acumular em até ^96f5ff5^ffffff camadas. A duração será reiniciada ao aplicar uma nova camada."*/ 
