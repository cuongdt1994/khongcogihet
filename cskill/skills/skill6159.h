...
/* 
61590  "Baili Fengjiang - Efeito Ataque Normal "61591  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6159 
#define __CPPGEN_GNET_SKILL6159 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6159:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6159 }; 
        Skill6159 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6159Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6159Stub ():SkillStub (6159) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"百里封疆-平a效果"; 
        nativename          = "百里封疆-平a效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
