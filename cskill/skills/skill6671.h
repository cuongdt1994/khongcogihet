...
/* 
66710  "Reflexo da Montanha"66711  "^ffffffReflexo da Montanha^ffcb4aMP ^96f5ff%.1f^ffffff^ffcb4aCanaliza莽茫o ^ffffffInstant芒nea^ffcb4aEspera ^ffffff1 ^ffcb4asegundo^ffcb4aArma ^ffffffSabreA habilidade copiada pelo Retalhador com poder celestial. Transforma-se em um cora莽茫o de pedra e torna-se invenc铆vel por ^96f5ff5^ffffff segundos.^a6caf0Custa ^ffffff1 ^a6caf0Chi.^ffa4a9Obtenha a habilidade ^00FF00 Reflexo do C茅u^ffa4a9 ao usar esta habilidade."*/ 
