...
/* 
62440  "Mo Rayin-Espada de Vento (N茫o Usada)"62441  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6244 
#define __CPPGEN_GNET_SKILL6244 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6244:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6244 }; 
        Skill6244 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6244Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6244Stub ():SkillStub (6244) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"墨然允-刮风剑（无用）"; 
        nativename          = "墨然允-刮风剑（无用）"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
