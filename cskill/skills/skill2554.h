...
/* 
25540  "Nuvem Distante"25541  "^ffffffNuvem Distante (Nível %d)
...
^ffcb4aCultivo Necessário: ^ffffffAmeaçador
Lance o alvo no ar com um golpe poderoso, causando dano 
físico básico mais ^96f5ff%.1f%%^ffffff de dano de arma
e mais ^96f5ff%.1f^ffffff. Aumenta a sua taxa de acertos críticos
em ^96f5ff35%%^ffffff por ^96f5ff6^ffffff segundos. Zera o intervalo
da Deriva Implacável e remove o intervalo da 
próxima Deriva Implacável nos ^96f5ff6^ffffff segundos seguintes.
