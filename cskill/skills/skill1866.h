...
/* 
18660  "Carga Galvânica"
18661  "^ffff00Carga Galvânica

^ffcb4aCusto em MP: ^96f5ff%d^ffffff
^ffcb4aConjuração: ^ffffff1.4 ^ffcb4asgundos
^ffcb4aDuração: ^ffffff1.0 ^ffcb4asegundos
^ffcb4aEspera: ^ffffff180.0 ^ffcb4asegundos
^ffcb4aRestrições da Arma: ^ffffffArma de Longo Alcance

^ffcb4aEstima: ^ffffffMahayana
Melhore-se com uma corrente elétrica.
IAumenta o alcance de ataque por ^96f5ff6^ffffff metros e
o dano crítico por ^96f5ff15%%^ffffff entre ^96f5ff4^ffffff a ^96f5ff8^ffffff vezes, 
dependendo da anima, durante os próximos ^96f5ff20^ffffff segundos.

Após utilizar, você irá recuperar ^96f5ff100^ffffff de Chi emr ^96f5ff10^ffffff segundos.
