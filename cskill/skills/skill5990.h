...
/* 
59900  "Lobo do TrovÃ£o - Positivo Polar"59901  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5990 
#define __CPPGEN_GNET_SKILL5990 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5990:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5990 }; 
        Skill5990 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5990Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5990Stub ():SkillStub (5990) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Õý´Å¼«"; 
        nativename          = "À×ÀÇ-Õý´Å¼«"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
