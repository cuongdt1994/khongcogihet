...
/* 
65150  "â—‹ExpansÃ£o Letal"65151  "^8080ffâ—‹ExpansÃ£o Letal              ^ffcb4aAlcance ^ffffffCorpo-a-corpo^ffcb4aCusto em MP ^96f5ff%.1f^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff0,1 ^ffcb4asegundo    ^ffcb4aConjuraÃ§Ã£o ^ffffff1,5^ffcb4asegundo    ^ffcb4aEspera ^ffffff30,0 ^ffcb4asegundos    ^ffcb4aChi Recebido ^ffffff5   ^ffcb4aArma ^ffffffClavas^ffcb4aCultivo  ^ffffffDiabÃ³licoA atÃ© ^96f5ff8^ffffff metros, causa dano fÃ­sico bÃ¡sico mais ^96f5ff360%%^ffffff de dano da arma mais ^96f5ff%d^ffffff aos inimigos. Recebe a Marca de Yang. InvencÃ­vel enquanto conjura.^d618e7Aumenta o seu dano em ^96f5ff1000^d618e7."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6515 
#define __CPPGEN_GNET_SKILL6515 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6515:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6515 }; 
        Skill6515 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6515Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
