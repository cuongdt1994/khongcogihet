...
/* 
68610  "Arrancar Carne"68611  "^ffcb4aAlcance^ffffff10      ^ffcb4ametros^ffcb4aEspera^ffffff2,0    ^ffcb4asegundos^ffffffUsar Arrancar em Armadilhas causa dano a elas."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6861 
#define __CPPGEN_GNET_SKILL6861 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6861:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6861 }; 
        Skill6861 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6861Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
