...
/* 
64150  "ΨReversão Tática"
64151  "^ff5c00ΨReversão Tática
...
Marca o ^96f5ffinimigo ^ffffff e causa dano a eles enquanto se movem.
Quão mais longe se movem, mas dano sofrerão. Dura ^96f5ff6^ffffff segundos.
...
Para cada ^96f5ff1^ffeaab metro,
^ffeaabNível 1 a 4: Causa ^96f5ff15%%^ffeaab de dano básico mágico.
^ffeaabNível 5 a 7: Causa ^96f5ff20%%^ffeaab de dano básico mágico.
^ffeaabNível 8 a 9: Causa ^96f5ff25%%^ffeaab de dano básico mágico.
^ffeaabNível 10: Causa ^96f5ff30%%^ffeaab de dano básico mágico.@1@2
^ffeaab Causa ^96f5ff%d%%^ffeaab do dano básico mágico.@2
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6415 
#define __CPPGEN_GNET_SKILL6415 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6415:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6415 }; 
        Skill6415 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6415Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (_glyph_value * skill->GetT0 ());
            skill->GetVictim ()->SetApplyDamageforRange (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
