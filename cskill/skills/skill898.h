...
/* 
8980  "Corte do Infinito"8981  "^ffffff Corte do Infinito            
...
Acerte seu inimigo com um impacto devastador, causando dano físico básico mais 
^96f5ff100%%^ffffff de dano de arma mais ^96f5ff5135^ffffff. Interrompe
e silencia alvo por ^96f5ff3^ffffff segundos. 
Nunca erra.

Tipos diferentes de armas causam efeitos diferentes.
Machado e Martelo: A duração do Silêncio é aumentada para ^96f5ff5^ffffff segundos.
Arma de Haste: O Alcance é aumentado para ^96f5ff20^ffffff metros, mais ^96f5ff100%%^ffffff de dano físico do Ataque de Equipamento.
Lâmina ou Espada: Não Silencia mais o alvo; a Canalização é reduzida para ^96f5ff0,1 
^ffffffsegundo; a Conjuração é reduzida para ^96f5ff0,6^ffffff segundo; o Dano Físico é aumentado em um adicional de ^96f5ff200%%^ffffff
do Ataque do de Equipamento.
Outro: O mesmo efeito do Machado e do Martelo.

^a6caf0Custa ^ffffff15^a6caf0 de Chi.
"*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5135);
                skill->SetRatio (skill->GetPlayer()->GetCurWeapon() == 1 ? 2 : 1);
