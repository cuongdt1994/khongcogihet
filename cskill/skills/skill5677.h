...
/* 
56770  "Chefe Principal do Continente Ocidental Congela Alvos e Invoca Monstros"56771  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5677 
#define __CPPGEN_GNET_SKILL5677 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5677:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5677 }; 
        Skill5677 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5677Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5677Stub ():SkillStub (5677) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"西陆主线BOSS定身招怪"; 
        nativename          = "西陆主线BOSS定身招怪"; 
        icon                = "泥泞.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
