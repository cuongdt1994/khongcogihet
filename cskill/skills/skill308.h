...
{ 
    ...
    { 
        static int aarray[10] = { 10000,13150,17100,22050,28300,36200,46200,59000,75500,96000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 36,40,44,48,52,56,60,64,68,72 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
