...
/* 
34410  "ΨRuptura Descendente"34411  "^ff5c00ΨRuptura Descendente 
...
^00ffffNível 5 a 7: Causa ^ffffff120%%^00ffff a mais de dano por arma.
^00ffffNível 8 a 9: Causa ^ffffff160%%^00ffff a mais de dano por arma.
^00ffffNível 10: Causa ^ffffff200%%^00ffff a mais de dano por arma.@1@2
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3580);
                skill->SetRatio (1.2 + (skill->GetPlayer ()->GetBalls () == 11 ? _glyph_value : 0));
