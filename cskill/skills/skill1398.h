...
/* 
13980  "Dissolução"13981  "^ffffffDissolução (Nível %d)^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff1.5^ffcb4a segundos^ffcb4aDuração: ^ffffff0.5^ffcb4a segundos^ffcb4aEspera: ^96f5ff%.1f^ffffff segundos^ffcb4aRestrições da Arma: ^ffffffMãos ou Instrumento Mágico^ffcb4aEstima: ^ffffffHarmoniosoTodas as plantas dentro de ^96f5ff%.1f^ffffff metros, explodem.Causando dano em todos os inimigos próximos.Também adiciona um efeito de status especial aos alvos.^a6caf0Deve selecionar um alvo para lançar.^a6caf0O alcance de cada explosão da planta é de 10 metros."*/ 
