...
/* 
66820  "NTW Torre de Guarda Causa Dano em Alvo 煤nico"66821  "8% do HP M谩ximo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6682 
#define __CPPGEN_GNET_SKILL6682 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6682:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6682 }; 
        Skill6682 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6682Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6682Stub ():SkillStub (6682) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战塔楼单体伤害"; 
        nativename          = "新城战塔楼单体伤害"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 3; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "2021_完美国际_高级箭塔_蓝_普攻击中.att"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
