...
/* 
13880  "Lorde Crag"13881  "^ffffffLorde Crag (Nível %d)
...
^ffcb4aCultivo Necessário ^ffffffSinistro
Invoque um guerreiro elemental para proteger você. O Lorde Cragg ataca seus inimigos,
causando enormes danos físico e de Fogo, mas só dura ^96f5ff20^ffffff segundos.

^a6caf0Você pode usar a Transferência para aumentar a duração do Lorde Cragg.
^a6caf0Não é possível usar o Sugador de Energia no Lorde Cragg.
