...
/* 
22250  "Dissolução Extrema"22251  "^ffff00Dissolução Extrema^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuração: ^ffffffInstantâneo^ffcb4aEspera: ^96f5ff%.1f ^ffffff segundo^ffcb4arestrição de arma: ^ffffffInstrumento mágico, Desarmado^ffcb4aCultivo necessário: ^ffffffHarmoniosoExplode uma de suas plantas dentro de um raio ^96f5ff26.5^ffffff metros.Causando dano em todos os inimigos próximos.Também adiciona um efeito de status especial aos alvos.^a6caf0Deve selecionar um alvo para lançar.^a6caf0O alcance de cada explosão da planta é de ^ffffff10^a6caf0 metros."*/ 
