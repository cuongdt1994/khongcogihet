...
/* 
26530  "Não é possível selecionar a Imagem da Sombra"26531  "^ffffffSobrecarga (Nível %d)

^ffcb4aCanalização ^ffffff0.1 ^ffcb4asegundos
^ffcb4aConjuração ^ffffff0.1 ^ffcb4asegundos
^ffcb4aEspera  ^ffffff10 ^ffcb4asegundos

^ffffffDá aos seus ataques básicos ^96f5ff30%%^ffffff de chance de aumentar as
esperas do alvo em ^96f5ff%d%%^ffffff por^96f5ff4^ffffff segundos. Menos eficiente em alvos não jogadores."*/ 
