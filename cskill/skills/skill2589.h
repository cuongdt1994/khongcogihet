...
/* 
25890  "Chamar RelÃ¢mpago"25891  "^ffffffChamar RelÃ¢mpago (NÃ­vel %d)^ffcb4aAlcance: ^96f5ff%.1f ^ffffff ^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aCanalizaÃ§Ã£o: ^ffffff1.9 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o: ^ffffff1.6 ^ffcb4asegundos^ffcb4aEspera: ^ffffff30.0 ^ffcb4asegundos^ffcb4aArma: ^ffffff Foice, Desarmado^ffcb4aCultivo NecessÃ¡rio: ^ffffffAmeaÃ§adorInvoca um raio para atingir seu inimigo, causando dano mÃ¡gico bÃ¡sico, mais ^96f5ff%.1f%%^ffffff de dano da arma e mais ^96f5ff%.1f^ffffff de danode metal. Consome qualquer acÃºmulo de Queimadura por Raio no alvo,causando dano de metal instantaneamente com base no nÃºmero de acÃºmulos.^a6caf0Custa ^ffffff75 ^a6caf0Chi."*/ 
