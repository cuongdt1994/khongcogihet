...
#ifndef __CPPGEN_GNET_SKILL6440 
#define __CPPGEN_GNET_SKILL6440 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6440:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6440 }; 
        Skill6440 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6440Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
