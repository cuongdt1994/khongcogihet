...
/* 
10120  "Tornado Rastejante"10121  "^ffffffTornado Rastejante (NÃ­vel %d)^ffcb4aAlcance: ^ffffff18 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff15 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffTodasConjura um redemoinho que atinge todos os inimigos em um cone de 18 metros Ã  sua frente.Reduz a velocidade deles em %d%% por 10 segundos.Causa %.1f de dano por Metal.^ffa083ForÃ§a: A cada ponto de ForÃ§a de Daimon, o dano Ã© aumentado em 4.3.^ffa083ForÃ§a: A cada 5 pontos de ForÃ§a de Daimon, o efeito de reduÃ§Ã£o da velocidade Ã© aumentado em 2%%.^ffa083ForÃ§a: A cada 30 pontos de ForÃ§a de Daimon, o tempo de reduÃ§Ã£o de velocidade Ã© aumentado em 1 segundo."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 1020115,1020120,1020125,1020130,1020135,1020140,1020145,1020150,1020155,1020160 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
