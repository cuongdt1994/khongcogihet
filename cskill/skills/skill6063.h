...
/* 
60630  "Declive das Montanhas"60631  "|if&skilllv()>0&^00FF00&^ffffff||if&skilllv()>1&^00FFFF&||if&skilllv()>2&^d618e7&||if&skilllv()>3&^FF6600&|Declive das Montanhas             ^ffffffNÃ­vel %d^ffcb4aAlcance ^ffffffCorpo a Corpo^ffcb4aCanalizaÃ§Ã£o ^ffffff0,1 ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff1,5 ^ffcb4asegundo^ffcb4aEspera ^ffffff12,0 ^ffcb4asegundos   ^ffffffBalance a arma para um ataque poderoso contra um alvo corpo a corpo.Causa dano fÃ­sico igual a ^96f5ff200%%^ffffff do Ataque base.|if&skilllv()>1&LV2: ^ffffffCausa dano fÃ­sico igual a ^96f5ff250%%^ffffff do Ataque de Base. &^808080Nv2: Causa dano fÃ­sico igual a 250%% do Ataque base. ||if&skilllv()>2&LV3: ^ffffffO golpe paralisa o alvo por ^96f5ff2^ffffff segundos. E ^808080Nv.3: O golpe paralisa o alvo por 2 segundos. ||if&skilllv()>3&LV4: ^ffffffA espera da habilidade Ã© reduzida para ^96f5ff8^ffffff segundos. E^808080Nv.4: A espera Ã© reduzida para 8 segundos. |^ffcb4aCom o BebÃª Celestial no Nv.^ffffff30/70/90/105^ffcb4a, a Habilidade: Nv.^ffffff1/2/3/4^ffcb4a serÃ¡ liberada."*/ 
...
{ 
    ...
    { 
        ...
        combosk_nobreak     = 1; 
#ifdef _SKILL_CLIENT 
        effect              = "Ì¹¿Ëº¢×Ó_»÷µ¹Ê©·ÅÂäµØÃæ01ÐÂ.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
    ...
    { 
        static int aarray[10] = { 1500,1500,1500,1500,1500,1500,1500,1500,1500,1500 }; 
