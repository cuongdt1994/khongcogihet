...
/* 
57890  "Ataque de 脕gua e de Fogo do Monstro de Aida"57891  "Habilidade dos monstros invocados por Aida. Inflige o pacote de status de 谩gua e de fogo aos alvos, causando dano adicional."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5789 
#define __CPPGEN_GNET_SKILL5789 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5789:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5789 }; 
        Skill5789 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5789Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5789Stub ():SkillStub (5789) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"阿伊达小怪水火组合技"; 
        nativename          = "阿伊达小怪水火组合技"; 
        icon                = "朔光咏.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
