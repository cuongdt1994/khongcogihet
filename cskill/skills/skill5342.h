...
/* 
53420  "脕rea de Efeito Pessoal do Geral Demon铆aco"53421  "脕rea de Efeito Pessoal do Geral Demon铆aco"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5342 
#define __CPPGEN_GNET_SKILL5342 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5342:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5342 }; 
        Skill5342 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5342Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 3201,3201,3201,3201,3201,3201,3201,3201,3201,3201 }; 
