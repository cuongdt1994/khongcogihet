...
/* 
70160  "Ben莽茫o Neutra Tao铆sta: Sangramento"70161  "Aura amaldi莽oada dentro de 100 metros de si mesmo que faz com que cada alvo pera 25% do HP atual por segundo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7016 
#define __CPPGEN_GNET_SKILL7016 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7016:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7016 }; 
        Skill7016 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7016Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill7016Stub ():SkillStub (7016) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-中性祝福流血"; 
        nativename          = "道家-中性祝福流血"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 12; 
