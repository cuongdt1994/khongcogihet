...
/* 
53750  "Habilidade de Aura de Cristal Amarela"53751  "Habilidade de Aura de Cristal Amarela"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5375 
#define __CPPGEN_GNET_SKILL5375 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5375:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5375 }; 
        Skill5375 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5375Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
