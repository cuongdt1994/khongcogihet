...
#ifndef __CPPGEN_GNET_SKILL6541 
#define __CPPGEN_GNET_SKILL6541 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6541:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6541 }; 
        Skill6541 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6541Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
