...
/* 
67760  "Teleporte Banido do Or谩culo"67761  "Determina se h谩 um pacote de efeitos 4602 e, se houver, teleporta para xyz"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6776 
#define __CPPGEN_GNET_SKILL6776 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6776:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6776 }; 
        Skill6776 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6776Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
