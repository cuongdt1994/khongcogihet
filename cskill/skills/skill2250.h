...
/* 
22500  "ΩLâmina da Desordem"22501  "^ffff00ΦLâmina do Caos
...
de habilidades em ^96f5ff35%% ^ffffff por ^96f5ff600 ^ffffffsegundos.
Ao ser usado em um jogador, aumenta o dano recebido 
de habilidades em ^96f5ff20%% ^ffffffpor ^96f5ff5 ^ffffffsegundos.

^d618e7Quando usada no monstro alvo, aumenta a chance dele receber Acertos Críticos em ^96f5ff15%%^d618e7.
Quando usada no jogador alvo, a duração do efeito é aumentada para ^96f5ff8^d618e7 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * ((skill->GetTarget ()->GetCls () != 127 || skill->GetTarget ()->GetCls () != -1) ? 100 : 0));
