...
#ifndef __CPPGEN_GNET_SKILL6038 
#define __CPPGEN_GNET_SKILL6038 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6038:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6038 }; 
        Skill6038 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6038Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
