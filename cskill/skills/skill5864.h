...
/* 
58640  "Dan√ßarina_Flor Vermelha do Al√©m"58641  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5864 
#define __CPPGEN_GNET_SKILL5864 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5864:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5864 }; 
        Skill5864 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5864Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5864Stub ():SkillStub (5864) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ŒË≈Æ_∫Ï±À∞∂ª®"; 
        nativename          = "ŒË≈Æ_∫Ï±À∞∂ª®"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
