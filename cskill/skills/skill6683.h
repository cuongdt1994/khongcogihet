...
/* 
66830  "Ataque de Catapulta Lado Vermelho"66831  "N/Aå·¥ç¨‹è½¦æ”»å‡»æŠ€èƒ½"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6683 
#define __CPPGEN_GNET_SKILL6683 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6683:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6683 }; 
        Skill6683 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6683Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
