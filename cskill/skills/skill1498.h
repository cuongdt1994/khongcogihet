...
/* 
14980  "Curar Conjurado"
14981  "^ffffffCurar Conjurado (Nível %d)

^ffcb4aAlcance ^96f5ff%.1f^ffffff ^ffcb4ametros
^ffcb4aMP ^96f5ff%d^ffffff
^ffcb4aCanalização ^ffffff0,5 ^ffcb4a segundo 
...
Cure as feridas do seu mascote, recuperando todo o HP dele."
*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 960,2240,4160,6720,10240,14880,21040,29200,38900,53200 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 7,12,17,22,27,32,37,42,47,52 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
