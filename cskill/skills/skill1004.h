...
/* 
10040  "Lâmina Flamejante"10041  "^ffffffLâmina Flamejante (Nível %d)^ffcb4Alcance: ^ffffff25 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff8 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasInvoca a Lâmina Flamejante,Causando %.1f de dano físico e %.1f de dano de metal.^d618e7Dano é duplicado para alvos corpo a corpo."*/ 
