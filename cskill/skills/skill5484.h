...
/* 
54840  "ΨGarras do Paraíso"54841  "^ff5c00ΨÁguia da Fúria da Tempestade
...
^ffcb4aNível 5 a 7: Causa um adicional de ^96f5ff40%%^ffcb4a do Ataque da Arma.
^ffcb4aNível 8 a 9: Causa um adicional de ^96f5ff60%%^ffcb4a do Ataque da Arma.
^ffcb4aNível 10: Causa adicional de ^96f5ff80%%^ffcb4a do Dano da Arma.@1@2
Causa adicional de ^96f5ff%d%%^ffcb4a do Dano da Arma.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            float _glyph_value = get_glyph(player->GetSkilllevel(5484), 0.2, 0.4, 0.6, 0.8);
