...
#ifndef __CPPGEN_GNET_SKILL6977 
#define __CPPGEN_GNET_SKILL6977 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6977:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6977 }; 
        Skill6977 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6977Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 160; } 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 641; } 
        bool Quit (Skill * skill) const { return false; } 
        bool Loop (Skill * skill) const { return false; } 
        bool Bypass (Skill * skill) const { return false; } 
        void Calculate (Skill * skill) const 
        { 
            static int aarray[10] = { 6,6,6,6,6,6,6,6,6,6 }; 
            skill->GetPlayer ()->SetDecmp (aarray[skill->GetLevel () - 1]); 
...
#endif 
    Skill6977Stub ():SkillStub (6977) 
    { 
        cls                 = 11; 
#ifdef _SKILL_CLIENT 
        name                = L"神月神之体技能效果银2"; 
        nativename          = "神月神之体技能效果银2"; 
        icon                = "朔光咏.dds"; 
#endif 
        max_level           = 1; 
        type                = 3; 
