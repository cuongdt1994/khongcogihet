...
/* 
67840  "InvocaÃ§Ã£o de Esporos do Curandeiro"67841  "Invoca Servos Esporos 71625"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6784 
#define __CPPGEN_GNET_SKILL6784 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6784:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6784 }; 
        Skill6784 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6784Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6784Stub ():SkillStub (6784) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ò½¼Ò-ÕÙ»½æß×Ó"; 
        nativename          = "Ò½¼Ò-ÕÙ»½æß×Ó"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 12; 
