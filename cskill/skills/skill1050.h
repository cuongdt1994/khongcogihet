...
/* 
10500  "Garra Violenta"10501  "^ffffffGarra Violenta (NÃ­vel %d)^ffcb4Alcance: ^ffffff25 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff20 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffFeiticeiraUm ataque de energia no formato de garra,causando dano fÃ­sico e metal por %.1f,Ao mesmo tempo causa efeito de EstilhaÃ§ar e Sangramento,diminui 20%% de defesa por 9s,sangramento de %d por 9s.^ffa083For: Cada ponto aumenta %d de sangramento.^ffa083For: Cada ponto aumenta 10 pontos de dano fÃ­sico.^72fe00Agi: Cada ponto aumenta 10 pontos de dano de metal.^d618e7Causa dano triplo no alvo no cÃ©u.^ff0000SÃ³ pode ser usada no chÃ£o."*/ 
