...
/* 
53890  "Efeito de Aura de Cobertura de Monstro"53891  "Efeito de Aura de Cobertura de Monstro"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5389 
#define __CPPGEN_GNET_SKILL5389 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5389:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5389 }; 
        Skill5389 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5389Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
