...
#ifndef __CPPGEN_GNET_SKILL6529 
#define __CPPGEN_GNET_SKILL6529 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6529:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6529 }; 
        Skill6529 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6529Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
