...
/* 
40490  "ΨForça dos Espinhos"40491  "^ff5c00ΨForça dos Espinhos
...
^00ffffNível 1 a 4: Tem ^ffffff60%%^00ffff de chance de silenciar os alvos.
^00ffffNível 5 a 7: Tem ^ffffff65%%^00ffff de chance de silenciar os alvos.
^00ffffNível 8 a 9: Tem ^ffffff70%%^00ffff de chance de silenciar os alvos.
^00ffffNível 10: Tem ^ffffff75%%^00ffff de chance de silenciar os alvos.@1@2
Tem ^ffffff%d%%^00ffff de chance de silenciar os alvos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            int _glyph_value = get_glyph(skill->GetLevel (), 60, 65, 70, 75);
