...
/* 
58410  "General - Remover Predefini莽茫o de Aura Dupla"58411  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5841 
#define __CPPGEN_GNET_SKILL5841 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5841:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5841 }; 
        Skill5841 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5841Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5841Stub ():SkillStub (5841) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-清单挑前置光环"; 
        nativename          = "将军-清单挑前置光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
