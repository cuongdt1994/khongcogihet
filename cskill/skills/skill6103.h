...
/* 
61030  "Borboleta - Dano AdE da Esfera do TrovÃ£o "61031  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6103 
#define __CPPGEN_GNET_SKILL6103 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6103:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6103 }; 
        Skill6103 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6103Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6103Stub ():SkillStub (6103) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÉÁµçÇòaoeÉËº¦"; 
        nativename          = "ºûµû-ÉÁµçÇòaoeÉËº¦"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
