...
/* 
25520  "Corte do Orgulho"25521  "^ffffffCorte do Orgulho (Nível %d)
...
^ffcb4aCultivo ^ffffffAmeaçador
Carregue sua arma por ^96f5ff3^ffffff segundos e libere a energia acumulada contra todos os alvos dentro de ^96f5ff12^ffffff metros, 
causando dano físico base mais ^96f5ff%.1f%%^ffffff de Ataque da Arma 
mais ^96f5ff%.1f^ffffff. Atordoa os alvos por ^96f5ff1 ^ffffff
segundo."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 24000,23000,22000,21000,20000,19000,18000,17000,16000,15000 }; 
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetT0 () >= 3000 ? 100 : 0);
