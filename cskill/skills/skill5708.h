...
/* 
57080  "Efeito do Ataque Normal da Torre de Flechas do Campo de Batalha"57081  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5708 
#define __CPPGEN_GNET_SKILL5708 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5708:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5708 }; 
        Skill5708 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5708Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5708Stub ():SkillStub (5708) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"阵营战箭塔普攻效果"; 
        nativename          = "阵营战箭塔普攻效果"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 3; 
