...
/* 
13870  "Salvação"13871  "^ffffffSalvação           Nível %d
...
Invoca um servo angelical para te proteger. A Salvação protege
seus aliados, aumentando suas defesas, ou recupera o HP deles. Dura 
^96f5ff20^ffffff segundos. Você pode usar o Sugador de Energia para drenar força 
da Salvação para se proteger, absorvendo ^96f5ff%d^ffffff de dano e aplicando uma versão do feitiço Pétalas Cadentes, que recupera ^96f5ff%d^ffffff de HP e dura ^96f5ff30^ffffff segundos.

^a6caf0Você pode usar a Transferência para aumentar a duração da Salvação.
"*/ 
