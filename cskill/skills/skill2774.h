...
em que você não pode ser selecionado e é invulnerável contra qualquer 
dano. Também aumenta sua Velocidade de Movimento em ^96f5ff100%%^ffffff.
Você pode usar habilidades ou ataques. Dura ^96f5ff10^ffffff segundos.
Apesar de muitos seres malignos terem adotado a escuridão, os Sombrios
nasceram nela. 
