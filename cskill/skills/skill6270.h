...
/* 
62700  "ΦMente Taoista"62701  "^ffff00ΦMente Taoista^ffcb4aMP ^96f5ff175^ffffff^ffcb4aCanalização ^ffffff0,1 ^ffcb4asegundo^ffcb4aConjuração ^ffffff16 ^ffcb4asegundos^ffcb4aEspera ^ffffff120 ^ffcb4asegundos^ffcb4aChi Recebido ^ffffff10^ffcb4aArma ^ffffffAdaga^ffcb4aCultivo Necessário ^ffffffAlma CelestialAumenta suas chances de resistir a status negativos em ^96f5ff66%%^ffffff e a chance de resistir a dano em ^96f5ff35%%^ffffff. Dura ^96f5ff60^ffffff segundos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6270 
#define __CPPGEN_GNET_SKILL6270 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6270:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6270 }; 
        Skill6270 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6270Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1284, 1)); 
        pre_skills.push_back (std::pair < ID, int >(1286, 1)); 
