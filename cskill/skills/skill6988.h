...
/* 
69880  "ΨMente Taoista"69881  "^ff5c00ΨMente Taoista
...
Aumenta a sua chance de resistir a efeitos negativos em 
^96f5ff100%%^ffffff. 

^00ff00Efeito da Runa Verdejante:@1
^00ff00Nível 1 a 4: A redução do dano dura ^96f5ff25^00ff00 segundos.
^00ff00Nível 5 a 7: A redução do dano dura ^96f5ff30^00ff00 segundos.
^00ff00Nível 8 a 9: A redução do dano dura ^96f5ff35^00ff00 segundos.
^00ff00Nível 10: A redução de dano dura ^96f5ff40^00ff00 segundos.@1@2
A redução de dano dura ^96f5ff%d^00ff00 segundos.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6988 
#define __CPPGEN_GNET_SKILL6988 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6988:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6988 }; 
        Skill6988 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6988Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            int _glyph_value = get_glyph(skill->GetLevel (), 25000, 30000, 35000, 40000);
