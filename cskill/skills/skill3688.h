...
/* 
36880  "ΨChuva de Areia"36881  "^ff5c00ΨChuva de Areia
...
^ff0000Nível 1 a 4: Aumenta a velocidade de canalização da sua próxima ^96f5ffΨAsas da Fênix^ff0000 por ^96f5ff6^ff0000 segundos em ^96f5ff40%%.
^ff0000Nível 5 a 7: Aumenta a velocidade de canalização da sua próxima ^96f5ffΨAsas da Fênix^ff0000 por ^96f5ff6^ff0000 segundos em ^96f5ff60%%.
^ff0000Nível 8 a 9: Aumenta a velocidade de canalização da sua próxima ^96f5ffΨAsas da Fênix^ff0000 por ^96f5ff6^ff0000 segundos em ^96f5ff80%%.
^ff0000Nível 10: Aumenta a velocidade de canalização da sua próxima ^96f5ffΨAsas da Fênix^ff0000 por ^96f5ff6^ff0000 segundos em ^96f5ff100%%@1@2
^ff0000Aumenta a velocidade de canalização da sua próxima ^96f5ffΨAsas da Fênix^ff0000 por ^96f5ff6^ff0000 segundos em ^96f5ff%d%%@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {            
            ...
            skill->GetVictim ()->SetRatio (1000 * _glyph_value); //Value
