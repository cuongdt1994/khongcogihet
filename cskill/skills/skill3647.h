...
/* 
36470  "ΨAlma da Vingança - Reação"36471  "^ff5c00ΨAlma da Vingança - Reação
...
^ffeaabNível 1 a 4: Aumenta a duração para ^96f5ff14^ffeaab segundos contra alvos silenciados.
^ffeaabNível 5 a 7: Aumenta a duração para ^96f5ff16^ffeaab segundos contra alvos silenciados.
^ffeaabNível 8 a 9: Aumenta a duração para ^96f5ff18^ffeaab segundos contra alvos silenciados.
^ffeaabNível 10: Aumenta a duração para ^96f5ff20^ffeaab segundos contra alvos silenciados.@1@2
Aumenta a duração para ^96f5ff%d^ffeaab segundos contra alvos silenciados.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetPlayer ()->CheckBuffState (9) ? _glyph_value : 11000);
