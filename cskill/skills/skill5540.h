...
/* 
55400  "Efeito da Aura de Fogo do Evento de Chamar 2019"55401  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5540 
#define __CPPGEN_GNET_SKILL5540 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5540:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5540 }; 
        Skill5540 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5540Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5540Stub ():SkillStub (5540) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2019回流火圈光环效果"; 
        nativename          = "2019回流火圈光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 1; 
        type                = 3; 
