...
/* 
59720  "Lobo do TrovÃ£o -Teste de Polo MagnÃ©tico"59721  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5972 
#define __CPPGEN_GNET_SKILL5972 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5972:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5972 }; 
        Skill5972 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5972Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5972Stub ():SkillStub (5972) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-´Å¼«²âÊÔ"; 
        nativename          = "À×ÀÇ-´Å¼«²âÊÔ"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
