...
#ifndef __CPPGEN_GNET_SKILL6095 
#define __CPPGEN_GNET_SKILL6095 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6095:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6095 }; 
        Skill6095 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6095Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
