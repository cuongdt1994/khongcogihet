...
/* 
58660  "Dan√ßarina_Adicionar Defesa em Chefes"58661  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5866 
#define __CPPGEN_GNET_SKILL5866 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5866:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5866 }; 
        Skill5866 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5866Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5866Stub ():SkillStub (5866) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ŒË≈Æ_BOSSº”∑¿”˘"; 
        nativename          = "ŒË≈Æ_BOSSº”∑¿”˘"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
