...
/* 
66620  "Andarilho Principal - Personagem Sem Habilidade"66621  "Anular habilidade, 1 Cancelar, 2 Transforma莽茫o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6662 
#define __CPPGEN_GNET_SKILL6662 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6662:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6662 }; 
        Skill6662 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6662Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6662Stub ():SkillStub (6662) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"妖猴主线-少年主角无技能"; 
        nativename          = "妖猴主线-少年主角无技能"; 
        icon                = "诀雪狐变身卡.dds"; 
#endif 
        max_level           = 1; 
        type                = 4; 
