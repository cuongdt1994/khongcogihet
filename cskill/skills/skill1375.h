...
/* 
13750  "Névoa Rodopiante"13751  "^ffffffNévoa Rodopiante (Nível %d)^ffcb4aAlcance: ^96f5ff%.1f^ffffff ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff1.0 ^ffcb4asegundos^ffcb4aDuração: ^ffffff1.0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff5.0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff10^ffcb4aRestrições da Arma: ^ffffffDesarmado, Instrumentos Mágicos^ffcb4aEstima: ^ffffffLealCausa Dano Mágico básico e o alvo sofre o efeito de status do Aperto da Névoa. Quando o HP do alvo está abaixo de ^96f5ff60%%^ffffff, ele recebe dano contínuo. O efeito de status Aperto da Névoa dura ^96f5ff9^ffffff segundos. de Madeira equivalente ao Dano Mágico básico mais ^96f5ff%.1f^ffffff a cada ^96f5ff45^ffffff segundos."*/ 
