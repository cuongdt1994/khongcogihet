...
/* 
68920  "Ilha dos Cavaleiros: DragÃ£o"68921  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6892 
#define __CPPGEN_GNET_SKILL6892 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6892:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6892 }; 
        Skill6892 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6892Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6892Stub ():SkillStub (6892) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÏÉÏÀµºÅç»ðÁú"; 
        nativename          = "ÏÉÏÀµºÅç»ðÁú"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 12; 
