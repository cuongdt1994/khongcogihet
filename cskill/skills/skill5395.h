...
/* 
53950  "Transformar 2"53951  "^ffffffTransformar 2^ffcb4aEspera ^ffffff30,0 ^ffcb4asegundos^ffcb4aCultivo ^ffffffLealTransforma em 2 por ^96f5ff5^ffffff minutos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5395 
#define __CPPGEN_GNET_SKILL5395 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5395:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5395 }; 
        Skill5395 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5395Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
