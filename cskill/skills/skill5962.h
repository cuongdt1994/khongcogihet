...
/* 
59620  "Dancer_3s de Atraso em Morte Instant√¢nea"59621  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5962 
#define __CPPGEN_GNET_SKILL5962 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5962:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5962 }; 
        Skill5962 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5962Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5962Stub ():SkillStub (5962) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ŒË≈Æ_—”≥Ÿ3√Î√Î…±"; 
        nativename          = "ŒË≈Æ_—”≥Ÿ3√Î√Î…±"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
