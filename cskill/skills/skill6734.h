...
/* 
67340  "Corrida Celestial: Forçar"67341  "^ffffffJato de Água^ffcb4aCanalização ^ffffffInstantânea^ffcb4aEspera ^96f5ff5^ffffff ^ffcb4asegundos^ffffffDispara um jato de água para frente que instantânea faz com que você vá ^96f5ff20^ffffff metros para trás."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6734 
#define __CPPGEN_GNET_SKILL6734 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6734:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6734 }; 
        Skill6734 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6734Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
