...
/* 
55280  "Forma da Estratégia Yajie"55281  "Transformação Nv. 1:  Cabeça GrandeTransformação Nv. 2:  Pão DefumadoCancelamento Nv. 10"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5528 
#define __CPPGEN_GNET_SKILL5528 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5528:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5528 }; 
        Skill5528 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5528Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
