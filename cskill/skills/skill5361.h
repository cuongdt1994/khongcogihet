...
#ifndef __CPPGEN_GNET_SKILL5361 
#define __CPPGEN_GNET_SKILL5361 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5361:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5361 }; 
        Skill5361 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5361Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    public: 
        ...
        { 
            static int aarray[10] = { 131,131,131,131,131,131,131,131,131,131 }; 
    ...
    { 
    public: 
        int GetTime (Skill * skill) const { return 1200; } 
        bool Quit (Skill * skill) const { return false; } 
        bool Loop (Skill * skill) const { return false; } 
        bool Bypass (Skill * skill) const { return false; } 
        void Calculate (Skill * skill) const 
        { 
            static int aarray[10] = { 524,524,524,524,524,524,524,524,524,524 }; 
            skill->GetPlayer ()->SetDecmp (aarray[skill->GetLevel () - 1]); 
    ...
    { 
        static int aarray[10] = { 9658,9658,9658,9658,9658,9658,9658,9658,9658,9658 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
