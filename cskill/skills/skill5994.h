...
/* 
59940  "Lobo do TrovÃ£o - AcÃºmulo de Negativo Polar"59941  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5994 
#define __CPPGEN_GNET_SKILL5994 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5994:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5994 }; 
        Skill5994 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5994Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5994Stub ():SkillStub (5994) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-¸º´Å¼«µþ²ã"; 
        nativename          = "À×ÀÇ-¸º´Å¼«µþ²ã"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
