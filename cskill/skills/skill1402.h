...
{ 
    ...
    { 
        static int aarray[10] = { 30000,50000,100000,150000,200000,500000,1000000,1000000,1000000,1000000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 60,70,80,90,95,99,100,105,105,105 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredItem (Skill * skill) const 
    { 
        static int aarray[10] = { 28941,28942,28943,28944,28945,28946,28947,28948,28949,28950 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredMoney (Skill * skill) const 
    { 
        static int aarray[10] = { 0,50000,100000,200000,500000,1000000,2000000,3500000,6000000,10000000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
