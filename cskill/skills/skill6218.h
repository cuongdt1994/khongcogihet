...
/* 
62180  "Bailin Feron, Morte Instant√¢nea"62181  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6218 
#define __CPPGEN_GNET_SKILL6218 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6218:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6218 }; 
        Skill6218 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6218Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6218Stub ():SkillStub (6218) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"∞Ÿ¿Ô∑‚ΩÆ_√Î…±"; 
        nativename          = "∞Ÿ¿Ô∑‚ΩÆ_√Î…±"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 12; 
