...
/* 
39190  "ΨAvalanche do Rio"39191  "^ff5c00ΨAvalanche do Rio
...
Faça o poder das ondas devastadoras recaírem sobre seus inimigos, causando
dano físico base, mais ^96f5ff170%%^ffffff de dano de arma e mais ^96f5ff4664^ffffff. Aumenta a sua ameaça.

Tipos diferentes de armas causam efeitos diferentes.
Machado e Martelo: Tem ^96f5ff55%%^ffffff de chance de Atordoar o alvo por ^96f5ff3^ffffff segundos.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 53890,53890,53890,53890,53890,53890,53890,53890,53890,53890 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {    
            //skill->GetVictim ()->SetProbability (1.0 * ((int)skill->GetT1 () != 1 || (int)skill->GetT1 () != 5) ? 55 : 0);
