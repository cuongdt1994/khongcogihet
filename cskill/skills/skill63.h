...
/* 
630  "Golpe de Sopro do Dragão"631  "^ffffffGolpe de Sopro do Dragão (Nível %d)^ffcb4aAlcance: ^ffffffCorpo-a-Corpo^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff0,6 ^ffcb4asegundos^ffcb4aDuração: ^ffffff1,0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff30,0 ^ffcb4asegundos^ffcb4aRestrições de Armas: ^ffffffDesarmado, Punhos, Lâminas Leves^ffcb4aCultivo necessário: ^ffffffSinistroAo focar toda a energia em suas palmas, o personagem ataca todos os inimigos numa ^96f5ff%.1f^ffffff linha reta. Causa ^96f5ff%d%%^ffffff dano físico base e ^96f5ff%.1f^ffffff dano por arma, e imbui todos os ataques normais com ^96f5ff%d%%^ffffff dano por fogo por 15 segundos.^a6caf0O uso requer ^ffffff 2^a6caf0 de Chi"*/ 
