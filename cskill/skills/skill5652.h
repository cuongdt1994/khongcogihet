...
/* 
56520  "Reino do Norte - Mina Carregada 03"56521  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5652 
#define __CPPGEN_GNET_SKILL5652 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5652:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5652 }; 
        Skill5652 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5652Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5652Stub ():SkillStub (5652) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-携带矿物03"; 
        nativename          = "北陆-携带矿物03"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
