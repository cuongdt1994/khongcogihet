...
/* 
58930  "Corrup√ß√£o - Resistir Corrup√ß√£o"58931  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5893 
#define __CPPGEN_GNET_SKILL5893 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5893:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5893 }; 
        Skill5893 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5893Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5893Stub ():SkillStub (5893) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"∏ØªØ-µ÷”˘∏ØªØ"; 
        nativename          = "∏ØªØ-µ÷”˘∏ØªØ"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
