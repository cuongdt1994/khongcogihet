...
/* 
29880  "Vulnerabilidade de Iluminado do Sofrimento"29881  "Habilidade usada pela bomba de causar vulnerabilidade, visando o chefe"*/ 
...
{ 
    ...
    { 
        ...
        {        
            ...
            skill->GetVictim ()->SetRatio (skill->GetLevel () * 0.2);
