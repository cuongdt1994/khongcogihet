...
/* 
35620  "ΨDança Ultravioleta"35621  "^ff5c00ΨDança Ultravioleta
...
^ff0000Nível 1 a 4: O tempo de canalização é reduzido para ^96f5ff1,0^ff0000 segundos.
^ff0000Nível 5 a 7: O tempo de canalização é reduzido para ^96f5ff0,7^ff0000 segundo.
^ff0000Nível 8 a 9: O tempo de canalização é reduzido para ^96f5ff0,4^ff0000 segundo.
^ff0000Nível 10: O tempo de canalização é reduzido para ^96f5ff0,1^ff0000 segundos.@1@2
O tempo de canalização é reduzido para ^96f5ff%.1f^ff0000 segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {               
                int _glyph_value = get_glyph((skill->GetLevel ()), 1000, 700, 400, 100);
                return _glyph_value;
            }
