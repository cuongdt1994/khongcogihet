...
/* 
59650  "Lobo do TrovÃ£o - Morte InstantÃ¢nea a Todos com Queda da Esfera"59651  "Penalidade da Habilidade Queda da EsferaIgnore Defesa, dano de MÃ¡x. HPmaxhp*1.1"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5965 
#define __CPPGEN_GNET_SKILL5965 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5965:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5965 }; 
        Skill5965 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5965Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5965Stub ():SkillStub (5965) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-ÂäÇòÈ«³¡ÃëÉ±"; 
        nativename          = "À×ÀÇ-ÂäÇòÈ«³¡ÃëÉ±"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
