...
/* 
10430  "ExplosÃ£o de Gelo"10431  "^ffffffExplosÃ£o de Gelo (NÃ­vel %d)^ffcb4Alcance: ^ffffff8 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasReduz %.1f%% de HP de todos inimigos na Ã¡rea.DuraÃ§Ã£o de 5s.^72fe00Agi: Cada 16 pontos 1%% de efeito."*/ 
