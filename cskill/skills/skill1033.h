...
/* 
10330  "Estrela do Mago"10331  "^ffffffEstrela do Mago (N铆vel %d)^ffcb4aCusto de SP: ^96f5ff108^ffffff^ffcb4aCusto de EP: ^96f5ff480^ffffff^ffcb4aInstant芒neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada:   ^ffffffMagoInvoca um novo escudo de elementos 谩gua, fogo e terra.aumentando recupera莽茫o de HP em 50 pontos,absorve 1000 de dano m谩gico.O efeito de absor莽茫o termina na quantidade limite.Dura莽茫o de %.1f.^72fe00Agi: Cada 16 pontos aumenta 1s de dura莽茫o."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 33341,33346,33351,33356,33361,33366,33371,33376,33381,33386 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
