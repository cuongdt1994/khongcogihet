...
/* 
37240  "ΨVerme Venenoso da Pedra Vermelha"37241  "^ff5c00ΨVerme Venenoso da Pedra Vermelha
...
Reduz a Defesa Física por ^96f5ff10^ffffffsegundos em ^96f5ff180%% ^ffffff.
...
^ff0000Nível 1 a 4: O tempo de espera é reduzido para ^96f5ff135 ^ff0000segundos.
^ff0000Nível 5 a 7: O tempo de espera é reduzido para ^96f5ff120 ^ff0000segundos.
^ff0000Nível 8 a 9: O tempo de espera é reduzido para ^96f5ff105 ^ff0000segundos.
^ff0000Nível 10: O tempo de espera é reduzido para ^96f5ff90 ^ff0000segundos.@1@2
^ff0000O tempo de espera é reduzido para ^96f5ff%d ^ff0000segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.8); //1.8
