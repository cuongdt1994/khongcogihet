...
/* 
58200  "Novo n铆vel de ataque de Batalha Real"58201  "^FFFFFFO N铆vel de Ataque 茅 aumentado em ^00ffff%d^FFFFFF."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5820 
#define __CPPGEN_GNET_SKILL5820 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5820:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5820 }; 
        Skill5820 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5820Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
