...
/* 
62430  "Mo Rayin, Shin Jonha explode espadas cadentes"62431  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6243 
#define __CPPGEN_GNET_SKILL6243 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6243:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6243 }; 
        Skill6243 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6243Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6243Stub ():SkillStub (6243) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä«È»ÔÊ-ÐÌ¾ýºÆÒý±¬Âä½£"; 
        nativename          = "Ä«È»ÔÊ-ÐÌ¾ýºÆÒý±¬Âä½£"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
