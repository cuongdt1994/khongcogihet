...
#ifndef __CPPGEN_GNET_SKILL5400 
#define __CPPGEN_GNET_SKILL5400 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5400:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5400 }; 
        Skill5400 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5400Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
