...
/* 
56680  "Associa莽茫o Invenc铆vel 2"56681  "Segundos do n铆vel invenc铆vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5668 
#define __CPPGEN_GNET_SKILL5668 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5668:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5668 }; 
        Skill5668 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5668Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
