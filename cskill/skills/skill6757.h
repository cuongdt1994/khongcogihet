...
/* 
67570  "6 Removedores de Veneno Curativo Adquiridos"67571  "Remove 6 atributos de venenoinfligindo uma vez por segundo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6757 
#define __CPPGEN_GNET_SKILL6757 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6757:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6757 }; 
        Skill6757 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6757Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
