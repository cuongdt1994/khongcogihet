...
#ifndef __CPPGEN_GNET_SKILL6076 
#define __CPPGEN_GNET_SKILL6076 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6076:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6076 }; 
        Skill6076 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6076Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6076Stub ():SkillStub (6076) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½£Ê¥-Ô²Ì¨ÍâÃëÉ±"; 
        nativename          = "½£Ê¥-Ô²Ì¨ÍâÃëÉ±"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
