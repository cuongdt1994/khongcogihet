...
/* 
52240  "ΨEscudo da Auréola"52241  "^ff5c00ΨEscudo da Auréola
...
^96f5ff12^ffffff metros, dano este equivalente a seu Ataque Físico base mais
^96f5ff8.255^ffffff. Dura ^96f5ff10^ffffff segundos.
...
^ffeaabEnquanto o escudo estiver ativo, sua Velocidade de Movimento é aumentada.
^ffeaabNível 1 a 4: Sua Velocidade de Movimento é aumentada em ^96f5ff30%%^ffeaab.
^ffeaabNível 5 a 7: Sua Velocidade de Movimento é aumentada em ^96f5ff60%%^ffeaab.
^ffeaabNível 8 a 9: Sua Velocidade de Movimento é aumentada em ^96f5ff90%%^ffeaab.
^ffeaabNível 10: Sua Velocidade de Movimento é aumentada em ^96f5ff120%%^ffeaab. @1@2
^ffeaabEnquanto o escudo estiver ativo, sua Velocidade de Movimento é aumentada em ^96f5ff%d%%^ffeaab.
@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            float _glyph_value = get_glyph(skill->GetLevel (), 0.3, 0.6, 0.9, 1.2);
