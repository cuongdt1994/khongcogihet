...
{ 
...
#ifdef _SKILL_CLIENT 
        name                = L"Ðþ¡¤Ë®ÆÙãüãó"; 
        nativename          = "Ðþ¡¤Ë®ÆÙãüãó"; 
        icon                = "Ë®ÆÙÊõÏÉ¼¼ÄÜ.dds"; 
#endif 
        max_level           = 1; 
        type                = 1; 
        allow_ride          = 0; 
    ...
    { 
        static int aarray[10] = { 49950,49950,49950,49950,49950,49950,49950,49950,49950,49950 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
