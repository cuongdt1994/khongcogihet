...
/* 
66560  "NTW Invenc铆vel por 5 minutos."66561  "Torre de Flechas"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6656 
#define __CPPGEN_GNET_SKILL6656 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6656:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6656 }; 
        Skill6656 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6656Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6656Stub ():SkillStub (6656) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战防御塔5分钟无敌"; 
        nativename          = "新城战防御塔5分钟无敌"; 
        icon                = ""; 
#endif 
        max_level           = 1; 
        type                = 2; 
