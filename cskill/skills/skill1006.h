...
/* 
10060  "Proteção de Vida"10061  "^ffffffProteção de Vida (Nível %d)^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff700^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff60 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffTodasInvoca uma Aura de Proteção. Aumenta o HP máximo em %d%% por 5 segundos.Restaura %d%% de seu HP máximo a cada 3 segundos por 6 segundos.A habilidade interromperá o efeito do Amuleto Cinábrio.^ffa083Força: A cada 2 pontos de Força de Daimon, o HP máximo é aumentado em mais 1%%. A cada 60 FOR o tempo de duração é aumentado em 1 segundo.^72fe00Destreza: A cada 8 pontos de Destreza de Daimon, o efeito de recuperação do HP é aumentado em 1%%."*/ 
