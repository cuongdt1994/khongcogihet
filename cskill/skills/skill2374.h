...
/* 
23740  "ΦDragão Nascente"23741  "^ffff00ΦDragão Nascente
...
^f7dfa5A versão Sábio tem 35%% de chance de não consumir Chi.^96f5ff^f7dfa5
...
{ 
    ...
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            int GetTime (Skill * skill) const
            {
                return skill->GetPlayer()->GetCurweapon() != 1 ? 1500 : 1400;
            }
            bool Quit (Skill * skill) const
            {
                return false;
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5834);
               	skill->SetRatio (
                    skill->GetPlayer()->GetCurweapon() == 1 ? 4.05 : 
                    skill->GetPlayer()->GetCurweapon() == 5 ? 2.05 : 1.05
                    );                
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (5000 + ((int)skill->GetT0 () == 9 ? 2000 : 0) + 1500);
