...
#ifndef __CPPGEN_GNET_SKILL6883 
#define __CPPGEN_GNET_SKILL6883 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6883:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6883 }; 
        Skill6883 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6883Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
