...
/* 
56250  "Reino do Norte - Perda de HP durante movimento"56251  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5625 
#define __CPPGEN_GNET_SKILL5625 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5625:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5625 }; 
        Skill5625 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5625Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5625Stub ():SkillStub (5625) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½-ÒÆ¶¯µôÑª"; 
        nativename          = "±±Â½-ÒÆ¶¯µôÑª"; 
        icon                = "Ë·¹âÓ½.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
