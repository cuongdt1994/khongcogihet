...
/* 
61890  "Mestre bêbado - Uivo de Lâminas à Brisa"61891  "Esta habilidade é  em grupo por 10 segundos"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6189 
#define __CPPGEN_GNET_SKILL6189 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6189:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6189 }; 
        Skill6189 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6189Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
