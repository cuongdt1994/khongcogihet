...
#ifndef __CPPGEN_GNET_SKILL6050 
#define __CPPGEN_GNET_SKILL6050 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6050:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6050 }; 
        Skill6050 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6050Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
