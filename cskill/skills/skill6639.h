...
/* 
66390  "ΨAbismo Celestial"66391  "^ff5c00ΨAbismo Celestial              
...
causa^96f5ff230%%^ffffffde dano físico básico mais aos inimigos 
e mais ^96f5ff%d^ffffff, 
os congelando por ^96f5ff1^ffffff segundo e os paralisando por ^96f5ff1^ffffff segundo.
...
^ffeaabNível 1 a 4: Paralisa o alvo por ^96f5ff1,5^ffeaab segundo
^ffeaabNível 5 a 7: Paralisa o alvo por ^96f5ff2,0^ffeaab segundos
^ffeaabNível 8 a 9: Paralisa o alvo por ^96f5ff2,5^ffeaab segundos
^ffeaabNível 10: Paralisa o alvo por ^96f5ff3,0^ffeaab segundos.@1@2
^ffeaabParalisa o alvo por ^96f5ff%.1f^ffeaab segundos.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6639 
#define __CPPGEN_GNET_SKILL6639 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6639:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6639 }; 
        Skill6639 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6639Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    bool StateAttack (Skill * skill) const
    {
            ...
            skill->GetVictim ()->SetTime (4150 + _glyph_value);
