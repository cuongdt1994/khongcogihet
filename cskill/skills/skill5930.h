...
/* 
59300  "General - Preset de Efeito de Repuls茫o em Duelo"59301  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5930 
#define __CPPGEN_GNET_SKILL5930 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5930:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5930 }; 
        Skill5930 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5930Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5930Stub ():SkillStub (5930) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-单挑前置击退效果"; 
        nativename          = "将军-单挑前置击退效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 12; 
