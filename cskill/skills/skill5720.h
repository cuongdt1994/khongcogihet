...
/* 
57200  "Ataque Normal da Arauto de Pelagius"57201  "1å·¨çŸ³è›Š.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5720 
#define __CPPGEN_GNET_SKILL5720 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5720:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5720 }; 
        Skill5720 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5720Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5720Stub ():SkillStub (5720) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ë®ÔªËØÊ¹ÕßÅ®ÆÕ¹¥sgc"; 
        nativename          = "Ë®ÔªËØÊ¹ÕßÅ®ÆÕ¹¥sgc"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "ÕóÓªÕ½Ë®ÔªËØÊ¹Õß_ÆÕ¹¥»÷ÖÐ.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
