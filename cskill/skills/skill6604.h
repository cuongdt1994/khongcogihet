...
/* 
66040  "ΨRasante do Ganso"66041  "^ff5c00ΨRasante do Ganso              
...
#ifndef __CPPGEN_GNET_SKILL6604 
#define __CPPGEN_GNET_SKILL6604 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6604:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6604 }; 
        Skill6604 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6604Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 70220,70220,70220,70220,70220,70220,70220,70220,70220,70220 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
