...
/* 
66270  "ΨUnião Cósmica"66271  "^ff5c00ΨUnião Cósmica              
...
^ffcb4aCanalização ^ffffff60,0 ^ffcb4asegundos    
...
Seu primeiro golpe 
atordoa os inimigos próximos. Dura ^96f5ff1^ffffff segundo.
...
^ffeaabNível 1 a 4: Atordoa o alvo por ^96f5ff1,5^ffeaab segundos
^ffeaabNível 5 a 7: Atordoa o alvo por ^96f5ff2,0^ffeaab segundos
^ffeaabNível 8 a 9: Atordoa o alvo por ^96f5ff2,5^ffeaab segundo
^ffeaabNível 10: Atordoa o alvo por ^96f5ff3,0^ffeaab segundos@1@2
^ffeaabAtordoa o alvo por ^96f5ff%.1f^ffeaab segundo(s)@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6627 
#define __CPPGEN_GNET_SKILL6627 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6627:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6627 }; 
        Skill6627 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6627Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    bool StateAttack (Skill * skill) const
    {
            ...
            skill->GetVictim ()->SetTime (5100 + _glyph_value);
