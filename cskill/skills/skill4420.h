...
/* 
44200  "ΨDragão Nascente"44201  "^ff5c00ΨDragão Nascente
...
dano físico básico, mais ^96f5ff105%%^ffffff de Ataque de Arma e mais ^96f5ff5834^ffffff
e paralisa o alvo por ^96f5ff5^ffffff segundos.
Nunca erra.
...
e o tempo de conjuração é reduzido para ^96f5ff1^ffffff segundo, causando dano físico adicional de ^96f5ff700%%^ffffff
 do ataque de arma.

^a6caf0Custa ^ffffff80^a6caf0 Chi.

^00ff00Efeito de Runa Verdejante@1
^00ff00Nível 1 a 4: Lâminas Afiadas, Piques e Clavas também causam um dano Físico constante por ^96f5ff6^00ff00 segundos igual a ^96f5ff200%%^00ff00 do Ataque da Arma.
^00ff00Nível 5 a 7: Lâminas Afiadas, Piques e Clavas também causam um dano Físico constante por ^96f5ff6^00ff00 segundos igual a ^96f5ff300%%^00ff00 do Ataque da Arma.
^00ff00Nível 8 a 9: Lâminas Afiadas, Piques e Clavas também causam um dano Físico constante por ^96f5ff6^00ff00 segundos igual a ^96f5ff400%%^00ff00 do Ataque da Arma.
^00ff00 Nível 10: Lâminas Afiadas, Piques e Clavas também causam um dano Físico constante por ^96f5ff6^00ff00 segundos igual a ^96f5ff500%%^00ff00 do Ataque de Arma.@1@2
^00ff00Lâminas Afiadas, Piques e Clavas também causam um dano Físico constante por ^96f5ff6^00ff00 segundos igual a ^96f5ff%d%%^00ff00 do Ataque de Arma.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetT0 () == 5 ? 100 : 0));
        ...
        float GetTalent1 (PlayerWrapper * player) const
        {
            ...
            return (float) (player->GetWeapondamage ());
        }
#endif 
#ifdef _SKILL_SERVER 
