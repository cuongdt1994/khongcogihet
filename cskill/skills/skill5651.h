...
/* 
56510  "Reino do Norte - Mina Carregada 02"56511  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5651 
#define __CPPGEN_GNET_SKILL5651 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5651:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5651 }; 
        Skill5651 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5651Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5651Stub ():SkillStub (5651) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-携带矿物02"; 
        nativename          = "北陆-携带矿物02"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
