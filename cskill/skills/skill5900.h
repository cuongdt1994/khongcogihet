...
/* 
59000  "Colosso - Aceno_M√£o Esquerda"59001  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5900 
#define __CPPGEN_GNET_SKILL5900 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5900:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5900 }; 
        Skill5900 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5900Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5900Stub ():SkillStub (5900) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æﬁœÒ-ª”ŒË_◊Û ÷"; 
        nativename          = "æﬁœÒ-ª”ŒË_◊Û ÷"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
