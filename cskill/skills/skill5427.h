...
/* 
54270  "ΨEstilhaçar"54271  "^ff5c00ΨEstilhaçar
...
^00ffffNível 1 a 4: Recupera ^ffffff5^00ffff Chi
^00ffffNível 5 a 7: Recupera ^ffffff10^00ffff Chi
^00ffffNível 8 a 9: Recupera ^ffffff15^00ffff Chi
^00ffffNível 10: Recupera ^ffffff20^00ffff Chi @1@2
^00ffffRecupera ^ffffff%d^00ffff Chi @2
"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5427 
#define __CPPGEN_GNET_SKILL5427 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5427:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5427 }; 
        Skill5427 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5427Stub:public SkillStub 
    { 
    public: 
