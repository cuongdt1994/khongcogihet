...
/* 
61120  "General - C芒ntico Dimensional "61121  "Aura Pessoal de Raio Pequeno; Aumento de Dano"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6112 
#define __CPPGEN_GNET_SKILL6112 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6112:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6112 }; 
        Skill6112 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6112Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
