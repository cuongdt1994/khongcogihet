...
/* 
59610  "Aura de Ã“dio do Lobo do TrovÃ£o"59611  "Aura da MaldiÃ§Ã£o do CrepÃºsculoLocal Var 0 - Alcance da AuraLocal Var 1 - IntervaloLocal Var 2 - ID da Habilidade"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5961 
#define __CPPGEN_GNET_SKILL5961 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5961:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5961 }; 
        Skill5961 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5961Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5961Stub ():SkillStub (5961) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ³ðºÞ¹â»·"; 
        nativename          = "À×ÀÇ³ðºÞ¹â»·"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
