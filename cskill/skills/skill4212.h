...
/* 
42120  "Efeito de Habilidade [3947] de 唯Dez Mil L芒minas"42121  "efeito 3947: Reduz o Custo de Chi do 唯Golpe de Sopro do Drag茫o e aumenta seu Alcance."*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·万剑诀[3947]的技能效果"; 
        nativename          = "神·万剑诀[3947]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
