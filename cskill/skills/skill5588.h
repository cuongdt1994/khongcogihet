...
#ifndef __CPPGEN_GNET_SKILL5588 
#define __CPPGEN_GNET_SKILL5588 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5588:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5588 }; 
        Skill5588 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5588Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
