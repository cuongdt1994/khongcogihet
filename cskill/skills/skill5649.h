...
/* 
56490  "Reino do Norte - Aura de 脕gua Venenosa"56491  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5649 
#define __CPPGEN_GNET_SKILL5649 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5649:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5649 }; 
        Skill5649 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5649Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5649Stub ():SkillStub (5649) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-毒水光环效果"; 
        nativename          = "北陆-毒水光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
