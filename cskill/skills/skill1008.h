...
/* 
10080  "Fogo Verdadeiro"10081  "^ffffffFogo Verdadeiro                            Nv.%d^ffcb4Alcance:   ^ffffff12 m^ffcb4aCusto de SP:   ^96f5ff%d^ffffff^ffcb4aCusto de EP:   ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera:   ^ffffff20 ^ffcb4as^ffcb4aClasse:   ^ffffffMagoUsa um fogo verdadeiro para atacar todos alvos em 12m, causando %d.1f de dano contÃ­nuoao mesmo tempo, causando ao mesmo tempo %.1f de a si e aos inimigosDuraÃ§Ã£o de 15s.NÃ£o funciona contra membro do grupo.^ffa083For: Cada ponto aumenta 1%% de dano."*/ 
