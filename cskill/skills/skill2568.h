...
/* 
25680  "Mergulho Estrigiforme"25681  "^ffffffMergulho Estrigiforme (Nível %d)^ffcb4aAlcance: ^ffffffCorpo a Corpo^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aCanalização: ^ffffff0.1 ^ffcb4asegundos^ffcb4aConjuração: ^ffffff1.5 ^ffcb4asegundos^ffcb4aEspera: ^ffffff30.0 ^ffcb4asegundos^ffcb4aVigor Recebido: ^ffffff15^ffcb4aArma: ^ffffffSabre^ffcb4aCultivo Necessário: ^ffffffAmeaçadorSalte no ar para intensificar o seu ataque, mergulhando sobre o inimigo com a sua arma apontada para ele. Causa danofísico básico, mais ^96f5ff%d%%^ffffff do dano de armae mais ^96f5ff%.1f^ffffff. Paralisa o alvo por ^96f5ff2^ffffff segundos.Você não recebe danos enquanto estiver conjurando esta habilidade.^ffa4a9Habilidade Combinada: Atalho padrão ^59EE4CE^ffa4a9Habilidade Necessária: ^59EE4CMarca do Vendaval"*/ 
