...
/* 
46110  "Bela eliminaÃ§Ã£o"46111  "Puxa para o cÃ­rculo e elimina o monstro selecionado"*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 5.00,6.00,7.00,8.00,9.00,10.00,11.00,12.00,13.00,14.00 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
