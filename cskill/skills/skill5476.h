...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(557, 1)); 
        pre_skills.push_back (std::pair < ID, int >(559, 1)); 
