...
/* 
67500  "Defesa Especial da Laranja da Inst芒ncia Vermelha 2021"67501  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6750 
#define __CPPGEN_GNET_SKILL6750 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6750:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6750 }; 
        Skill6750 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6750Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6750Stub ():SkillStub (6750) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021小红本推水果_橘子特殊防御"; 
        nativename          = "2021小红本推水果_橘子特殊防御"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
