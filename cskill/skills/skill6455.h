...
#ifndef __CPPGEN_GNET_SKILL6455 
#define __CPPGEN_GNET_SKILL6455 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6455:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6455 }; 
        Skill6455 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6455Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
