...
/* 
69630  "ΨEscudo Zênite"69631  "^ff5c00ΨEscudo Zênite
...
^ffcb4aNível 1 a 4: Receba ^96f5ff60%%^ffcb4a de Defesa de Metal extra baseada no equipamento.
^ffcb4aNível 5 a 7: Receba ^96f5ff80%%^ffcb4a de Defesa de Metal Extra baseada no equipamento.
^ffcb4aNível 8 a 9 Receba ^96f5ff100%%^ffcb4a de Defesa de Metal extra baseada no equipamento.
^ffcb4aNível 10: Receba ^96f5ff120%%^ffcb4a de Defesa de Metal Extra baseada no equipamento.@1@2
^ffcb4aReceba ^96f5ff%d%%^ffcb4a de Defesa de Metal Extra baseada no equipamento.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6963 
#define __CPPGEN_GNET_SKILL6963 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6963:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6963 }; 
        Skill6963 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6963Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetNewValue2 (_glyph_value);
