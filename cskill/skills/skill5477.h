...
/* 
54770  "ΨCinco Significados"54771  "^ff5c00ΨCinco Significados
...
Transforma energia vital em um encantamento de cinco significados, reduzindo as Defesas Mágica e Física do alvo
em ^96f5ff%d%%^ffffff do valor do equipamento. Dura ^96f5ff%d^ffffff segundos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5477 
#define __CPPGEN_GNET_SKILL5477 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5477:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5477 }; 
        Skill5477 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5477Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 61680,61680,61680,61680,61680,61680,61680,61680,61680,61680 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
