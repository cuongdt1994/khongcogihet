...
#ifndef __CPPGEN_GNET_SKILL5556 
#define __CPPGEN_GNET_SKILL5556 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5556:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5556 }; 
        Skill5556 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5556Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
