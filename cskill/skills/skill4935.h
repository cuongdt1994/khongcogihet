...
/* 
49350  "Técnica Letal: Queimar"49351  "^ffffffTécnica Letal: Queimar          Nível: %d
...
^ffcb4aCultivo Necessário^ffffffLeal
Coloca um Dispositivo Letal no chão, que será acionado
quando um inimigo estiver dentro de ^96f5ff6^ffffff metros, causando
dano igual a seu HP Máximo mais ^96f5ff%.1f^ffffff
dano físico.
