...
/* 
49890  "●Indulgência Assassina"49891  "^8080ff●Indulgência Assassina
...
^96f5ff380%%^ffffff do seu Ataque Físico base.

^a6caf0Custa ^ffffff1 ^a6caf0Chi.

^f7dfa5Aumenta o Ataque Físico base em ^96f5ff20%%^f7dfa5."*/ 
...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(4949, 10)); 
