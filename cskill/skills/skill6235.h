...
Pula agressivamente em um inimigo a até^96f5ff12^ffffff metros,
causando ^96f5ff100%%^ffffff do dano de arma mais
^96f5ff5516^ffffff de dano físico. Distrai o alvo por ^96f5ff8^ffffff segundos, 
reduzindo a Esquiva dele em ^96f5ff50%%^ffffff. Em ^96f5ff6^ffffff segundos, aumenta
a sua Taxa de Acerto Crítico em ^96f5ff40%%^ffffff.
Ataques Críticos garantidos pelos próximos ^96f5ff6^ffffff segundos.
^f7dfa5Nunca erra.

^ffeaabEfeito da Runa Argêntea@1
^ffeaabNível 1 a 4: O custo de Chi do alvo dobra por ^96f5ff1^ffeaab segundo
^ffeaabNível 5 a 7: O custo de Chi do alvo dobra por ^96f5ff2^ffeaab segundos
^ffeaabNível 8 a 9: O custo de Chi do alvo dobra por ^96f5ff3^ffeaab segundos
^ffeaabNível 10: O custo de Chi do alvo dobra por ^96f5ff4^ffeaab segundos@1@2
^ffeaabO custo de Chi do alvo dobra para ^96f5ff%d^ffeaab segundos@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6235 
#define __CPPGEN_GNET_SKILL6235 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6235:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6235 }; 
        Skill6235 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6235Stub:public SkillStub 
    { 
    public: 
