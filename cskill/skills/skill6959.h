...
#ifndef __CPPGEN_GNET_SKILL6959 
#define __CPPGEN_GNET_SKILL6959 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6959:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6959 }; 
        Skill6959 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6959Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        float _glyph_value = get_glyph((skill->GetLevel ()), 45000, 40000, 35000, 30000);
        return _glyph_value; 
    } 
