...
/* 
3060  "Muralha de Espinhos"3061  "^ffffffMuralha de Espinhos   (Nível %d)
...
Conjura um escudo espinheiro para proteger um
aliado a até ^96f5ff10 ^ffffffmetros, causando ^96f5ff%d%%^ffffff do dano recebido,
mais ^96f5ff%d%% ^ffffff do dano da arma aos inimigos
atacantes. Aumenta seu dano contra monstros em ^96f5ff%d%%^ffffff.
Dura ^96f5ff10 ^ffffffminutos. 

O dano não é refletido a jogadores atacantes."*/ 
