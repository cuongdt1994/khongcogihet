...
#ifndef __CPPGEN_GNET_SKILL6361 
#define __CPPGEN_GNET_SKILL6361 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6361:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6361 }; 
        Skill6361 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6361Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6361Stub ():SkillStub (6361) 
    { 
        cls                 = 1; 
#ifdef _SKILL_CLIENT 
        name                = L"ÖÁ¡¤»ÍºÚÖ®Ñæ"; 
        nativename          = "ÖÁ¡¤»ÍºÚÖ®Ñæ"; 
        icon                = "ÖËÑæ.dds"; 
#endif 
        max_level           = 1; 
        type                = 3; 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1808, 1)); 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetDizzyondamage (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
