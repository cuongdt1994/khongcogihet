...
/* 
53760  "Transformação do Príncipe Chongming"53761  "Transformação do Príncipe Chongming"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5376 
#define __CPPGEN_GNET_SKILL5376 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5376:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5376 }; 
        Skill5376 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5376Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
