...
/* 
58250  "Mestre Espadachim - ExplosÃ£o da Espada Espectral 1"58251  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5825 
#define __CPPGEN_GNET_SKILL5825 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5825:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5825 }; 
        Skill5825 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5825Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5825Stub ():SkillStub (5825) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½£Ê¥-½£Òâ±Å·¢ÊÕÉ¢1"; 
        nativename          = "½£Ê¥-½£Òâ±Å·¢ÊÕÉ¢1"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
