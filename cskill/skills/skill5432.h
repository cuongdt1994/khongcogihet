...
Ataca a si mesmo para estimular o poder interior, entrando no estado de Vajra.
Recupera instantaneamente ^96f5ff50%%^ffffff do HP, e converte ^96f5ff80%%^ffffff do seu
Ataque Físico em Defesa Física e Defesa Elemental. Dura ^96f5ff60^ffffff segundos.
Nos próximos ^96f5ff60^ffffff segundos, recupera seu HP máximo.
Resiste ao próximo dano letal,
recuperando todo o HP.
