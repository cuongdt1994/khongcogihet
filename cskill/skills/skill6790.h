...
/* 
67900  "Efeito de Aura de Invoca莽茫o Tao铆sta"67901  "Invoca Servos 71948"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6790 
#define __CPPGEN_GNET_SKILL6790 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6790:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6790 }; 
        Skill6790 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6790Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6790Stub ():SkillStub (6790) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-召唤光环效果48"; 
        nativename          = "道家-召唤光环效果48"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
