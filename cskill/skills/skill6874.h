...
/* 
68740  "Morte InstantÃ¢nea das TrÃªs Deusas"68741  "Habilidade Morte InstantÃ¢nea"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6874 
#define __CPPGEN_GNET_SKILL6874 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6874:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6874 }; 
        Skill6874 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6874Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6874Stub ():SkillStub (6874) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÈýÅ®Éñ-ÃëÉ±"; 
        nativename          = "ÈýÅ®Éñ-ÃëÉ±"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 3; 
