...
/* 
32130  "ΣCurar Mascote"32131  "^ffff00ΣCurar Mascote
...
^ffcb4aEspera ^96f5ff60^ffffff ^ffcb4asegundos
^ffcb4aChi Recebido^ffffff8
^ffcb4aArma ^ffffffDesarmado, Instrumentos Mágicos

^ffcb4aCultivo Necessário ^ffffffMahayana
Cure as feridas do seu mascote, recuperando todo o HP.
Também reduz o dano de AdE causado no seu mascote por inimigos
não jogadores em^96f5ff 95%%^ffffff por ^96f5ff60^ffffff segundos. Durante os ^96f5ff60^ffffff segundos, seu mascote ficará imune
ao dano fatal e mais ^96f5ff20%%^ffffff do HP máximo dele será curado.

^ff0000Quando o HP do seu mascote cair para ^96f5ff50%%^ff0000 
irá recuperar todo o HP dele. O tempo de espera é de ^96f5ff20^ff0000 segundos."*/ 
