...
#ifndef __CPPGEN_GNET_SKILL6426 
#define __CPPGEN_GNET_SKILL6426 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6426:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6426 }; 
        Skill6426 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6426Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 25); // 25% de chances de duplicar
            skill->GetVictim ()->SetRatio (1);
            skill->GetVictim ()->SetMagicFrenetic (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
