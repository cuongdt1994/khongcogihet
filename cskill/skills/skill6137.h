...
/* 
61370  "20 Celestial - CamaleÃ£o"61371  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6137 
#define __CPPGEN_GNET_SKILL6137 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6137:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6137 }; 
        Skill6137 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6137Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6137Stub ():SkillStub (6137) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"20ÓùÏÉ-±äÉ«Áú"; 
        nativename          = "20ÓùÏÉ-±äÉ«Áú"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 4; 
