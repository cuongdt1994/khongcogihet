...
#ifndef __CPPGEN_GNET_SKILL5517 
#define __CPPGEN_GNET_SKILL5517 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5517:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5517 }; 
        Skill5517 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5517Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
