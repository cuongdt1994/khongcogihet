...
/* 
620  "Nuvens Dissipadas"621  "^ffffffNuvens Dissipadas (NÃ­vel %d)^ffcb4aAlcance: ^ffffffCorpo-a-Corpo^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuraÃ§Ã£o: ^ffffff0,2 ^ffcb4asegundos^ffcb4aDuraÃ§Ã£o: ^ffffff1,8 ^ffcb4asegundos^ffcb4aEspera: ^ffffff15,0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff10 ^ffcb4aRestriÃ§Ãµes de Armas: ^ffffffDesarmado, Punhos, LÃ¢minas Leves^ffcb4aCultivo necessÃ¡rio: ^ffffffAmeaÃ§adorA sorte sorri para o personagem, permitindo que ele ataque todos os inimigos num raio de ^96f5ff8^ffffff metros.  Causa ^96f5ff%d%%^ffffffdano fÃ­sico base e ^96f5ff%.1f^ffffffdano por arma. A velocidade de ataque regular do personagem tambÃ©m Ã© aumentada em ^96f5ff%d^ffffffpor ^96f5ff%d%%^ffffffsegundos."*/ 
