...
/* 
58480  "Novo n铆vel de Defesa de Batalha Real"58481  "^FFFFFFN铆vel de Defesa aumenta em ^00ffff%d^FFFFFF"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5848 
#define __CPPGEN_GNET_SKILL5848 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5848:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5848 }; 
        Skill5848 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5848Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
