...
/* 
67880  "Efeito de Aura de Pux茫o Tao铆sta"67881  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6788 
#define __CPPGEN_GNET_SKILL6788 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6788:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6788 }; 
        Skill6788 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6788Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6788Stub ():SkillStub (6788) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-拉人光环效果"; 
        nativename          = "道家-拉人光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
