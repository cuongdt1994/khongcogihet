...
/* 
39140  "ΨDragão Repentino"39141  "^ff5c00ΨDragão Repentino
...
^ffcb4aNível 1 a 4: Causa ^96f5ff30%%^ffcb4a de dano adicional da arma.
^ffcb4aNível 5 a 7: Causa ^96f5ff40%%^ffcb4a de dano adicional da arma.
^ffcb4aNível 8 a 9: Causa ^96f5ff50%%^ffcb4a de dano adicional da arma.
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                  ...
                  skill->SetWooddamage (temp + skill->GetMagicattack ());
