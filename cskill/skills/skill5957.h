...
/* 
59570  "Borboleta - Status de Esfera de TrovÃ£o"59571  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5957 
#define __CPPGEN_GNET_SKILL5957 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5957:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5957 }; 
        Skill5957 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5957Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5957Stub ():SkillStub (5957) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-À×Çò×´Ì¬"; 
        nativename          = "ºûµû-À×Çò×´Ì¬"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
