...
/* 
13860  "Dama da Tempestade"13861  "^ffffffDama da Tempestade (Nível %d)
...
^ffcb4aCultivo Necessário ^ffffffHarmonioso
Invoque um espírito elemental do trovão para proteger você. A Dama
da Tempestade dura ^96f5ff20^ffffff segundos e ataca seus inimigos, causando dano de Metal. 
Você pode usar o Sugador de Energia para drenar força da Dama da Tempestade para aumentar
sua Defesa Mágica em ^96f5ff%d%%^ffffff e seu Ataque Mágico em ^96f5ff%d%%^ffffff
