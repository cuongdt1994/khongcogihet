...
/* 
44230  "ΨDragão Nascente"
44231  "^ff5c00ΨDragão Nascente
...
dano físico básico, mais ^96f5ff105%%^ffffff de dano de arma e mais^96f5ff5834^ffffff e
 paralisa o alvo por ^96f5ff5^ffffff segundos.
Nunca erra.
...
o tempo de conjuração é reduzido para ^96f5ff1^ffffff segundo, causando dano Base Físico adicional de ^96f5ff700%%^ffffff 
de dano de arma.

^a6caf0Custa ^ffffff80^a6caf0 Chi

^ffeaabEfeito da Runa Argêntea@1
^ffeaabQuando essa habilidade é conjurada usando Lâminas e Espadas, você entra no status Invencível.
^ffeaabNível 1 a 4: O efeito dura ^96f5ff0,5^ffeaab segundos
^ffeaabNível 5 a 7: O efeito dura ^96f5ff1^ffeaab segundo
^ffeaabNível 8 a 9: O efeito dura ^96f5ff1,5^ffeaab segundos
^ffeaab Nível 10: O efeito dura ^96f5ff2 ^ffeaab segundos@1@2
^ffeaabQuando essa habilidade é conjurada usando Lâminas e Espadas, você entra no status Invencível.
O efeito dura ^96f5ff%.1f^ffeaab segundos@2"
*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            return (float) (player->GetSkilllevel (4423));
        }
#endif 
#ifdef _SKILL_SERVER 
