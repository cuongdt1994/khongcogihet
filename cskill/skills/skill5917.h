...
/* 
59170  "Dan莽arina_Cura da Flor Preta  Efeito de Aura da Flor Vermelha"59171  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5917 
#define __CPPGEN_GNET_SKILL5917 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5917:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5917 }; 
        Skill5917 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5917Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5917Stub ():SkillStub (5917) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_黑花解红花光环效果"; 
        nativename          = "舞女_黑花解红花光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
