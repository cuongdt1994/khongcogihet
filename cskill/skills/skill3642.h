...
/* 
36420  "ΨAlma da Vingança - Reação"36421  "^ff5c00ΨAlma da Vingança - Reação
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1223, 1)); 
        pre_skills.push_back (std::pair < ID, int >(1222, 1)); 
    ...
    { 
        static int aarray[10] = { 53964,53964,53964,53964,53964,53964,53964,53964,53964,53964 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
