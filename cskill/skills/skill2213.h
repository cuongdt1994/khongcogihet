...
/* 
22130  "ΩCaçador de Vidas"22131  "^ffff00ΩCaçador da Vida
...
a Defesa Física do alvo em ^96f5ff40%% ^ffffffpor ^96f5ff10 ^ffffffsegundos.
O efeito não ocorrerá se o alvo for um monstro
e tem um melhor efeito de redução de Defesa Física.


^d618e7A versão do Demônio tem um adicional de redução de Defesa Física de ^96f5ff10%%^d618e7."*/ 
