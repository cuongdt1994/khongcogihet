...
/* 
44240  "ΨMagia de Retorno da Lâmina"44241  "^ff5c00 ΨMagia de Retorno da Lâmina
...
E irá deixar você com uma probabilidade ^96f5ff15%%^ffffff maior de causar um acerto crítico. O efeito tem duração de ^96f5ff12^ffffff segundos.
"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1733, 1)); 
        pre_skills.push_back (std::pair < ID, int >(1734, 1)); 
    ...
    { 
        static int aarray[10] = { 56631,56631,56631,56631,56631,56631,56631,56631,56631,56631 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
