...
#ifndef __CPPGEN_GNET_SKILL5589 
#define __CPPGEN_GNET_SKILL5589 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5589:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5589 }; 
        Skill5589 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5589Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
