...
/* 
53860  "Habilidade de Item de C贸dice"53861  "Habilidade de Item de C贸dice"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5386 
#define __CPPGEN_GNET_SKILL5386 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5386:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5386 }; 
        Skill5386 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5386Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
