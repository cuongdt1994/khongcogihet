...
/* 
61580  "AdE de Alma de Bailin Feron"61581  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6158 
#define __CPPGEN_GNET_SKILL6158 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6158:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6158 }; 
        Skill6158 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6158Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6158Stub ():SkillStub (6158) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"°ÙÀï·â½®-Áé»êAOE"; 
        nativename          = "°ÙÀï·â½®-Áé»êAOE"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 200; 
        type                = 3; 
