...
/* 
66680  "Habilidade de Item - Venerar"66681  "Esp铆rito da Defesa + Esp铆rito do Ataque"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6668 
#define __CPPGEN_GNET_SKILL6668 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6668:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6668 }; 
        Skill6668 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6668Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
