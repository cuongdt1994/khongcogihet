...
/* 
59040  "Colosso - Aura de Morte Instant√¢nea"59041  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5904 
#define __CPPGEN_GNET_SKILL5904 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5904:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5904 }; 
        Skill5904 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5904Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5904Stub ():SkillStub (5904) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æﬁœÒ-√Î…±π‚ª∑"; 
        nativename          = "æﬁœÒ-√Î…±π‚ª∑"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 99999; 
        type                = 2; 
