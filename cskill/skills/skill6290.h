...
#ifndef __CPPGEN_GNET_SKILL6290 
#define __CPPGEN_GNET_SKILL6290 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6290:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6290 }; 
        Skill6290 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6290Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
