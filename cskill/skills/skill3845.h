...
/* 
38450  "ΨMartelo de Mil Quilos"38451  "^ff5c00ΨMartelo de Mil Quilos
...
Tem ^96f5ff100%% ^ffffffde chance de paralisar o alvo por ^96f5ff4 ^ffffffsegundos. Nunca erra.
...
Não compartilha o tempo de espera com o grupo Devorador.
^ff0000Nível 1 a 4: A espera é reduzida para ^96f5ff18 ^ff0000segundos.
^ff0000Nível 5 a 7: A espera é reduzida para ^96f5ff16 ^ff0000segundos.
^ff0000Nível 8 a 9: A espera é reduzida para ^96f5ff14 ^ff0000segundos.
^ff0000Nível 10: A espera é reduzida para ^96f5ff12 ^ff0000segundos.@1@2
^ff0000A espera é reduzida para ^96f5ff%d ^ff0000segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        int _glyph_value = get_glyph(skill->GetLevel (), 18000, 16000, 14000, 12000); 
        return _glyph_value; 
    } 
