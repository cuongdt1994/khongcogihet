...
{ 
    ...
    { 
        ...
        {
            float value = 0.8;
			skill->GetPlayer ()->SetIncfight (value);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
