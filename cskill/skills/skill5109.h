...
/* 
51090  "ΣGrito Estilhaçador"51091  "^ffff00ΣGrito Estilhaçador
...
Ao usar os próximos ^96f5ff30^ffffff Ataques Normais e Habilidades,
você irá se teleportar até o local do alvo. A distância do teleporte é
de, no máximo, ^96f5ff35^ffffff metros. Dura ^96f5ff%d^ffffff segundos.
...
{ 
    ...
    bool StateAttack(Skill *skill) const
    {
        ...
        skill->GetVictim()->SetTime(17000); //tempo
