...
/* 
20580  "Fantasma"20581  "^ffffffFantasma                                 Nível %d

^ffcb4aCanalização: ^ffffffInstantâneo^ffcb4a
^ffcb4aConjuração: ^ffffff10 ^ffcb4asegundos 
^ffcb4aEspera: ^ffffff10 ^ffcb4asegundos
^ffffffO dano dos jogadores é reduzido em ^96f5ff%d%%^ffffff. "*/ 
