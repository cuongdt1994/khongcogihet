...
/* 
40280  "ΨAbsorver Alma"40281  "^ff5c00ΨAbsorver Alma^ffcb4aAlcance: ^96f5ff27^ffffff ^ffcb4ametros^ffcb4aCusto de MP: ^96f5ff300^ffffff^ffcb4aCanalização: ^ffffff5,0 ^ffcb4asegundos^ffcb4aConjuração: ^ffffff0,8 ^ffcb4asegundos^ffcb4aEspera: ^ffffff2 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff20^ffcb4aArma: Necessária  ^ffffffDesarmado, Instrumento Mágico^ffcb4aBônus de Runa: ^ff5c00Fúria do Tigre^ffcb4aCultivo necessário: ^ffffffAlma CaóticaInfunde uma parte da sua própria alma em um poderoso ataque mágico.Causa ^96f5ff125%%^ffffff de dano mágico básico mais ^96f5ff2900^ffffff em alvos jogadores.Causa ^96f5ff200%%^ffffff de dano mágico básico mais ^96f5ff5800^ffffff em alvos que não sejam jogadores.Não pode ser um ataque crítico, mas tem a chance dedobrar sua Taxa de Acerto Crítico para causar ^96f5ff1,3^ffffff vezes mais dano.Também interrompe a canalização do alvo."*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 53977,53977,53977,53977,53977,53977,53977,53977,53977,53977 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
