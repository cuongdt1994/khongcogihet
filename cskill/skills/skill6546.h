...
/* 
65460  "○Gole Fluvial"65461  "^8080ff○Gole Fluvial            
...
A até ^96f5ff8^ffffff metros, causa ^96f5ff140%%^ffffff de dano físico 
básico mais ^96f5ff%d^ffffff aos inimigos.
Você recebe a Marca de Yang. 

^ffa4a9Petrificação. Imune aos efeitos negativos enquanto usa a habilidade. 
Não pode ser cancelada.

^d618e7Causa ^96f5ff1000^d618e7 de dano físico adicional."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6546 
#define __CPPGEN_GNET_SKILL6546 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6546:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6546 }; 
        Skill6546 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6546Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
