...
/* 
63440  "ΨEscudo da Imprecação"63441  "^ff5c00ΨEscudo da Imprecação
...
^00ff00Nível 1 a 4: A duração é aumentada para ^96f5ff14^00ff00 segundos.
^00ff00Nível 5 a 7: A duração é aumentada para ^96f5ff15^00ff00 segundos.
^00ff00Nível 8 a 9: A duração é aumentada para ^96f5ff16^00ff00 segundos.
^00ff00Nível 10: A duração é aumentada para ^96f5ff17^00ff00 segundos.@1@2
A duração é aumentada para ^96f5ff%d^00ff00 segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {				
            ...
            skill->GetVictim ()->SetTime (_glyph_value); // Tempo
