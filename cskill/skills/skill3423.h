...
Arremesse uma nuvem carregada no rosto do adversário, causando ^96f5ff90%%^ffffff do ataque
mágico básico mais ^96f5ff170%%^ffffff do dano da arma e mais ^96f5ff5887^ffffff como Dano de Metal.
Reduz as Resistências Elementais do alvo em até ^96f5ff45%%^ffffff, baseado na
quantidade de Cargas de Trovão, por ^96f5ff10^ffffff segundos. Gera uma Carga de Trovão.
As Resistências Elementais são reduzidas de ^96f5ff30%%^ffffff para ^96f5ff40%%^ffffff.
...
^00ffffNível 1 a 4: Causa ^ffffff80%%^00ffff do dano da arma.
^00ffffNível 5 a 7: Causa ^ffffff120%%^00ffff do dano da arma.
^00ffffNível 8 a 9: Causa ^ffffff160%%^00ffff do dano da arma.
^00ffffNível 10: Causa ^ffffff200%%^00ffff do dano da arma.@1@2
Se você tiver ^ffffff1 Carga de Trovão e 2 Cargas de Gelo^00ffff, causa ^ffffff%d%%^00ffff do dano da arma .@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetT0 () == 15 ? 0.75 : (skill->GetT0 () == 11 ? 0.37 : (skill->GetT0 () == 7 ? 0.33 : 0.3)));
