...
/* 
64590  "Festival da Primavera Personagem Fu, Lu, Shou TransformaÃ§Ã£o"64591  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6459 
#define __CPPGEN_GNET_SKILL6459 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6459:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6459 }; 
        Skill6459 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6459Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6459Stub ():SkillStub (6459) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"´º½Ú±äÉí¸£Â»ÊÙ"; 
        nativename          = "´º½Ú±äÉí¸£Â»ÊÙ"; 
        icon                = "º®±ùÁìÓò.dds"; 
#endif 
        max_level           = 10; 
        type                = 4; 
