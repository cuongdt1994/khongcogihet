...
/* 
31460  "Final: Invocar Monstro"31461  ""*/ 
...
{ 
    ...
    float ifplayer;
    ifplayer = skill->GetPlayer ()->GetCls () >= 0 ? 100:0;

    skill->GetVictim ()->SetProbability(1.0 * ifplayer);
    skill->GetVictim ()->SetTime (0);
    skill->GetVictim ()->SetRatio (0);
    skill->GetVictim ()->SetAmount (1);
    float mob;
    mob = skill->GetPlayer ()->GetCls () > 11 ?  48767 : skill->GetPlayer ()->GetCls () + 48767;
    
    skill->GetVictim ()->SetValue(mob);
