...
/* 
5810  "â—‹RelÃ¢mpago Sagrado"5811  "^8080ffâ—‹Esfera do TrovÃ£o^ffcb4aAlcance ^96f5ff%d^ffffff ^ffcb4ametros^ffcb4aCusto em MP ^96f5ff%d^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff2,4 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o ^ffffff1,2 ^ffcb4asegundo^ffcb4aEspera ^ffffff8,0 ^ffcb4asegundos^ffcb4aChi Recebido ^ffffff5^ffcb4aArma ^ffffffDesarmado, Instrumentos MÃ¡gicos^ffcb4aCultivo ^ffffffDiabÃ³licoCria uma esfera de relÃ¢mpagos sobre a cabeÃ§a do inimigo, causando dano mÃ¡gicobÃ¡sico em Dano de Metal e eletrocutando o alvo por ^96f5ff12 ^ffffffsegundos, causandoum adicional de ^96f5ff400%% ^ffffffdo dano da arma mais ^96f5ff6800 ^ffffffem Dano de Metal.^d618e7A versÃ£o do DemÃ´nio reduz a duraÃ§Ã£o para ^96f5ff3 ^d618e7segundos."*/ 
