...
#ifndef __CPPGEN_GNET_SKILL6947 
#define __CPPGEN_GNET_SKILL6947 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6947:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6947 }; 
        Skill6947 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6947Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6947Stub ():SkillStub (6947) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ðþ»Ä°æÔÖÐÇÎþÉü"; 
        nativename          = "Ðþ»Ä°æÔÖÐÇÎþÉü"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 4; 
