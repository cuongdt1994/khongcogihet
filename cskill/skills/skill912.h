...
/* 
9120  "Animação Suspensa"
9121  "^8080ffAnimação Suspensa

^ffcb4aMP ^96f5ff%d
^ffcb4aCanalização ^ffffff0,5 ^ffcb4asegundo
^ffcb4aConjuração ^ffffff1,0 ^ffcb4asegundo
^ffcb4aEspera ^ffffff3,0 ^ffcb4aminutos
^ffcb4aArma ^ffffffDesarmado, Instrumentos Mágicos

^ffcb4aCultivo Necessário ^ffffffMahayana
Foca toda sua concentração na defesa, 
tornando você imune a todo dano recebido,
mas impedindo-o de se mover, de usar habilidades, ataques
normais e habilidade do Daimon. Dura ^96f5ff10^ffffff segundos.

Utilizável na forma de Raposa
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetInvincibleWf (1);
