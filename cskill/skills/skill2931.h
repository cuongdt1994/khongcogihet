...
{ 
    ...
    { 
        static int aarray[10] = { 3350,3350,3350,3350,3350,3350,3350,3350,3350,3350 }; 
    ...
    { 
        static float aarray[10] = { 11.00,12.00,13.00,14.00,15.00,16.00,17.00,18.00,19.00,20.00 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
