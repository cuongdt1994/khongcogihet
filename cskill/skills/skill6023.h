...
/* 
60230  "Mestre Espadachim - Golpe Forte de Espada"60231  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6023 
#define __CPPGEN_GNET_SKILL6023 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6023:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6023 }; 
        Skill6023 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6023Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6023Stub ():SkillStub (6023) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½£Ê¥-ÖØ½£Ç§¾ù´ò»÷"; 
        nativename          = "½£Ê¥-ÖØ½£Ç§¾ù´ò»÷"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 12; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "BOSS_½£Ê¥_ÖØ½£Ç§¾û_»÷ÖÐ.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
