...
/* 
40370  "ΨDança Tempestuosa"40371  "^ff5c00ΨDança Tempestuosa

^ffcb4aAlcance: ^96f5ff27^ffffff ^ffcb4ametros
^ffcb4aCusto de MP: ^96f5ff900^ffffff
^ffcb4aCanalização: ^ffffff2 ^ffcb4asegundos
...
Ataque o inimigo com o poder de uma tempestade violenta, causando dano
mágico básico, mais ^96f5ff250%%^ffffff de dano por arma e mais ^96f5ff9158^ffffff como dano por Madeira. Diminui
o HP máximo do alvo em ^96f5ff8%%^ffffff por ^96f5ff8^ffffff segundos. Tem ^96f5ff50%%^ffffff de chance de
reduzir a espera da sua próxima ^96f5ffΨAbsorver Alma^ffffff em até ^96f5ff6^ffffff segundos em ^96f5ff50%%^ffffff.

^00ffffEfeito da Runa Celeste:@1
^00ffffNível 1 a 4: O tempo de canalização é reduzido para ^ffffff0,4^00ffff segundos.
^00ffffNível 5 a 7: O tempo de canalização é reduzido para ^ffffff0,6^00ffff segundos.
^00ffffNível 8 a 9: O tempo de canalização é reduzido para ^ffffff0,8^00ffff segundos.
^00ffffNível 10: O tempo de canalização é reduzido para ^ffffff1^00ffff segundo.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                int _glyph_value = get_glyph((skill->GetLevel ()), 400, 600, 800, 1000);
                return 2000 - _glyph_value;
            }
...
bool BlessMe (Skill * skill) const
        {            
            ...
            skill->GetVictim ()->SetRatio (0.5); //Value
