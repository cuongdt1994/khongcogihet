...
/* 
5900  "鈼廙irar"5901  "^8080ff鈼廙irar^ffcb4aAlcance ^ffffffAtaque 脿 Dist芒ncia^ffcb4aCusto em MP ^96f5ff%d^ffffff^ffcb4aCanaliza莽茫o ^ffffffCarregamento^ffcb4aConjura莽茫o ^ffffff0,6 ^ffcb4asegundo^ffcb4aEspera ^ffffff1,0 ^ffcb4asegundo^ffcb4aChi Recebido ^ffffff15^ffcb4aArma ^ffffffArmas 脿 Dist芒ncia^ffcb4aCultivo ^ffffffDiab贸licoPrepare e carregue sua arma por ^96f5ff3 ^ffffffsegundos antes de liberar um tiro mais poderoso. Causa dano f铆sico b谩sico mais ^96f5ff%d%% ^ffffffdo dano da arma.^a6caf0Custa ^ffffff1 ^a6caf0unidade de muni莽茫o.^f7dfa5A vers茫o do S谩bio causa ^96f5ff500%%^f7dfa5do dano da arma."*/ 
