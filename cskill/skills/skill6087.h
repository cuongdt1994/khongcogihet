...
#ifndef __CPPGEN_GNET_SKILL6087 
#define __CPPGEN_GNET_SKILL6087 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6087:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6087 }; 
        Skill6087 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6087Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
