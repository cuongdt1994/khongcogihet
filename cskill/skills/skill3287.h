...
/* 
32870  "ΩNuvem Distante"32871  "^ffff00ΩNuvem Distante
...
dano por arma e mais ^96f5ff8781^ffffff. Aumenta a sua Taxa de
Acerto Crítico em ^96f5ff35%%^ffffff por ^96f5ff6^ffffff segundos. Zera a espera
...
^d618e7A versão Demônio tem uma Taxa de Acerto Crítico ^96f5ff40%%^d618e7 maior
^d618e7e aumenta o alcance em ^96f5ff10^d618e7 metros."*/ 
...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(2743, 1)); 
    ...
    { 
        static int aarray[10] = { 49970,49970,49970,49970,49970,49970,49970,49970,49970,49970 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
