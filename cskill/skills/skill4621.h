...
/* 
46210  "Cura Status (área de cone)"46211  "level==1, reduz velocidade em 99%;
 level==2, reduz HP ao se mover;
 level==3, drena a Mana;
 Estado aleatório, Estratégia coordenada adicionada aleatoriamente com diferentes pacotes de status"*/ 
