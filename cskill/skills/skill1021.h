...
/* 
10210  "Aprisionamento"10211  "^ffffffAprisionamento (NÃ­vel %d)^ffcb4Alcance: ^ffffff6 metros^ffcb4aCusto de SP: ^96f5ff70^ffffff^ffcb4aCusto de EP: ^96f5ff400^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff30 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffArqueiroAprisiona o alvo,paralisa o inimigo por %.1fs,chance de ficar imune por reduÃ§Ã£o de velocidade e atordoamento por 5s.^72fe00Agi: Cada 4 pontos aumenta 1%% de chance de ter efeito de imunidade."*/ 
