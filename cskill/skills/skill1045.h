...
/* 
10450  "Alma Confusa"10451  "^ffffffAlma Confusa (Nível %d)^ffcb4Alcance: ^ffffff20 metros^ffcb4aCusto de SP: ^96f5ff160^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffFeiticeiraUma magia forte deixando alvo confuso,forçando o uso de Harmonia no alvo(Troca HP e MP)%d%% de chance de sucesso.Só pode ser usada contra inimigo.^72fe00Agi: Cada 3 pontos aumenta 1%% de chance."*/ 
