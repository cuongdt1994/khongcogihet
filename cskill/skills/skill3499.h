...
/* 
34990  "ΨFlecha Inspirada"34991  "^ff5c00ΨFlecha Inspirada
...
^ffcb4aNível 1 a 4: Causa ^96f5ff80%% ^ffcb4ade dano de arma adicional.
^ffcb4aNível 5 a 7: Causa ^96f5ff120%% ^ffcb4ade dano de arma adicional.
^ffcb4aNível 8 a 9: Causa ^96f5ff160%% ^ffcb4ade dano de arma adicional.
^ffcb4aNível 10: Causa ^96f5ff200%% ^ffcb4ade dano de arma adicional.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.6, 1.2, 1.6, 2);
