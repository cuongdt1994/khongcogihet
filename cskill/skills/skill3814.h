...
/* 
38140  "ΨCorte Inferior"38141  "^ff5c00ΨCorte Inferior
...
Imobiliza o alvo por ^96f5ff1^ffffff segundo e causa lentidão
...
Aumenta a duração do Congelamento em ^ffffff1^00ffff segundo por Carga de Ataque.
^00ffffNível 1 a 4: Causa ^ffffff120%%^00ffff a mais de dano por arma e mais ^ffffff1430^00ffff.
^00ffffNível 5 a 7: Causa ^ffffff180%%^00ffff a mais de dano por arma e mais ^ffffff2145^00ffff.
^00ffffNível 8 a 9: Causa ^ffffff240%%^00ffff a mais de dano por arma e mais ^ffffff2860^00ffff.
^00ffffNível 10: Causa ^ffffff300%%^00ffff a mais de dano por arma e mais ^ffffff3575^00ffff.@1@2
Aumenta a duração do Congelamento em ^ffffff1^00ffff segundo por Carga de Ataque.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {	
            ...
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (1500 + (1100 * _charge_merc_count));
