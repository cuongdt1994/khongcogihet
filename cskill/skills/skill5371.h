...
/* 
53710  "Carga do Lanceiro Morto-Vivo"53711  "Carga do Lanceiro Morto-Vivo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5371 
#define __CPPGEN_GNET_SKILL5371 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5371:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5371 }; 
        Skill5371 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5371Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5371Stub ():SkillStub (5371) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ê¬±øÇ¹±øÍ»½ø"; 
        nativename          = "Ê¬±øÇ¹±øÍ»½ø"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
