...
/* 
50920  "Escudo do Cataclisma"50921  "^ffffffEscudo do Cataclisma            Nível %d
...
dano em ^96f5ff%d%%^ffffff do seu HP Máximo por ^96f5ff10^ffffff segundos.
Quando o escudo está ativo, fica imune a todos os efeitos negativos.

^FFFF00Pode ser usado ao ser infligido com efeitos de controle de movimentos.
