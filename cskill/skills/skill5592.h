...
#ifndef __CPPGEN_GNET_SKILL5592 
#define __CPPGEN_GNET_SKILL5592 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5592:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5592 }; 
        Skill5592 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5592Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
