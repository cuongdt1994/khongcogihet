...
/* 
63370  "Portador do Vazio Sacrif铆cio 3"63371  "+ ATQ M + RES"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6337 
#define __CPPGEN_GNET_SKILL6337 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6337:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6337 }; 
        Skill6337 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6337Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6337Stub ():SkillStub (6337) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"创世3虚无游神牺牲"; 
        nativename          = "创世3虚无游神牺牲"; 
        icon                = "虚无游神技能2.dds"; 
#endif 
        max_level           = 10; 
        type                = 4; 
