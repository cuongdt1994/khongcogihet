...
/* 
53840  "Habilidade de Aura de Tristeza"53841  "Habilidade de Aura de Tristeza"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5384 
#define __CPPGEN_GNET_SKILL5384 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5384:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5384 }; 
        Skill5384 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5384Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
