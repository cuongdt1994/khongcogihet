...
/* 
60400  "Cidade Glacial: Finalizando Efeito de Aura Dois "60401  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6040 
#define __CPPGEN_GNET_SKILL6040 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6040:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6040 }; 
        Skill6040 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6040Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6040Stub ():SkillStub (6040) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"玄冰城结局二光环效果"; 
        nativename          = "玄冰城结局二光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
