...
#ifndef __CPPGEN_GNET_SKILL6134 
#define __CPPGEN_GNET_SKILL6134 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6134:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6134 }; 
        Skill6134 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6134Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
