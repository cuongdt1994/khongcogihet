...
/* 
10390  "Terreno Absoluto"10391  "^ffffffTerreno Absoluto (N铆vel %d)^ffcb4aAlcance: ^ffffff5 metros^ffcb4aCusto de SP: ^96f5ff135^ffffff^ffcb4aCusto de EP: ^96f5ff999^ffffff^ffcb4aInstant芒neo^ffcb4aEspera: ^ffffff180 ^ffcb4asegundos^ffcb4aClasse: ^ffffffTodasTe faz imune a todos os danos por %.1f segundose imune a imobiliza莽茫o por 2 segundos depois."*/ 
