...
/* 
67330  "Corrida Celestial: Transformação 2"67331  "2021 Corrida Celestial: TransformaçãoDura uma hora. Cancela no nível 1"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6733 
#define __CPPGEN_GNET_SKILL6733 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6733:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6733 }; 
        Skill6733 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6733Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 5000000,0,0,0,0,0,0,0,0,0 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
