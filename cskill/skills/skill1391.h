...
/* 
13910  "Vinha de Aranha"13911  "^ffffffVinha de Aranha (Nível %d)^ffcb4aAlcance: ^96f5ff%.1f^ffffff^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff1.0^ffcb4a segundos^ffcb4aDuração: ^ffffff1.0^ffcb4a segundos^ffcb4aEspera: ^ffffff12.0^ffcb4a segundos^ffcb4aRestrições da Arma: ^ffffffDesarmado, Instrumentos Mágicos^ffcb4aEstima: ^ffffffAstutoInvoca uma Vinha de Aranha que pode reduzir a velocidade de movimento do alvo em ^96f5ff%d%%^ffffff e enfraquecer o ataque físicoe mágico deles em ^96f5ff%d%%^ffffff por ^96f5ff6^ffffff segundos.A dissolução da Vinha de Aranha causa dano moderado e ofereceuma chance alta de Confundir, Assustar e Retardar os inimigos por ^96f5ff12^ffffff segundos.^a6caf0A Vinha de Aranha aparece por ^96f5ff1^a6caf0 minuto.^a6caf0A Vinha da Aranha tem certa chance de evasão.^a6caf0Requer ^ffffff30^a6caf0 Chi. "*/ 
