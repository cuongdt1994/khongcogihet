...
/* 
65790  "ΨPunição Cadente"65791  "^ff5c00ΨPunição Cadente              
...
aos inimigos. 
Limita a velocidade de seus inimigos para ^96f5ff0^ffffff m/s e eles não poderão usar Reposição. Dura ^96f5ff1^ffffff segundo.
...
^ffeaabNível 1 a 4: A duração é aumentada para ^96f5ff2 ^ffeaabsegundos.
^ffeaabNível 5 a 7: A duração é aumentada para ^96f5ff3^ffeaab segundos.
^ffeaabNível 8 a 9: A duração é aumentada para ^96f5ff4 ^ffeaabsegundos.
^ffeaabNível 10: Duração é aumentada para ^96f5ff5 ^ffeaabsegundos.@1@2
^ffeaabDuração é aumentada para ^96f5ff%d^ffeaab segundos. @2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    bool StateAttack (Skill * skill) const
    {
            ...
            skill->GetVictim ()->SetTime (_glyph_value + 500);
