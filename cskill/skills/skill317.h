...
/* 
3170  "MalÃ­cia da Raposa"3171  "^ffffffMalÃ­cia da Raposa (NÃ­vel %d)^ffcb4aNecessÃ¡rio estar em modo raposa^ffcb4aAlcance: ^ffffffCorpo a Corpo^ffcb4aCusto em MP: ^ffffff0.8 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o: ^ffffff1.1 ^ffcb4asegundos^ffcb4aDuraÃ§Ã£o: ^ffffff12.0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff10^ffcb4aRestriÃ§Ãµes da Arma: ^ffffffDesarmado, Instrumentos MÃ¡gicos^ffcb4aCultivo necessÃ¡rio: ^ffffffAmeaÃ§adorEnquanto estiver em forma de raposa, consome ^96f5ff%d%%^ffffff do HP atual para causar dano fÃ­sico bÃ¡sico ao inimigo e ^96f5ff3^ffffff segundos depois ganhar ^96f5ff%d^ffffff de Mana."*/ 
