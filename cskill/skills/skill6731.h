...
#ifndef __CPPGEN_GNET_SKILL6731 
#define __CPPGEN_GNET_SKILL6731 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6731:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6731 }; 
        Skill6731 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6731Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6731Stub ():SkillStub (6731) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÓùÏÉÅÜ-ÅÜ¼õËÙÐ§¹û"; 
        nativename          = "ÓùÏÉÅÜ-ÅÜ¼õËÙÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
