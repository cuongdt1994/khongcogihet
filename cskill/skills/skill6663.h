...
/* 
66630  "Andarilho Principal - Personagem Sem Habilidade"66631  "Anular habilidade, 1 Cancelar, 2 Transforma莽茫o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6663 
#define __CPPGEN_GNET_SKILL6663 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6663:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6663 }; 
        Skill6663 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6663Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6663Stub ():SkillStub (6663) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"妖猴主线-成年主角无技能"; 
        nativename          = "妖猴主线-成年主角无技能"; 
        icon                = "诀雪狐变身卡.dds"; 
#endif 
        max_level           = 1; 
        type                = 4; 
