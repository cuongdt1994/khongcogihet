...
/* 
61840  "Mo Ranyun - Resist锚ncia m谩gica em porcentagem"61841  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6184 
#define __CPPGEN_GNET_SKILL6184 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6184:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6184 }; 
        Skill6184 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6184Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6184Stub ():SkillStub (6184) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"墨然允-魔法百分比抗性"; 
        nativename          = "墨然允-魔法百分比抗性"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
