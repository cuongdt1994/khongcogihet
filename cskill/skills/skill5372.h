...
/* 
53720  "Habilidade de Aura de Buff do Carni莽al Morto-Vivo"53721  "Habilidade de Aura de Buff do Carni莽al Morto-Vivo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5372 
#define __CPPGEN_GNET_SKILL5372 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5372:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5372 }; 
        Skill5372 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5372Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5372Stub ():SkillStub (5372) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"尸鬼buff光环技能"; 
        nativename          = "尸鬼buff光环技能"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
