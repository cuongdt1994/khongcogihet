...
/* 
32560  "ΣSutra Essencial"32561  "^ffff00ΣSutra Essencial
...
^ffcb4aArma: ^ffffffDesarmado, Esfera de Alma

^ffcb4aCultivo: ^ffffffMahayana
Invoque as rajadas de vento do mar aberto para
acelerar um aliado, aumentando a velocidade
de voo e nado do seu alvo em ^96f5ff60%%^ffffff por ^96f5ff15 ^ffffff segundos."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 49952,49952,49952,49952,49952,49952,49952,49952,49952,49952 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
