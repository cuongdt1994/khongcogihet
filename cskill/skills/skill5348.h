...
/* 
53480  "BÃªnÃ§Ã£o de Chungyun"53481  "BÃªnÃ§Ã£o de Chungyun - DissipÃ¡vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5348 
#define __CPPGEN_GNET_SKILL5348 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5348:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5348 }; 
        Skill5348 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5348Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
