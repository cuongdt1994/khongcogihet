...
/* 
58500  "Novo HP de Batalha Real"58501  "^FFFFFFO HP aumenta em ^00ffff%d%%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5850 
#define __CPPGEN_GNET_SKILL5850 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5850:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5850 }; 
        Skill5850 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5850Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
