...
/* 
64450  "Σ Animação Suspensa"
64451  "^ffff00Animação Suspensa
...
Concentra-se totalmente na sua defesa,
 garantindo imunidade a todo
o dano recebido. Dura ^96f5ff10^ffffff segundos.

Requer forma de Raposa

^a6caf0Custa ^ffffff1 ^a6caf0Chi"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6445 
#define __CPPGEN_GNET_SKILL6445 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6445:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6445 }; 
        Skill6445 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6445Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(912, 1)); 
