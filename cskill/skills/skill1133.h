...
/* 
11330  "Tempestade de Areia"11331  "^ffffffEspírito da Terra (Nível %d)^ffcb4aAlcance: ^96f5ff%.1f^ffffff^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuração: ^ffffff1.0^ffcb4a segundos^ffcb4aDuração: ^ffffff1.0^ffcb4a segundos^ffcb4aEspera: ^ffffff20.0^ffcb4a segundos^ffcb4aRestrições da Arma: ^ffffffOrbe^ffcb4aCultivo necessário: ^ffffffSinistro Invoca um espírito causando danos de terra que atinge até ^96f5ff6^ffffff metros. Causa dano mágico básico mais ^96f5ff%d%%^ffffff de dano por arma mais ^96f5ff%.1f^ffffffOferece ^96f5ff%d%%^ffffff de chance de Atordoar os inimigos por ^96f5ff%.1f^ffffff segundos.^a6caf0Custa ^ffffff1^a6caf0 Chi"*/ 
