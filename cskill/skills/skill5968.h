...
/* 
59680  "Lobo do TrovÃ£o - Investida de Pisoteio"59681  "AdE com foco no alvo conjurada no alvoCausa dano alto e inflige Atordoar no alvoInflige repulsÃ£o de longa distÃ¢ncia a jogadores em torno do alvo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5968 
#define __CPPGEN_GNET_SKILL5968 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5968:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5968 }; 
        Skill5968 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5968Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5968Stub ():SkillStub (5968) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Ìø²È"; 
        nativename          = "À×ÀÇ-Ìø²È"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
