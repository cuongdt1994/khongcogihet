...
/* 
69640  "ΨEscudo Zênite"69641  "^ff5c00ΨEscudo Zênite
...
^00ff00Nível 1 a 4: Receba um adicional de ^96f5ff60%%^00ff00 de Defesa de Madeira baseado no equipamento.
^00ff00Nível 5 a 7: Receba um adicional de ^96f5ff80%%^00ff00 de Defesa de Madeira baseado no equipamento
^00ff00Nível 8 a 9: Receba um adicional de ^96f5ff100%%^00ff00 de Defesa de Madeira baseado no equipamento
^00ff00Nível 10: Receba um adicional de ^96f5ff120%%^00ff00 de Defesa de Madeira baseado no equipamento@1@2
^00ff00Receba um adicional de ^96f5ff%d%%^00ff00 de Defesa de Madeira baseado no equipamento.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6964 
#define __CPPGEN_GNET_SKILL6964 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6964:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6964 }; 
        Skill6964 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6964Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetNewValue3 (_glyph_value);
