...
/* 
32350  "Î©LÃ¢mina de Penas"32351  "^ffff00Î©LÃ¢mina de Penas^ffcb4aAlcance: ^96f5ff%d^ffffff ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aCanalizaÃ§Ã£o ^ffffff2,5 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o: ^ffffff1,5 ^ffcb4asegundo^ffcb4aEspera: ^ffffff6,0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff10^ffcb4aArma: ^ffffffDesarmado, Instrumentos MÃ¡gicos^ffcb4aCultivo: ^ffffffDiabÃ³licoUse o poder de suas asas para lanÃ§ar penas mÃ¡gicas contraos inimigos a ^96f5ff8^ffffff metros de alcance do seu alvo.Causa dano mÃ¡gico bÃ¡sico, mais ^96f5ff360%%^ffffff de dano por arma e mais ^96f5ff10466^ffffff de dano fÃ­sico.^d618e7A versÃ£o DiabÃ³lica reduz a espera para ^96f5ff6^d618e7 segundos."*/ 
...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(577, 1)); 
    ...
    { 
        static int aarray[10] = { 49933,49933,49933,49933,49933,49933,49933,49933,49933,49933 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
