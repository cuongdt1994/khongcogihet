...
/* 
38550  "ΨIra do Insano"38551  "^ff5c00ΨIra do Insano
...
a até ^96f5ff20^ffffff metros do alvo. Causa ^96f5ff120%%^ffffff de dano
físico básico. Tem ^96f5ff100%%^ffffff de chance de derrubar
inimigos voando para o chão e impedir que voem
por ^96f5ff30^ffffff segundos. Causa dano ^96f5fftriplo^ffffff contra alvos voadores.
Não pode ser usado voando. Nunca erra.

^a6caf0Esta habilidade não pode ser conjurada no ar.
^a6caf0Custa ^ffffff2^a6caf0 Chi.

^00ff00Efeito da Runa Verdejante:@1
^00ff00Nível 1 a 4: Impede que os alvos voem por ^96f5ff36^00ff00 segundos.
^00ff00Nível 5 a 7: Impede que os alvos voem por ^96f5ff39^00ff00 segundos.
^00ff00Nível 8 a 9: Impede que os alvos voem por ^96f5ff42^00ff00 segundos.
^00ff00Nível 10: Impede que os alvos voem por ^96f5ff45^00ff00 segundos.@1@2
^00ff00Impede que os alvos voem por ^96f5ff%d^00ff00 segundos.@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {       
            int _glyph_value = get_glyph(skill->GetLevel (), 36000, 39000, 42000, 45000); 
