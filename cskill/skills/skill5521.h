...
/* 
55210  "Poder do Imperador Negro"
55211  "^ffff00Poder do Imperador Negro            ^ffffffNível %d

^ffcb4aHabilidade Passiva

^ffcb4aCultivo Necessário ^ffffffAlma Celestial

Eldros, o Imperador do Norte, combina seu rancor contra os deuses
com uma energia caótica, criando um poder formidável 
que os desafia. Iniciantes podem aprender essa habilidade básica.
Se quiser aprender o poder avançado do desafio, você precisa 
unir-se ao clã e continuar praticando.


^ffffffTodos os danos diretos de habilidade são aumentados em ^96f5ff%d%%^ffffff.
^ffffffO Ataque Físico é aumentado em ^96f5ff%d^ffffff."
*/ 
