...
/* 
53640  "Autoexploṣo de Soldado Morto-Vivo"53641  "Autoexploṣo de Soldado Morto-Vivo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5364 
#define __CPPGEN_GNET_SKILL5364 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5364:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5364 }; 
        Skill5364 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5364Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
