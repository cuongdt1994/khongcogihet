...
/* 
58470  "Mestre Espadachim - Aura de Dano da Espada de Luz"58471  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5847 
#define __CPPGEN_GNET_SKILL5847 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5847:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5847 }; 
        Skill5847 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5847Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5847Stub ():SkillStub (5847) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ω£ •-«·Ω£…À∫¶π‚ª∑"; 
        nativename          = "Ω£ •-«·Ω£…À∫¶π‚ª∑"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
