...
/* 
64010  "ΨReversão Tática"
64011  "^ff5c00ΨReversão Tática
...
Coloque um sinalizador mágico aos pés do alvo. Após ^96f5ff6^ffffff segundos, 
o sinalizador puxará o alvo de volta à sua posição inicial.
...
^a6caf0Só tem efeito sobre os jogadores.
^a6caf0Não pode ser usado na zona segura.
^a6caf0Custa ^ffffff20^a6caf0 de Chi."
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6401 
#define __CPPGEN_GNET_SKILL6401 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6401:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6401 }; 
        Skill6401 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6401Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 69106,69106,69106,69106,69106,69106,69106,69106,69106,69106 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
