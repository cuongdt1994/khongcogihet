...
/* 
39130  "ΨDragão Repentino"39131  "^ff5c00ΨDragão Repentino
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(3196, 1)); 
        pre_skills.push_back (std::pair < ID, int >(3197, 1)); 
    ...
    { 
        static int aarray[10] = { 53889,53889,53889,53889,53889,53889,53889,53889,53889,53889 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {
            return _snwprintf (buffer, length, format, 24, 150, 2211);
