...
/* 
36450  "ΨAlma da Vingança - Reação"36451  "^ff5c00ΨAlma da Vingança - Reação
...
^00ffffNível 1 a 4: O tempo de canalização é reduzido para ^ffffff1,5^00ffff segundos.
^00ffffNível 5 a 7: O tempo de canalização é reduzido para ^ffffff1,2^00ffff segundos.
^00ffffNível 8 a 9: O tempo de canalização é reduzido para ^ffffff0,9^00ffff segundos.
^00ffffNível 10: O tempo de canalização é reduzido para ^ffffff0,6^00ffff segundos.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                int _glyph_value = get_glyph((skill->GetLevel ()), 1500, 1200, 900, 600);
                return _glyph_value;
            }
