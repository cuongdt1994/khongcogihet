...
/* 
61830  "Mo Ranyun - Resist锚ncia f铆sica em porcentagem "61831  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6183 
#define __CPPGEN_GNET_SKILL6183 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6183:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6183 }; 
        Skill6183 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6183Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6183Stub ():SkillStub (6183) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"墨然允-物理百分比抗性"; 
        nativename          = "墨然允-物理百分比抗性"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
