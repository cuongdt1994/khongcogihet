...
/* 
53320  "Limite de Velocidade de Veraneio M/A"53321  "Limite de Velocidade de Veraneio M/AN铆vel = 1 Cancelamento"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5332 
#define __CPPGEN_GNET_SKILL5332 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5332:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5332 }; 
        Skill5332 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5332Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
