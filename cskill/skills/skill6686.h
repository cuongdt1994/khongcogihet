...
/* 
66860  "Habilidade do Item - Wenliang B锚bado"66861  "Iniciando intoxica莽茫o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6686 
#define __CPPGEN_GNET_SKILL6686 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6686:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6686 }; 
        Skill6686 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6686Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
