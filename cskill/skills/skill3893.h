...
/* 
38930  "ΨDevorar"38931  "^ff5c00ΨDevorar
...
ao seu Ataque Físico mais ^96f5ff3317 ^ffffff. Também aumenta a sua ameaça.
...
^ff0000Nível 1 a 4: Causa um dano de arma adicional de ^96f5ff92%% ^ff0000mais ^96f5ff2276^ff0000.
^ff0000Nível 5 a 7: Causa um dano de arma adicional de ^96f5ff138%% ^ff0000mais ^96f5ff3414^ff0000.
^ff0000Nível 8 a 9: Causa um dano de arma adicional de ^96f5ff184%% ^ff0000mais ^96f5ff4552^ff0000.
^ff0000Nível 10: Causa um dano de arma adicional de ^96f5ff230%% ^ff0000mais ^96f5ff5690^ff0000.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {              
                float _glyph_value = get_glyph(skill->GetLevel (), 0.92, 1.38, 1.84, 2.3);
