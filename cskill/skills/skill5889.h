...
/* 
58890  "Corrup莽茫o - Ataque Normal de Chefe"58891  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5889 
#define __CPPGEN_GNET_SKILL5889 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5889:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5889 }; 
        Skill5889 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5889Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5889Stub ():SkillStub (5889) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"腐化-boss平a"; 
        nativename          = "腐化-boss平a"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
