...
/* 
43290  "Trovão Cadente (Indisponível)"43291  "^ffcb4a Tempesatde^ffcb4a Distância: ^96f5ff50 ^ffffff ^ffcb4a metros.^ffcb4a Tempo de Conjuração: ^ffffff Instantâneo^ffcb4a Intervalo de Conjuração ^ffffff3 ^ffcb4a segundos.^ffffff Ataca todos os alvos que foram marcados com uma besta, o máximo de alvos é ^96f5ff20 ^ffffff.Resultando um período de danos físicos e danos menores.^00ffff Apenas efetivo contra monstros!^ff00ff Pode ser utilização para se mover."*/ 
