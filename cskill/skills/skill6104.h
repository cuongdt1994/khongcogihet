...
/* 
61040  "Inst芒ncia Aleat贸ria_Passagem Invis铆vel_Ben莽茫o "61041  "Inst芒ncia Aleat贸ria_N铆vel de Passagem Transparente"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6104 
#define __CPPGEN_GNET_SKILL6104 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6104:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6104 }; 
        Skill6104 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6104Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6104Stub ():SkillStub (6104) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"随机本_通路隐身_祝福"; 
        nativename          = "随机本_通路隐身_祝福"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
