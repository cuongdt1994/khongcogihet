...
/* 
56450  "Reino do Norte - Guarda Vantajosa 2"56451  "Pux茫o + Lentid茫o em 90%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5645 
#define __CPPGEN_GNET_SKILL5645 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5645:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5645 }; 
        Skill5645 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5645Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
