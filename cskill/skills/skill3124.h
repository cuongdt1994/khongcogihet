...
/* 
31240  "Final: Tormenta"31241  "Tormenta lan̤ada por monstros de Sacerdote."*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 18.40,19.30,20.20,21.10,22.00,22.90,23.80,24.70,25.60,26.50 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime ((200 * skill->GetLevel ()) + 6000);
