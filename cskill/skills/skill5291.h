...
/* 
52910  "Transformação Ilimitada"52911  "^ff0000Transformação Ilimitada Nível %d
^ffffffTransforme-se em uma árvore que cresce numa proporção
%d vezes maior do que seu tamanho. Espera de ^96f5ff%d^ffffff minutos.
Disponível fora de combate.
Cancela a transformação ao deslocar ou em combate."*/ 
