...
/* 
61240  "Monstro do Espelho - Espelho_Dano Refletido 1"61241  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6124 
#define __CPPGEN_GNET_SKILL6124 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6124:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6124 }; 
        Skill6124 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6124Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6124Stub ():SkillStub (6124) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾µÄ§-¾µ_ÉËº¦·´À¡1"; 
        nativename          = "¾µÄ§-¾µ_ÉËº¦·´À¡1"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 99999; 
        type                = 3; 
    ...
    { 
        static float aarray[10] = { 95.00,95.00,95.00,95.00,95.00,95.00,95.00,95.00,95.00,95.00 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
