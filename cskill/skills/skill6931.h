...
/* 
69310  "ΨQueda da Terra"69311  "^ff5c00ΨQueda da Terra
...
^00ff00Nível 1 a 4: Empurra os alvos para trás em ^96f5ff7^00ff00 metros.
^00ff00Nível 5 a 7: Empurra os alvos para trás em ^96f5ff8^00ff00 metros.
^00ff00Nível 8 a 9: Empurra os alvos para trás em ^96f5ff9^00ff00 metros.
^00ff00 Nível 10: Empurra os alvos para trás em ^96f5ff10^00ff00 metros@1@2
Empurra os alvos para trás em ^96f5ff%d^00ff00 metros@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6931 
#define __CPPGEN_GNET_SKILL6931 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6931:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6931 }; 
        Skill6931 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6931Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            int _glyph_value = get_glyph((skill->GetLevel ()), 7, 8, 9, 10);
