...
/* 
10170  "Tremor da Terra"10171  "^ffffffTremor da Terra (Nível %d) ^ffcb4Alcance: ^ffffff30 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff200%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff30 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffSacerdoteCria um tremor da da terra,%d%% de chance de diminuir 20 pontos de Chi do alvo.A duração é de 60s, o efeito não é acumulativo.^ffa083For: Cada ponto aumenta 1 ponto de Chi.^ffa083For: Cada 5 pontos aumenta 1s de duração.^ff0000Só pode ser usado no chão."*/ 
