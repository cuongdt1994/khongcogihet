...
/* 
57190  "Reino do Norte - Efeito de Morte InstantÃ¢nea 04"57191  "ç¥žç«ç¬¦.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5719 
#define __CPPGEN_GNET_SKILL5719 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5719:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5719 }; 
        Skill5719 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5719Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5719Stub ():SkillStub (5719) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½ÃëÉ±Ð§¹û04"; 
        nativename          = "±±Â½ÃëÉ±Ð§¹û04"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
