...
/* 
57310  "Hab. do Walbyre 1"57311  "ç¥ž_é’è—¤ç»•_é£žè¡Œ1.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5731 
#define __CPPGEN_GNET_SKILL5731 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5731:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5731 }; 
        Skill5731 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5731Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5731Stub ():SkillStub (5731) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÎÖÂ×°Ý¶û¼¼ÄÜ1"; 
        nativename          = "ÎÖÂ×°Ý¶û¼¼ÄÜ1"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
