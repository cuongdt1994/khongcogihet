...
/* 
65030  "Abismo Celestial"65031  "^ffffffAbismo Celestial              
...
Rodopie e esmague seu alvo a até ^96f5ff20^ffffff metros! A até ^96f5ff8^ffffff metros do alvo, causa ^96f5ff180%%^ffffff de dano físico 
básico mais ^96f5ff%d^ffffff aos inimigos, 
os congelando por ^96f5ff1^ffffff segundo. 
Se você tiver a marca de Yin ou Yang, ela será removida e seu golpe irá 
paralisar os inimigos por ^96f5ff5^ffffff segundos.
...
#ifndef __CPPGEN_GNET_SKILL6503 
#define __CPPGEN_GNET_SKILL6503 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6503:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6503 }; 
        Skill6503 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6503Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
