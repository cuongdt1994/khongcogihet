...
/* 
13570  "Ataque Geminiano"13571  "^ffffffAtaque Geminiano (Nível %d)^ffcb4aAlcance: ^96f5ff%d^ffffff^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff3,3^ffcb4a segundos^ffcb4aDuração: ^ffffff2,0^ffcb4a segundos^ffcb4aEspera: ^ffffff15.0^ffcb4a segundos^ffcb4aRestrições da Arma: ^ffffffLâmina ou Espada^ffcb4aEstima: ^ffffffLúcidoAtaca os inimigos dentro de ^96f5ff%.1f^ffffff metros,e causa danos físicos básicos, mais ^96f5ff%d%%^ffffff de danos de arma, mais ^96f5ff%.1f^ffffff.Use em um inimigo com o status Espírito Arruinado para causar danos de metal extremos e reduzir o nível de ataque e defesa do alvo."*/ 
