...
/* 
37290  "ΨEnxame Primitivo"37291  "^ff5c00ΨEnxame Primitivo
...
Causa dano mágico básico, mais ^96f5ff200%%^ffffff de dano por arma e mais
^96f5ff3054^ffffff como dano por Madeira. Pelos próximos ^96f5ff9^ffffff segundos, os alvos vão
...
^00ffffNível 1 a 4: O tempo de canalização é reduzido para ^ffffff2,1^00ffff segundos.
^00ffffNível 5 a 7: O tempo de canalização é reduzido para ^ffffff1,9^00ffff segundos.
^00ffffNível 8 a 9: O tempo de canalização é reduzido para ^ffffff1,7^00ffff segundos.
^00ffffNível 10: O tempo de canalização é reduzido para ^ffffff1,5^00ffff segundos.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                int _glyph_value = get_glyph(skill->GetLevel (), 2100, 1900, 1700, 1500); 
                return _glyph_value;
            }
