...
/* 
59540  "Borboleta - Dano de Anel de Chefe "59541  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5954 
#define __CPPGEN_GNET_SKILL5954 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5954:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5954 }; 
        Skill5954 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5954Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5954Stub ():SkillStub (5954) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-BOSS»·ÐÎÉËº¦"; 
        nativename          = "ºûµû-BOSS»·ÐÎÉËº¦"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
