...
/* 
66610  "NTW Dragonet Causa Dano em Alvo 煤nico"66611  "8% do HP M谩ximo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6661 
#define __CPPGEN_GNET_SKILL6661 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6661:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6661 }; 
        Skill6661 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6661Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6661Stub ():SkillStub (6661) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"新城战小龙单体伤害"; 
        nativename          = "新城战小龙单体伤害"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 3; 
