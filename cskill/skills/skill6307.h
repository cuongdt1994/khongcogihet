...
#ifndef __CPPGEN_GNET_SKILL6307 
#define __CPPGEN_GNET_SKILL6307 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6307:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6307 }; 
        Skill6307 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6307Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6307Stub ():SkillStub (6307) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ð¡ÓãÌØÊâ·ÀÓù"; 
        nativename          = "Ð¡ÓãÌØÊâ·ÀÓù"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
