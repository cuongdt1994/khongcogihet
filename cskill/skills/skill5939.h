...
/* 
59390  "Aura Habilidade Esgotada do Reduto de Magia"59391  "Efeito de Habilidade 3354"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5939 
#define __CPPGEN_GNET_SKILL5939 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5939:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5939 }; 
        Skill5939 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5939Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5939Stub ():SkillStub (5939) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"堡垒魔法废柴技能光环"; 
        nativename          = "堡垒魔法废柴技能光环"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
