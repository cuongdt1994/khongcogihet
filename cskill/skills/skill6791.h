...
/* 
67910  "Aura de Teleporte Tao铆sta"67911  "N铆vel = 1 Cancelamento. O n铆vel corresponde ao alcance"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6791 
#define __CPPGEN_GNET_SKILL6791 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6791:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6791 }; 
        Skill6791 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6791Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
