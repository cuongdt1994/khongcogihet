...
/* 
67990  "Efeito de Aura de Invoca莽茫o Tao铆sta"67991  "Invoca Servos 71949"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6799 
#define __CPPGEN_GNET_SKILL6799 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6799:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6799 }; 
        Skill6799 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6799Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6799Stub ():SkillStub (6799) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-召唤光环效果49"; 
        nativename          = "道家-召唤光环效果49"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
