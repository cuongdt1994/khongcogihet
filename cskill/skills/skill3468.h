...
/* 
34680  "ΨSupercélula"34681  "^ff5c00ΨSupercélula
...
^96f5ff3 Cargas de Trovão^ffffff: Também causa dano mágico básico
mais ^96f5ff230%%^ffffff do dano da arma e mais ^96f5ff5694^ffffff.
^96f5ff3 Cargas de Gelo^ffffff: Imobiliza o alvo por ^96f5ff4^ffffff segundos.
^96f5ff2 Cargas de Trovão^ffffff, ^96f5ff1 Carga de Gelo^ffffff: Aumenta o seu
dano de habilidades em ^96f5ff30%%^ffffff por ^96f5ff20^ffffff segundos.
^96f5ff1 Carga de Trovão^ffffff, ^96f5ff2 Cargas de Gelo^ffffff: Cura metade do seu HP Máximo
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 54005,54005,54005,54005,54005,54005,54005,54005,54005,54005 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
