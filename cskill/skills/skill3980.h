...
/* 
39800  "ΨAtaque de Stalag"39801  "^ff5c00ΨAtaque de Stalag
...
de dano físico base mais ^96f5ff100%%^ffffff de dano de arma
mais ^96f5ff6.600^ffffff. Atordoa e causa dano adicional
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1704, 1)); 
        pre_skills.push_back (std::pair < ID, int >(1705, 1)); 
    ...
    { 
        static int aarray[10] = { 53970,53970,53970,53970,53970,53970,53970,53970,53970,53970 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
