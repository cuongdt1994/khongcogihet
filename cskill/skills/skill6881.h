...
/* 
68810  "Habilidades2 girosc贸pio das Tr锚s Deusas"68811  "Alvo Circular: Dano de Silenciamento"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6881 
#define __CPPGEN_GNET_SKILL6881 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6881:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6881 }; 
        Skill6881 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6881Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "2021_命运三女神老二_普攻02_飞行.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 3; 
        has_stateattack     = 0; 
