...
/* 
13820  "NÃ©voa Reconfortante"13821  "^ffffffNÃ©voa Reconfortante (NÃ­vel %d)^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuraÃ§Ã£o: ^ffffff3.5 ^ffcb4asegundos^ffcb4aDuraÃ§Ã£o: ^ffffff1.0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff6.0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff20^ffcb4aRestriÃ§Ãµes da Arma: ^ffffffDesarmado, Instrumentos MÃ¡gicos^ffcb4aEstima: ^ffffffEnigmÃ¡ticoRestaura o HP dos membros do grupo em um raio de ^96f5ff%d^ffffff metros em ^96f5ff%d^ffffff mais ^96f5ff%d%%^ffffff de seu Ataque MÃ¡gico bÃ¡sico."*/ 
