...
/* 
66310  "ΨTravessia Planar"66311  "^ff5c00ΨTravessia Planar              
...
Ruja seu grito de guerra! Causa ^96f5ff190%%^ffffffde dano físico básico e
mais ^96f5ff%d^ffffff aos inimigos dentro de uma área em cone, empurrando-os para trás. 
Se você possui a Marca de Yin ou a Marca de Yang, seu golpe
atordoa os inimigos dentro da área em cone por^96f5ff5^ffffff segundos.
Recupera ^96f5ff20^ffffff Chi após o uso.
...
^00ffffNível 1 a 4: O Chi recebido é aumentado para ^ffffff40
^00ffffNível 5 a 7: O Chi recebido é aumentado para ^ffffff60
^00ffffNível 8 a 9: O Chi recebido é aumentado para ^ffffff80
^00ffffNível 10: O Chi recebido é aumentado para ^ffffff100@1@2
^00ffffO Chi recebido é aumentado para ^ffffff%d^00ffff@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6631 
#define __CPPGEN_GNET_SKILL6631 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6631:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6631 }; 
        Skill6631 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6631Stub:public SkillStub 
    { 
    public: 
