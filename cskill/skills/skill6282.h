...
/* 
62820  "Nova 螖Invoca莽茫o Suprema Queima de Chi"62821  "Autodestruir ao morrer"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6282 
#define __CPPGEN_GNET_SKILL6282 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6282:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6282 }; 
        Skill6282 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6282Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
