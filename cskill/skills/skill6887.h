...
/* 
68870  "Aura Segura de Cyphon"68871  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6887 
#define __CPPGEN_GNET_SKILL6887 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6887:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6887 }; 
        Skill6887 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6887Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "2021_儒家BOSS_锦风_预警扩散.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
