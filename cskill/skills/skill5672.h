...
#ifndef __CPPGEN_GNET_SKILL5672 
#define __CPPGEN_GNET_SKILL5672 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5672:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5672 }; 
        Skill5672 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5672Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
