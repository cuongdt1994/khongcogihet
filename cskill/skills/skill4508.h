...
/* 
45080  "ΨMaldição: Petrificação"45081  "^ff5c00ΨMaldição: Petrificação
 ...
 de dano de arma mais ^96f5ff150%%^ffffff do HP mais ^96f5ff20%%^ffffff dano nos ataques mágicos de madeira, Remoção simultânea de magias e outras defesas de magia 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                  ...
                  skill->SetWooddamage (temp + (skill->GetMagicattack () * 1.2));
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(914, 1)); 
        pre_skills.push_back (std::pair < ID, int >(928, 1)); 
    ...
    { 
        static int aarray[10] = { 56874,56874,56874,56874,56874,56874,56874,56874,56874,56874 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
