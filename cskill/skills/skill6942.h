...
/* 
69420  "ΨEsmagamento Estelar"69421  "^ff5c00ΨEsmagamento Estelar
...
^ffcb4aArma ^ffffffLança Afiada, Pique, Clava, Lâmina ou Espada
...
^ffcb4aNível 10: Causa ^96f5ff100%%^ffcb4a de dano adicional da arma.@1@2
^ffcb4aCausa ^96f5ff%d%%^ffcb4a de dano adicional da arma.@2"*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5115);
                skill->SetRatio (_glyph_value + skill->GetPlayer ()->GetCurweapon () == 5 ? 1 : skill->GetPlayer ()->GetCurweapon () == 1 ? 3 : 0);
