...
Coloca os Amuletos do Guardião do alvo em espera imediatamente.

O Vigor Diminuído divide uma espera de ^96f5ff90^ffffff segundos com o Vigor Fortalecido."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmuletInstantCoolDown (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
