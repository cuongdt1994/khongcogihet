...
/* 
67590  "Habilidades de Talentos do Chefe"67591  "75% de Redu莽茫o De Dano de Ataque NormalEfeito de Ataque Normal 6760"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6759 
#define __CPPGEN_GNET_SKILL6759 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6759:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6759 }; 
        Skill6759 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6759Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
