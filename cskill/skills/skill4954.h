...
/* 
49540  "ΔFata Morgana"49541  "^ff0000ΔFata Morgana               Nível%d|if&dynskilllv()>0&^ffcb4a +%d&|
...
Invoca uma sombra que rastreia o inimigo por ^96f5ff|if&(skilllv()+dynskilllv())<2&10&20|^ffffff segundos,
enquanto aumenta seu Nível de Ataque em ^96f5ff%d^ffffff.
 Se o inimigo rastreado estiver ao alcance do ataque, ele também será atacado quando você usar habilidades ofensivas em outros alvos.
Se o alvo atacado e o 
alvo rastreado estiverem ambos dentro do alcance do seu ataque e da sua sombra,
ambos receberão o dobro de dano.

|if&(skilllv()+dynskilllv())>2&3Lv.: ^ffffffEnquanto a Sombra estiver ativada, a cada ^96f5ff3^ffffff segundos, purifica
 seus status Negativos uma vez. &^808080Nível 3: Enquanto a Sombra estiver ativada, a cada 3 segundos, purifica
 seus status Negativos uma vez."*/ 
...
{ 
    ...
    { 
        ...
        {              
            ...
            skill->GetVictim ()->SetTime (skill->GetLevel () < 2 ? 11000 : 21000);
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 100); // Aumenta o Nível de Ataque
            skill->GetVictim ()->SetTime (skill->GetLevel () < 2 ? 11000 : 21000);
