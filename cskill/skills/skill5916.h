...
/* 
59160  "Dan莽arina_Cura da Flor Azul Efeito de Aura da Flor Branca"59161  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5916 
#define __CPPGEN_GNET_SKILL5916 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5916:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5916 }; 
        Skill5916 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5916Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5916Stub ():SkillStub (5916) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_蓝花解白花光环效果"; 
        nativename          = "舞女_蓝花解白花光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
