...
/* 
53700  "Alvo da Ãrea do Arqueiro Morto-Vivo"53701  "Alvo da Ãrea do Arqueiro Morto-Vivo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5370 
#define __CPPGEN_GNET_SKILL5370 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5370:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5370 }; 
        Skill5370 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5370Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5370Stub ():SkillStub (5370) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ê¬±ø¹­ÊÖÄ¿±êÔ²"; 
        nativename          = "Ê¬±ø¹­ÊÖÄ¿±êÔ²"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
