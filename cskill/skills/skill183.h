...
/* 
1830  "Sutra do Coração"1831  "^ffffffSutra do Coração^ffcb4aConjuração: ^ffffffInstantâneo^ffcb4aEspera: ^ffffff60,0 ^ffcb4asegundos^ffcb4aRestrições de Armas: ^ffffffInstrumento Místico, Desarmado^ffcb4aCultivo necessário: ^ffffffSinistroAo se concentrar em sua força interior, o personagem recobra ^96f5ff10%%^ffffff de sua energia máxima. As habilidades usadas nos proximos ^96f5ff6^ffffff segundos terão seu tempo de conjuração zerados.^a6caf0O uso requer ^ffffff2^a6caf0 Chi"*/ 
