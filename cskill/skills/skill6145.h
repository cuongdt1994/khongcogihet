...
/* 
61450  "20 Celestial - Prova莽茫o de Monstro do N煤cleo de Celeiro"61451  "Provoca o Rato Gigante."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6145 
#define __CPPGEN_GNET_SKILL6145 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6145:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6145 }; 
        Skill6145 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6145Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6145Stub ():SkillStub (6145) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"周年庆中心环扇形技能效果"; 
        nativename          = "周年庆中心环扇形技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 12; 
