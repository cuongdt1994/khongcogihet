...
/* 
15610  "Nubium: Exorcismo"15611  "^ffffffNubium: Exorcismo      ^ffcb4aEspera ^ffffff3 ^ffcb4a segundos^ffffffAumenta a defesa mÃ¡gica em ^96f5ff180%%^ffffff por 1 hora."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 30262,30262,30262,30262,30262,30262,30262,30262,30262,30262 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
