...
/* 
59870  "Habilidade Vazia de SimulaÃ§Ã£o de ColisÃ£o (NÃ£o editar)"59871  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5987 
#define __CPPGEN_GNET_SKILL5987 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5987:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5987 }; 
        Skill5987 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5987Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5987Stub ():SkillStub (5987) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä£ÄâÅö×²¿Õ¼¼ÄÜ£¨Îð¶¯£©"; 
        nativename          = "Ä£ÄâÅö×²¿Õ¼¼ÄÜ£¨Îð¶¯£©"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
