...
/* 
66380  "ΨAbismo Celestial"66381  "^ff5c00ΨAbismo Celestial              
...
causa ^96f5ff230%%^ffffffde dano físico básico mais aos inimigos e mais ^96f5ff%d^ffffff, 
...
^ff0000Nível 1 a 4: Aumenta o Alcance para ^96f5ff1^ff0000 metro
^ff0000Nível 5 a 7: Aumenta o Alcance para^96f5ff2^ff0000 metros
^ff0000Nível 8 a 9: Aumenta o Alcance para^96f5ff3^ff0000 metros
^ff0000Nível 10: O Alcance é aumentado para^96f5ff4^ff0000 metros@1@2
O Alcance é aumentado para ^96f5ff%d metros.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6638 
#define __CPPGEN_GNET_SKILL6638 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6638:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6638 }; 
        Skill6638 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6638Stub:public SkillStub 
    { 
    public: 
