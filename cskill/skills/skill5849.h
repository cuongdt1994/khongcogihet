...
/* 
58490  "Nova Defesa de Batalha Real"58491  "^FFFFFFDefesa FÃ­s./MÃ¡g. aumenta em^00ffff%d%%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5849 
#define __CPPGEN_GNET_SKILL5849 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5849:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5849 }; 
        Skill5849 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5849Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5849Stub ():SkillStub (5849) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÐÂ³Ô¼¦¼Ó·ÀÓù"; 
        nativename          = "ÐÂ³Ô¼¦¼Ó·ÀÓù"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 6; 
