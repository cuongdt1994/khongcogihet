...
/* 
62050  "Continente Ocidental, Purificar"62051  "Mate o monstro 68303 indicado que entrar na zona."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6205 
#define __CPPGEN_GNET_SKILL6205 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6205:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6205 }; 
        Skill6205 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6205Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
