...
/* 
44610  "ΨAtaque Súbito"44611  "^ff5c00ΨAtaque Súbito
...
Salte entre as sombras, movendo-se
na hora até o local do alvo
em uma erupção de magia das sombras
que atordoa o alvo por ^96f5ff4^ffffff segundos.
...
Aumenta a duração do Atordoamento por ^96f5ff0,7^ff0000 segundo por Cargas de Ataque.
^ff0000Nível 1 a 4: Gera ^96f5ff20^ff0000 de Chi após o uso.
^ff0000Nível 5 a 7: Gera ^96f5ff30^ff0000 de Chi após o uso.
^ff0000Nível 8 a 9: Gera ^96f5ff40^ff0000 de Chi após o uso.
^ff0000Nível 10: Gera ^96f5ff50^ff0000 de Chi após o uso.@1@2
Aumenta a duração do Atordoamento por ^96f5ff0,7^ff0000 segundo.
Gera ^96f5ff%d^ff0000 de Chi após o uso.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (4500 + (700 * _charge_merc_count));
