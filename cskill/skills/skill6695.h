...
/* 
66950  "Mordida do Tigre"66951  "^ffffffMordida do Tigre^ffcb4aEspera ^ffffff1^ffcb4a segundo    ^ffffffA Ãºnico ataque concentrado que faz com que o inimigo sofra grande dano fÃ­sico."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6695 
#define __CPPGEN_GNET_SKILL6695 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6695:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6695 }; 
        Skill6695 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6695Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 968,968,968,968,968,968,968,968,968,968 }; 
