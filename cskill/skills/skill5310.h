...
/* 
53100  "Fúria Sinistra"53101  "^ff0000Fúria Sinistra Nível %d
^ffffffAumenta o dano direto de habilidades em ^96f5ff%d%%^ffffff."*/ 
...
{ 
    ...
    {        
        skill->GetPlayer ()->SetAddskilldamage (3 * skill->GetLevel ());
        return true;
    }
#endif 
#ifdef _SKILL_SERVER 
