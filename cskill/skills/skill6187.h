...
/* 
61870  "Mestre bÃªbado - LeÃ£o de Pedra cuspe gelo"61871  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6187 
#define __CPPGEN_GNET_SKILL6187 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6187:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6187 }; 
        Skill6187 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6187Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6187Stub ():SkillStub (6187) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÆÏÉ-Ê¯Ê¨×ÓÅç±ù"; 
        nativename          = "¾ÆÏÉ-Ê¯Ê¨×ÓÅç±ù"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
