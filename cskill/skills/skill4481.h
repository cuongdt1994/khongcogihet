...
/* 
44810  "唯Car铆cia do Vento"44811  "^ff5c00唯Car铆cia do Vento^ffcb4aMP ^96f5ff%d^ffffff^ffcb4aCanaliza莽茫o ^ffffff1 ^ffcb4asegundo^ffcb4aConjura莽茫o ^ffffff1 ^ffcb4asegundo^ffcb4aEspera ^ffffff12 ^ffcb4asegundos^ffcb4aArma ^ffffffVarinha, Desarmado^ffcb4aCultivo Necess谩rio ^ffffffAlma Ca贸ticaInvoca uma tempestade m谩gica para atacar todos os inimigos a at茅^96f5ff12^ffffffmetros, causando dano m谩gico b谩sico, mais ^96f5ff5783^ffffff como danode Metal. Tem ^96f5ff80%%^ffffff de chance de imobilizar inimigos por ^96f5ff3^ffffff segundos.^a6caf0Custa ^ffffff75^a6caf0 Chi."*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 56876,56876,56876,56876,56876,56876,56876,56876,56876,56876 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
