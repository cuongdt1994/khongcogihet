...
/* 
22340  "ΦTabu Sombrio"22341  "^ffff00ΦTabu Sombrio
...
Exploda o alvo com energia sombria, sugando a força vital dele para si.
Causa dano físico básico e mais ^96f5ff300%%^ffffff do dano de arma mais ^96f5ff6319^ffffff.
Recupera ^96f5ff20%%^ffffff seu HP máximo.

Esse ataque tem a garantia de acertar.

^f7dfa5A versão Sábio reduz a espera em ^96f5ff1^f7dfa5 segundo."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 42139,42139,42139,42139,42139,42139,42139,42139,42139,42139 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
