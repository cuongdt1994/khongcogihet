...
#ifndef __CPPGEN_GNET_SKILL5706 
#define __CPPGEN_GNET_SKILL5706 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5706:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5706 }; 
        Skill5706 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5706Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "Éñ»ú_»ðÏµÉËº¦Ö±ÏßÈº_»÷ÖÐ.sgc"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
