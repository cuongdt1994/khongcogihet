...
/* 
10100  "Espada Celestial"10101  "^ffffffEspada Celestial (NÃ­vel %d)^ffcb4Alcance: ^ffffff30 metros^ffcb4aCusto de SP: ^96f5ffTodo^ffffff^ffcb4aCusto de EP: ^96f5ff500^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff15 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasUsa toda energia para formar uma espada para atacar o alvo,Cada 100 ponto de SP causa %.1f dano fÃ­sico.Esta habilidade tem 100% de acerto.^ffa083ForÃ§a: Cada ponto aumenta dano causado."*/ 
