...
/* 
52350  "ΨCorte Fantasma"52351  "^ff5c00ΨCorte Fantasma
...
Ataca com toda sua força, causando Dano Físico ao alvo igual ao
seu Ataque Físico mais ^96f5ff8994^ffffff. Pelos próximos ^96f5ff10^ffffff segundos,
reduz a Defesa do alvo em ^96f5ff50%%^ffffff do valor do equipamento dele. Também interrompe o alvo.

^ff0000Efeito da Runa Escarlate:@1
^ff0000Nível 1 a 4: Acertos Críticos também Silenciam o alvo por ^96f5ff0,5^ff0000 segundo
^ff0000Nível 5 a 7: Acertos Críticos também Silenciam o alvo por ^96f5ff1,0^ff0000 segundo
^ff0000Nível 8 a 9: Acertos Críticos também Silenciam o alvo por ^96f5ff1,5^ff0000 segundo
^ff0000Nível 10: Acertos Críticos também Silenciam o alvo por ^96f5ff2,0^ff0000 segundos @1@2
Acertos Críticos também Silenciam o alvo por ^96f5ff%.1f^ff0000 segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph(skill->GetLevel (), 1000, 1500, 2000, 2500); 
