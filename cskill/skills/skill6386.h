...
#ifndef __CPPGEN_GNET_SKILL6386 
#define __CPPGEN_GNET_SKILL6386 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6386:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6386 }; 
        Skill6386 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6386Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
