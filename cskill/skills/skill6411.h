...
/* 
64110  "ΨReversão Tática"64111  "^ff5c00ΨReversão Tática
...
^ffcb4aEspera ^ffcb4a60,0 ^ffcb4asegundos
^ffcb4aArma ^ffffffVarinha, Desarmado
^ffcb4aBônus de Runa ^ff5c00Poder do Dragão

^ffcb4aCultivo Necessário ^ffffffAlma Celestial
Marca ^96f5ff você mesmo^ffffff e lhe torna imune a efeitos limitadores de movimento por um período de tempo.
...
^ffcb4aNível 1 a 4: Torna você imune aos efeitos que restringem o movimento por ^96f5ff3^ffcb4a segundos 
^ffcb4aNível 5 a 7: Torna você imune aos efeitos que restringem o movimento por ^96f5ff4^ffcb4a segundos 
^ffcb4aNível 8 a 9: Torna você imune aos efeitos que restringem o movimento por ^96f5ff5^ffcb4a segundos 
^ffcb4aNível 10: torna você imune aos efeitos que restringem o movimento por ^96f5ff6^ffcb4a segundos@1@2
^ffcb4aTorna você imune aos efeitos que restringem o movimento por ^96f5ff%d^ffcb4a segundos @2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6411 
#define __CPPGEN_GNET_SKILL6411 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6411:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6411 }; 
        Skill6411 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6411Stub:public SkillStub 
    { 
    public: 
