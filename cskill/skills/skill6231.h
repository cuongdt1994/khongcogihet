...
/* 
62310  "Ψ Desafio"62311  "^ff5c00 Ψ Desafio 
...
reduzindo a Esquiva dele em ^96f5ff50%%^ffffff. Em ^96f5ff6^ffffffsegundos, aumenta a Taxa de Acerto Crítico em ^96f5ff40%%^ffffff.
Ataques Críticos garantidos pelos próximos ^96f5ff6^ffffff segundos.

^f7dfa5Nunca erra.

^ffcb4aEfeito da Runa Áurea:@1
^ffcb4aNível 1 a 4: Causa ^96f5ff60%%^ffcb4a de dano de arma adicional
^ffcb4aNível 5 a 7: Causa ^96f5ff80%%^ffcb4a de dano de arma adicional
^ffcb4aNível 8 -9: Causa ^96f5ff100%%^ffcb4a de dano de arma adicional
^ffcb4aNível 10: Causa ^96f5ff120%%^ffcb4a de dano de arma adicional.@1@2
^ffcb4aCausa ^96f5ff%d%%^ffcb4a de dano de arma adicional.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6231 
#define __CPPGEN_GNET_SKILL6231 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6231:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6231 }; 
        Skill6231 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6231Stub:public SkillStub 
    { 
    public: 
