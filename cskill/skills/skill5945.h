...
/* 
59450  "Colosso - BÃ´nus de Estalagmite "59451  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5945 
#define __CPPGEN_GNET_SKILL5945 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5945:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5945 }; 
        Skill5945 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5945Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5945Stub ():SkillStub (5945) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÞÏñ-Ê¯Ëñbuff"; 
        nativename          = "¾ÞÏñ-Ê¯Ëñbuff"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
