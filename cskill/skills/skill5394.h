...
/* 
53940  "Transformar 1"53941  "^ffffffTransformar 1^ffcb4aEspera ^ffffff30,0 ^ffcb4asegundos^ffcb4aCultivo ^ffffffLealTransforma em 1 por ^96f5ff5^ffffff minutos."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5394 
#define __CPPGEN_GNET_SKILL5394 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5394:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5394 }; 
        Skill5394 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5394Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
