...
/* 
58570  "Dan√ßarina_Dano ao Matar Ref√©m Pr√≥ximo"58571  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5857 
#define __CPPGEN_GNET_SKILL5857 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5857:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5857 }; 
        Skill5857 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5857Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5857Stub ():SkillStub (5857) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ŒË≈Æ_ª˜…±÷‹Œß»À÷ …À∫¶"; 
        nativename          = "ŒË≈Æ_ª˜…±÷‹Œß»À÷ …À∫¶"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
