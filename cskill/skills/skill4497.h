...
/* 
44970  "ΨBênção de Gaia"44971  "^ff5c00ΨBenção de Gaia
...
Cura companheiros dentro de ^96f5ff20^ffffff metros em
^96f5ff20%%^ffffff do seu HP Máximo. Também concede imunidade
contra o status Exílio, por um tempo.

^ffa4a9Pode ser dissipada por Feiticeiras

^a6caf0Custa ^ffffff1 ^a6caf0Chi.

^ff0000Efeito da Runa Escarlate:@1
^ff0000Nível 1 a 4: Imunidade a Exílio dura ^96f5ff15^ff0000 segundos.
^ff0000Nível 5 a 7: Imunidade a Exílio dura ^96f5ff20^ff0000 segundos.
^ff0000Nível 8 a 9: Imunidade a Exílio dura ^96f5ff25^ff0000 segundos.
^ff0000Nível 10: Imunidade a Exílio dura ^96f5ff30^ff0000 segundos. @1@2
Imunidade a Exílio dura ^96f5ff%d^ff0000 segundos. @2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAnticlearbuf2 (1);
