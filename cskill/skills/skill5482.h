...
/* 
54820  "ΨCinco Significados"
54821  "^ff5c00ΨCinco Significados
...
^ffeaabNível 1 a 4: Dura ^96f5ff14^ffeaab segundos
^ffeaabNível 5 a 7: Dura ^96f5ff16^ffeaab segundos
^ffeaabNível 8 a 9: Dura ^96f5ff18^ffeaab segundos
^ffeaabNível 10: Dura ^96f5ff20^ffeaab segundos@1@2
Diminui a Defesa Mágica e Defesa Física do alvo em ^96f5ff%d%%^ffeaab do valor do equipamento. Dura ^96f5ff%d^ffeaab segundos.@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5482 
#define __CPPGEN_GNET_SKILL5482 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5482:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5482 }; 
        Skill5482 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5482Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            int _glyph_value = get_glyph((skill->GetLevel ()), 14000, 16000, 18000, 20000);
