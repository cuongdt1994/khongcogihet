...
/* 
59990  "2020 Novo Banimento de AcÃºmulo de Cura na Batalha Real"59991  "Novo Banimento de Cura da Batalha Real1-2: 1,6%3-4: 3,2% 5-6: 6,4%7: 12,8%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5999 
#define __CPPGEN_GNET_SKILL5999 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5999:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5999 }; 
        Skill5999 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5999Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5999Stub ():SkillStub (5999) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2020ÐÂ³Ô¼¦µþ²ãµþ²ã½ûÁÆ"; 
        nativename          = "2020ÐÂ³Ô¼¦µþ²ãµþ²ã½ûÁÆ"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
