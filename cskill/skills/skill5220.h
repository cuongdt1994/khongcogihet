...
/* 
52200  "ΨEscudo da Auréola"52201  "^ff5c00ΨEscudo da Auréola
...
^ffcb4aNível 1 a 4: Aumenta o dano em ^96f5ff50%%^ffcb4a do Ataque de seu equipamento.
^ffcb4aNível 5 a 7: Aumenta o dano em ^96f5ff100%%^ffcb4a do Ataque de seu equipamento.
^ffcb4aNível 8 a 9: Aumenta o dano em ^96f5ff150%%^ffcb4a do Ataque de seu equipamento.
^ffcb4aNível 10: Aumenta o dano em ^96f5ff200%%^ffcb4a do Ataque de seu equipamento.@1@2
...
bool BlessMe (Skill * skill) const
        ...
        {
            float _glyph_value = get_glyph(player->GetSkilllevel (5220), 0.5, 1, 1.5, 2);
            
            return (float) (player->GetPureattack () + 8255 + (_glyph_value * player->GetWeapondamage ()));
        }
#endif 
#ifdef _SKILL_SERVER 
