...
/* 
38430  "ΨMartelo de Mil Quilos"38431  "^ff5c00ΨMartelo de Mil Quilos
...
^00ff00Nível 8 a 9: O alcance aumenta em ^96f5ff4 ^00ff00metros.
    ...
    float GetPraydistance (Skill * skill) const
        {
            ...
            return (float) (skill->GetPlayer ()->GetPrayrangeplus () + skill->GetPlayer ()->GetRange () + _glyph_value);
        }
...
bool BlessMe (Skill * skill) const
        ...
        {   
            ...
            return (float) (skill->GetPlayer ()->GetPrayrangeplus () + skill->GetPlayer ()->GetRange () + 8 + _glyph_value);
        }		
#endif 
#ifdef _SKILL_SERVER 
