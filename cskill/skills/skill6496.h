...
/* 
64960  "Rasante do Ganso"64961  "^ffffffRasante do Ganso              

^ffcb4aAlcance ^96f5ffCorpo a corpo
^ffcb4aMP ^96f5ff%d^ffffff    
^ffcb4aCanalização ^ffffffInstantânea
^ffcb4aConjuração ^ffffff120 ^ffcb4asegundos    
^ffcb4aArma ^ffffffBastão

^ffcb4aCultivo Necessário ^ffffffImortal
Gire sua clava para se defender. O dano direto à distância causado por jogadores 
a até ^96f5ff8^ffffff metros é reduzido em ^96f5ff90%%^ffffff.
