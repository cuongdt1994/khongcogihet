...
/* 
55740  "CrÃ­tico"55741  "Aumenta a Taxa de Ataque CrÃ­tico, o Ataque FÃ­sico e a Taxa de Ataque por um tempo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5574 
#define __CPPGEN_GNET_SKILL5574 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5574:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5574 }; 
        Skill5574 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5574Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
