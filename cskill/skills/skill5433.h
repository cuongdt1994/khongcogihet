...
/* 
54330  "ΨSugador de Energia"54331  "^ff5c00ΨSugador de Energia
...
#ifndef __CPPGEN_GNET_SKILL5433 
#define __CPPGEN_GNET_SKILL5433 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5433:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5433 }; 
        Skill5433 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5433Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 61682,61682,61682,61682,61682,61682,61682,61682,61682,61682 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
