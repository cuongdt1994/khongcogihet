...
/* 
10470  "ExplosÃ£o de Energia"10471  "^ffffffExplosÃ£o de Energia (NÃ­vel %d)^ffcb4aAlcance:  Longo^ffffff^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada:   ^ffffffTodasExplode prÃ³pria energia acrescentando 1 Chi,mais %d de pontos de Chi.^ffa083FOR: A cada 2 pontos a habilidade Ã© melhorada em 1 ponto"*/ 
