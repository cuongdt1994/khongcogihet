...
/* 
67620  "Tao铆sta Lozzar"67621  "Causa dano baseado na porcentagem do n铆vel atual.Porcentagem de n铆vel%"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6762 
#define __CPPGEN_GNET_SKILL6762 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6762:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6762 }; 
        Skill6762 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6762Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
