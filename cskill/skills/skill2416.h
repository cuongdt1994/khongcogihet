...
/* 
24160  "ΦGolpe Atordoante"24161  "^ffff00ΦGolpe Atordoante
...
Acerte o inimigo com um golpe atordoante, causando dano físico básico mais ^96f5ff300%%^ffffff
do dano da arma mais ^96f5ff5537^ffffff de dano físico. Atordoa o alvo
...
^f7dfa5A versão do Sábio recupera ^96f5ff50 ^f7dfa5de Chi após conjurar."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 42145,42145,42145,42145,42145,42145,42145,42145,42145,42145 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            /*->GetVictim ()->SetProbability (1.0 * 100);
