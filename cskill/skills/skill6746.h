...
#ifndef __CPPGEN_GNET_SKILL6746 
#define __CPPGEN_GNET_SKILL6746 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6746:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6746 }; 
        Skill6746 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6746Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
