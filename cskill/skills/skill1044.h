...
/* 
10440  "Amuleto de Ãgua e Fogo"10441  "^ffffffAmuleto de Ãgua e Fogo (NÃ­vel %d)^ffcb4aAlcance: ^ffffff25 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff12 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffTodasAtira um raio composto de elementos de Ãgua e de Fogo.Causa %.1f de dano por Ãgua e por Fogo ao alvo.E oferece %d%% de chance de recuperar seu prÃ³prio HP em 20%%.^72fe00Destreza: A cada ponto de Destreza de Daimon, os danos por Ãgua e por Fogo sÃ£o aumentados em 4.3 cada.^72fe00Destreza: A cada 2 pontos de Destreza de Daimon, a chance de recuperar seu HP Ã© aumentada em 1%%."*/ 
