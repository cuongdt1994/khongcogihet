...
/* 
10350  "Enfraquecer"10351  "^ffffffEnfraquecer (Nível %d)^ffcb4Alcance: ^ffffff6 metros^ffcb4aCusto de SP: ^96f5ff115^ffffff^ffcb4aCusto de EP: ^96f5ff500^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasRetira a força do alvo,deixando alvo sem poder de levantar a sua arma.Redua %d%% de velocidade de ataque.Duração de 5s.^ffa083For: Cada 2 pontos aumenta efeito em 1%%.^72fe00Agi: Cada 2 pontos aumenta efeito em 1%%."*/ 
