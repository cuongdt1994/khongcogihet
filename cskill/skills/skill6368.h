...
/* 
63680  "Σ Salto do Tigre "63681  "^ffff00 Σ Salto do Tigre              Nível %d

^ffcb4aCanalização ^ffffffInstantâneo
^ffcb4aEspera ^96f5ff%.1f^ffffff ^ffcb4asegundos
^ffcb4aArma ^ffffffArmas Corpo a Corpo

^ffcb4aCultivo Requisitado ^ffffffMahayana
Pula instantaneamente  ^96f5ff%d^ffffff metros para frente.
Evite todos os seus efeitos de status negativos durante o salto.
