...
#ifndef __CPPGEN_GNET_SKILL6278 
#define __CPPGEN_GNET_SKILL6278 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6278:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6278 }; 
        Skill6278 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6278Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1227, 1)); 
