...
/* 
59270  "General - Habilidade Pequena em 脕rea Circular"59271  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5927 
#define __CPPGEN_GNET_SKILL5927 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5927:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5927 }; 
        Skill5927 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5927Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5927Stub ():SkillStub (5927) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-自身圆小技能"; 
        nativename          = "将军-自身圆小技能"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
