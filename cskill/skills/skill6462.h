...
/* 
64620  "Manuseio Pesado"64621  "^ffffffManuseio Pesado             Nível %d  

^ffcb4aDistância ^ffffffCorpo a corpo
...
Manuseando a clava, causa dano físico igual ao dano básico mais ^96f5ff%.1f^ffffff."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 0,200,700,1600,3000,3800,5900,6500,9200,12900 }; 
