...
/* 
68510  "6 Remo莽玫es2 de Veneno de Curandeiro"68511  "Remove 6 atributos de venenoinfligindo uma vez por segundo."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6851 
#define __CPPGEN_GNET_SKILL6851 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6851:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6851 }; 
        Skill6851 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6851Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
