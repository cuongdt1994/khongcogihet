...
/* 
39200  "ΨAvalanche do Rio"39201  "^ff5c00ΨAvalanche do Rio
...
^ffcb4aArma ^ffffffCorpo a Corpo
...
^ffcb4aNível 1 a 4: Causa um dano de arma adicional de ^96f5ff20%%^ffcb4a e mais ^96f5ff2028^ffcb4a.
^ffcb4aNível 5 a 7: Causa um dano de arma adicional de ^96f5ff30%%^ffcb4a e mais ^96f5ff3042^ffcb4a.
^ffcb4aNível 8 a 9: Causa um dano de arma adicional de ^96f5ff40%%^ffcb4a e mais ^96f5ff4056^ffcb4a.
^ffcb4aNível 10: Causa um dano de arma adicional de ^96f5ff50%%^ffcb4a e mais ^96f5ff5070^ffcb4a.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            int _glyph_value_2 = get_glyph(skill->GetLevel (), 2028, 3042, 4056, 5070);

                skill->GetPlayer ()->SetDecmp (170);
                skill->SetPlus (4664 + _glyph_value_2);
                skill->SetRatio (_glyph_value + 1.7 + (skill->GetPlayer ()->GetCurWeapon () == 5 ? 0.5 : skill->GetPlayer ()->GetCurWeapon () == 1 ? 2 : 0));
