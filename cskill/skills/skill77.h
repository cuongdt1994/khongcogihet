...
/* 
770  "Aura de Aço"771  "^ffffffAura de Aço  (Nível %d)
...
a Defesa Física dos equipamentos em ^96f5ff%d%%^ffffff e
o dano deles contra monstros em ^96f5ff%d%%^ffffff por ^96f5ff30^ffffff minutos."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 1680,3280,5600,8720,12880,18400,25600,35280,48160,65400 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
