...
/* 
53800  "Golpe Sombrio Dividido"53801  "Golpe Sombrio DivididoVerdadeiro no NV10, falso no NV1, nenhum dano no NV1"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5380 
#define __CPPGEN_GNET_SKILL5380 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5380:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5380 }; 
        Skill5380 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5380Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
