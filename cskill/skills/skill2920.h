...
/* 
29200  "Frio Corrosivo"29201  "^ffff00Frio Corrosivo                                        ^ffffffNível %d^ffcb4aHabilidade Passiva^ffcb4aCultivo necessário: ^ffffffMahayana^ffffffImbui em seus ataques a essência de um frio terrível, aumentandoa espera dos Amuletos do Guardião e do Espírito dos alvos em ^96f5ff%d^ffffff segundo."*/ 
