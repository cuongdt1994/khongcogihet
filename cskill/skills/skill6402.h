...
#ifndef __CPPGEN_GNET_SKILL6402 
#define __CPPGEN_GNET_SKILL6402 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6402:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6402 }; 
        Skill6402 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6402Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
