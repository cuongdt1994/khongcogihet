...
/* 
59740  "Lobo do Trov茫o - Efeito de Carga tardia "59741  "Conjura repuls茫o tardia no local alvoEfetivo em 2 segundos"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5974 
#define __CPPGEN_GNET_SKILL5974 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5974:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5974 }; 
        Skill5974 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5974Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5974Stub ():SkillStub (5974) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"雷狼-突进延时效果"; 
        nativename          = "雷狼-突进延时效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
