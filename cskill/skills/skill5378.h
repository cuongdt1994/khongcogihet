...
/* 
53780  "Carga de Aura e Morte InstantÃ¢nea do Alvo"53781  "Carga de Aura e Morte InstantÃ¢nea do Alvo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5378 
#define __CPPGEN_GNET_SKILL5378 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5378:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5378 }; 
        Skill5378 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5378Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5378Stub ():SkillStub (5378) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä¿±êÔ²Í»½øÃëÉ±"; 
        nativename          = "Ä¿±êÔ²Í»½øÃëÉ±"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
