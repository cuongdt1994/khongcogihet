...
/* 
59070  "Colosso - Efeito de NÃ©voa TÃ³xica"59071  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5907 
#define __CPPGEN_GNET_SKILL5907 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5907:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5907 }; 
        Skill5907 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5907Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5907Stub ():SkillStub (5907) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÞÏñ-¶¾ÎíÐ§¹û"; 
        nativename          = "¾ÞÏñ-¶¾ÎíÐ§¹û"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
