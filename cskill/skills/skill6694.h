...
/* 
66940  "Detec莽茫o de Furtividade Principal do Mago"66941  "Aumenta sua habilidade de detec莽茫o de furtividade"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6694 
#define __CPPGEN_GNET_SKILL6694 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6694:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6694 }; 
        Skill6694 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6694Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
