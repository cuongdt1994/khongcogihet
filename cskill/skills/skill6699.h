...
/* 
66990  "Setores dos Curandeiros"66991  "Setor de 180 graus1. Penalidade Vulner谩vel n铆vel 1,  Pacote de Efeitos 635; o dano aumenta em 10% por n铆vel2. Penalidade de diminui莽茫o de cura n铆vel 1; Novo Pacote de Efeitos3. Dano=3x o dano b谩sico"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6699 
#define __CPPGEN_GNET_SKILL6699 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6699:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6699 }; 
        Skill6699 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6699Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
