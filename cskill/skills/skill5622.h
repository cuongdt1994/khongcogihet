...
/* 
56220  "Reino do Norte - Aura de 脕rea de Lentid茫o"56221  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5622 
#define __CPPGEN_GNET_SKILL5622 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5622:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5622 }; 
        Skill5622 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5622Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5622Stub ():SkillStub (5622) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-区域减速光环"; 
        nativename          = "北陆-区域减速光环"; 
        icon                = "朔光咏.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
