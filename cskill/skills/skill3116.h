...
/* 
31160  "Final: Praga dos Gafanhotos"31161  "Praga dos Gafanhotos lan莽ada por monstros de Feiticeira."*/ 
...
{ 
    ...
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio ((skill->GetLevel () * 0.15) + 1.5);
    ...
    { 
        static float aarray[10] = { 17.40,18.30,19.20,20.10,21.00,21.90,22.80,23.70,24.60,25.50 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
         ...
         bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime ((500 * skill->GetLevel ()) + 4000);
