...
/* 
49490  "Indulgência Assassina"49491  "^ffffffIndulgência Assassina          Nível %d  
...
^ffcb4aCultivo Necessário ^ffffffTranscendente
Lança um ataque frenético que causa dano Físico igual a
^96f5ff%d%%^ffffff do seu Ataque Físico base.
...
{ 
    ...
    public: 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetSection (1);
                skill->SetPlus ((((skill->GetLevel () < 2 ? 1.98 : 1.98 + (0.18 * skill->GetLevel ()) - 0.18)*skill->GetPlayer ()->GetAttack ())));
                skill->SetRatio (0);
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(4947, 1)); 
