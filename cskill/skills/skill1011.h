...
/* 
10110  "Onda de Veneno"10111  "^ffffffOnda de Veneno (NÃ­vel %d)^ffcb4aAlcance: ^ffffff15 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantÃ¢neo^ffcb4aEspera: ^ffffff60 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffTodasCria uma onda de veneno que atinge todos os inimigos em 15 metros.Reduz o HP mÃ¡ximo em %d%% por 10 segundos.Oferece %d%% de chance de interromper a conjuraÃ§Ã£o dos alvos.^72fe00Destreza: A cada 20 pontos de Destreza de Daimon, a duraÃ§Ã£o Ã© aumentada em 1 segundo.^ff0000UsÃ¡vel apenas na Ã¡gua."*/ 
