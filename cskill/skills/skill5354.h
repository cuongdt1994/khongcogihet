...
#ifndef __CPPGEN_GNET_SKILL5354 
#define __CPPGEN_GNET_SKILL5354 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5354:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5354 }; 
        Skill5354 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5354Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5354Stub ():SkillStub (5354) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÆÕ¹¥Ôö¼Ó³ðºÞ"; 
        nativename          = "ÆÕ¹¥Ôö¼Ó³ðºÞ"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
