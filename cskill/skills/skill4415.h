...
/* 
44150  "ΨTsunami de Chamas"44151  "^ff5c00ΨTsunami de Chamas
...
Dano físico básico, mais 
^96f5ff200%%^ffffff de dano de arma e mais ^96f5ff7200^ffffff
Nunca erra.

Tipos diferentes de armas causam efeitos diferentes.
Machado e Martelo: Atordoa o alvo por ^96f5ff5^ffffff segundos.
Arma de Haste: O alcance é aumentado para ^96f5ff20^ffffff metros. Causa dano a inimigos numa linha de ^96f5ff22^ffffff metros.
...
^00ffffNível 1 a 4: Ao usar arma de haste, paralisará o inimigo por ^ffffff2^00ffff segundos
^00ffffNível 5 a 7: Ao usar arma de haste, paralisará o inimigo por ^ffffff3^00ffff segundos
^00ffffNível 8 a 9: Ao usar arma de haste, paralisará o inimigo por ^ffffff4^00ffff segundos
^00ffff Nível 10: Ao usar arma de haste, paralisará o inimigo por ^ffffff5^00ffff segundos@1@2
^00ffffAo usar arma de haste, paralisará o inimigo por ^ffffff%d^00ffff segundos@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            //int _glyph_value = get_glyph(skill->GetLevel (), 1, 5, 8, 10);
            ...
            skill->GetVictim ()->SetValue (18007);
