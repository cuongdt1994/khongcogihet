...
/* 
68670  "Morte Instant芒nea 4602 das Tr锚s Deusas"68671  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6867 
#define __CPPGEN_GNET_SKILL6867 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6867:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6867 }; 
        Skill6867 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6867Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6867Stub ():SkillStub (6867) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"三女神书秒杀4602"; 
        nativename          = "三女神书秒杀4602"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 12; 
