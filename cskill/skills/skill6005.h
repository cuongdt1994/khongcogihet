...
/* 
60050  "Janjan_Morte InstantÃ¢nea de Bolo de Rolo"60051  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6005 
#define __CPPGEN_GNET_SKILL6005 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6005:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6005 }; 
        Skill6005 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6005Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6005Stub ():SkillStub (6005) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¼ú¼ú_ÃëÉ±Ô²±ý"; 
        nativename          = "¼ú¼ú_ÃëÉ±Ô²±ý"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 3; 
