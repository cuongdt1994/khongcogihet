...
/* 
60240  "Borboleta - Golpe de Corrente ElÃ©trica "60241  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6024 
#define __CPPGEN_GNET_SKILL6024 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6024:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6024 }; 
        Skill6024 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6024Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6024Stub ():SkillStub (6024) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÉÁµçÁ´À×»÷"; 
        nativename          = "ºûµû-ÉÁµçÁ´À×»÷"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
