...
/* 
13580  "Borrão Pontiagudo"13581  "^ffffffBorrão Pontiagudo (Nível %d)^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aConjuração: ^ffffff0,5 ^ffcb4a segundos^ffcb4aDuração: ^ffffff1,5^ffcb4a segundos^ffcb4aEspera: ^ffffff30,0 ^ffcb4asegundos^ffcb4aRestrições da Arma: ^ffffffLâmina ou Espada^ffcb4aEstima: ^ffffffSinistroAtaca por ^96f5ff12^ffffff segundos e acerta a cada ^96f5ff3^ffffff segundos causando danos ao alvo e a todos os inimigos dentro de um raio de ^96f5ff8^ffffff metros.Causa danos físicos básicos e ^96f5ff%.1f^ffffff adicionais de danos de Metal. A habilidade não pode gerar um acerto crítico, mas dobra sua chance de um acerto crítico ao causar ^96f5ff1.5^ffffffx de danos.^a6caf0Custa ^ffffff2^a6caf0 Chi."*/ 
