...
/* 
56650  "Nevasca do Reino do Norte"56651  "^ffffffNevasca^ffcb4aAlcance ^ffffff%d ^ffcb4ametros^ffcb4aCanalizaÃ§Ã£o ^ffffff0,1 ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff1,0 ^ffcb4asegundo^ffcb4aEspera ^ffffff20,0 ^ffcb4asegundos^ffffffLibere o poder do dragÃ£o gÃ©lido, causando um dano enorme na Ã¡rea visada."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5665 
#define __CPPGEN_GNET_SKILL5665 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5665:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5665 }; 
        Skill5665 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5665Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
