...
/* 
62370  "Imperador da Luz 60"62371  "proporção = -0,5 + 0,5*nívelDiminui o efeito de acerto"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6237 
#define __CPPGEN_GNET_SKILL6237 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6237:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6237 }; 
        Skill6237 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6237Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
