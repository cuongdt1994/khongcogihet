...
/* 
66790  "Cerco de Monstros Habilidade 8"66791  "2021 NTW AdE. Causa dano a jogadores a at茅 10 metros e fere jogadores que montaram uma barraca."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6679 
#define __CPPGEN_GNET_SKILL6679 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6679:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6679 }; 
        Skill6679 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6679Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6679Stub ():SkillStub (6679) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"怪物攻城小怪技能8"; 
        nativename          = "怪物攻城小怪技能8"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 1; 
