...
/* 
59500  "Borboleta - RegeneraÃ§Ã£o de Chefe "59501  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5950 
#define __CPPGEN_GNET_SKILL5950 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5950:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5950 }; 
        Skill5950 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5950Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5950Stub ():SkillStub (5950) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-BOSS»ØÑª"; 
        nativename          = "ºûµû-BOSS»ØÑª"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
