...
/* 
58700  "Monstro do Espelho - Dissipar Dano Aumentado"58701  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5870 
#define __CPPGEN_GNET_SKILL5870 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5870:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5870 }; 
        Skill5870 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5870Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5870Stub ():SkillStub (5870) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾µÄ§_ÇýÉ¢ÔöÉË"; 
        nativename          = "¾µÄ§_ÇýÉ¢ÔöÉË"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 999; 
        type                = 3; 
