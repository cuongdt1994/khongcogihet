...
/* 
36790  "ΨTempestade de Granizo"36791  "^ff5c00ΨTempestade de Granizo
...
^ffcb4aNível 1 a 4: Causa um dano de arma adicional de ^96f5ff72%% ^ffcb4amais ^96f5ff1036^ffcb4a.
^ffcb4aNível 5 a 7: Causa um dano de arma adicional de ^96f5ff108%% ^ffcb4amais ^96f5ff1554^ffcb4a.
^ffcb4aNível 8 a 9: Causa um dano de arma adicional de ^96f5ff144%% ^ffcb4amais ^96f5ff2072^ffcb4a.
^ffcb4aNível 10: Causa um dano de arma adicional de ^96f5ff180%% ^ffcb4amais ^96f5ff2590^ffcb4a.@1@2
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            bool Bypass (Skill * skill) const
            {
             ...
             void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.72, 1.08, 1.44, 1.8);
                int _glyph_value_2 = get_glyph(skill->GetLevel (), 1036, 1554, 2072, 2590);

                skill->GetPlayer ()->SetDecmp (256);
                skill->SetPlus (4740 + _glyph_value_2);
