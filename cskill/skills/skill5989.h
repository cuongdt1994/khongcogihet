...
/* 
59890  "Dan莽arina_Morte Instant芒nea em Massa com Flor do Al茅m"59891  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5989 
#define __CPPGEN_GNET_SKILL5989 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5989:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5989 }; 
        Skill5989 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5989Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5989Stub ():SkillStub (5989) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_群秒有彼岸花"; 
        nativename          = "舞女_群秒有彼岸花"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
