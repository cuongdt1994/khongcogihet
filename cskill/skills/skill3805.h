...
/* 
38050  "ΨPrisão Amaldiçoada"38051  "^ff5c00ΨPrisão Amaldiçoada
...
de precisão, atordoando o alvo por ^96f5ff6^ffffff segundos e causando o ^96f5ffdobro^ffffff
dano físico básico, mais ^96f5ff750%%^ffffff de dano por arma e mais ^96f5ff14994^ffffff.
Causa lentidão no alvo por ^96f5ff10^ffffff segundos, reduzindo a velocidade em ^96f5ff60%%^ffffff.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(2366, 1)); 
        pre_skills.push_back (std::pair < ID, int >(2451, 1)); 
    ...
    { 
        static int aarray[10] = { 53951,53951,53951,53951,53951,53951,53951,53951,53951,53951 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
