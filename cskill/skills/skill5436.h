...
/* 
54360  "ΨSugador de Energia"54361  "^ff5c00ΨSugador de Energia
...
^00ffffNível 1 a 4: Os efeitos que não são afetados por Atordoar e Congelar duram ^ffffff10^00ffff segundos.
^00ffffNível 5 a 7: Os efeitos que não são afetados por Atordoar e Congelar duram ^ffffff11^00ffff segundos.
^00ffffNível 8 a 9: Os efeitos que não são afetados por Atordoar e Congelar duram ^ffffff12^00ffff segundos.
^00ffffNível 10: Os efeitos que não são afetados por Atordoar e Congelar duram ^ffffff13^00ffff segundos. @1@2
^00ffffOs efeitos que não são afetados por Atordoar e Congelar duram ^ffffff%d^00ffff segundos. @2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5436 
#define __CPPGEN_GNET_SKILL5436 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5436:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5436 }; 
        Skill5436 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5436Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph(skill->GetLevel (), 10000, 11000, 12000, 13000);
