...
/* 
61570  "Baili Fengjiang - Efeito Espa莽o Fragmentado"61571  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6157 
#define __CPPGEN_GNET_SKILL6157 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6157:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6157 }; 
        Skill6157 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6157Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6157Stub ():SkillStub (6157) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"百里封疆-碎空间效果"; 
        nativename          = "百里封疆-碎空间效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
