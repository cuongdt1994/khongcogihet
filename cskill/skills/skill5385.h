...
/* 
53850  "Habilidade de Item de Punho e Escudo"53851  "Habilidade de Item de Punho e Escudo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5385 
#define __CPPGEN_GNET_SKILL5385 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5385:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5385 }; 
        Skill5385 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5385Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        runes_attr          = 0; 
#ifdef _SKILL_CLIENT 
        gfxfilename         = "回血护盾_子效果01改色_总.gfx"; 
