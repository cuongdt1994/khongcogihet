...
/* 
43310  "Ataque com AdE em Linha Reta (Indispon铆vel)"43311  "^ffcb4a Acelerar^ffcb4a Dist芒ncia: ^96f5ff40 ^ffffff ^ffcb4a metros^ffcb4a Tempo de conjura莽茫o: ^ffffff Instant芒neo^ffcb4a Intervalo de uso: ^ffffff%d ^ffcb4a segundos^ffffff Acelera seu ve铆culo para uma velocidade extrema, durante ^96f5ff5^ffffff segundos.^00ffff Vrum, Vrum!"*/ 
