...
/* 
53770  "Melhoria Individual do Pr铆ncipe Chongming"53771  "Melhoria Individual do Pr铆ncipe Chongming"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5377 
#define __CPPGEN_GNET_SKILL5377 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5377:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5377 }; 
        Skill5377 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5377Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
