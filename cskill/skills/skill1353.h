...
/* 
13530  "Lança de Íon"13531  "^ffffffLança de Ion  (Nível %d)
...
a até ^96f5ff%.1f ^ffffffmetros do alvo. Causa dano físico 
básico mais ^96f5ff%d%% ^ffffffdo dano da arma mais ^96f5ff%.1f ^ffffffem Dano de
Metal. Tem ^96f5ff%d%% ^ffffffde chance de reduzir a
Resistência a Metal dos alvos em ^96f5ff%d%% ^ffffffpor ^96f5ff10 ^ffffffsegundos.
