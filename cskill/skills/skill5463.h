...
/* 
54630  "ΨFísico Abençoado"54631  "^ff5c00ΨFísico Abençoado
...
#ifndef __CPPGEN_GNET_SKILL5463 
#define __CPPGEN_GNET_SKILL5463 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5463:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5463 }; 
        Skill5463 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5463Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 61676,61676,61676,61676,61676,61676,61676,61676,61676,61676 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
