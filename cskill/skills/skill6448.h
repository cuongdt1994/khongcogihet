...
/* 
64480  "Inst芒ncia Aleat贸ria_ Ret芒ngulo de Morte Instant芒nea"64481  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6448 
#define __CPPGEN_GNET_SKILL6448 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6448:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6448 }; 
        Skill6448 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6448Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
