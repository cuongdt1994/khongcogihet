...
/* 
26050  "Reflexo do Encantar"26051  "^ffffffReflexo do Encantar^ffcb4aAlcance: ^ffffff27 ^ffcb4ametros^ffcb4aCanalizaÃ§Ã£o: ^ffffff0.6 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o:   ^ffffff1.3 ^ffcb4asegundos^ffcb4aEspera: ^ffffff60.0 ^ffcb4asegundos^ffcb4aArma: ^ffffffSabreReflexo da habilidade de Feiticeira.Manipula sua energia vital para transformar o alvo em um passÃ¡ro por ^96f5ff4^ffffff segundos.PassÃ¡ros nÃ£o podem atacar ou usar habilidades, a Ãºnica aÃ§Ã£o permitada Ã© a movimentaÃ§Ã£o.^a6caf0^a6caf0Custa ^ffffff50^a6caf0 de Chi."*/ 
