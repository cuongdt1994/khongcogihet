...
/* 
59530  "Borboleta - Status de Lama"59531  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5953 
#define __CPPGEN_GNET_SKILL5953 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5953:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5953 }; 
        Skill5953 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5953Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5953Stub ():SkillStub (5953) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÄàÌ¶×´Ì¬"; 
        nativename          = "ºûµû-ÄàÌ¶×´Ì¬"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
