...
/* 
62850  "Φ Salvação"62851  "^ffff00ΦSalvação           Nível %d
...
^f7dfa5Reduz o custo de MP em ^96f5ff10%%^f7dfa5.
^f7dfa5Concede à Salvação a habilidade ^96f5ffEscudo de Teletransporte^f7dfa5."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6285 
#define __CPPGEN_GNET_SKILL6285 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6285:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6285 }; 
        Skill6285 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6285Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1660, 1)); 
