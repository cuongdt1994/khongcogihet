...
#ifndef __CPPGEN_GNET_SKILL6895 
#define __CPPGEN_GNET_SKILL6895 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6895:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6895 }; 
        Skill6895 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6895Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
