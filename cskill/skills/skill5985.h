...
/* 
59850  "Lobo do TrovÃ£o - Grito de Guerra 2"59851  "RepulsÃ£o em Ãrea de Cone do Chefe"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5985 
#define __CPPGEN_GNET_SKILL5985 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5985:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5985 }; 
        Skill5985 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5985Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5985Stub ():SkillStub (5985) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-Õ½ºð2"; 
        nativename          = "À×ÀÇ-Õ½ºð2"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
