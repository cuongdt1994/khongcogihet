...
/* 
55030  "Empurṛo do Buraco Negro"55031  "Empurṛo do Buraco Negro"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5503 
#define __CPPGEN_GNET_SKILL5503 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5503:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5503 }; 
        Skill5503 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5503Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static int aarray[10] = { 1168,1168,1168,1168,1168,1168,1168,1168,1168,1168 }; 
