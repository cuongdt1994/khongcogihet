...
/* 
62690  "Ψ Fada das Ondas"
62691  "^ff5c00Ψ Fada das Ondas            
...
^ffeaabNível 1 a 4: A Taxa de Acerto Crítico é aumentada em ^96f5ff25%%^ffeaab
^ffeaabNível 5 a 7: A Taxa de Acerto Crítico é aumentada em ^96f5ff30%%^ffeaab
^ffeaabNível 8 a 9: A Taxa de Acerto Crítico é aumentada em ^96f5ff35%%^ffeaab
^ffeaabNível 10: A Taxa de Acerto Crítico é aumentada em ^96f5ff40%%^ffeaab@1@2
A Taxa de Acerto Crítico é aumentada em ^96f5ff%d%%^ffeaab@2"
*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph((skill->GetLevel ()), 25, 30, 35, 40);
