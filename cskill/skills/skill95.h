...
/* 
3950  "○Nuvens Dissipadas"3951  "^8080ff○Nuvens Dissipadas^ffcb4aAlcance: ^ffffffCorpo a Corpo^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuração: ^ffffff0.2 ^ffcb4asegundos^ffcb4aDuração: ^ffffff1.8 ^ffcb4asegundos^ffcb4aEspera: ^ffffff15.0 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff8^ffcb4aRestrições da Arma: ^ffffffDesarmado, Punho ou Garra^ffcb4aCultivo necessário: ^ffffffDiabólicoSalta do chão e dá um chute giratório atacando todos os inimigos em um raio de ^96f5ff8^ffffff metros. Causa dano físico básico mais ^96f5ff%d%%^ffffff de dano por arma mais ^96f5ff%d^ffffff. Dá um aumento na velocidade de ataque de^96f5ff%d^ffffff segundo de ^96f5ff%d%%^ffffff.^d618e7A versão Demônio aumenta a taxa de ataque em ^96f5ff20%%^d618e7."*/ 
