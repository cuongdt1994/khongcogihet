...
/* 
42140  "Efeito de Habilidade [3951] do 唯Golpe de Sopro do Drag茫o"42141  "efeito 3951: Dano por Fogo. A 唯Lan莽a Glacial n茫o tem espera."*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·云龙九现[3951]的技能效果"; 
        nativename          = "神·云龙九现[3951]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
