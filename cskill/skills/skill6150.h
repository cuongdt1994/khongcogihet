...
/* 
61500  "Regra de Equil铆brio Ocupada 1"61501  "Regra Tempor谩ria de Equil铆brio para Auto Reviver"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6150 
#define __CPPGEN_GNET_SKILL6150 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6150:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6150 }; 
        Skill6150 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6150Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
