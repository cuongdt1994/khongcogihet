...
/* 
61790  "Mo Ranyun - Boss recupera HP"61791  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6179 
#define __CPPGEN_GNET_SKILL6179 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6179:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6179 }; 
        Skill6179 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6179Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6179Stub ():SkillStub (6179) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä«È»ÔÊ-boss×ÔÄÌ"; 
        nativename          = "Ä«È»ÔÊ-boss×ÔÄÌ"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
