...
/* 
10300  "Armadura de Fogo e Água"10301  "^ffffffArmadura de Fogo e Água (Nível %d)^ffcb4aCusto de SP: ^96f5ff95^ffffff^ffcb4aCusto de EP: ^96f5ff%d^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff60 ^ffcb4a segundos^ffcb4aClasse Requisitada: ^ffffffMagoCombina os poderes do Fogo e da Água em um escudo caótico.Reduz o dano que você recebe em %d%% por 10 segundos,depois aumenta dano que você recebe em %d%% por 10 segundos.^72fe00Destreza: A cada 8 pontos de Destreza de Daimon, a redução do dano é aumentada em 1%%.^72fe00Destreza: A cada 8 pontos de Destreza de Daimon, o aumento de dano é reduzido em 1%%."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 4600,6400,8820,12040,16360,22200,30200,43000,72200,117200 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 44038,44043,44048,44053,44058,44063,44068,44073,44078,44083 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
