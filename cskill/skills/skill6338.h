...
/* 
63380  "AniversÃ¡rio DecoraÃ§Ã£o de Parede Nove DragÃµes"63381  "AniversÃ¡rio Habilidade de TransformaÃ§Ã£o do Peixinho Dourado"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6338 
#define __CPPGEN_GNET_SKILL6338 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6338:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6338 }; 
        Skill6338 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6338Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6338Stub ():SkillStub (6338) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÖÜÄêÇì¾ÅÁú±Ú»­±Ê"; 
        nativename          = "ÖÜÄêÇì¾ÅÁú±Ú»­±Ê"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 4; 
