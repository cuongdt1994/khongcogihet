...
/* 
59770  "Lobo do TrovÃ£o - Grito de Guerra"59771  "ApÃ³s retirar anel, causa dano e repulsÃ£o aos jogadores sobreviventes"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5977 
#define __CPPGEN_GNET_SKILL5977 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5977:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5977 }; 
        Skill5977 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5977Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
