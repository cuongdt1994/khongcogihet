...
/* 
42130  "Efeito de Habilidade [3950] do 唯Golpe de Sopro do Drag茫o"42131  "efeito 3950: Dano por Fogo. A 唯Ira do Para铆so n茫o tem espera."*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·云龙九现[3950]的技能效果"; 
        nativename          = "神·云龙九现[3950]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
