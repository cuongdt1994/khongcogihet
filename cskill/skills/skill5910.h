...
/* 
59100  "Colosso - Efeito de Nocaute"59101  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5910 
#define __CPPGEN_GNET_SKILL5910 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5910:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5910 }; 
        Skill5910 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5910Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5910Stub ():SkillStub (5910) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÞÏñ-»÷ÍËÐ§¹û"; 
        nativename          = "¾ÞÏñ-»÷ÍËÐ§¹û"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
