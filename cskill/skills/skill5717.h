...
/* 
57170  "Morte Instant芒nea B谩sica do Reino do Norte"57171  "绁瀇鍐叉妧鏈痏鍑讳腑.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5717 
#define __CPPGEN_GNET_SKILL5717 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5717:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5717 }; 
        Skill5717 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5717Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
