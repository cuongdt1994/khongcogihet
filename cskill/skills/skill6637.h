...
/* 
66370  "ΨAbismo Celestial"66371  "^ff5c00ΨAbismo Celestial              
...
^ffcb4aArma ^ffffffBastão ou Desarmado

^ffcb4aCultivo ^ffffffAlma Celestial
Rodopie e esmague o alvo a até ^96f5ff20^ffffff metros! A até ^96f5ff10^ffffff metros do alvo,  
causa ^96f5ff230%%^ffffff de dano físico básico mais aos inimigos e mais ^96f5ff%d^ffffff, 
os congelando por ^96f5ff1^ffffff segundo. 
Se você possuir a Marca de Yin ou Marca de Yang, a marca será removida e seu ataque
irá paralisar os inimigos por ^96f5ff5^ffffff segundos.
 Recupera ^96f5ff20^ffffff de Chi após usar a habilidade.

Não pode ser um acerto crítico, mas tem a chance de
dobrar a sua Taxa de Acerto Crítico para causar ^96f5ff1,5^ffffff vezes de dano.
...
^00ffffNível 1 a 4: O Chi recebido é aumentado para ^ffffff60
^00ffffNível 5 a 7: Chi recebido aumentado para ^ffffff100
^00ffffNível 8 a 9: Chi recebido aumentado para ^ffffff140
^00ffffNível 10: O Chi recebido é aumentado para ^ffffff180@1@2
^00ffffO Chi recebido é aumentado para ^ffffff%d^00ffff@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6637 
#define __CPPGEN_GNET_SKILL6637 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6637:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6637 }; 
        Skill6637 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6637Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    bool BlessMe (Skill * skill) const
    {
            ...
            int _glyph_value = get_glyph(skill->GetLevel (), 60, 100, 140, 180);
