...
/* 
59660  "Lobo do TrovÃ£o - Dano de Esfera ao Apanhar Queda de Esfera"59661  "VerificaÃ§Ã£o Bem Sucedida da Queda da EsferaCausa dano aos jogadores ao alcance"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5966 
#define __CPPGEN_GNET_SKILL5966 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5966:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5966 }; 
        Skill5966 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5966Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5966Stub ():SkillStub (5966) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-ÂäÇò½ÓÇòÉËº¦"; 
        nativename          = "À×ÀÇ-ÂäÇò½ÓÇòÉËº¦"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
