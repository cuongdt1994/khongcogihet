...
/* 
66340  "ΨAbismo Celestial"66341  "^ff5c00ΨAbismo Celestial             
...
#ifndef __CPPGEN_GNET_SKILL6634 
#define __CPPGEN_GNET_SKILL6634 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6634:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6634 }; 
        Skill6634 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6634Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        pre_skills.push_back (std::pair < ID, int >(6503, 1)); 
    ...
    { 
        static int aarray[10] = { 70225,70225,70225,70225,70225,70225,70225,70225,70225,70225 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
