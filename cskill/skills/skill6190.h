...
/* 
61900  "Mestre b√™bado - Raio de Luz do Uivo de L√¢minas"61901  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6190 
#define __CPPGEN_GNET_SKILL6190 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6190:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6190 }; 
        Skill6190 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6190Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6190Stub ():SkillStub (6190) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æ∆œ…-Ω£–•π‚ª∑"; 
        nativename          = "æ∆œ…-Ω£–•π‚ª∑"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
