...
/* 
53570  "Aumento da Taxa de Ataque da Inst芒ncia de Mestre e Aprendiz"53571  "Cancelamento NV1Aumenta em 1 minuto por n铆vel; 10 minutos no n铆vel 10."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5357 
#define __CPPGEN_GNET_SKILL5357 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5357:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5357 }; 
        Skill5357 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5357Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
