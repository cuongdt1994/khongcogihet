...
/* 
61160  "Mestre Espadachim - Dano de Golpe Forte "61161  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6116 
#define __CPPGEN_GNET_SKILL6116 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6116:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6116 }; 
        Skill6116 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6116Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6116Stub ():SkillStub (6116) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½£Ê¥-Ç§¾ù´ò»÷ÉËº¦"; 
        nativename          = "½£Ê¥-Ç§¾ù´ò»÷ÉËº¦"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 3; 
