...
/* 
62830  "Nova 螖Invoca莽茫o Suprema Dominador de Almas"62831  "Autodestruir ao morrer"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6283 
#define __CPPGEN_GNET_SKILL6283 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6283:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6283 }; 
        Skill6283 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6283Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
