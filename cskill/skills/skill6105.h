...
/* 
61050  "Inst芒ncia Aleat贸ria_Passagem Invis铆vel_Maldi莽茫o"61051  "Inst芒ncia Aleat贸ria_N铆vel de Passagem Transparente"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6105 
#define __CPPGEN_GNET_SKILL6105 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6105:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6105 }; 
        Skill6105 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6105Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6105Stub ():SkillStub (6105) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"随机本_通路隐身_诅咒"; 
        nativename          = "随机本_通路隐身_诅咒"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
