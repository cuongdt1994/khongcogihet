...
/* 
55450  "Efeito da Aura do Escudo Protetor do Evento de Chamar 2019"55451  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5545 
#define __CPPGEN_GNET_SKILL5545 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5545:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5545 }; 
        Skill5545 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5545Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5545Stub ():SkillStub (5545) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2019回流保护罩任务光环效果"; 
        nativename          = "2019回流保护罩任务光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 2; 
