...
/* 
18780  "Alma da Fraqueza"18781  "^ffffffAlma da Fraqueza             ^ffcb4aAlcance ^ffffff10 ^ffcb4ametros^ffcb4aCanalizaÃ§Ã£o ^ffffff1,0 ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff1,0 ^ffcb4asegundo^ffcb4aEspera ^ffffff12,0 ^ffcb4asegundos^ffffffCausa dano fÃ­sico equivalente a duas vezes o ataque fÃ­sico dos Anjos,atingindo os inimigos a atÃ© 5 metros de distÃ¢ncia do alvo. Por ^96f5ff%d^ffffff segundos, aumenta a chance dos alvos receberem Acertos CrÃ­ticos em ^96f5ff%d^ffffff por cento. A chance Ã© determinada pela ForÃ§a da Alma."*/ 
