...
/* 
60190  "Colosso - Efeito de Carregar "60191  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6019 
#define __CPPGEN_GNET_SKILL6019 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6019:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6019 }; 
        Skill6019 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6019Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6019Stub ():SkillStub (6019) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÞÏñ-³å·æÐ§¹û"; 
        nativename          = "¾ÞÏñ-³å·æÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
