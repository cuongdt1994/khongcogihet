...
/* 
59410  "General - Aura de Pux茫o em Massa"59411  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5941 
#define __CPPGEN_GNET_SKILL5941 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5941:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5941 }; 
        Skill5941 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5941Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5941Stub ():SkillStub (5941) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-群体拉人光环"; 
        nativename          = "将军-群体拉人光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
