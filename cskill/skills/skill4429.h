...
/* 
44290  "ΨMagia de Retorno da Lâmina"44291  "^ff5c00 ΨMagia de Retorno da Lâmina
 ...
 Esforce-se, está tudo na palma da sua mão! Após utilizar zerará
 o tempo de intervalo da Irrestrito e do Passo no Vazio. 
 Em um curto período vai aumentar no próprio corpo ^96f5ff100%%^ffffff da força do ataque 
 físico das armas, se manterá por ^96f5ff8^ffffff segundos.
 
 ^ffeaab Efeito Runa Argêntea @1
 ^ffeaabNv. 1-4: efeito se manterá por mais ^96f5ff12^ffeaab segundos
 ^ffeaabNv. 5-7: efeito se manterá por mais ^96f5ff16^ffeaab segundos
 ^ffeaabNv. 8-9: efeito se manterá por mais ^96f5ff20^ffeaab segundos
 ^ffeaab Nv. 10: efeito se manterá por mais ^96f5ff24^ffeaab segundos@1@2
 ^ffeaab nível: efeito se manterá por mais ^96f5ff%d^ffeaab segundos@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
	     ...
	     bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph(skill->GetLevel (), 12500, 16500, 20500, 24500);
