...
/* 
23700  "ΦEsmagamento Estelar"23701  "^ffff00ΦEsmagamento Estelar
...
^f7dfa5A versão do Sábio também interrompe o alvo."*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5115);
                skill->SetRatio (skill->GetPlayer()->GetCurWeapon() == 1 ? 3.0 : 1.0);
