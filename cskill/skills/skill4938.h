...
/* 
49380  "Chama: Fluxo Mortal"49381  "^ffffffChama: Banimento Mortal          Nível %d  
...
causando Dano Físico a ele e a todos os alvos inimigos dentro de ^96f5ff%.1f^ffffff metros
pelo Ataque Físico base mais ^96f5ff%.1f^ffffff. Para cada inimigo adicional dentro 
do alcance do efeito, o conjurador ganha ^96f5ff1^ffffff Chi. "*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 4100,6790,10028,14007,18860,24640,31752,40334,50716,63270 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 18,23,28,33,38,43,48,53,58,63 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
