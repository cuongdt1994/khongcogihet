...
/* 
54850  "ΨGarras do Paraíso"54851  "^ff5c00ΨÁguia da Fúria da Tempestade
...
Quanto mais distante o alvo estiver, mais poderosa essa habilidade é.
^00ff00Nível 1 a 4: Aumenta o dano em até ^96f5ff50%%^00ff00 do Ataque da Arma.
^00ff00Nível 5 a 7: Aumenta o dano em até ^96f5ff100%%^00ff00 do Ataque da Arma
^00ff00Nível 8 a 9: Aumenta o dano em até ^96f5ff150%%^00ff00 do Ataque da Arma
^00ff00Nível 10: Aumenta o dano em até ^96f5ff200%%^00ff00 do Ataque da Arma.@1@2
Quanto mais distante o alvo estiver, mais poderosa esta habilidade se torna. Aumenta o dano em até ^96f5ff%d%%^00ff00
 de dano de arma@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            float distance = player->GetRangetotarget ();       
            float max_distance = player->GetRange ();       
            float _glyph_value = get_glyph(player->GetSkilllevel(5485), 0.5, 1, 1.5, 2);

            return (float) ((1 + (( distance / max_distance ) * _glyph_value)) * player->GetWeapondamage () + 8343);
        }
#endif 
#ifdef _SKILL_SERVER 
