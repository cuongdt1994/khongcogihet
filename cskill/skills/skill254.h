...
/* 
22540  "ΦArmadura de Terra"22541  "^ffff00ΦArmadura de Terra
...
Forma uma barreira durável ao seu redor, aumentando a
resistência contra Terra em ^96f5ff150%%^ffffff e a defesa física em ^96f5ff120%%^ffffff por ^96f5ff15^ffffff minutos.

^a6caf0Apenas uma armadura elemental pode ser ativada por vez.

^a6caf0Custa ^ffffff10 ^a6caf0Chi.

^f7dfa5A versão do Sábio aumenta a resistência da terra em ^96f5ff150%%^f7dfa5."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 5250,8175,12075,17250,24000,33075,45150,61350,83250,113250 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
