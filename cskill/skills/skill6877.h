...
/* 
68770  "A Vingan莽a das Tr锚s Deusas"68771  "Espalhem-se, Pal谩cio Rio da Prata - Amorea - Habilidade do S煤cubo Florido"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6877 
#define __CPPGEN_GNET_SKILL6877 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6877:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6877 }; 
        Skill6877 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6877Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
