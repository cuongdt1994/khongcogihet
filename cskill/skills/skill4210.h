...
/* 
42100  "Efeito de Habilidade [3940] da 唯Lan莽a Glacial"42101  "Efeito 3940, aumenta o dano da 唯Dez Mil L芒minas"*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·寒冰刃域[3940]的技能效果"; 
        nativename          = "神·寒冰刃域[3940]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
