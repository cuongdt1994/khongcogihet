...
/* 
69320  "ΨQueda da Terra"69321  "^ff5c00ΨQueda da Terra
...
^00ffffNível 1 a 4: A Taxa de Acerto Crítico Adicional aumenta para^ffffff17%%
^00ffffNível 5 a 7: A Taxa de Acerto Crítico Adicional aumenta para^ffffff18%%
^00ffffNível 8 a 9: A Taxa de Acerto Crítico Adicional aumenta para^ffffff19%%
^00ffffNível 10: A Taxa de Acerto Crítico Adicional aumenta para^ffffff20%%@1@2
^00ffffA Taxa de Acerto Crítico Adicional aumenta para^ffffff%d%%^00ffff@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6932 
#define __CPPGEN_GNET_SKILL6932 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6932:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6932 }; 
        Skill6932 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6932Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
            float _glyph_value = get_glyph(skill->GetLevel (), 17, 18, 19, 20);
