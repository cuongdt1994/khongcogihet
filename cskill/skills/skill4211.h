...
/* 
42110  "Efeito de Habilidade [3941] da 唯Lan莽a Glacial"42111  "Efeito 3941, aumenta o dano do Golpe do Sopro do Drag茫o"*/ 
...
{ 
    ...
    { 
        cls                 = 0; 
#ifdef _SKILL_CLIENT 
        name                = L"神·寒冰刃域[3941]的技能效果"; 
        nativename          = "神·寒冰刃域[3941]的技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
