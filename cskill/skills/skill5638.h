...
/* 
56380  "Reino do Norte - Ataque Normal da Sentinela Vermelha"56381  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5638 
#define __CPPGEN_GNET_SKILL5638 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5638:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5638 }; 
        Skill5638 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5638Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5638Stub ():SkillStub (5638) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½-ºì·½Ç°ÉÚÆÕ¹¥"; 
        nativename          = "±±Â½-ºì·½Ç°ÉÚÆÕ¹¥"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
