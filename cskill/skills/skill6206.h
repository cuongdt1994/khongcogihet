...
/* 
62060  "Sem Entrada 脿 Barreira da Morte"62061  "Reino do Norte Use Pacote Tempor谩rio do Status 4652"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6206 
#define __CPPGEN_GNET_SKILL6206 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6206:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6206 }; 
        Skill6206 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6206Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
