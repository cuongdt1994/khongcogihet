...
/* 
69910  "ΨMente Taoista"
69911  "^ff5c00ΨMente Taoista
...
^96f5ff66%%^ffffffe a chance de evitar dano em ^96f5ff40%%^ffffff.
 Dura ^96f5ff60^ffffff segundos.

^ffeaabEfeito da Runa Argêntea:@1
^ffeaabNível 1 a 4: Gera ^96f5ff15^ffeaab de Chi após o uso.
^ffeaabNível 5 a 7: Gera ^96f5ff20^ffeaab de Chi após o uso.
^ffeaabNível 8 a 9: Gera ^96f5ff25^ffeaab de Chi após o uso.
^ffeaabNível 10: Gera ^96f5ff30^ffeaab de Chi após o uso.@1@2
Gera ^96f5ff%d^ffeaab de Chi após o uso.@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6991 
#define __CPPGEN_GNET_SKILL6991 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6991:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6991 }; 
        Skill6991 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6991Stub:public SkillStub 
    { 
    public: 
