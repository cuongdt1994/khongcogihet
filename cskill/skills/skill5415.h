...
#ifndef __CPPGEN_GNET_SKILL5415 
#define __CPPGEN_GNET_SKILL5415 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5415:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5415 }; 
        Skill5415 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5415Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(4991, 1)); 
