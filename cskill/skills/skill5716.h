...
/* 
57160  "Reino do Norte - Efeito de Morte InstantÃ¢nea 01"57161  "1å¯’å†°ä¹‹çŸ¢.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5716 
#define __CPPGEN_GNET_SKILL5716 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5716:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5716 }; 
        Skill5716 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5716Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5716Stub ():SkillStub (5716) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½ÃëÉ±Ð§¹û01"; 
        nativename          = "±±Â½ÃëÉ±Ð§¹û01"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
