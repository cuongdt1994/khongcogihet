...
/* 
69870  "ΨMente Taoista"69871  "^ff5c00ΨMente Taoista
...
^96f5ff66%%^ffffff e a chance de resistir a dano em ^96f5ff40%%^ffffff.
 Dura ^96f5ff60^ffffff segundos. 

^ffcb4aEfeito da Runa Áurea:@1
^ffcb4aNível 1 a 4: Obtém ^96f5ff1^ffcb4a Carga de Ataque.
^ffcb4aNível 5 a 7: Obtém ^96f5ff2^ffcb4a Cargas de Ataque.
^ffcb4aNível 8 a 9: Obtém ^96f5ff3^ffcb4a Cargas de Ataque.
^ffcb4aNível 10: Obtém ^96f5ff4^ffcb4a Cargas de Ataque.@1@2
Obtém ^96f5ff%d^ffcb4a Cargas de Ataque.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6987 
#define __CPPGEN_GNET_SKILL6987 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6987:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6987 }; 
        Skill6987 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6987Stub:public SkillStub 
    { 
    public: 
