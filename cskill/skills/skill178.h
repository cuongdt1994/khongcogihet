...
/* 
1780  "Sutra Exterior"1781  "^ffffffSutra Exterior (NÃ­vel %d)^ffcb4aCusto em MP: ^ffffff20^ffcb4aConjuraÃ§Ã£o: ^ffffffInstantÃ¢neo^ffcb4aEspera: ^ffffff10 ^ffcb4asegundos^ffcb4aVitalidade: ^ffffff10^ffcb4aRestriÃ§Ãµes de Arma: ^ffffffArmas Corpo-a-Corpo^ffcb4aCultivo necessÃ¡rio: ^ffffffHarmoniosoApÃ³s a ativaÃ§Ã£o, a defesa fÃ­sica do personagem aumenta em ^96f5ff%d%%^ffffff, porÃ©m, a defesa mÃ¡gica diminui em ^96f5ff%d%%^ffffff. Dura por ^96f5ff30^ffffff segundos.^a6caf0 Sutra Interior e Sutra Exterior nÃ£o podem ser ativadas ao mesmo tempo."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 5600,8720,12880,18400,25600,35280,48160,65440,88800,120800 }; 
