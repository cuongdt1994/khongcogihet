...
#ifndef __CPPGEN_GNET_SKILL6297 
#define __CPPGEN_GNET_SKILL6297 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6297:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6297 }; 
        Skill6297 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6297Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
