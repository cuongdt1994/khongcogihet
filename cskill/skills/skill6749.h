...
/* 
67490  "Defesa Especial da Ma莽茫 da Inst芒ncia Vermelha 2021"67491  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6749 
#define __CPPGEN_GNET_SKILL6749 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6749:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6749 }; 
        Skill6749 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6749Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6749Stub ():SkillStub (6749) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021小红本推水果_苹果特殊防御"; 
        nativename          = "2021小红本推水果_苹果特殊防御"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
