...
/* 
66050  "ΨRasante do Ganso"66051  "^ff5c00ΨRasante do Ganso              
...
^ffcb4aNível 1 a 4: Reduz o dano à distância recebido em ^96f5ff92%%.
^ffcb4aNível 5 a 7: Reduz o dano à distância recebido em ^96f5ff94%%.
^ffcb4aNível 8 a 9: Reduz o dano à distância recebido em ^96f5ff96%%.
^ffcb4aNível 10: Reduz o dano à distância recebido em ^96f5ff98%%.@1@2
Reduz o dano à distância recebido em ^96f5ff%d%%.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6605 
#define __CPPGEN_GNET_SKILL6605 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6605:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6605 }; 
        Skill6605 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6605Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            float _glyph_value = get_glyph(skill->GetLevel (), 0.92, 0.94, 0.96, 0.98);
