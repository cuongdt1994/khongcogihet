...
#ifndef __CPPGEN_GNET_SKILL6135 
#define __CPPGEN_GNET_SKILL6135 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6135:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6135 }; 
        Skill6135 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6135Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
