...
/* 
35610  "ΨDança Ultravioleta"35611  "^ff5c00ΨDança Ultravioleta
...
^00ffffNível 1 a 4: Espera reduzida para ^ffffff11^00ffff segundos.
^00ffffNível 5 a 7: Espera reduzida para ^ffffff9^00ffff segundos.
^00ffffNível 8 a 9: Espera reduzida para ^ffffff7^00ffff segundos.
^00ffffNível 10: A espera reduzida para ^ffffff5^00ffff segundos.@1@2
A espera reduzida para ^ffffff%d^00ffff segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        int _glyph_value = get_glyph((skill->GetLevel ()), 11000, 9000, 7000, 5000);
        return _glyph_value; 
    } 
