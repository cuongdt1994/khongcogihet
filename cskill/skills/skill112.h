...
/* 
1120  "Rugido do Tigre"
1121  "^ffffffRugido do Tigre (Nível %d)
...
Muda de forma para um tigre branco. 
Aumenta o HP máximo em ^96f5ff%d%%^ffffff, melhora a taxa de movimento em ^96f5ff%d%%^ffffff, 
e todos os ataques normais sofrem penalidade de ^96f5ff%d%%^ffffff."
*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 1000,11800,87000,87000,87000,87000,87000,87000,87000,87000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredLevel (Skill * skill) const 
    { 
        static int aarray[10] = { 9,29,59,59,59,59,59,59,59,59 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
