...
/* 
61860  "Mestre bÃªbado - LeÃ£o de Pedra cuspe fogo"61861  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6186 
#define __CPPGEN_GNET_SKILL6186 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6186:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6186 }; 
        Skill6186 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6186Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6186Stub ():SkillStub (6186) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÆÏÉ-Ê¯Ê¨×ÓÅç»ð"; 
        nativename          = "¾ÆÏÉ-Ê¯Ê¨×ÓÅç»ð"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
