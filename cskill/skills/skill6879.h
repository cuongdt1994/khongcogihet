...
/* 
68790  "Tr锚s Deusas: Imune ao girosc贸pio 脿 dist芒ncia"68791  "Imunidade a dano a at茅 8 metros"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6879 
#define __CPPGEN_GNET_SKILL6879 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6879:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6879 }; 
        Skill6879 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6879Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6879Stub ():SkillStub (6879) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"三女神纺锤远程免疫"; 
        nativename          = "三女神纺锤远程免疫"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
