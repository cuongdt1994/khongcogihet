...
/* 
62670  "Ψ Fada das Ondas"62671  "^ff5c00Ψ Fada das Ondas            
...
^96f5ff15^ffffff segundos e remove o tempo de canalização de todos os feitiços por ^96f5ff9^ffffff segundos. Aumenta sua Taxa de Acerto Crítico em mais ^96f5ff20%%^ffffffpor
...
^00ffffNível 1 a 4: A duração é aumentada em ^FFFFFF10^00ffff segundos
^00ffffNível 5 a 7: A duração é aumentada em ^FFFFFF11^00ffff segundos
^00ffffNível 8 a 9: A duração é aumentada em ^FFFFFF12^00ffff segundos
^00ffffNível 10: A duração é aumentada em ^FFFFFF13^00ffff segundos@1@2
^00ffffA duração é aumentada em ^FFFFFF%d^00ffff segundos@2
"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {            
            int _glyph_value = get_glyph((skill->GetLevel ()), 11000, 12000, 13000, 14000);
