...
/* 
57180  "Reino do Norte - Efeito de Morte InstantÃ¢nea 03"57181  "ç¥ž_é’è—¤ç»•_é£žè¡Œ1.sgc"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5718 
#define __CPPGEN_GNET_SKILL5718 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5718:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5718 }; 
        Skill5718 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5718Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5718Stub ():SkillStub (5718) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½ÃëÉ±Ð§¹û03"; 
        nativename          = "±±Â½ÃëÉ±Ð§¹û03"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
