...
/* 
58670  "Dan莽arina_Mata Instantaneamente Todos os Jogadores em 脕rea"58671  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5867 
#define __CPPGEN_GNET_SKILL5867 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5867:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5867 }; 
        Skill5867 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5867Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5867Stub ():SkillStub (5867) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_群秒杀所有玩家"; 
        nativename          = "舞女_群秒杀所有玩家"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
