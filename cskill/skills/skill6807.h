...
/* 
68070  "Efeito Banido de Reposi莽茫o de Curandeiro "68071  "Reposi莽茫o em 脕rea Banida"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6807 
#define __CPPGEN_GNET_SKILL6807 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6807:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6807 }; 
        Skill6807 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6807Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6807Stub ():SkillStub (6807) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"医家-禁止位移效果"; 
        nativename          = "医家-禁止位移效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 12; 
