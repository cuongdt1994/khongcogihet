...
/* 
61750  "Aura de brinde do Mestre Cervejeiro"61751  "Remove o b̫nus de Bebida Mortal dos jogadores, causando dano.Causa dano mortal em jogadores com mais de 2 camadas de Bebida Mortal!"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6175 
#define __CPPGEN_GNET_SKILL6175 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6175:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6175 }; 
        Skill6175 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6175Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
