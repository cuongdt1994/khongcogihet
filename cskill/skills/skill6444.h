...
#ifndef __CPPGEN_GNET_SKILL6444 
#define __CPPGEN_GNET_SKILL6444 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6444:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6444 }; 
        Skill6444 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6444Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
