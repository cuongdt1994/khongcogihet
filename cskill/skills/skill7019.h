...
/* 
70190  "Efeito de auto-acelera莽茫o de 10 metros"70191  "Acelera 300%Dura莽茫o=n铆vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7019 
#define __CPPGEN_GNET_SKILL7019 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7019:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7019 }; 
        Skill7019 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7019Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill7019Stub ():SkillStub (7019) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"10米自身圆加速光环效果"; 
        nativename          = "10米自身圆加速光环效果"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 12; 
