...
/* 
61010  "Lobo do TrovÃ£o - Golpe mÃºltiplo"61011  "TestarAtaque o alvo com golpes mÃºltiplos"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6101 
#define __CPPGEN_GNET_SKILL6101 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6101:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6101 }; 
        Skill6101 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6101Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6101Stub ():SkillStub (6101) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-¹ÖÎï¶à¶ÎÍ»½ø"; 
        nativename          = "À×ÀÇ-¹ÖÎï¶à¶ÎÍ»½ø"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
