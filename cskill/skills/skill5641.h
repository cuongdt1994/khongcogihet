...
/* 
56410  "Reino do Norte - 脕rea em Leque da Sentinela Azul"56411  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5641 
#define __CPPGEN_GNET_SKILL5641 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5641:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5641 }; 
        Skill5641 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5641Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5641Stub ():SkillStub (5641) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-蓝方前哨扇形"; 
        nativename          = "北陆-蓝方前哨扇形"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
