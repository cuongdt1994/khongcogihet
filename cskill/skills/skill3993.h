...
/* 
39930  "ΨDardo da Nuvem Negra"39931  "^ff5c00ΨDardo da Nuvem Negra
...
^ffcb4aNível 1 a 4: Causa ^96f5ff40%% ^ffcb4ade dano adicional da arma.
^ffcb4aNível 5 a 7: Causa ^96f5ff60%% ^ffcb4a de dano de arma adicional.
^ffcb4aNível 8 a 9: Causa ^96f5ff80%% ^ffcb4a de dano de arma adicional.
^ffcb4aNível 10: Causa ^96f5ff100%% ^ffcb4ade dano adicional de arma.@1@2
^ffcb4aCausa ^96f5ff%d%% ^ffcb4ade dano adicional de arma.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {     
            ...
            int _glyph_value = get_glyph(skill->GetPlayer ()->GetSkilllevel (3993), 2000, 3000, 4000, 5000);
            int _glyph_value_2 = get_glyph(skill->GetPlayer ()->GetSkilllevel (3993), 11, 14, 17, 20);
