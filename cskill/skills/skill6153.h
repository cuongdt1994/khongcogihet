...
/* 
61530  "Explos茫o de les茫o interna Baili Feron"61531  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6153 
#define __CPPGEN_GNET_SKILL6153 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6153:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6153 }; 
        Skill6153 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6153Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6153Stub ():SkillStub (6153) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"百里封疆-内伤爆发"; 
        nativename          = "百里封疆-内伤爆发"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 1000; 
        type                = 3; 
