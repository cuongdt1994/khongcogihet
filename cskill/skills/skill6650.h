...
/* 
66500  "Uni茫o C贸smica"66501  "^ffffffUni茫o C贸smica              ^ffffffBate quatro vezes com f煤ria! Causa um grande dano a inimigos em at茅 ^96f5ff8^ffffff metros. ^ffa4a9Petrifica莽茫o. Imune aos efeitos negativos enquanto usa a habilidade. N茫o pode ser cancelada."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6650 
#define __CPPGEN_GNET_SKILL6650 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6650:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6650 }; 
        Skill6650 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6650Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
