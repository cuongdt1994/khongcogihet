...
/* 
62040  "Mo Rayin, Espada de Vento"62041  "EmpurrÃ£o em Linha Reta"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6204 
#define __CPPGEN_GNET_SKILL6204 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6204:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6204 }; 
        Skill6204 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6204Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6204Stub ():SkillStub (6204) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä«È»ÔÊ-¹Î·ç½£"; 
        nativename          = "Ä«È»ÔÊ-¹Î·ç½£"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
