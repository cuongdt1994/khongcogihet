...
/* 
11310  "Onda de Areia"11311  "^ffffffOnda de Areia (NÃ­vel %d)^ffcb4aAlcance: ^96f5ff%.1f^ffffff^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuraÃ§Ã£o: ^ffffff1.6^ffcb4a segundos^ffcb4aDuraÃ§Ã£o: ^ffffff1.4^ffcb4a segundos^ffcb4aEspera: ^ffffff15.0^ffcb4a segundos^ffcb4aVitalidade: ^ffffff15^ffcb4aRestriÃ§Ãµes de Arma: ^ffffffOrbe^ffcb4aCultivo necessÃ¡rio: ^ffffffLÃºcidoUsa poder mÃ¡gica para formar uma onda de areia, em ^96f5ff15^ffffff segundos causando no alvo base de dano mÃ¡gico mais ^96f5ff%d%%^ffffff de dano da armae ^96f5ff%.1f^ffffff de dano de terra contÃ­nuo."*/ 
