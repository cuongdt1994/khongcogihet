...
/* 
53380  "Derrubada de Alvo Circular do Chungyun"53381  "Derrubada de Alvo Circular do Chungyun"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5338 
#define __CPPGEN_GNET_SKILL5338 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5338:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5338 }; 
        Skill5338 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5338Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
