...
/* 
35200  "ΨFlecha Sangrenta"35201  "^ff5c00ΨFlecha Sangrenta
...
^ff0000Nível 1 a 4: Reduz o HP máximo do alvo em ^96f5ff24%%^ff0000.
^ff0000Nível 5 a 7: Reduz o HP máximo do alvo em ^96f5ff26%%^ff0000.
^ff0000Nível 8 a 9: Reduz o HP máximo do alvo em ^96f5ff28%%^ff0000.
^ff0000Nível 10: Reduz o HP máximo do alvo em ^96f5ff30%%^ff0000.@1@2
Reduz o HP máximo do alvo em ^96f5ff%d%%^ff0000.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
           float _glyph_value = get_glyph(skill->GetLevel (), 0.24, 0.26, 0.28, 0.3);
