...
/* 
56190  "AceleraÃ§Ã£o do VeÃ­culo do DragÃ£o do Reino do Norte"56191  "^8080ffAcelerar^ffcb4aCanalizaÃ§Ã£o ^ffffff0,5 ^ffcb4asegundo^ffcb4aConjuraÃ§Ã£o ^ffffff0,5 ^ffcb4asegundo^ffcb4aEspera ^ffffff60,0 ^ffcb4asegundos^ffffffAumenta a velocidade em ^96f5ff50%%^ffffff."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5619 
#define __CPPGEN_GNET_SKILL5619 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5619:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5619 }; 
        Skill5619 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5619Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5619Stub ():SkillStub (5619) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±Â½ÁúÔØ¾ß¼ÓËÙ"; 
        nativename          = "±±Â½ÁúÔØ¾ß¼ÓËÙ"; 
        icon                = "Î×Ê¦¼ÓËÙ.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
