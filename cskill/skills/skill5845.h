...
/* 
58450  "Mestre Espadachim - Morte Instant√¢nea 2"58451  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5845 
#define __CPPGEN_GNET_SKILL5845 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5845:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5845 }; 
        Skill5845 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5845Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5845Stub ():SkillStub (5845) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ω£ •-Ω£æ˜√Î»À2"; 
        nativename          = "Ω£ •-Ω£æ˜√Î»À2"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
