...
/* 
70060  "ΨPresença do Tigre"70061  "^ff5c00ΨPresença do Tigre
...
^00ffffNível 1 a 4: Gera ^ffffff25^00ffff de Chi.
^00ffffNível 5 a 7: Gera ^ffffff30^00ffff de Chi.
^00ffffNível 8 a 9: Gera ^ffffff35^00ffff de Chi.
^00ffffNível 10: Gera ^ffffff40^00ffff de Chi.@1@2
^00ffffGera ^ffffff%d^00ffff de Chi.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7006 
#define __CPPGEN_GNET_SKILL7006 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7006:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7006 }; 
        Skill7006 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7006Stub:public SkillStub 
    { 
    public: 
