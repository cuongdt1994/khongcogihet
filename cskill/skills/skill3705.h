...
/* 
37050  "ΨIra do Dragão da Água"37051  "^ff5c00ΨIra do Dragão da Água
...
^00ffffNível 1 a 4: Restaura ^ffffff64 de Chi
^00ffffNível 5 a 7: Recupera ^ffffff76 de Chi
^00ffffNível 8 a 9:Recupera ^ffffff88 de Chi
^00ffffNível 10: Recupera ^ffffff100 de Chi@1@2
^00ffffRecupera ^ffffff%d de Chi@2"*/ 
...
bool BlessMe (Skill * skill) const
    {      
		...
		int _glyph_value = get_glyph(skill->GetLevel (), 24, 36, 48, 60);
