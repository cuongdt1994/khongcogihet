...
/* 
61670  "Espada sombria Mo Rayin (esgotada)"61671  "Alvo Ãºnico, empurrÃ£o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6167 
#define __CPPGEN_GNET_SKILL6167 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6167:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6167 }; 
        Skill6167 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6167Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6167Stub ():SkillStub (6167) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ä«È»ÔÊ-·ÖÉí½£(·ÏÆú£©"; 
        nativename          = "Ä«È»ÔÊ-·ÖÉí½£(·ÏÆú£©"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
