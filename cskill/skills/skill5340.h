...
/* 
53400  "Carga de Alvo Circular do Chungyun"53401  "Carga de Alvo Circular do Chungyun"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5340 
#define __CPPGEN_GNET_SKILL5340 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5340:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5340 }; 
        Skill5340 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5340Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
