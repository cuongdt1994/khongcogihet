...
/* 
68000  "Efeito de Aura de Invoca莽茫o Tao铆sta"68001  "Invoca Servos 71950"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6800 
#define __CPPGEN_GNET_SKILL6800 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6800:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6800 }; 
        Skill6800 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6800Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6800Stub ():SkillStub (6800) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-召唤光环效果"; 
        nativename          = "道家-召唤光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
