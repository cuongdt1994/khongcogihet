...
/* 
10420  "Roubo de Energia"10421  "^ffffffRoubo de Energia (N铆vel %d)^ffcb4Alcance: ^ffffff15 metros^ffcb4aCusto de SP: ^96f5ff%d^ffffff^ffcb4aCusto de EP: ^96f5ff300^ffffff^ffcb4aInstant芒neo^ffcb4aEspera: ^ffffff1 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasTira %d de Chi do alvo para uso pr贸prio,deixando alvo nervoso, aumentando 30 pontos de Chi cada 3s durante 30s.S贸 pode ser usada contra inimigo.^72fe00Agi: Cada 2 pontos aumenta 1 ponto de Chi ganho."*/ 
