...
#ifndef __CPPGEN_GNET_SKILL6461 
#define __CPPGEN_GNET_SKILL6461 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6461:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6461 }; 
        Skill6461 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6461Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6461Stub ():SkillStub (6461) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021暖春活动赛艇减速10秒 "; 
        nativename          = "2021暖春活动赛艇减速10秒 "; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
