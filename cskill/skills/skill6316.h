...
/* 
63160  "Continente Ocidental-Jato Congelante"63161  "Continente Ocidental-Jato Congelante"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6316 
#define __CPPGEN_GNET_SKILL6316 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6316:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6316 }; 
        Skill6316 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6316Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6316Stub ():SkillStub (6316) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Î÷Â½-±ùËªÉ¢Éä"; 
        nativename          = "Î÷Â½-±ùËªÉ¢Éä"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
