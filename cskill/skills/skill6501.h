...
/* 
65010  "Travessia Planar"65011  "^ffffffTravessia Planar              
...
Ruja seu grito de guerra! Causa ^96f5ff170%%^ffffff de dano físico
básico mais ^96f5ff%d^ffffff aos inimigos em uma área em formato de cone, os arremessando para trás. 
Se você tiver o bônus da Marca de Ying ou Yang, seu golpe irá 
atordoar os inimigos dentro da área em cone por ^96f5ff5^ffffff segundo.
...
#ifndef __CPPGEN_GNET_SKILL6501 
#define __CPPGEN_GNET_SKILL6501 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6501:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6501 }; 
        Skill6501 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6501Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
