...
/* 
59960  "Lobo do TrovÃ£o - Anel em Cone "59961  "AdE de Retirar Anel, nÃ­vel Ã© o tamanho do anel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5996 
#define __CPPGEN_GNET_SKILL5996 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5996:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5996 }; 
        Skill5996 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5996Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5996Stub ():SkillStub (5996) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"À×ÀÇ-»·ÉÈÐÎ"; 
        nativename          = "À×ÀÇ-»·ÉÈÐÎ"; 
        icon                = ""; 
#endif 
        max_level           = 25; 
        type                = 1; 
