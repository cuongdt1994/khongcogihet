...
#ifndef __CPPGEN_GNET_SKILL7023 
#define __CPPGEN_GNET_SKILL7023 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7023:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7023 }; 
        Skill7023 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7023Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
