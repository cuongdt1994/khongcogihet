...
{ 
    ...
    { 
        static int aarray[10] = { 69000,68000,67000,66000,65000,64000,63000,62000,61000,60000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    int GetRequiredSp (Skill * skill) const 
    { 
        static int aarray[10] = { 40,840,2800,6440,12800,24080,44400,86000,234400,560800 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static int aarray[10] = { 11525,0,0,0,0,0,0,0,0,0 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
