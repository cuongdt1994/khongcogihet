...
/* 
55220  "Acumular Veneno BoS"55221  "Acumula veneno para o alvo. Acumule 5 camadas para causar dano massivo."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5522 
#define __CPPGEN_GNET_SKILL5522 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5522:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5522 }; 
        Skill5522 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5522Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
