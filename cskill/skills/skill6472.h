...
/* 
64720  "Intensidade Metam贸rfica"64721  "^ffffffIntensidade Metam贸rfica             N铆vel %d  ^ffcb4aHabilidades Passivas^ffcb4aCultivo Necess谩rio ^ffffffAstuto^ffffffAo mudar de forma, aumenta dano f铆sico em mais ^96f5ff%d%%^ffffff do dano de arma."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 2100,2800,4500,5200,7500,10600,14700,20200,27600,38800 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
