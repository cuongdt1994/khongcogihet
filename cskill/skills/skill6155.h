...
#ifndef __CPPGEN_GNET_SKILL6155 
#define __CPPGEN_GNET_SKILL6155 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6155:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6155 }; 
        Skill6155 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6155Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6155Stub ():SkillStub (6155) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"°ÙÀï·â½®-Ëé¿Õ¼ä"; 
        nativename          = "°ÙÀï·â½®-Ëé¿Õ¼ä"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 200; 
        type                = 2; 
