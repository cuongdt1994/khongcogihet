...
/* 
55870  "Amu. de SaÃºde BÃ¡sico de Mascote"55871  "Amuleto de SaÃºde BÃ¡sico de Mascote que nÃ£o serÃ¡ afetado por curaHabilidade ocupada pelo processo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5587 
#define __CPPGEN_GNET_SKILL5587 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5587:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5587 }; 
        Skill5587 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5587Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5587Stub ():SkillStub (5587) 
    { 
        cls                 = 255; 
#ifdef _SKILL_CLIENT 
        name                = L"³èÎïÍ¨ÓÃºì·û"; 
        nativename          = "³èÎïÍ¨ÓÃºì·û"; 
        icon                = ""; 
#endif 
        max_level           = 1; 
        type                = 10; 
