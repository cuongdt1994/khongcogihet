...
/* 
30590  "Dano de Madeira da Dama Desregrada"30591  "Ataque de Madeira"*/ 
...
{ 
    ...
    { 
        ...
        {      
			...
			skill->GetVictim ()->SetTime (skill->GetLevel () == 1 ? 1000 : 36000);
			skill->GetVictim ()->SetRatio (2);
			skill->GetVictim ()->SetAmount (skill->GetLevel () == 1 ? 1 : 
                                            skill->GetPlayer ()->GetMaxhp () * (skill->GetLevel () * 0.6));
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetToxic3 (1);
