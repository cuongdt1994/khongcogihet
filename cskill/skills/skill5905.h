...
/* 
59050  "Colosso - Efeito de Aura de Morte InstantÃ¢nea"59051  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5905 
#define __CPPGEN_GNET_SKILL5905 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5905:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5905 }; 
        Skill5905 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5905Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5905Stub ():SkillStub (5905) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÞÏñ-ÃëÉ±Ð§¹û"; 
        nativename          = "¾ÞÏñ-ÃëÉ±Ð§¹û"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
