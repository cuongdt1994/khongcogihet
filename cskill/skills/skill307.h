...
/* 
3070  "Vigor"3071  "^ffffffVigor (N铆vel %d)^ffcb4aConjura莽茫o: ^ffffff2,0 ^ffcb4asegundos^ffcb4aDura莽茫o: ^ffffff1,0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff300,0 ^ffcb4asegundos^ffcb4aRestri莽玫es da Arma: ^ffffffInstrumento M铆stico, Desarmado^ffcb4aCultivo necess谩rio: ^ffffffHarmoniosoRecupera ^96f5ff%d%%^ffffff do HP m谩ximo quando lan莽ado."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 4600,6950,10000,14050,19450,26600,36200,49150,66500,90500 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
