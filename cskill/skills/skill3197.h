...
/* 
31970  "ΩDragão Repentino"31971  "^ffff00ΩDragão Repentino
...
de longe e causar dano físico básico, mais ^96f5ff6747^ffffff.
Tem uma chance de ^96f5ff66%%^ffffff de imobilizar o alvo por ^96f5ff3^ffffff segundos.
O Alcance: é aumentado pelo ^96f5ffdobro^ffffff do Alcance: da arma.

^d618e7A versão Demônio aumenta o Alcance: em ^96f5ff2^d618e7 metros."*/ 
...
{ 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(383, 1)); 
    ...
    { 
        static int aarray[10] = { 49899,49899,49899,49899,49899,49899,49899,49899,49899,49899 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {
            return (float) (10 + (skill->GetPlayer ()->GetCurweaponRange () * 2) + 2);
        }
    ...
    { 
        ...
        {
            return (float) (10 + (skill->GetPlayer ()->GetCurweaponRange () * 2) + 2 + 8);
        }
#endif 
#ifdef _SKILL_SERVER 
