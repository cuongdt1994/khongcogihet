...
/* 
59230  "General - Longa Linha Reta de Duelo"59231  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5923 
#define __CPPGEN_GNET_SKILL5923 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5923:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5923 }; 
        Skill5923 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5923Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5923Stub ():SkillStub (5923) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-决斗-长直线"; 
        nativename          = "将军-决斗-长直线"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
