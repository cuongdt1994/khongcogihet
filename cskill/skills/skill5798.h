...
/* 
57980  "Nevasca e Chuva de Fogo do Chefe de Batalha da AssociaÃ§Ã£o"57981  "level=1 Nevascalevel=2 Chuva de Fogo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5798 
#define __CPPGEN_GNET_SKILL5798 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5798:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5798 }; 
        Skill5798 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5798Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5798Stub ():SkillStub (5798) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÕóÓªÕ½BOSS±©·çÑ©»ðÓê"; 
        nativename          = "ÕóÓªÕ½BOSS±©·çÑ©»ðÓê"; 
        icon                = "±±Â½»ðÓê.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
