...
/* 
67520  "Cura da 脕rvore da Inst芒ncia Vermelha 2021"67521  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6752 
#define __CPPGEN_GNET_SKILL6752 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6752:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6752 }; 
        Skill6752 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6752Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6752Stub ():SkillStub (6752) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021小红本推水果_树回血"; 
        nativename          = "2021小红本推水果_树回血"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
