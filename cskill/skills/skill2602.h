...
/* 
26020  "Reflexo da Chama do ParaÃ­so"26021  "^ffffffReflexo da Chama do ParaÃ­so^ffcb4aAlcance: ^ffffff8 ^ffcb4a metros^ffcb4aCanalizaÃ§Ã£o: ^ffffff0.1 ^ffcb4asegundos^ffcb4aConjuraÃ§Ã£o: ^ffffff1.0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff60.0 ^ffcb4asegundos^ffcb4aArma: ^ffffffSabreReflexo lunar de uma habilidade de Guerreiro.Evoca um dragÃ£o terrÃ­vel para atacar todos os inimigos a atÃ© ^96f5ff12^ffffff do seu oponente, causando dano fÃ­sico bÃ¡sico mais ^96f5ff80%%^ffffff do dano de arma e mais ^96f5ff%.1f^ffffff. Aumenta o dano que eles recebem nos prÃ³ximos ^96f5ff6^ffffff segundos em ^96f5ff75%%^ffffff.^a6caf0Custa ^ffffff2^a6caf0 Chi."*/ 
...
{ 
    ...
    { 
        cls                 = 10; 
#ifdef _SKILL_CLIENT 
        name                = L"Ë®ÔÂ¾µ»¨¡¤Ìì»ð¿ñÁú"; 
        nativename          = "Ë®ÔÂ¾µ»¨¡¤Ìì»ð¿ñÁú"; 
        icon                = "Ìì»ð¿ñÁú.dds"; 
#endif 
        max_level           = 1; 
        type                = 1; 
