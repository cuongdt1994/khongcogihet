...
^ffeaabNível 1 a 4: Enquanto você estiver na Forma Sombria, tem ^96f5ff40%% de chance de ativar uma segunda Supercélula.
^ffeaabNível 5 a 7: Enquanto você estiver na Forma Sombria, tem ^96f5ff60%% de chance de ativar uma segunda Supercélula.
^ffeaabNível 8 a 9: Enquanto você estiver na Forma Sombria, tem ^96f5ff80%% de chance de ativar uma segunda Supercélula.
^ffeaabNível 10: Enquanto você estiver na Forma Sombria, tem ^96f5ff100%% de chance de ativar uma segunda Supercélula.@1@2
^ffeaabEnquanto você estiver na Forma Sombria, tem ^96f5ff%d%% de chance de ativar uma segunda Supercélula.@2"
*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetT0 () == 15 ? 100 : 0);
