...
/* 
44130  "ΨTsunami de Chamas"44131  "^ff5c00ΨTsunami de Chamas   
...
Causa dano a todos os oponentes em uma linha de ^96f5ff12^ffffff metros. Dano físico básico, mais 
...
Arma de Haste: O alcance é aumentado para ^96f5ff20^ffffff metros. Causa dano a Oponente numa linha de ^96f5ff22^ffffff metros.
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->GetPlayer ()->SetDecmp (0);
                skill->SetPlus (7200);
                skill->SetRatio (_glyph_value + 2 + skill->GetPlayer ()->GetCurWeapon () == 1 ? 2 : 0);
