...
/* 
63360  "Î¦/Î© SacrifÃ­cio de SalvaÃ§Ã£o"63361  "+ RecuperaÃ§Ã£o + Escudo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6336 
#define __CPPGEN_GNET_SKILL6336 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6336:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6336 }; 
        Skill6336 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6336Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6336Stub ():SkillStub (6336) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ðþ»Ä°æÁðÁ§ÎþÉü"; 
        nativename          = "Ðþ»Ä°æÁðÁ§ÎþÉü"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 4; 
