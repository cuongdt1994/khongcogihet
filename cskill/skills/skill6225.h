...
#ifndef __CPPGEN_GNET_SKILL6225 
#define __CPPGEN_GNET_SKILL6225 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6225:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6225 }; 
        Skill6225 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6225Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6225Stub ():SkillStub (6225) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"周年庆鲤鱼变身技能"; 
        nativename          = "周年庆鲤鱼变身技能"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 4; 
