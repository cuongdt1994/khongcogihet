...
/* 
62810  "Nova 螖Invoca莽茫o Suprema Aumentar Dano"62811  "Autodestruir ao morrer"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6281 
#define __CPPGEN_GNET_SKILL6281 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6281:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6281 }; 
        Skill6281 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6281Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
