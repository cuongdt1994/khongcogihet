...
/* 
60800  "Chakra Sombrio"60801  "^ffffffChakra Sombrio                        NÃ­vel %d^ffcb4aHabilidade Passiva   ^ffffffPerder HP o tornarÃ¡ nervoso. Para cada ponto de^96f5ff%d^ffffff HPperdido, o Ataque aumenta em ^96f5ff%d^ffffff."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6080 
#define __CPPGEN_GNET_SKILL6080 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6080:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6080 }; 
        Skill6080 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6080Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6080Stub ():SkillStub (6080) 
    { 
        cls                 = 262; 
#ifdef _SKILL_CLIENT 
        name                = L"¾ÅÀèÂöÂÖ"; 
        nativename          = "¾ÅÀèÂöÂÖ"; 
        icon                = "º¢×Ó¾ÅÀèÂöÂÖ.dds"; 
#endif 
        max_level           = 4; 
        type                = 5; 
        allow_ride          = 0; 
