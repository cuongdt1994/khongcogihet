...
/* 
11390  "Brisa da Maré"11391  "^ffffffBrisa da Maré (Nível %d)

^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff
^ffcb4aConjuração: ^ffffffInstantâneo
^ffcb4aEspera: ^ffffff60.0 ^ffcb4asegundos
^ffcb4aRestrições de Arma: ^ffffffAdaga

^ffcb4aCultivo necessário: ^ffffffAstuto
Recebe a brisa da maré, aumentando a vel. do movimento em ^96f5ff%d%%^ffffff, 
durante 15 segundos."*/ 
