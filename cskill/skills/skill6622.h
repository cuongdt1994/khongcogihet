...
/* 
66220  "ΨUnião Cósmica"66221  "^ff5c00ΨUnião Cósmica              
...
A até ^96f5ff8^ffffff metros. Esbofeteie furiosamente quatro vezes! Causa ^96f5ff380%%^ffffff de dano físico 
básico mais ^96f5ff12891^ffffff aos inimigos
Se você possuir a Marca de Yin ou a Marca de Yang, seu primeiro ataque 
...
#ifndef __CPPGEN_GNET_SKILL6622 
#define __CPPGEN_GNET_SKILL6622 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6622:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6622 }; 
        Skill6622 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6622Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 70223,70223,70223,70223,70223,70223,70223,70223,70223,70223 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
