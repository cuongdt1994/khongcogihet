...
/* 
66300  "ΨTravessia Planar"66301  "^ff5c00ΨTravessia Planar              
...
^f7dfa5Esse ataque tem a garantia de acertar.

^00ff00Efeito da Runa Verdejante:@1
^00ff00Nível 1 a 4: Espera reduzida para ^96f5ff27^00ff00 segundos
^00ff00Nível 5 a 7: Espera reduzida para ^96f5ff23^00ff00 segundos
^00ff00Nível 8 a 9: Espera reduzida para ^96f5ff19^00ff00 segundos 
^00ff00Nível 10: Espera reduzida para ^96f5ff15^00ff00 segundos@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        int _glyph_value = get_glyph((skill->GetLevel ()), 27000, 23000, 19000, 15000);
        return _glyph_value;
    } 
