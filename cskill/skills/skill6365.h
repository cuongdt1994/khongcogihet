...
#ifndef __CPPGEN_GNET_SKILL6365 
#define __CPPGEN_GNET_SKILL6365 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6365:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6365 }; 
        Skill6365 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6365Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6365Stub ():SkillStub (6365) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"酒仙-僵僵兽兽打击技能效果"; 
        nativename          = "酒仙-僵僵兽兽打击技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
