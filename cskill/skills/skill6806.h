...
/* 
68060  "Efeito de Aura Tao铆sta 6805"68061  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6806 
#define __CPPGEN_GNET_SKILL6806 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6806:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6806 }; 
        Skill6806 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6806Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6806Stub ():SkillStub (6806) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-6805光环效果"; 
        nativename          = "道家-6805光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
