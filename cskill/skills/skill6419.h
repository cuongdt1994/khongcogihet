...
/* 
64190  "Mestre Cervejeiro-Destruir Raio da Morte"64191  "Sif√£o de Drag√£oVers√£o Alterada"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6419 
#define __CPPGEN_GNET_SKILL6419 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6419:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6419 }; 
        Skill6419 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6419Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6419Stub ():SkillStub (6419) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æ∆œ…-∆∆ªµÀ¿π‚"; 
        nativename          = "æ∆œ…-∆∆ªµÀ¿π‚"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 11; 
