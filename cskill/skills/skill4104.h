...
/* 
41040  "ΨOde Perene"41041  "^ff5c00ΨOde Perene
...
^ff0000Nível 1 a 4: Reduz o Chi em ^96f5ff20^ff0000.
^ff0000Nível 5 a 7: Reduz o Chi em ^96f5ff25^ff0000.
^ff0000Nível 8 a 9: Reduz o Chi em ^96f5ff30^ff0000.
^ff0000Nível 10: Reduz o Chi em ^96f5ff35^ff0000.@1@2
Reduz o Chi em ^96f5ff%d^ff0000.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
			int _glyph_value = get_glyph(skill->GetLevel (), 20, 25, 30, 35);
