...
/* 
37910  "ΨCortador de Feitiços"37911  "^ff5c00ΨCortador de Feitiços
...
^ff0000Nível 1 a 4: Gera ^96f5ff15^ff0000 de Chi.
^ff0000Nível 5 a 7: Gera ^96f5ff20^ff0000 de Chi.
^ff0000Nível 8 a 9: Gera ^96f5ff25^ff0000 de Chi.
^ff0000Nível 10: Gera ^96f5ff30^ff0000 de Chi.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    {            
		float _glyph_value = get_glyph((skill->GetLevel ()), 5, 10, 15, 20);
