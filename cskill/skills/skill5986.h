...
/* 
59860  "Poder Um: Morte Instant芒nea - Efeito de Habilidade"59861  "Poder Um: Morte Instant芒nea - Efeito de Habilidade"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5986 
#define __CPPGEN_GNET_SKILL5986 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5986:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5986 }; 
        Skill5986 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5986Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5986Stub ():SkillStub (5986) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"真武【秒杀】-技能效果"; 
        nativename          = "真武【秒杀】-技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 1; 
        type                = 3; 
