...
/* 
67680  "Efeito de Aura Tao铆sta"67681  "O efeito 茅 uma morte Instant芒nea em 100 metros"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6768 
#define __CPPGEN_GNET_SKILL6768 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6768:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6768 }; 
        Skill6768 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6768Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
