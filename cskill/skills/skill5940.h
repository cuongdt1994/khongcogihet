...
/* 
59400  "General - Efeito Pux茫o em Massa"59401  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5940 
#define __CPPGEN_GNET_SKILL5940 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5940:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5940 }; 
        Skill5940 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5940Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5940Stub ():SkillStub (5940) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-群体拉人效果"; 
        nativename          = "将军-群体拉人效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 12; 
