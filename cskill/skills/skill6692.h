...
/* 
66920  "Furtividade Principal da Atiradora"66921  "N铆vel 1 0,5 segundoN铆vel 2-10 3 min*Nv"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6692 
#define __CPPGEN_GNET_SKILL6692 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6692:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6692 }; 
        Skill6692 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6692Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
