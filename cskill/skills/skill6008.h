...
/* 
60080  "Dan莽arina_Aura da Flor do Al茅m Vermelha"60081  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6008 
#define __CPPGEN_GNET_SKILL6008 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6008:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6008 }; 
        Skill6008 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6008Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6008Stub ():SkillStub (6008) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"舞女_红彼岸花光环"; 
        nativename          = "舞女_红彼岸花光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 2; 
