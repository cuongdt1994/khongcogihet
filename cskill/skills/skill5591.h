...
#ifndef __CPPGEN_GNET_SKILL5591 
#define __CPPGEN_GNET_SKILL5591 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5591:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5591 }; 
        Skill5591 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5591Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5591Stub ():SkillStub (5591) 
    { 
        cls                 = 8; 
#ifdef _SKILL_CLIENT 
        name                = L"¡¾Éñ¡¤ÏèÁú½£¾¢£¨ÂÌÒ¶£©¡¿´¥·¢¾Å×ð×¨ÓÃÐ§¹û"; 
        nativename          = "¡¾Éñ¡¤ÏèÁú½£¾¢£¨ÂÌÒ¶£©¡¿´¥·¢¾Å×ð×¨ÓÃÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
