...
/* 
62190  "ProjÃ©til LÃ­quido"62191  "^ffcb4aProjÃ©til LÃ­quido^ffcb4aAlcance ^ffffff40^ffffff ^ffcb4ametros^ffcb4aCanalizaÃ§Ã£o ^ffffffInstantÃ¢nea^ffcb4aEspera ^ffffff3 ^ffcb4asegundos^ffffffAtÃ© um pequeno peixe pode ser muito difÃ­cil de enfrentar! Mira na Serpente Topo das Nuvens, causando ^96f5ff10000^ffffff de dano."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6219 
#define __CPPGEN_GNET_SKILL6219 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6219:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6219 }; 
        Skill6219 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6219Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6219Stub ():SkillStub (6219) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Óã¶ùÇåË®µ¯"; 
        nativename          = "Óã¶ùÇåË®µ¯"; 
        icon                = "òÑË®Òý.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
