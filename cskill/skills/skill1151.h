...
/* 
11510  "Ar Rarefeito"11511  "^ffffffAr Rarefeito (NÃ­vel %d)^ffcb4aAlcance:^96f5ff%.1f^ffffff^ffcb4a metros^ffcb4aCusto em MP: ^96f5ff%d^ffffff^ffcb4aConjuraÃ§Ã£o: ^ffffff0.2^ffcb4a segundos^ffcb4aDuraÃ§Ã£o: ^ffffff0.8^ffcb4a segundos^ffcb4aEspera: ^ffffff3.0^ffcb4a segundos^ffcb4aVitalidade: ^ffffff5^ffcb4aRestriÃ§Ãµes de Arma: ^ffffffOrbe, Desarmado^ffcb4aCultivo necessÃ¡rio: ^ffffffAstutoUsa poder mÃ¡gico para queimar todo ar ao redor do alvo, sufocando o alvo e causando ^96f5ff%d%%^ffffff de dano da armamais ^96f5ff%.1f^ffffff de dano de Ã¡gua.Durante ^96f5ff15^ffffff segundos, causando ^96f5ff%.1f^ffffff de dano fÃ­sico e desacelerar em ^96f5ff%.1f^ffffff seg. a velocidade do alvo em^96f5ff50%%^ffffff.Somente disponÃ­vel no modo transformado."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 3800,7000,12000,18000,26000,37000,51000,70000,96000,130000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
