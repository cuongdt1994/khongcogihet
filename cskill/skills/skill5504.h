...
/* 
55040  "Teleporte para Sair de combate do Pr铆ncipe Chongming"55041  "Mate o Chefe e Teleporte de Volta 脿 Plataforma Central"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5504 
#define __CPPGEN_GNET_SKILL5504 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5504:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5504 }; 
        Skill5504 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5504Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5504Stub ():SkillStub (5504) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"苍仲明脱战传送效果"; 
        nativename          = "苍仲明脱战传送效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
