...
/* 
37660  "ΨDevastar"37661  "^ff5c00ΨDevastar
...
Amaldiçoe o alvo com esquecimento, reduzindo significativamente seu
Chi. Se o alvo tiver menos Chi do que a maldição remove, então
cada ^96f5ff1^ffffff ponto em excesso de Chi irá causar dano igual
a ^96f5ff1%%^ffffff do HP máximo seu ou do alvo,
qual for menor. Não afeta alvos não jogadores.

^a6caf0Se o inimigo já estiver amaldiçoado, a maldição anterior será removida.

^ff0000Efeito da Runa Escarlate:@1
^ff0000Nível 1 a 4: Reduz o Chi em ^96f5ff40^ff0000.
^ff0000Nível 5 a 7: Reduz o Chi em ^96f5ff60^ff0000.
^ff0000Nível 8 a 9: Reduz o Chi em ^96f5ff80^ff0000.
^ff0000Nível 10: Reduz o Chi em ^96f5ff100^ff0000.@1@2
^ff0000Reduz o Chi em ^96f5ff%d^ff0000.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetValue (skill->GetTarget ()->GetCls () != -1 || skill->GetTarget ()->GetCls () != 127 ? (skill->GetPlayer ()->GetAp () < _glyph_value ? (target_max_hp < performer_max_hp ? target_max_hp : performer_max_hp) * _ratio_glyph : 1) : 1);
