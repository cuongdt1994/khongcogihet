...
/* 
60920  "Cidade Glacial: Paralisar Alvo Ãºnico de Elite"60921  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6092 
#define __CPPGEN_GNET_SKILL6092 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6092:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6092 }; 
        Skill6092 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6092Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6092Stub ():SkillStub (6092) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ðþ±ù³Ç¾«Ó¢µ¥ÌåÑ£ÔÎ"; 
        nativename          = "Ðþ±ù³Ç¾«Ó¢µ¥ÌåÑ£ÔÎ"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
