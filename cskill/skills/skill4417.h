...
/* 
44170  "ΨTsunami de Chamas"44171  "^ff5c00ΨTsunami de Chamas   
...
Causa um dano de arma adicional de ^96f5ff200%%^ffffff e mais ^96f5ff7200^ffffff.
Nunca erra.

Tipos diferentes de armas causam efeitos diferentes.
Machado e Martelo: Atordoa o alvo por ^96f5ff5^ffffff segundos.
Arma de Haste: O alcance é aumentado para ^96f5ff20^ffffff metros. Causa dano a alvos numa linha de ^96f5ff22^ffffff metros.
...
^ffeaabNível 1 a 4: Ao usar Lâminas e Espadas, causará ^96f5ff110%%^ffeaab de dano de arma adicional
^ffeaabNível 5 a 7: Ao usar Lâminas e Espadas, causará ^96f5ff140%%^ffeaab de dano de arma adicional
^ffeaabNível 8 a 9: Ao usar Lâminas e Espadas, causará ^96f5ff170%%^ffeaab de dano de arma adicional
^ffeaab Nível 10: Ao usar Lâminas e Espadas, causará ^96f5ff200%%^ffeaab de dano de arma adicional
@1@2
^ffeaabAo usar Lâminas e Espadas, causará ^96f5ff%d%%^ffeaab de dano de arma adicional
@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 1.1, 1.4, 1.7, 2);

                skill->GetPlayer ()->SetDecmp (0);
                skill->SetPlus (7200);
                skill->SetRatio (2 + skill->GetPlayer ()->GetCurWeapon () == 1 ? (2 + _glyph_value) : 0);
