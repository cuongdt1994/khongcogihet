...
/* 
70140  "Dreangem de Chi Tao铆sta"70141  "O Chefe absorve 2 Chi do jogador. Deduz 1% do HP M谩ximo a cada 2 perdas de Chi"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL7014 
#define __CPPGEN_GNET_SKILL7014 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill7014:public Skill 
    { 
    public: 
        enum { SKILL_ID = 7014 }; 
        Skill7014 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill7014Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
