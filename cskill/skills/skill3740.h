...
/* 
37400  "ΨPraga dos Gafanhotos"37401  "^ff5c00ΨPraga dos Gafanhotos
...
^00ff00Nível 1 a 4: Alvos enlouquecidos recebem ^96f5ff35%% ^00ff00de dano adicional.
^00ff00Nível 5 a 7: Alvos enlouquecidos recebem ^96f5ff40%% ^00ff00de dano adicional.
^00ff00Nível 8 a 9: Alvos enlouquecidos recebem ^96f5ff45%% ^00ff00de dano adicional.
^00ff00Nível 10: Alvos enlouquecidos recebem ^96f5ff50%% ^00ff00de dano adicional.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {            			
            ...
            skill->GetVictim ()->SetTime (9000);
            skill->GetVictim ()->SetRatio (0.3 + _glyph_value);
