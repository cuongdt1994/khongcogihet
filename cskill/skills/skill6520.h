...
/* 
65200  "●Vento Ascendente"65201  "^8080ff●Vento Ascendente              
...
Gire sua clava para cima, causando dano de ataque básico mais 
^96f5ff%d^ffffff de dano físico ao alvo, reduzindo a defesa física em 
^96f5ff60%%^ffffff do valor do equipamento por ^96f5ff10^ffffff segundos.
Causa Marca do Fogo. A marca dura ^96f5ff15^ffffff segundos.

^a6caf0A Marca só faz efeito em jogadores.

^f7dfa5A habilidade possui uma chance de ^96f5ff%d%%^f7dfa5 de regenerar 100 Chi."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6520 
#define __CPPGEN_GNET_SKILL6520 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6520:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6520 }; 
        Skill6520 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6520Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
