...
/* 
61150  "General - Ignorar Dano M谩ximo "61151  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6115 
#define __CPPGEN_GNET_SKILL6115 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6115:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6115 }; 
        Skill6115 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6115Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6115Stub ():SkillStub (6115) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"通用-无视上限伤害"; 
        nativename          = "通用-无视上限伤害"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 12; 
