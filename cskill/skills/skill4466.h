...
/* 
44660  "ΨPresa das Sombras"44661  "^ff5c00 ΨPresa das Sombras  
 ...
 ^ffffff50%%^00ffff probabilidade de acionar 'Fantasmas', aumentando o dano
 ^00ffffNv. 1-4: Adiciona ^ffffff40%%^00ffff dano do ataque das armas
 ^00ffffNv. 5-7: Adiciona ^ffffff60%%^00ffff dano do ataque das armas
 ^00ffffNv. 8-9: Adiciona ^ffffff80%%^00ffff dano do ataque das armas
 ^00ffffNv. 10: Adiciona ^ffffff100%%^00ffff dano do ataque das armas@1@2
 ^ffffff50%%^00ffff probabilidade de acionar 'Fantasmas', adiciona ^ffffff%d%%^00ffff dano do ataque das armas. @2
"*/ 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetSection (1);
                skill->SetPlus (13880);
                skill->SetRatio (4.5 + (skill->GetRand() > 50 ? _glyph_value : 0));
