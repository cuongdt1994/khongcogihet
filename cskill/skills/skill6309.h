...
#ifndef __CPPGEN_GNET_SKILL6309 
#define __CPPGEN_GNET_SKILL6309 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6309:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6309 }; 
        Skill6309 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6309Stub:public SkillStub 
    { 
    public: 
    Skill6309Stub ():SkillStub (6309) 
    { 
        cls                 = 7; 
#ifdef _SKILL_CLIENT 
        name                = L"·ÏÆú"; 
