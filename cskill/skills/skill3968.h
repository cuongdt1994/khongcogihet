...
/* 
39680  "ΨLâmina do Vento"39681  "^ff5c00ΨLâmina do Vento
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(2447, 1)); 
        pre_skills.push_back (std::pair < ID, int >(2448, 1)); 
    ...
    { 
        static int aarray[10] = { 53968,53968,53968,53968,53968,53968,53968,53968,53968,53968 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
