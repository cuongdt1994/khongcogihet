...
{ 
    ...
    { 
        static int aarray[10] = { 1000001,1000005,1000010,1000015,1000020,1000025,1000030,1000035,1000040,1000045 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
