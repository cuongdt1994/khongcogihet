...
/* 
56870  "Reino do Norte - Redu莽茫o do Ataque Corpo a Corpo Comum "56871  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5687 
#define __CPPGEN_GNET_SKILL5687 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5687:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5687 }; 
        Skill5687 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5687Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5687Stub ():SkillStub (5687) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"北陆-近战普攻减伤"; 
        nativename          = "北陆-近战普攻减伤"; 
        icon                = ""; 
#endif 
        max_level           = 20; 
        type                = 2; 
