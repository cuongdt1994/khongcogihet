...
#ifndef __CPPGEN_GNET_SKILL6998 
#define __CPPGEN_GNET_SKILL6998 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6998:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6998 }; 
        Skill6998 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6998Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6998Stub ():SkillStub (6998) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"²ÐÑªÁú³öÉú¿ÛÑª"; 
        nativename          = "²ÐÑªÁú³öÉú¿ÛÑª"; 
        icon                = "Á÷ÐÇ´¸.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
