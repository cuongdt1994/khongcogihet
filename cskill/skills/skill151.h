...
/* 
11510  "Ar Rarefeito"11511  "^ffffffAr Rarefeito (Nível %d)
...
^ffcb4aRestrições de Arma: ^ffffffOrbe, Desarmado

^ffcb4aCultivo necessário: ^ffffffAstuto
Usa poder mágico para queimar todo ar ao redor do alvo, sufocando o alvo 
e causando ^96f5ff%d%%^ffffff de dano da armamais ^96f5ff%.1f^ffffff de dano de água.
Durante ^96f5ff15^ffffff segundos, causando ^96f5ff%.1f^ffffff de dano físico
 e desacelerar em ^96f5ff%.1f^ffffff seg. a velocidade do alvo em^96f5ff50%%^ffffff.

Somente disponível no modo transformado."*/ 
