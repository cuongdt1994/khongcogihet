...
/* 
63300  "Continente Ocidental-Efeito Virtuoso"63301  "Mar de chamas lan莽ada por monstros de Mago."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6330 
#define __CPPGEN_GNET_SKILL6330 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6330:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6330 }; 
        Skill6330 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6330Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
