...
/* 
63220  "Continente Ocidental-Corte do Orgulho"63221  "Continente Ocidental-Corte do Orgulho"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6322 
#define __CPPGEN_GNET_SKILL6322 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6322:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6322 }; 
        Skill6322 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6322Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
