...
/* 
69890  "ΨMente Taoista"69891  "^ff5c00ΨMente Taoista
...
A duração é relacionada ao seu nível de Runa.

^00ffffEfeito da Runa Celeste:@1
^00ffffNível 1 a 4: Evita dano por ^ffffff6^00ffff segundos.
^00ffffNível 5 a 7: Evita dano por ^ffffff9^00ffff segundos.
^00ffffNível 8 a 9: Evita dano por ^ffffff12^00ffff segundos.
^00ffffNível 10: Evita dano por ^ffffff15^00ffff segundos.@1@2
Evita dano por ^ffffff%d^00ffff segundos.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6989 
#define __CPPGEN_GNET_SKILL6989 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6989:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6989 }; 
        Skill6989 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6989Stub:public SkillStub 
    { 
    public: 
