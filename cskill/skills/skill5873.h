...
/* 
58730  "Monstro do Espelho - Espelho_EsplosÃ£o de Chi em Chefe"58731  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5873 
#define __CPPGEN_GNET_SKILL5873 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5873:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5873 }; 
        Skill5873 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5873Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5873Stub ():SkillStub (5873) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾µÄ§-¾µ_boss±¬Ôª"; 
        nativename          = "¾µÄ§-¾µ_boss±¬Ôª"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
