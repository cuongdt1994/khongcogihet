...
/* 
67580  "DetecÃ§Ã£o Maomao Curativa"67581  "DÃª a mm um pacote de efeitos aceitÃ¡vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6758 
#define __CPPGEN_GNET_SKILL6758 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6758:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6758 }; 
        Skill6758 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6758Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6758Stub ():SkillStub (6758) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ò½¼Ò_Ã«Ã«¼ì²â"; 
        nativename          = "Ò½¼Ò_Ã«Ã«¼ì²â"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
