...
/* 
59550  "Borboleta - Corrente ElÃ©trica "59551  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5955 
#define __CPPGEN_GNET_SKILL5955 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5955:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5955 }; 
        Skill5955 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5955Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5955Stub ():SkillStub (5955) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÉÁµçÁ´"; 
        nativename          = "ºûµû-ÉÁµçÁ´"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "bossºûµû¹Ö_ÉÁµçÁ¬Ïß_»÷ÖÐ2.att"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
