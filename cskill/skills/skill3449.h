...
/* 
34490  "ΨBala de Gelo"34491  "^ff5c00ΨBala de Gelo  
...
de dano por arma e mais ^96f5ff5555^ffffff como dano por Água.
atordoa o alvo por ^96f5ff4^ffffff a ^96f5ff5^ffffff segundos, com base no
número de Cargas de Gelo. Gera uma Carga de Gelo.
...
^ffeaabNível 5 a 7: Enquanto você estiver na Forma Sombria, o dano é aumentado em ^96f5ff44,5%%.
...
^ffeaabEnquanto você estiver na Forma Sombria, o dano é aumentado em ^96f5ff%.1f%%.@2
"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 46352,46352,46352,46352,46352,46352,46352,46352,46352,46352 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
