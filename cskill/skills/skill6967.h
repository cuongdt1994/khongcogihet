...
/* 
69670  "ΨEscudo Zênite"
69671  "^ff5c00ΨEscudo Zênite
...
^ffeaabNível 1 a 4:A Taxa de Acerto Crítico aumenta para ^96f5ff12%%^ffffff
^ffeaabNível 5 a 7:A Taxa de Acerto Crítico aumenta para ^96f5ff13%%^ffffff
^ffeaabNível 8 a 9:A Taxa de Acerto Crítico aumenta para ^96f5ff14%%^ffffff
^ffeaabNível 10 :A Taxa de Acerto Crítico aumenta para ^96f5ff15%%^ffffff@1@2
^ffeaabA Taxa de Acerto Crítico aumenta para ^96f5ff%d%%^ffeaab@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6967 
#define __CPPGEN_GNET_SKILL6967 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6967:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6967 }; 
        Skill6967 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6967Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            float _glyph_value = get_glyph(skill->GetLevel (), 0.12, 0.13, 0.14, 0.15);
            ...
            skill->GetVictim ()->SetNewValue (_glyph_value); // Critical
