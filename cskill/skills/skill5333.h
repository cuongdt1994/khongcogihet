...
/* 
53330  "Invocar Monstro de Velocidade de Veraneio M/A"53331  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5333 
#define __CPPGEN_GNET_SKILL5333 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5333:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5333 }; 
        Skill5333 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5333Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5333Stub ():SkillStub (5333) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ê¦Í½ÏÄ¹ØÕÐ¹Ö"; 
        nativename          = "Ê¦Í½ÏÄ¹ØÕÐ¹Ö"; 
        icon                = ""; 
#endif 
        max_level           = 2; 
        type                = 13; 
