...
/* 
58590  "DanÃ§arina_Cura Veneno de Flor do AlÃ©m"58591  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5859 
#define __CPPGEN_GNET_SKILL5859 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5859:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5859 }; 
        Skill5859 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5859Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5859Stub ():SkillStub (5859) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÎèÅ®_½â±Ë°¶»¨¶¾"; 
        nativename          = "ÎèÅ®_½â±Ë°¶»¨¶¾"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 1000; 
        type                = 2; 
