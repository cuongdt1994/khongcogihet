...
#ifndef __CPPGEN_GNET_SKILL6446 
#define __CPPGEN_GNET_SKILL6446 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6446:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6446 }; 
        Skill6446 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6446Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
