...
/* 
54380  "ΦDama da Tempestade"
54381  "^ff5c00ΨSugador de Energia
...
em invocações diferentes. Reduz o dano que você recebe por ^96f5ff9^ffffff segundos.

^a6caf0Custa ^ffffff1 ^a6caf0Chi.

^ffeaabEfeito da Runa Argêntea:@1
^ffeaabNível 1 a 4: O dano que você recebe é reduzido em ^96f5ff20%%^ffeaab
^ffeaabNível 5 a 7: O dano que você recebe é reduzido em ^96f5ff30%%^ffeaab
^ffeaabNível 8 a 9: O dano que você recebe é reduzido em ^96f5ff40%%^ffeaab
^ffeaabNível 10 a 50: O dano que você recebe é reduzido em ^96f5ff50%%^ffeaab@1@2
^ffeaabO dano que você recebe é reduzido em ^96f5ff%d%%^ffeaab@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5438 
#define __CPPGEN_GNET_SKILL5438 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5438:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5438 }; 
        Skill5438 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5438Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (1 * 972);
