...
/* 
32820  "Tempestade das Trevas"32821  "Habilidade especial para Vórtice Turbulento, Puxar de Área"*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetTarget ()->GetCls() == -1 || skill->GetTarget ()->GetCls() == 127 ? 0.4 : 0.8);
            skill->GetVictim ()->SetAmount (2);
            skill->GetVictim ()->SetValue (skill->GetTarget ()->GetCls() == -1 || skill->GetTarget ()->GetCls() == 127 ? 0.4 : 0.8);
