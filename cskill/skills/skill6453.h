...
/* 
64530  "Ataque Normal Efeito de Reduzir HP por Porcentagem"64531  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6453 
#define __CPPGEN_GNET_SKILL6453 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6453:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6453 }; 
        Skill6453 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6453Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6453Stub ():SkillStub (6453) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"普攻百分比掉血效果"; 
        nativename          = "普攻百分比掉血效果"; 
        icon                = ""; 
#endif 
        max_level           = 99999; 
        type                = 3; 
