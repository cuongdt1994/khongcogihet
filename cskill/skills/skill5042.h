...
/* 
50420  "ΨIndulgência Assassina"50421  "^ff5c00ΨIndulgência Assassina
...
O alvo deve estar dentro do alcance do efeito para ser empurrado
^ff0000Nível 1 a 4: O alcance do efeito é aumentado para ^96f5ff12^ff0000 metros
^ff0000Nível 5 a 7: O alcance do efeito é aumentado para ^96f5ff13^ff0000 metros
^ff0000Nível 8 a 9: O alcance do efeito é aumentado para ^96f5ff14^ff0000 metros
^ff0000Nível 10: O alcance do efeito é aumentado para ^96f5ff15^ff0000 metros.@1@2
O alcance do efeito é aumentado para ^96f5ff%d^ff0000 metros.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
            int _glyph_value = get_glyph(skill->GetLevel (), 12, 13, 14, 15);


            int rapel = 0;
			if(skill->GetSection () < 2) rapel = 100;

            skill->GetVictim ()->SetProbability (1.0 * skill->GetT0 () <= _glyph_value ? rapel : 0);
