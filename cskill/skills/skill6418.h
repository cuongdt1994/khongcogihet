...
/* 
64180  "Mestre Cervejeiro-Dano de Espada do Predador de Almas"64181  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6418 
#define __CPPGEN_GNET_SKILL6418 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6418:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6418 }; 
        Skill6418 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6418Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6418Stub ():SkillStub (6418) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æ∆œ…-◊∑ªÍΩ£…À∫¶"; 
        nativename          = "æ∆œ…-◊∑ªÍΩ£…À∫¶"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
