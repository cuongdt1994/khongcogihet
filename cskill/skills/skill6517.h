...
/* 
65170  "○Lua Frígida"65171  "^8080ff○Lua Frígida            
...
Maneja rapidamente a clava, causando dano base mais ^96f5ff
%d^ffffff de dano físico ao alvo, reduzindo o Chi dele em^96f5ff10^ffffff,
e causando a Marca do Vento. A marca dura ^96f5ff15^ffffff segundos.

^a6caf0A Marca só tem efeito nos jogadores.

^d618e7 Reduz ^96f5ff5^d618e7 Chi adicional."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6517 
#define __CPPGEN_GNET_SKILL6517 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6517:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6517 }; 
        Skill6517 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6517Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
