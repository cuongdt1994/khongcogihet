...
/* 
10050  "Dança Glacial"10051  "^ffffffDança Glacial (Nível %d)^ffcb4Alcance: ^ffffffJogador^ffcb4aCusto de SP: ^96f5ff40^ffffff^ffcb4aCusto de EP: ^96f5ff500^ffffff^ffcb4aInstantâneo^ffcb4aEspera: ^ffffff20 ^ffcb4asegundos^ffcb4aClasse Requisitada: ^ffffffTodasUsa grande quantidade de folhas imobilizadas para se proteger,ganhando aumento de 2%% de taxa de crítico,durante %ds.Não é acumulativo com outras magias.^ffa083For: Cada ponto aumenta 1s de duração."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 1110015,1110020,1110025,1110030,1110035,1110040,1110045,1110050,1110055,1110060 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
