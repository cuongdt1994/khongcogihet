...
#ifndef __CPPGEN_GNET_SKILL6098 
#define __CPPGEN_GNET_SKILL6098 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6098:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6098 }; 
        Skill6098 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6098Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
