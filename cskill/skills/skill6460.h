...
/* 
64600  "Festival da Primavera Barco de Corrida Acelera 10 segundos"64601  "Usado para acelerar o Barco na Corrida de Barco. 5* 10"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6460 
#define __CPPGEN_GNET_SKILL6460 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6460:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6460 }; 
        Skill6460 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6460Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6460Stub ():SkillStub (6460) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021暖春活动赛艇加速10秒"; 
        nativename          = "2021暖春活动赛艇加速10秒"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
