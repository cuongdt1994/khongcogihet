...
/* 
25560  "Caçador do Destino"25561  "^ffffffCaçador do Destino (Nível %d)^ffcb4aAlcance: ^ffffff20 ^ffcb4ametros^ffcb4aCusto em MP: ^96f5ff%.1f^ffffff^ffcb4aCanalização: ^ffffff0.1 ^ffcb4asegundos^ffcb4aConjuração: ^ffffff0.6 ^ffcb4asegundos^ffcb4aEspera: ^ffffff30.0 ^ffcb4asegundos^ffcb4aArma: ^ffffffSabre^ffcb4aCultivo Necessário: ^ffffffLúcidoMarque magicamente um inimigo como seu oponente destinado. Após ^96f5ff8^ffffff segundos, a marca causa dano físico básico mais ^96f5ff%.1f^ffffff e atordoa o alvo por ^96f5ff6^ffffff segundos. Se o alvo causar dano a qualquer pessoa, a marca é removida.^a6caf0Custa ^ffffff50 ^a6caf0 Chi."*/ 
