...
/* 
54030  "危Esplendor M谩gico"54031  "A habilidade do Mundo do Gelo"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5403 
#define __CPPGEN_GNET_SKILL5403 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5403:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5403 }; 
        Skill5403 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5403Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
       ...
       bool StateAttack (Skill * skill) const
        {
            ...
            /*skill->GetVictim ()->SetProbability (1.0 * 100); // Skill de Congelamento
            skill->GetVictim ()->SetTime (6000); // 5 Segundos
    ...
    { 
        ...
        {
        return (float) (player->GetFilterID (4501));
        }
#endif 
#ifdef _SKILL_SERVER 
