...
/* 
25960  "Rapidez Lunar"
25961  "^ffffffRapidez Lunar (Nível %d)
...
Absorva o poder da lua, aumentando sua velocidade em ^96f5ff50%%^ffffff
e ficando imune a efeitos de imobilização por ^96f5ff%.1f^ffffff segundos.
    ...
    public: 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (21 * 7.5 * skill->GetLevel ());
