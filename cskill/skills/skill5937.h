...
/* 
59370  "Efeito de Aura G锚mea Preta/Branca"59371  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5937 
#define __CPPGEN_GNET_SKILL5937 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5937:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5937 }; 
        Skill5937 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5937Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5937Stub ():SkillStub (5937) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"黑白双子用光环效果"; 
        nativename          = "黑白双子用光环效果"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
