...
/* 
60860  "Efeito Ricochete de Praga Fatal"60861  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6086 
#define __CPPGEN_GNET_SKILL6086 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6086:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6086 }; 
        Skill6086 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6086Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6086Stub ():SkillStub (6086) 
    { 
        cls                 = 262; 
#ifdef _SKILL_CLIENT 
        name                = L"éâÎÁ¹Æµ¯ÌøÐ§¹û"; 
        nativename          = "éâÎÁ¹Æµ¯ÌøÐ§¹û"; 
        icon                = "ÏÉÍ¯À¥ÂØÕ¶.dds"; 
#endif 
        max_level           = 4; 
        type                = 3; 
