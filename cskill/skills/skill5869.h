...
/* 
58690  "Monstro do Espelho - Espelho_Reflete Dano"58691  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5869 
#define __CPPGEN_GNET_SKILL5869 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5869:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5869 }; 
        Skill5869 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5869Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5869Stub ():SkillStub (5869) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"¾µÄ§-¾µ_ÉËº¦·´À¡"; 
        nativename          = "¾µÄ§-¾µ_ÉËº¦·´À¡"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 99999; 
        type                = 3; 
