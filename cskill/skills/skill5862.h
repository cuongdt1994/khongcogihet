...
/* 
58620  "Dan√ßarina_Veneno da Flor Branca do Al√©m"58621  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5862 
#define __CPPGEN_GNET_SKILL5862 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5862:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5862 }; 
        Skill5862 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5862Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5862Stub ():SkillStub (5862) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ŒË≈Æ_∞◊±À∞∂ª®∂æ"; 
        nativename          = "ŒË≈Æ_∞◊±À∞∂ª®∂æ"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 1000; 
        type                = 3; 
