...
/* 
66850  "Transforma莽茫o Principal da Atiradora"66851  "Anular habilidade, 1 Cancelar, 2 Transforma莽茫o"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6685 
#define __CPPGEN_GNET_SKILL6685 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6685:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6685 }; 
        Skill6685 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6685Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
