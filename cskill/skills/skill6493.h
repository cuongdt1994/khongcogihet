...
/* 
64930  "Apanhador das Sombras"64931  "^ffffffApanhador das Sombras               
...
Remove imediatamente os efeitos negativos, como Paralisia, Desarme, Silêncio, Congelamento, 
Atordoamento e Sono. Ative Furtividade, aumentando velocidade de movimento
em ^96f5ff100%%^ffffff. Dura ^96f5ff3^ffffff segundo. 
Deixa uma sombra no local. Dura ^96f5ff10^ffffff segundo. Use a habilidade para
se tornar imune a efeito de restrição de movimento em ^96f5ff8^ffffff segundos.

^a6caf0Pode ser usado quando infligido com efeitos de controle."*/ 
