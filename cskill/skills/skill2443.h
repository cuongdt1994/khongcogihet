...
{ 
    ...
    { 
        static int aarray[10] = { 42257,42257,42257,42257,42257,42257,42257,42257,42257,42257 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static int aarray[10] = { 1,4,7,10,13,16,19,22,25,28 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
