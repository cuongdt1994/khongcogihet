...
/* 
67860  "Aura Tao铆sta da Morte Instant芒nea de Espada Gigante"67861  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6786 
#define __CPPGEN_GNET_SKILL6786 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6786:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6786 }; 
        Skill6786 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6786Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6786Stub ():SkillStub (6786) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"道家-秒杀巨剑光环"; 
        nativename          = "道家-秒杀巨剑光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 2; 
