...
/* 
38610  "ΨFúria Bestial"38611  "^ff5c00ΨFúria Bestial
...
^00ff00Nível 1 a 4: Aumenta a duração para ^96f5ff24^00ff00 segundos.
^00ff00Nível 5 a 7: Aumenta a duração para ^96f5ff26^00ff00 segundos.
^00ff00Nível 8 a 9: Aumenta a duração para ^96f5ff28^00ff00 segundos.
^00ff00Nível 10: Aumenta a duração para ^96f5ff30^00ff00 segundos.@1@2
^00ff00Aumenta a duração para ^96f5ff%d^00ff00 segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
			int _glyph_value = get_glyph(skill->GetLevel (), 24500, 26500, 28500, 30500);
