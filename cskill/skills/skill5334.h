...
#ifndef __CPPGEN_GNET_SKILL5334 
#define __CPPGEN_GNET_SKILL5334 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5334:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5334 }; 
        Skill5334 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5334Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5334Stub ():SkillStub (5334) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"Ê¦Í½ÏÄ¹ØÂ¯»ð"; 
        nativename          = "Ê¦Í½ÏÄ¹ØÂ¯»ð"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
