...
#ifndef __CPPGEN_GNET_SKILL6732 
#define __CPPGEN_GNET_SKILL6732 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6732:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6732 }; 
        Skill6732 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6732Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    public: 
        ...
        { 
            static int aarray[10] = { 7,7,7,7,7,7,7,7,7,7 }; 
