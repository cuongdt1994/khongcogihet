...
/* 
64760  "Soco Esquerdo"64761  "^ffffffSoco Esquerdo            Nível %d  
...
^ffcb4aCultivo ^ffffff Harmonioso
Esmague o chão com seu punho esquerdo, causando em até ^96f5ff8^ffffff metros, ^96f5ff130%%^ffffff de dano de ataque 
básico e mais ^96f5ff%.1f^ffffff de dano físico aos inimigos.
Em ^96f5ff3^ffffff segundos, reduz a velocidade de canalização do alvo em 
^96f5ff30%%^ffffff. Concede a você a Marca de Yin. 
