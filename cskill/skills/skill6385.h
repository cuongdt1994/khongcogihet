...
/* 
63850  "ΨMaré Flamejante"
63851  "^ff5c00ΩMaré Flamejante
...
Pode carregar até duas vezes, com uma espera de ^96f5ff5 ^ffeaabsegundos.
^ffeaabNível 1 a 4: Causa ^96f5ff32%% ^ffeaabde dano de arma adicional.
^ffeaabNível 5 a 7: Causa ^96f5ff48%% ^ffeaabde dano de arma adicional.
^ffeaabNível 8 a 9: Causa ^96f5ff64%% ^ffeaabde dano de arma adicional.
^ffeaabNível 10: Causa ^96f5ff80%% ^ffeaabde dano de arma adicional.@1@2
^ffeaabPode carregar até duas vezes. Causa ^96f5ff%d%% ^ffeaabde dano adicional da arma.@2"
*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6385 
#define __CPPGEN_GNET_SKILL6385 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6385:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6385 }; 
        Skill6385 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6385Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
               float _glyph_value = get_glyph(skill->GetLevel (), 0.32, 0.48, 0.64, 0.8);
