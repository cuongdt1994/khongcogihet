...
/* 
41440  "ΨNuvem Distante"41441  "^ff5c00ΨNuvem Distante
...
^00ff00Nível 5 a 7: O alcance aumenta em ^96f5ff6^00ff00 metros.
^00ff00Nível 8 a 9: O alcance aumenta em ^96f5ff8^00ff00 metros.
^00ff00Nível 10: O alcance aumenta em ^96f5ff10^00ff00 metros.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    float GetPraydistance (Skill * skill) const
    {
        ...
        return (float) ((skill->GetPlayer ()->GetRange () + 10) + _glyph_value);
    }
...
bool BlessMe (Skill * skill) const
        ...
        {
            return (float) ((skill->GetPlayer ()->GetRange () + 12.375 + 10) + 10);
        }		
#endif 
#ifdef _SKILL_SERVER 
