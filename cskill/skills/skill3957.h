...
/* 
39570  "ΨLâmina de Cascalho"39571  "^ff5c00ΨLâmina de Cascalho
...
Desfira um golpe devastador no inimigo, causando ^96f5ff110%%^ffffff de
 dano físico básico mais ^96f5ff100%%^ffffff de dano de arma mais ^96f5ff1650^ffffff.

Tem ^96f5ff60%%^ffffff de chance de aplicar o efeito ΨEspírito Arruinado,
fazendo com que seu ^96f5ffΨAtaque Geminiano^ffffff cause adicional de
^96f5ff7950 ^ffffffem Dano de Metal e reduza o nível de Ataque
e Defesa do alvo em ^96f5ff12^ffffff por ^96f5ff3^ffffff minutos.

Tem ^96f5ff25%% ^ffffffde chance de aplicar o efeito
ΨGota de Sangue, fazendo com que seu ^96f5ffΨAtaque de Stalag^ffffff dê
um adicional de ^96f5ff3750 ^ffffffde dano e
atordoe o alvo por ^96f5ff5^ffffff segundos.

^ffcb4aEfeito da Runa Áurea:@1
^ffcb4aNível 1 a 4: Causa um dano de arma adicional de ^96f5ff30%%^ffcb4a e mais ^96f5ff3780^ffcb4a.
^ffcb4aNível 5 a 7: Causa um dano de arma adicional de ^96f5ff45%% ^ffcb4a mais ^96f5ff4670^ffcb4a.
^ffcb4aNível 8 a 9: Causa um dano de arma adicional de ^96f5ff60%% ^ffcb4a mais ^96f5ff5560^ffcb4a.
^ffcb4aNível 10: Causa um dano de arma adicional de ^96f5ff75%% ^ffcb4amais ^96f5ff6450^ffcb4a.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 60); // Perfuração Espiritual
            skill->GetVictim ()->SetTime (180000);
            skill->GetVictim ()->SetFilterDebuffSK3Inc (1);

            skill->GetVictim ()->SetProbability (1.0 * 25); // Sangria
            skill->GetVictim ()->SetTime (6000);  
            skill->GetVictim ()->SetValue (3980);
            skill->GetVictim ()->SetNewValue (3981);
            skill->GetVictim ()->SetNewValue2 (3982);
            skill->GetVictim ()->SetNewValue3 (3983);
            skill->GetVictim ()->SetNewValue4 (-1);
            skill->GetVictim ()->SetAmount (6);  
            skill->GetVictim ()->SetFilterDebuffSK4Inc (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
