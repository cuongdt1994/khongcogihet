...
/* 
55530  "ΨEscudo da Monstruosidade"55531  "^ff5c00ΨEscudo da Monstruosidade
...
^ffeaabNível 1 a 4: Aumenta a duração do seu escudo em ^96f5ff1,0^ffeaab segundos. 
^ffeaabNível 5 a 7: Aumenta a duração do seu escudo em ^96f5ff2,0^ffeaab segundos.
^ffeaabNível 8 a 9: Aumenta a duração do seu escudo em ^96f5ff3,0^ffeaab segundos.
^ffeaabNível 10: Aumenta a duração do seu escudo em ^96f5ff4,0^ffeaab segundos. @1@2
^ffeaabAumenta a duração do seu escudo em ^96f5ff%d.0^ffeaab segundos. @2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5553 
#define __CPPGEN_GNET_SKILL5553 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5553:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5553 }; 
        Skill5553 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5553Stub:public SkillStub 
    { 
    public: 
