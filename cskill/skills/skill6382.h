...
/* 
63820  "ΨMaré Flamejante"63821  "^ff5c00ΩMaré Flamejante
...
^00ff00Nível 1 a 4: Causa um adicional de ^96f5ff40%%^00ff00 do Ataque da Arma.
^00ff00Nível 5 a 7: Causa um adicional de ^96f5ff60%%^00ff00 do Ataque da Arma.
^00ff00Nível 8 a 9: Causa um adicional de ^96f5ff80%%^00ff00 do Ataque da Arma.
^00ff00Nível 10: Causa um adicional de ^96f5ff100%%^00ff00 do Ataque da Arma.@1@2
Pode ativar Vida Residual, aumentando o dano em ^96f5ff%d%%^00ff00 do 
Ataque da Arma.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6382 
#define __CPPGEN_GNET_SKILL6382 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6382:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6382 }; 
        Skill6382 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6382Stub:public SkillStub 
    { 
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3525);
                skill->SetRatio (1.0 + _glyph_ratio_plus);
