...
/* 
67660  "Aura Tao铆sta: Morte Instant芒nea"67661  "Aura de morte Instant芒nea cont铆nua em alcance de n铆vel"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6766 
#define __CPPGEN_GNET_SKILL6766 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6766:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6766 }; 
        Skill6766 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6766Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
