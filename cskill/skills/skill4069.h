...
/* 
40690  "ΨBarreira Natural"40691  "^ff5c00ΨBarreira Natural
...
Aprisiona a Daimon do inimigo em uma barreira de
luz, o impedindo de usar habilidades.

^a6caf0Custa ^ffffff30^a6caf0 de Chi.

^ffeaabEfeito da Runa Argêntea:@1
^ffeaabNível 1 a 4: Dura ^96f5ff15^ffeaab segundos.
^ffeaabNível 5 a 7: Dura ^96f5ff20^ffeaab segundos.
^ffeaabNível 8 a 9: Dura ^96f5ff25^ffeaab segundos.
^ffeaabNível 10: Dura ^96f5ff30^ffeaab segundos.@1@2
...
bool BlessMe (Skill * skill) const
    ...
    { 
        return (float) (player->GetSkilllevel(4069)); 
    }
#endif 
#ifdef _SKILL_SERVER 
