...
/* 
39890  "ΨEspada do Dragão Voador"39891  "^ff5c00ΨEspada do Dragão Voador

^ffcb4aAlcance ^96f5ff28^ffffff  ^ffcb4ametros
^ffcb4aMP ^96f5ff200^ffffff
...
Salte e execute um ataque circular com a sua arma,
causando dano físico básico mais ^96f5ff370%%^ffffff do dano da
 arma mais ^96f5ff8778^ffffff. Causa dano adicional aos alvos
e remove as armas deles com o status Desarmado.
...
^00ffffNível 10: O tempo de canalização é reduzido para ^ffffff0,5^00ffff segundo.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {        
            ...
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetDebuffSeeker2IsActive () ? 100 : 0));
            skill->GetVictim ()->SetTime (7000);
            skill->GetVictim ()->SetWeapondisabled (1);

            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetDebuffSeeker2IsActive () ? 4080 : 1);
            skill->GetVictim ()->SetPhysichurt (1);

            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetFilterDebuffSK2Dec (1);
