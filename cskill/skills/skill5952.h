...
/* 
59520  "Borboleta - Aura de Lama Envenenada"59521  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5952 
#define __CPPGEN_GNET_SKILL5952 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5952:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5952 }; 
        Skill5952 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5952Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5952Stub ():SkillStub (5952) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÄàÌ¶¶¾¹â»·"; 
        nativename          = "ºûµû-ÄàÌ¶¶¾¹â»·"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 2; 
