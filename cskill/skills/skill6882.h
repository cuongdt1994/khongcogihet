...
#ifndef __CPPGEN_GNET_SKILL6882 
#define __CPPGEN_GNET_SKILL6882 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6882:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6882 }; 
        Skill6882 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6882Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
