...
/* 
66800  "Cerco de Monstros Habilidade 9"66801  "2021 NTW AdE. Causa dano a jogadores a at茅 10 metros e fere jogadores que montaram uma barraca."*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6680 
#define __CPPGEN_GNET_SKILL6680 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6680:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6680 }; 
        Skill6680 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6680Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6680Stub ():SkillStub (6680) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"怪物攻城小怪技能9"; 
        nativename          = "怪物攻城小怪技能9"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 100; 
        type                = 1; 
