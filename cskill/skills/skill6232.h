...
/* 
62320  "Ψ Desafio"62321  "^ff5c00 Ψ Desafio 
...
^00ff00Nível 1 a 4: Dano de Fúria aumentado em ^96f5ff15%%
^00ff00Nível 5 a 7: Dano de Fúria aumentado em ^96f5ff20%%
^00ff00Nível 8 a 9: Dano de Fúria aumentado em ^96f5ff25%%
^00ff00 Nível 10: Dano de Fúria aumentado em ^96f5ff30%%^00ff00@1@2
^00ff00Dano de Fúria aumentado em ^96f5ff%d%%^00ff00@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6232 
#define __CPPGEN_GNET_SKILL6232 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6232:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6232 }; 
        Skill6232 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6232Stub:public SkillStub 
    { 
    public: 
