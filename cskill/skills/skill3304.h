...
/* 
33040  "Armadura de Pedra Drac̫nica"33041  "Armadura de Pedra Drac̫nica: ao ser atacado, voc̻ tem a chance de esquivardos efeitos negativos de status por 5 segundos."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetIncdebuffdodge2 (1);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
