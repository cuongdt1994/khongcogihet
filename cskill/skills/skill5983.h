...
/* 
59830  "Poder Um: Redṳ̣o de Canaliza̤̣o"59831  "^ff0000Impresṣo Temporal: Arcano^ffcb4aCanaliza̤̣o ^ffffffInstant̢nea^ffcb4aEspera ^ffffff60,0 ^ffcb4asegundos^FFFFFFUse para ativar a energia do Buda interno. Em ^96f5ff20^FFFFFF segundos,todo o tempo de canaliza̤̣o de habilidade ̩ reduzido em^96f5ff50%%^FFFFFF.^ff6666Poder fragmentado usado para ser contido na Impresṣo Temporal.Recobrou sua radi̢ncia devido a estabiliza̤̣o da Bolsa Temporal"*/ 
