...
/* 
28940  "1503 Espinho Noturno Mãos-estranhas"28941  "Ataque mágico de Fogo"*/ 
    ...
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				skill->SetFiredamage (skill->GetMagicattack () * skill->GetLevel () * 0.1 + -0.1);
