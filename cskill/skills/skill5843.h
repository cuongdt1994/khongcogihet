...
/* 
58430  "Mestre Espadachim - Efeito de Sacar e Cortar"58431  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5843 
#define __CPPGEN_GNET_SKILL5843 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5843:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5843 }; 
        Skill5843 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5843Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5843Stub ():SkillStub (5843) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"½£Ê¥-°Îµ¶Õ¶Ð§¹û"; 
        nativename          = "½£Ê¥-°Îµ¶Õ¶Ð§¹û"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
