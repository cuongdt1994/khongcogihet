...
/* 
65310  "●Solidificação"65311  "^8080ff●Solidificação            ^ffcb4aHabilidade Passiva^ffcb4aCultivo ^ffffffNobreBloqueie dano direto igual a ^96f5ff%d%%^ffffff do seu HP máximo e mais ^96f5ff100^ffffff.Até ^96f5ff3000^ffffff no total.^f7dfa5O Bloquear aumenta em ^96f5ff300^f7dfa5."*/ 
...
{ 
    ...
    { 
        ...
        {            
            skill->GetPlayer ()->SetIncsformmonkeyDefense (skill->GetPlayer ()->GetMaxhp () < 3000 ? 100 + (skill->GetPlayer ()->GetMaxhp () * (0.05)) : 3000);
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
