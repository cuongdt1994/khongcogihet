...
/* 
61980  "Efeito de Teletransporte do Cal. Anni"61981  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6198 
#define __CPPGEN_GNET_SKILL6198 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6198:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6198 }; 
        Skill6198 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6198Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6198Stub ():SkillStub (6198) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"周年庆地宫传入效果"; 
        nativename          = "周年庆地宫传入效果"; 
        icon                = ""; 
#endif 
        max_level           = 999; 
        type                = 3; 
