...
/* 
61190  "General - Efeito de Habilidade de Golpe B谩rbaro"61191  "Dano de Fera: 0,01*HP M谩x., Penetrar DefesaDano n茫o feral: 0,5*HP M谩x., Penetrar Defesa"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6119 
#define __CPPGEN_GNET_SKILL6119 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6119:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6119 }; 
        Skill6119 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6119Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6119Stub ():SkillStub (6119) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"将军-兽兽打击技能效果"; 
        nativename          = "将军-兽兽打击技能效果"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
