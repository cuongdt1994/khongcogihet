...
/* 
41520  "ΨCorte do Orgulho"41521  "^ff5c00ΨCorte do Orgulho
...
Adiciona o efeito de desarmamento ao carregar completamente, desarmando o alvo por até ^96f5ff5^ff0000 segundos
^ff0000Nível 1 a 4: Causa ^96f5ff35%%^ff0000 de dano adicional quando totalmente carregada.
^ff0000Nível 5 a 7: Causa ^96f5ff40%%^ff0000 de dano adicional quando totalmente carregada.
^ff0000Nível 8 a 9: Causa ^96f5ff45%%^ff0000 de dano adicional quando totalmente carregada.
^ff0000Nível 10: Causa ^96f5ff50%%^ff0000 de dano adicional ao carregar completamente.@1@2
Adiciona o efeito de desarmamento ao carregar completamente, desarmando o alvo por até ^96f5ff5^ff0000 segundos
Causa ^96f5ff%d%%^ff0000 de dano adicional ao carregar completamente.@2"*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio ((skill->GetCharging () / 2100) * 3.1 + (skill->GetCharging () >= 2100 ? _glyph_value : 0 ));
