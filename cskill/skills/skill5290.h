...
/* 
52900  "Espera Oportunista"52901  "^ff0000Espera Oportunista Nível %d
^ffffffEntra no estado de condição Furtiva.
Espera de ^96f5ff%d^ffffff minutos. Disponível quando está fora de combate.
Sai da furtividade ao deslocar-se ou entrar em combate."*/ 
...
{ 
    ...
    { 
        ...
        skill->GetVictim ()->SetInvisibleForced (1);
        return true; 
    } 
#endif 
#ifdef _SKILL_SERVER 
