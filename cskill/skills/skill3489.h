...
/* 
34890  "ΨEstrondo de Trovão"34891  "^ff5c00ΨEstrondo de Trovão
...
Dispare uma explosão de relâmpagos, atingindo os inimigos a até ^96f5ff8^ffffff metros
do alvo. Causa dano físico básico mais ^96f5ff7717 ^ffffffcomo dano de Metal.

^a6caf0Custa ^ffffff2^a6caf0 unidades de munição.
...
^00ffffNível 10: O tempo de canalização é reduzido para ^ffffff0,5 ^00ffffsegundo.
