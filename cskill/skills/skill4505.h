...
/* 
45050  "ΨMaldição: Demência"45051  "^ff5c00ΨMaldição: Demência
...
^00ffffNão diminui mais as velocidades de movimento e canalização.
^00ffffNível 1 a 4: Reduz o Ataque Mágico do alvo em ^ffffff200%%^00ffff por ^ffffff10^00ffff segundos.
^00ffffNível 5 a 7: Reduz o Ataque Mágico do alvo em ^ffffff250%%^00ffff por ^ffffff10^00ffff segundos.
^00ffffNível 8 a 9: Reduz o Ataque Mágico do alvo em ^ffffff300%%^00ffff por ^ffffff10^00ffff segundos.
^00ffffNível 10: Reduz o Ataque Mágico do alvo em ^ffffff350%%^00ffff por ^ffffff10^00ffff segundos.@1@2
^00ffffNão diminui mais as velocidades de movimento e canalização. Reduz o Ataque Mágico do alvo em ^ffffff%d%%^00ffff por ^ffffff10^00ffff segundos.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                  ...
                  skill->SetRatio (1);
                  skill->SetDamage (skill->GetMagicattack () + (skill->GetAttack () * 0.2));
    ...
    { 
        ...
        {
			float _glyph_value = get_glyph(skill->GetLevel (), 2.0, 2.5, 3.0, 3.5 );
