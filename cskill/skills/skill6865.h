...
/* 
68650  "Aura da Contagem Regressiva das Tr锚s Deusas"68651  "Alcance Limpo 4602"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6865 
#define __CPPGEN_GNET_SKILL6865 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6865:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6865 }; 
        Skill6865 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6865Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6865Stub ():SkillStub (6865) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"三女神书清倒计时光环"; 
        nativename          = "三女神书清倒计时光环"; 
        icon                = "烈焰之矢1.dds"; 
#endif 
        max_level           = 999; 
        type                = 2; 
