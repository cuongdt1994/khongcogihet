...
/* 
59490  "Borboleta - TrovÃ£o em Cone "59491  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5949 
#define __CPPGEN_GNET_SKILL5949 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5949:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5949 }; 
        Skill5949 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5949Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5949Stub ():SkillStub (5949) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ºûµû-ÉÈÐÎÉÁµç"; 
        nativename          = "ºûµû-ÉÈÐÎÉÁµç"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 100; 
        type                = 3; 
