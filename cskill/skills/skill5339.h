...
/* 
53390  "EmpurrÃ£o Singular Circular do Chungyun"53391  "EmpurrÃ£o Singular Circular do Chungyun"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5339 
#define __CPPGEN_GNET_SKILL5339 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5339:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5339 }; 
        Skill5339 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5339Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5339Stub ():SkillStub (5339) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÖØÔÆ×ÔÉíÔ²»÷ÍË"; 
        nativename          = "ÖØÔÆ×ÔÉíÔ²»÷ÍË"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 1; 
