...
/* 
38200  "ΨCorte do Dragão"38201  "^ff5c00ΨCorte do Dragão
...
Drena ^ffffff16^00ffff de Chi por Carga de Ataque do alvo.
^00ffffNível 1 a 4: Causa ^ffffff40%%^00ffff a mais de dano por arma e mais ^ffffff640^00ffff.
^00ffffNível 5 a 7: Causa ^ffffff60%%^00ffff a mais de dano por arma e mais ^ffffff960^00ffff.
^00ffffNível 8 a 9: Causa ^ffffff80%%^00ffff a mais de dano por arma e mais ^ffffff1280^00ffff.
^00ffffNível 10: Causa ^ffffff100%%^00ffff a mais de dano por arma e mais ^ffffff1600^00ffff.@1@2
Drena ^ffffff16^00ffff de Chi por Carga de Ataque do alvo.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {          
            ...
            skill->GetVictim ()->SetValue (-(_charge_merc_count * 16));
