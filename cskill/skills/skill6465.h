...
#ifndef __CPPGEN_GNET_SKILL6465 
#define __CPPGEN_GNET_SKILL6465 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6465:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6465 }; 
        Skill6465 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6465Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill6465Stub ():SkillStub (6465) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"2021暖春活动赛艇正反面减速"; 
        nativename          = "2021暖春活动赛艇正反面减速"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 2; 
