...
/* 
55060  "Teleporte BoS"55061  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5506 
#define __CPPGEN_GNET_SKILL5506 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5506:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5506 }; 
        Skill5506 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5506Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        static float aarray[10] = { 145.00,145.00,145.00,145.00,145.00,145.00,145.00,145.00,145.00,145.00 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
