...
/* 
58790  "Monstro do Espelho - Morte Instant√¢nea em √Årea"58791  ""*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL5879 
#define __CPPGEN_GNET_SKILL5879 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5879:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5879 }; 
        Skill5879 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5879Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
...
#endif 
    Skill5879Stub ():SkillStub (5879) 
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"æµƒß-»∫ÃÂ√Î…±"; 
        nativename          = "æµƒß-»∫ÃÂ√Î…±"; 
        icon                = "¡“—Ê÷Æ ∏1.dds"; 
#endif 
        max_level           = 10; 
        type                = 3; 
