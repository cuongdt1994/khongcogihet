...
#ifndef __CPPGEN_GNET_SKILL5661 
#define __CPPGEN_GNET_SKILL5661 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill5661:public Skill 
    { 
    public: 
        enum { SKILL_ID = 5661 }; 
        Skill5661 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill5661Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
    ...
    { 
        ...
        extra_effect        = 0; 
        immune_casting      = 0; 
        pre_skills.push_back (std::pair < ID, int >(1659, 1)); 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (64247);
