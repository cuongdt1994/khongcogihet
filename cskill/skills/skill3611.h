...
/* 
36110  "ΨEsmagador de Pedras"36111  "^ff5c00ΨEsmagador de Pedras

^ffcb4aAlcance ^96f5ff28,5^ffffff ^ffcb4ametros
^ffcb4aCusto em MP ^96f5ff750^ffffff
^ffcb4aCanalização ^ffffff2.0 ^ffcb4asegundos
^ffcb4aConjuração ^ffffff1.0 ^ffcb4asegundo
^ffcb4aEspera ^ffffff60.0 ^ffcb4asegundos
^ffcb4aArma ^ffffffEsferas ou Desarmado
^ffcb4aBônus de Runa ^ff5c00Maestria Marcial

^ffcb4aCultivo ^ffffffAlma Celestial
A forma mais elevada de pesquisa mágica no elemento Terra.
Invoca uma chuva de pedras que cai em todos os inimigos dentro de 
^96f5ff8 ^ffffffmetros do seu alvo, causando dano mágico básico
mais ^96f5ff400%% ^ffffffdo Dano da Arma mais ^96f5ff15345^ffffff
como dano de Terra. Reduz a Taxa de Ataque do alvo em ^96f5ff30%%^ffffff
por ^96f5ff8 ^ffffffsegundos.

^a6caf0Custa ^ffffff2 ^a6caf0Chis.

^ffeaabEfeito da Runa Argêntea:@1
Causa dano adicional em alvos silenciados.
^ffeaabNível 1 a 4: Causa ^96f5ff28%% ^ffeaabde dano adicional em alvos silenciados.
^ffeaabNível 5 a 7: Causa ^96f5ff42%% ^ffeaabde dano adicional em alvos silenciados.
^ffeaabNível 8 a 9: Causa ^96f5ff56%% ^ffeaabde dano adicional em alvos silenciados.
^ffeaabNível 10: Causa ^96f5ff70%%^ffeaabde dano adicional em alvos silenciados.@1@2
Causa dano adicional em alvos silenciados.
Causa ^96f5ff%d%% ^ffeaab de dano adicional em alvos silenciados.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            float _glyph_value = get_glyph(skill->GetLevel (), 0.28, 0.42, 0.56, 0.7);
