...
/* 
18350  "Compartilhar a Furtividade"18351  "^ffff00Furtividade Compartilhada^ffcb4aCusto em MP: ^96f5ff454^ffffff^ffcb4aConjura莽茫o: ^ffffff0.9 ^ffcb4asegundos^ffcb4aDura莽茫o: ^ffffff1.0 ^ffcb4asegundos^ffcb4aEspera: ^ffffff120.0 ^ffcb4asegundos^ffcb4aRestri莽玫es da Arma: ^ffffffAdaga^ffcb4aEstima: ^ffffffMahayanaColoca todos os membros da equipe em um raio de ^96f5ff12^ffffff metrosem modo de Furtividade por at茅 ^96f5ff5^ffffff segundos.^a6caf0Custa ^ffffff1^a6caf0 Chi"*/ 
