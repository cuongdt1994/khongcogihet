...
/* 
65800  "ΨLua Frígida"65801  "^ff5c00ΨLua Frígida              
...
#ifndef __CPPGEN_GNET_SKILL6580 
#define __CPPGEN_GNET_SKILL6580 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6580:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6580 }; 
        Skill6580 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6580Stub:public SkillStub 
    { 
    public: 
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 0 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static int aarray[10] = { 70216,70216,70216,70216,70216,70216,70216,70216,70216,70216 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
