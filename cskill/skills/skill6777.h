...
/* 
67770  "Efeito de Morte Instant芒nea de Or谩culo"67771  "O efeito 茅 morte instant芒nea"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6777 
#define __CPPGEN_GNET_SKILL6777 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6777:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6777 }; 
        Skill6777 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6777Stub:public SkillStub 
    { 
    public: 
#ifdef _SKILL_SERVER 
