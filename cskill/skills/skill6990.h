...
/* 
69900  "ΨMente Taoista"69901  "^ff5c00ΨMente Taoista
...
^ff0000Nível 1 a 4: O efeito dura ^96f5ff4^ff0000 segundos.
^ff0000Nível 5 a 7: O efeito dura ^96f5ff6^ff0000 segundos.
^ff0000Nível 8 a 9: O efeito dura ^96f5ff8^ff0000 segundos.
^ff0000Nível 10: O efeito dura ^96f5ff10^ff0000 segundos.@1@2
O efeito dura ^96f5ff%d^ff0000 segundos.@2"*/ 
/* SKILL DESCRIPTION END */ 

#ifndef __CPPGEN_GNET_SKILL6990 
#define __CPPGEN_GNET_SKILL6990 
namespace GNET 
{ 
#ifdef _SKILL_SERVER 
    class Skill6990:public Skill 
    { 
    public: 
        enum { SKILL_ID = 6990 }; 
        Skill6990 ():Skill (SKILL_ID){ } 
    }; 
#endif 
    class Skill6990Stub:public SkillStub 
    { 
    public: 
