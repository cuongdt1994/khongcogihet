...
static SetLuaStorage __stub_SetLuaStorage (RPC_SETLUASTORAGE, new SetLuaStorageArg, new SetLuaStorageRes);
static GetLuaStorage __stub_GetLuaStorage (RPC_GETLUASTORAGE, new GetLuaStorageArg, new GetLuaStorageRes);
static SetNewTrashBox __stub_SetNewTrashBox (RPC_SETNEWTRASHBOX, new SetNewTrashBoxArg, new SetNewTrashBoxRes);
static GetNewTrashBox __stub_GetNewTrashBox (RPC_GETNEWTRASHBOX, new GetNewTrashBoxArg, new GetNewTrashBoxRes);
static SetNewRoleDetail __stub_SetNewRoleDetail (RPC_SETNEWROLEDETAIL, new SetNewRoleDetailArg, new SetNewRoleDetailRes);
static GetNewRoleDetail __stub_GetNewRoleDetail (RPC_GETNEWROLEDETAIL, new GetNewRoleDetailArg, new GetNewRoleDetailRes);
